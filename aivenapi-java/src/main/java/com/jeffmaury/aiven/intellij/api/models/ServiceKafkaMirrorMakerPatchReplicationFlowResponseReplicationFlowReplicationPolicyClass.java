...
public enum ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlowReplicationPolicyClass implements ValuedEnum {
    ...
    public static ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlowReplicationPolicyClass forValue(@jakarta.annotation.Nonnull final String searchValue) {
