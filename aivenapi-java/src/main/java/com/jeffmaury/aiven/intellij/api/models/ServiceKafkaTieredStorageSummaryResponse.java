...
public class ServiceKafkaTieredStorageSummaryResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTieredStorageSummaryResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceKafkaTieredStorageSummaryResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaTieredStorageSummaryResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setStorageUsageHistory(@jakarta.annotation.Nullable final ServiceKafkaTieredStorageSummaryResponseStorageUsageHistory value) {
