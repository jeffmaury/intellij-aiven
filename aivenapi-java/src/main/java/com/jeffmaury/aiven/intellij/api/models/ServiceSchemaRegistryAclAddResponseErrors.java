...
public class ServiceSchemaRegistryAclAddResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistryAclAddResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistryAclAddResponseErrors() {
    ...
    public static ServiceSchemaRegistryAclAddResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistryAclAddResponseErrors();
    }
    /**
