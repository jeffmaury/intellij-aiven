...
public class BillingGroupProjectsAssignResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupProjectsAssignResponseErrors and sets the default values.
     */
    public BillingGroupProjectsAssignResponseErrors() {
    ...
    public static BillingGroupProjectsAssignResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupProjectsAssignResponseErrors();
    }
    /**
