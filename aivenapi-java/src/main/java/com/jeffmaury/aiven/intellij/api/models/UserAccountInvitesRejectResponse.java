...
public class UserAccountInvitesRejectResponse implements AdditionalDataHolder, Parsable {
    ...
    public static UserAccountInvitesRejectResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a UserAccountInvitesRejectResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setAccountInvites(@javax.annotation.Nullable final java.util.List<UserAccountInvitesRejectResponseAccountInvites> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<UserAccountInvitesRejectResponseErrors> value) {
        this.errors = value;
    }
    /**
