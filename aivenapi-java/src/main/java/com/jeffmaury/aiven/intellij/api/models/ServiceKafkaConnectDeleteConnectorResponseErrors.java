...
public class ServiceKafkaConnectDeleteConnectorResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectDeleteConnectorResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectDeleteConnectorResponseErrors() {
    ...
    public static ServiceKafkaConnectDeleteConnectorResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectDeleteConnectorResponseErrors();
    }
    /**
