...
public class ServiceOpenSearchSecurityGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchSecurityGetResponseErrors and sets the default values.
     */
    public ServiceOpenSearchSecurityGetResponseErrors() {
    ...
    public static ServiceOpenSearchSecurityGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchSecurityGetResponseErrors();
    }
    /**
