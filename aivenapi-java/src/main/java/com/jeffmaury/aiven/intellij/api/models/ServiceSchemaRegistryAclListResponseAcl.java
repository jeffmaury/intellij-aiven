...
public class ServiceSchemaRegistryAclListResponseAcl implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistryAclListResponseAcl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("permission", (n) -> { this.setPermission(n.getEnumValue(ServiceSchemaRegistryAclListResponseAclPermission::forValue)); });
     ...
     */
    public void setPermission(@jakarta.annotation.Nullable final ServiceSchemaRegistryAclListResponseAclPermission value) {
