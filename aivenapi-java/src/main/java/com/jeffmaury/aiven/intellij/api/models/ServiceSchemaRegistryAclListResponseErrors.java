...
public class ServiceSchemaRegistryAclListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistryAclListResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistryAclListResponseErrors() {
    ...
    public static ServiceSchemaRegistryAclListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistryAclListResponseErrors();
    }
    /**
