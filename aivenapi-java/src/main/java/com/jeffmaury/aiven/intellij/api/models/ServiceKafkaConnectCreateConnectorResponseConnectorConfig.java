...
public class ServiceKafkaConnectCreateConnectorResponseConnectorConfig implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectCreateConnectorResponseConnectorConfig createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
