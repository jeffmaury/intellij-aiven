...
public class ServiceFlinkGetApplicationVersionResponseSinks implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkGetApplicationVersionResponseSinks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceFlinkGetApplicationVersionResponseSinksColumns>
     */
     ...
     */
    public void setColumns(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkGetApplicationVersionResponseSinksColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final ServiceFlinkGetApplicationVersionResponseSinksOptions value) {
        this.options = value;
    }
    /**
