...
public class WithReferralCodeItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithReferralCodeItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public WithReferralCodeItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<ValidateReferralCodeResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ValidateReferralCodeResponse> executionException = new java.util.concurrent.CompletableFuture<ValidateReferralCodeResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ValidateReferralCodeResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
