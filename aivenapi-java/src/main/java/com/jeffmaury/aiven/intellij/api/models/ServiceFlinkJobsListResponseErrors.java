...
public class ServiceFlinkJobsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkJobsListResponseErrors and sets the default values.
     */
    public ServiceFlinkJobsListResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceFlinkJobsListResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceFlinkJobsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkJobsListResponseErrors();
    }
    /**
