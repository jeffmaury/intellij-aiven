...
public class StaticIPListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new StaticIPListResponseErrors and sets the default values.
     */
    public StaticIPListResponseErrors() {
    ...
    public static StaticIPListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new StaticIPListResponseErrors();
    }
    /**
