...
public enum ServiceKafkaTopicGetResponseTopicConfigFlushMessagesSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigFlushMessagesSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigFlushMessagesSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
