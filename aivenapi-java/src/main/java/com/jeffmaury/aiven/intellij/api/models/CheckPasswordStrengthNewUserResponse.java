...
public class CheckPasswordStrengthNewUserResponse implements AdditionalDataHolder, Parsable {
    ...
    public static CheckPasswordStrengthNewUserResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<CheckPasswordStrengthNewUserResponseErrors>
     */
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<CheckPasswordStrengthNewUserResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setPasswordStrength(@jakarta.annotation.Nullable final CheckPasswordStrengthNewUserResponsePasswordStrength value) {
