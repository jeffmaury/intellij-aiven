...
public class ServiceSchemaRegistryAclDeleteResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistryAclDeleteResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAcl(@javax.annotation.Nullable final java.util.List<ServiceSchemaRegistryAclDeleteResponseAcl> value) {
        this.acl = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceSchemaRegistryAclDeleteResponseErrors> value) {
        this.errors = value;
    }
    /**
