...
public class VpcCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcCreateResponseErrors and sets the default values.
     */
    public VpcCreateResponseErrors() {
    ...
    public static VpcCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcCreateResponseErrors();
    }
    /**
