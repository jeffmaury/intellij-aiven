...
public class ServiceIntegrationGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationGetResponseErrors and sets the default values.
     */
    public ServiceIntegrationGetResponseErrors() {
    ...
    public static ServiceIntegrationGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationGetResponseErrors();
    }
    /**
