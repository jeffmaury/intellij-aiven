...
public class ServiceKafkaMirrorMakerDeleteReplicationFlowResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaMirrorMakerDeleteReplicationFlowResponseErrors and sets the default values.
     */
    public ServiceKafkaMirrorMakerDeleteReplicationFlowResponseErrors() {
    ...
    public static ServiceKafkaMirrorMakerDeleteReplicationFlowResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaMirrorMakerDeleteReplicationFlowResponseErrors();
    }
    /**
