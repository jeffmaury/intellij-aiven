...
public class ServiceCreateResponseServiceServiceIntegrations implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Integration status
     */
    private ServiceCreateResponseServiceServiceIntegrationsIntegrationStatus integrationStatus;
    /**
     ...
     */
    private ServiceCreateResponseServiceServiceIntegrationsUserConfig userConfig;
    /**
     * Instantiates a new ServiceCreateResponseServiceServiceIntegrations and sets the default values.
     */
    public ServiceCreateResponseServiceServiceIntegrations() {
    ...
    public static ServiceCreateResponseServiceServiceIntegrations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceServiceIntegrations();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceCreateResponseServiceServiceIntegrationsIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceCreateResponseServiceServiceIntegrationsUserConfig::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceServiceIntegrationsIntegrationStatus getIntegrationStatus() {
     ...
     * @return a ServiceCreateResponseServiceServiceIntegrationsUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceServiceIntegrationsUserConfig getUserConfig() {
     ...
     */
    public void setIntegrationStatus(@jakarta.annotation.Nullable final ServiceCreateResponseServiceServiceIntegrationsIntegrationStatus value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceCreateResponseServiceServiceIntegrationsUserConfig value) {
