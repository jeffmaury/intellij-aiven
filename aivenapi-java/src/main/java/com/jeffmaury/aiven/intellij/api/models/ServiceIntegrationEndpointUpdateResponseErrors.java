...
public class ServiceIntegrationEndpointUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationEndpointUpdateResponseErrors and sets the default values.
     */
    public ServiceIntegrationEndpointUpdateResponseErrors() {
    ...
    public static ServiceIntegrationEndpointUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationEndpointUpdateResponseErrors();
    }
    /**
