...
public class ServiceFlinkValidateApplicationVersionResponseSinksPosition implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseSinksPosition createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
