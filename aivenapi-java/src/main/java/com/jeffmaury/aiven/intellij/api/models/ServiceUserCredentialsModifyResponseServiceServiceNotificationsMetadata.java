...
public class ServiceUserCredentialsModifyResponseServiceServiceNotificationsMetadata implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsModifyResponseServiceServiceNotificationsMetadata and sets the default values.
     */
    public ServiceUserCredentialsModifyResponseServiceServiceNotificationsMetadata() {
    ...
    public static ServiceUserCredentialsModifyResponseServiceServiceNotificationsMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsModifyResponseServiceServiceNotificationsMetadata();
    }
    /**
