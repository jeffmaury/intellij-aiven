...
public class WithPeerVpcItemRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<VpcPeeringConnectionDeleteResponse> delete() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<VpcPeeringConnectionDeleteResponse> executionException = new java.util.concurrent.CompletableFuture<VpcPeeringConnectionDeleteResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<VpcPeeringConnectionDeleteResponse> delete(@javax.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        try {
