...
public class ProjectCreateResponseProjectEndOfLifeExtensionElasticsearch implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectCreateResponseProjectEndOfLifeExtensionElasticsearch and sets the default values.
     */
    public ProjectCreateResponseProjectEndOfLifeExtensionElasticsearch() {
    ...
    public static ProjectCreateResponseProjectEndOfLifeExtensionElasticsearch createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectCreateResponseProjectEndOfLifeExtensionElasticsearch();
    }
    /**
