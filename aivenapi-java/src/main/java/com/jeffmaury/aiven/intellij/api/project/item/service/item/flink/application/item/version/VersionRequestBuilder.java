...
public class VersionRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceFlinkCreateApplicationVersionResponse> post(@jakarta.annotation.Nonnull final ServiceFlinkCreateApplicationVersionRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceFlinkCreateApplicationVersionResponse> post(@jakarta.annotation.Nonnull final ServiceFlinkCreateApplicationVersionRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
