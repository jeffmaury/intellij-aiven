...
public class ServiceOpenSearchAclUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchAclUpdateResponseErrors and sets the default values.
     */
    public ServiceOpenSearchAclUpdateResponseErrors() {
    ...
    public static ServiceOpenSearchAclUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchAclUpdateResponseErrors();
    }
    /**
