...
public class ServiceClickHouseTieredStorageSummaryResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceClickHouseTieredStorageSummaryResponseErrors and sets the default values.
     */
    public ServiceClickHouseTieredStorageSummaryResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceClickHouseTieredStorageSummaryResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceClickHouseTieredStorageSummaryResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceClickHouseTieredStorageSummaryResponseErrors();
    }
    /**
