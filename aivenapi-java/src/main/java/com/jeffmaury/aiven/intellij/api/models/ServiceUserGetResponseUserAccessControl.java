...
public class ServiceUserGetResponseUserAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserGetResponseUserAccessControl and sets the default values.
     */
    public ServiceUserGetResponseUserAccessControl() {
    ...
    public static ServiceUserGetResponseUserAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserGetResponseUserAccessControl();
    }
    /**
