...
public class PGServiceQueryStatisticsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static PGServiceQueryStatisticsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<PGServiceQueryStatisticsResponseErrors>
     */
     ...
     * @return a java.util.List<PGServiceQueryStatisticsResponseQueries>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<PGServiceQueryStatisticsResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setQueries(@jakarta.annotation.Nullable final java.util.List<PGServiceQueryStatisticsResponseQueries> value) {
        this.queries = value;
    }
}
