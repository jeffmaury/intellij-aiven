...
public class AccountPaymentMethodDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountPaymentMethodDeleteResponseErrors and sets the default values.
     */
    public AccountPaymentMethodDeleteResponseErrors() {
    ...
    public static AccountPaymentMethodDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountPaymentMethodDeleteResponseErrors();
    }
    /**
