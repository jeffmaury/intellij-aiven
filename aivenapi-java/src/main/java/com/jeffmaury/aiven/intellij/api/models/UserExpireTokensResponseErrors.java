...
public class UserExpireTokensResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserExpireTokensResponseErrors and sets the default values.
     */
    public UserExpireTokensResponseErrors() {
    ...
    public static UserExpireTokensResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserExpireTokensResponseErrors();
    }
    /**
