...
public class ServiceOpenSearchSecurityResetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceOpenSearchSecurityResetResponseErrors> errors;
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchSecurityResetResponse and sets the default values.
     */
    public ServiceOpenSearchSecurityResetResponse() {
    ...
    public static ServiceOpenSearchSecurityResetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchSecurityResetResponse();
    }
    /**
     ...
     * @return a java.util.List<ServiceOpenSearchSecurityResetResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceOpenSearchSecurityResetResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(ServiceOpenSearchSecurityResetResponseErrors::createFromDiscriminatorValue)); });
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceOpenSearchSecurityResetResponseErrors> value) {
        this.errors = value;
    }
    /**
