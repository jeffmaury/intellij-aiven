package com.jeffmaury.aiven.intellij.api.project.item.service.item.kafka.rest.topics.item.produce;

import com.jeffmaury.aiven.intellij.api.models.ServiceKafkaTopicMessageProduceRequestBody;
import com.jeffmaury.aiven.intellij.api.models.ServiceKafkaTopicMessageProduceResponse;
...
public class ProduceRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceKafkaTopicMessageProduceResponse post(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageProduceRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceKafkaTopicMessageProduceResponse post(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageProduceRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceKafkaTopicMessageProduceResponse::createFromDiscriminatorValue);
    }
    /**
     * Produce message into a kafka topic
     * @param body ServiceKafkaTopicMessageProduceRequestBody
