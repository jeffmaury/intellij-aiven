...
public class ServiceDatabaseListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceDatabaseListResponseErrors and sets the default values.
     */
    public ServiceDatabaseListResponseErrors() {
    ...
    public static ServiceDatabaseListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceDatabaseListResponseErrors();
    }
    /**
