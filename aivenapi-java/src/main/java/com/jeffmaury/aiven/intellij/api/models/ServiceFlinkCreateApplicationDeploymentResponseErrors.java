...
public class ServiceFlinkCreateApplicationDeploymentResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationDeploymentResponseErrors and sets the default values.
     */
    public ServiceFlinkCreateApplicationDeploymentResponseErrors() {
    ...
    public static ServiceFlinkCreateApplicationDeploymentResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationDeploymentResponseErrors();
    }
    /**
