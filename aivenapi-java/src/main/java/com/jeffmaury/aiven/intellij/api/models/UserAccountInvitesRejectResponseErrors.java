...
public class UserAccountInvitesRejectResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserAccountInvitesRejectResponseErrors and sets the default values.
     */
    public UserAccountInvitesRejectResponseErrors() {
    ...
    public static UserAccountInvitesRejectResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAccountInvitesRejectResponseErrors();
    }
    /**
