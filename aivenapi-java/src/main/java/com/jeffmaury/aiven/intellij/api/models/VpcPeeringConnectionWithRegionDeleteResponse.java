...
public class VpcPeeringConnectionWithRegionDeleteResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<VpcPeeringConnectionWithRegionDeleteResponseErrors> errors;
    /**
     ...
     */
    private VpcPeeringConnectionWithRegionDeleteResponseState state;
    /**
     * State-specific help or error information
     */
    private VpcPeeringConnectionWithRegionDeleteResponseStateInfo stateInfo;
    /**
     ...
     */
    private VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType vpcPeeringConnectionType;
    /**
     * Instantiates a new VpcPeeringConnectionWithRegionDeleteResponse and sets the default values.
     */
    public VpcPeeringConnectionWithRegionDeleteResponse() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a VpcPeeringConnectionWithRegionDeleteResponse
     */
    @jakarta.annotation.Nonnull
    public static VpcPeeringConnectionWithRegionDeleteResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionWithRegionDeleteResponse();
    }
    /**
     ...
     * @return a java.util.List<VpcPeeringConnectionWithRegionDeleteResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<VpcPeeringConnectionWithRegionDeleteResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(VpcPeeringConnectionWithRegionDeleteResponseErrors::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(VpcPeeringConnectionWithRegionDeleteResponseState::forValue)); });
        deserializerMap.put("state_info", (n) -> { this.setStateInfo(n.getObjectValue(VpcPeeringConnectionWithRegionDeleteResponseStateInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("vpc_peering_connection_type", (n) -> { this.setVpcPeeringConnectionType(n.getEnumValue(VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType::forValue)); });
     ...
     * @return a VpcPeeringConnectionWithRegionDeleteResponseState
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionWithRegionDeleteResponseState getState() {
        return this.state;
    }
    /**
     * Gets the state_info property value. State-specific help or error information
     * @return a VpcPeeringConnectionWithRegionDeleteResponseStateInfo
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionWithRegionDeleteResponseStateInfo getStateInfo() {
     ...
     * @return a VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType getVpcPeeringConnectionType() {
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<VpcPeeringConnectionWithRegionDeleteResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setStateInfo(@jakarta.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseStateInfo value) {
     ...
     */
    public void setVpcPeeringConnectionType(@jakarta.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType value) {
