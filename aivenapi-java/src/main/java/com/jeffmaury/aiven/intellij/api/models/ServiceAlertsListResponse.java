...
public class ServiceAlertsListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceAlertsListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceAlertsListResponseAlerts
     */
    @javax.annotation.Nullable
     ...
     * @return a ServiceAlertsListResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setAlerts(@javax.annotation.Nullable final java.util.List<ServiceAlertsListResponseAlerts> value) {
        this.alerts = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceAlertsListResponseErrors> value) {
        this.errors = value;
    }
    /**
