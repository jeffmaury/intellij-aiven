...
public class ServiceListResponseServicesMaintenanceUpdates implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceListResponseServicesMaintenanceUpdates and sets the default values.
     */
    public ServiceListResponseServicesMaintenanceUpdates() {
    ...
    public static ServiceListResponseServicesMaintenanceUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServicesMaintenanceUpdates();
    }
    /**
