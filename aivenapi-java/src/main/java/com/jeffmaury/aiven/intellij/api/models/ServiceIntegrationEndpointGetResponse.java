...
public class ServiceIntegrationEndpointGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationEndpointGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceIntegrationEndpointGetResponseErrors>
     */
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceIntegrationEndpointGetResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setServiceIntegrationEndpoint(@jakarta.annotation.Nullable final ServiceIntegrationEndpointGetResponseServiceIntegrationEndpoint value) {
