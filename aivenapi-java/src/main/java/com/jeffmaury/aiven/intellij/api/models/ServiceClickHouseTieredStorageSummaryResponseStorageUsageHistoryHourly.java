...
public class ServiceClickHouseTieredStorageSummaryResponseStorageUsageHistoryHourly implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceClickHouseTieredStorageSummaryResponseStorageUsageHistoryHourly createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
