...
public class ServiceDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceDeleteResponseErrors and sets the default values.
     */
    public ServiceDeleteResponseErrors() {
    ...
    public static ServiceDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceDeleteResponseErrors();
    }
    /**
