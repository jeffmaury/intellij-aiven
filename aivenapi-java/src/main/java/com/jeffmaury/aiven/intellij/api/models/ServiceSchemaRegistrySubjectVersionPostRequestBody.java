...
public class ServiceSchemaRegistrySubjectVersionPostRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistrySubjectVersionPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setSchemaType(@jakarta.annotation.Nullable final ServiceSchemaRegistrySubjectVersionPostRequestBodySchemaType value) {
