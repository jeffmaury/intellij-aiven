...
public class ServiceTaskCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceTaskCreateResponseErrors and sets the default values.
     */
    public ServiceTaskCreateResponseErrors() {
    ...
    public static ServiceTaskCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceTaskCreateResponseErrors();
    }
    /**
