...
public class ServiceBackupsGetResponseBackups implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceBackupsGetResponseBackupsAdditionalRegions> additionalRegions;
    /**
    ...
    /**
     * Instantiates a new ServiceBackupsGetResponseBackups and sets the default values.
     */
    public ServiceBackupsGetResponseBackups() {
    ...
    public static ServiceBackupsGetResponseBackups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceBackupsGetResponseBackups();
    }
    /**
     ...
     * @return a java.util.List<ServiceBackupsGetResponseBackupsAdditionalRegions>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceBackupsGetResponseBackupsAdditionalRegions> getAdditionalRegions() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("additional_regions", (n) -> { this.setAdditionalRegions(n.getCollectionOfObjectValues(ServiceBackupsGetResponseBackupsAdditionalRegions::createFromDiscriminatorValue)); });
     ...
     */
    public void setAdditionalRegions(@jakarta.annotation.Nullable final java.util.List<ServiceBackupsGetResponseBackupsAdditionalRegions> value) {
