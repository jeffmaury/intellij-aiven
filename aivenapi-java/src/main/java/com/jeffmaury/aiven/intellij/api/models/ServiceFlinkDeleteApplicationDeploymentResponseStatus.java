...
public enum ServiceFlinkDeleteApplicationDeploymentResponseStatus implements ValuedEnum {
    ...
    ServiceFlinkDeleteApplicationDeploymentResponseStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceFlinkDeleteApplicationDeploymentResponseStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
