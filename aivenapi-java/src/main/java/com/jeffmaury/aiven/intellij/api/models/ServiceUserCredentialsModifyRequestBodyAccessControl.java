...
public class ServiceUserCredentialsModifyRequestBodyAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsModifyRequestBodyAccessControl and sets the default values.
     */
    public ServiceUserCredentialsModifyRequestBodyAccessControl() {
    ...
    public static ServiceUserCredentialsModifyRequestBodyAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsModifyRequestBodyAccessControl();
    }
    /**
