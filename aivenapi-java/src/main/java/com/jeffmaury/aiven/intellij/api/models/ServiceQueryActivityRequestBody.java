...
public class ServiceQueryActivityRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceQueryActivityRequestBody and sets the default values.
     */
    public ServiceQueryActivityRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceQueryActivityRequestBody
     */
    @jakarta.annotation.Nonnull
    public static ServiceQueryActivityRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceQueryActivityRequestBody();
    }
    /**
