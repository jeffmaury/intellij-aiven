...
public class ServiceIntegrationEndpointDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationEndpointDeleteResponseErrors and sets the default values.
     */
    public ServiceIntegrationEndpointDeleteResponseErrors() {
    ...
    public static ServiceIntegrationEndpointDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationEndpointDeleteResponseErrors();
    }
    /**
