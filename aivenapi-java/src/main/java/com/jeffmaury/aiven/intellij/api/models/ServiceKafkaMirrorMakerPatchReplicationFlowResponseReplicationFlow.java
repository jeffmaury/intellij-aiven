...
public class ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlow implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlow createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("offset_syncs_topic_location", (n) -> { this.setOffsetSyncsTopicLocation(n.getEnumValue(ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlowOffsetSyncsTopicLocation.class)); });
        deserializerMap.put("replication_policy_class", (n) -> { this.setReplicationPolicyClass(n.getEnumValue(ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlowReplicationPolicyClass.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setOffsetSyncsTopicLocation(@javax.annotation.Nullable final ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlowOffsetSyncsTopicLocation value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setReplicationPolicyClass(@javax.annotation.Nullable final ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlowReplicationPolicyClass value) {
