...
public class OrganizationAuthenticationConfigUpdateResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationAuthenticationConfigUpdateResponse and sets the default values.
     */
    public OrganizationAuthenticationConfigUpdateResponse() {
    ...
    public static OrganizationAuthenticationConfigUpdateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationAuthenticationConfigUpdateResponse();
    }
    /**
