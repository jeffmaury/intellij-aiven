...
public class VpcPeeringConnectionWithResourceGroupDeleteResponse implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionWithResourceGroupDeleteResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<VpcPeeringConnectionWithResourceGroupDeleteResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<VpcPeeringConnectionWithResourceGroupDeleteResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final VpcPeeringConnectionWithResourceGroupDeleteResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setStateInfo(@jakarta.annotation.Nullable final VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfo value) {
     ...
     */
    public void setVpcPeeringConnectionType(@jakarta.annotation.Nullable final VpcPeeringConnectionWithResourceGroupDeleteResponseVpcPeeringConnectionType value) {
