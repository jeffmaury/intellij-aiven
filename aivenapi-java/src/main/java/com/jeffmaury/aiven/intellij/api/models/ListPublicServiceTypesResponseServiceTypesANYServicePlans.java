...
public class ListPublicServiceTypesResponseServiceTypesANYServicePlans implements AdditionalDataHolder, Parsable {
    ...
    public static ListPublicServiceTypesResponseServiceTypesANYServicePlans createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setBackupConfig(@jakarta.annotation.Nullable final ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig value) {
     ...
     */
    public void setRegions(@jakarta.annotation.Nullable final ListPublicServiceTypesResponseServiceTypesANYServicePlansRegions value) {
        this.regions = value;
    }
    /**
