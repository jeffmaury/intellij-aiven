...
public class ServiceKafkaTopicUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTopicUpdateResponseErrors and sets the default values.
     */
    public ServiceKafkaTopicUpdateResponseErrors() {
    ...
    public static ServiceKafkaTopicUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTopicUpdateResponseErrors();
    }
    /**
