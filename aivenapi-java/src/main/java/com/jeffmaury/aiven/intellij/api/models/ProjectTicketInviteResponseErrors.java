...
public class ProjectTicketInviteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTicketInviteResponseErrors and sets the default values.
     */
    public ProjectTicketInviteResponseErrors() {
    ...
    public static ProjectTicketInviteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTicketInviteResponseErrors();
    }
    /**
