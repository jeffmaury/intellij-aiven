...
public class ProjectStaticIPPatchResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectStaticIPPatchResponseErrors and sets the default values.
     */
    public ProjectStaticIPPatchResponseErrors() {
    ...
    public static ProjectStaticIPPatchResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectStaticIPPatchResponseErrors();
    }
    /**
