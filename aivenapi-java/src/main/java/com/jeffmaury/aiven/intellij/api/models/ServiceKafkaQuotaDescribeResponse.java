...
public class ServiceKafkaQuotaDescribeResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaQuotaDescribeResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaQuotaDescribeResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setQuota(@javax.annotation.Nullable final ServiceKafkaQuotaDescribeResponseQuota value) {
        this.quota = value;
    }
}
