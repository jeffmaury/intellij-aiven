...
public class ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatusState implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatusState createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setLikelyErrorCause(@javax.annotation.Nullable final ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatusStateLikelyErrorCause value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setNodes(@javax.annotation.Nullable final ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatusStateNodes value) {
        this.nodes = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatusStateStatus value) {
        this.status = value;
    }
}
