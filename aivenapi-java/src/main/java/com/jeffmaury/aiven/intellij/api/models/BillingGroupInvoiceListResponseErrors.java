...
public class BillingGroupInvoiceListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupInvoiceListResponseErrors and sets the default values.
     */
    public BillingGroupInvoiceListResponseErrors() {
    ...
    public static BillingGroupInvoiceListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupInvoiceListResponseErrors();
    }
    /**
