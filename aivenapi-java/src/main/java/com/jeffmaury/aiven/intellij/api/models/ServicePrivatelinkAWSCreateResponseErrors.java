...
public class ServicePrivatelinkAWSCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAWSCreateResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAWSCreateResponseErrors() {
    ...
    public static ServicePrivatelinkAWSCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAWSCreateResponseErrors();
    }
    /**
