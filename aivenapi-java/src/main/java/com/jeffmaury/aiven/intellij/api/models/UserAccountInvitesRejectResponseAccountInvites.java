...
public class UserAccountInvitesRejectResponseAccountInvites implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
    ...
    /**
     * Instantiates a new UserAccountInvitesRejectResponseAccountInvites and sets the default values.
     */
    public UserAccountInvitesRejectResponseAccountInvites() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a UserAccountInvitesRejectResponseAccountInvites
     */
    @jakarta.annotation.Nonnull
    public static UserAccountInvitesRejectResponseAccountInvites createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAccountInvitesRejectResponseAccountInvites();
    }
    /**
