...
public class ServiceIntegrationEndpointGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationEndpointGetResponseErrors and sets the default values.
     */
    public ServiceIntegrationEndpointGetResponseErrors() {
    ...
    public static ServiceIntegrationEndpointGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationEndpointGetResponseErrors();
    }
    /**
