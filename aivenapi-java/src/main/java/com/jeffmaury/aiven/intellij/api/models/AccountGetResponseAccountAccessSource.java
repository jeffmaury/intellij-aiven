...
public enum AccountGetResponseAccountAccessSource implements ValuedEnum {
    Descendant_membership("descendant_membership"),
    Organization_membership("organization_membership"),
    Project_membership("project_membership"),
    Team_membership("team_membership");
    public final String value;
    AccountGetResponseAccountAccessSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static AccountGetResponseAccountAccessSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
