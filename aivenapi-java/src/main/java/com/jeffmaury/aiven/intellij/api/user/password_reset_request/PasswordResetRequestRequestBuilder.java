...
public class PasswordResetRequestRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserPasswordResetRequestResponse> post(@jakarta.annotation.Nonnull final UserPasswordResetRequestRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserPasswordResetRequestResponse> post(@jakarta.annotation.Nonnull final UserPasswordResetRequestRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
