...
public class ProjectTicketCreateResponseTicketFollowers implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTicketCreateResponseTicketFollowers and sets the default values.
     */
    public ProjectTicketCreateResponseTicketFollowers() {
    ...
    public static ProjectTicketCreateResponseTicketFollowers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTicketCreateResponseTicketFollowers();
    }
    /**
