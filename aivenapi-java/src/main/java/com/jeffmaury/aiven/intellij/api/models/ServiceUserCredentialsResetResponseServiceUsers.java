...
public class ServiceUserCredentialsResetResponseServiceUsers implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_control", (n) -> { this.setAccessControl(n.getObjectValue(ServiceUserCredentialsResetResponseServiceUsersAccessControl::createFromDiscriminatorValue)); });
        deserializerMap.put("access_key", (n) -> { this.setAccessKey(n.getStringValue()); });
        deserializerMap.put("authentication", (n) -> { this.setAuthentication(n.getEnumValue(ServiceUserCredentialsResetResponseServiceUsersAuthentication::forValue)); });
