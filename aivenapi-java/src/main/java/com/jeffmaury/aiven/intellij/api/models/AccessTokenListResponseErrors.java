...
public class AccessTokenListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccessTokenListResponseErrors and sets the default values.
     */
    public AccessTokenListResponseErrors() {
    ...
    public static AccessTokenListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccessTokenListResponseErrors();
    }
    /**
