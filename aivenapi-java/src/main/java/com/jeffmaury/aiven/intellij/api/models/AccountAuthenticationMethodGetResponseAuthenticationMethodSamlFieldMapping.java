...
public class AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping and sets the default values.
     */
    public AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping() {
    ...
    public static AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping();
    }
    /**
