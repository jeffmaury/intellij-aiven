...
public class BillingGroupCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupCreateResponseErrors and sets the default values.
     */
    public BillingGroupCreateResponseErrors() {
    ...
    public static BillingGroupCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupCreateResponseErrors();
    }
    /**
