...
public class UserCreateResponseUserProjectMemberships implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserCreateResponseUserProjectMemberships and sets the default values.
     */
    public UserCreateResponseUserProjectMemberships() {
    ...
    public static UserCreateResponseUserProjectMemberships createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserCreateResponseUserProjectMemberships();
    }
    /**
