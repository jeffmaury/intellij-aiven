...
public class ListProjectServiceTypesResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ListProjectServiceTypesResponseErrors and sets the default values.
     */
    public ListProjectServiceTypesResponseErrors() {
    ...
    public static ListProjectServiceTypesResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ListProjectServiceTypesResponseErrors();
    }
    /**
