...
public enum ServiceKafkaTopicGetResponseTopicConfigMaxMessageBytesSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMaxMessageBytesSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMaxMessageBytesSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
