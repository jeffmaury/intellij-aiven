...
public class WithPeerRegionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public VpcPeeringConnectionWithRegionDeleteResponse delete() {
        return delete(null);
    }
    /**
     * Delete a peering connection for a project VPC
     ...
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionWithRegionDeleteResponse delete(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toDeleteRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, VpcPeeringConnectionWithRegionDeleteResponse::createFromDiscriminatorValue);
    }
    /**
     * Delete a peering connection for a project VPC
