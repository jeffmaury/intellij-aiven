...
public class ServiceFlinkUpdateApplicationResponseApplicationVersionsSinksColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkUpdateApplicationResponseApplicationVersionsSinksColumns and sets the default values.
     */
    public ServiceFlinkUpdateApplicationResponseApplicationVersionsSinksColumns() {
    ...
    public static ServiceFlinkUpdateApplicationResponseApplicationVersionsSinksColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkUpdateApplicationResponseApplicationVersionsSinksColumns();
    }
    /**
