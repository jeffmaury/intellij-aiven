...
public enum ServiceKafkaTopicGetResponseTopicConfigFlushMessagesSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigFlushMessagesSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigFlushMessagesSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
