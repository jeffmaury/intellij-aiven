...
public class ProjectKmsGetCAResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectKmsGetCAResponseErrors and sets the default values.
     */
    public ProjectKmsGetCAResponseErrors() {
    ...
    public static ProjectKmsGetCAResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectKmsGetCAResponseErrors();
    }
    /**
