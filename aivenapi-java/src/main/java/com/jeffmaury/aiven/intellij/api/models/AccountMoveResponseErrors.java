...
public class AccountMoveResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountMoveResponseErrors and sets the default values.
     */
    public AccountMoveResponseErrors() {
    ...
    public static AccountMoveResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountMoveResponseErrors();
    }
    /**
