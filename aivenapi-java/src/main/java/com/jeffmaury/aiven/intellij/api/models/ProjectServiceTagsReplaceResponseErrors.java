...
public class ProjectServiceTagsReplaceResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectServiceTagsReplaceResponseErrors and sets the default values.
     */
    public ProjectServiceTagsReplaceResponseErrors() {
    ...
    public static ProjectServiceTagsReplaceResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectServiceTagsReplaceResponseErrors();
    }
    /**
