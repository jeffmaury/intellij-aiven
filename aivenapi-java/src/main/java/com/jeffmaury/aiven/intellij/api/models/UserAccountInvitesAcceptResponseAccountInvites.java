...
public class UserAccountInvitesAcceptResponseAccountInvites implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
    ...
    /**
     * Instantiates a new UserAccountInvitesAcceptResponseAccountInvites and sets the default values.
     */
    public UserAccountInvitesAcceptResponseAccountInvites() {
    ...
    public static UserAccountInvitesAcceptResponseAccountInvites createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAccountInvitesAcceptResponseAccountInvites();
    }
    /**
