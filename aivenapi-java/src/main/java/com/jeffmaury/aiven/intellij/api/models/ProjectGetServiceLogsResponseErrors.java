...
public class ProjectGetServiceLogsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectGetServiceLogsResponseErrors and sets the default values.
     */
    public ProjectGetServiceLogsResponseErrors() {
    ...
    public static ProjectGetServiceLogsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectGetServiceLogsResponseErrors();
    }
    /**
