...
public class ActivityRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ServiceQueryActivityResponse> post(@jakarta.annotation.Nonnull final ServiceQueryActivityRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceQueryActivityResponse> post(@jakarta.annotation.Nonnull final ServiceQueryActivityRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
