...
public class ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors and sets the default values.
     */
    public ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors() {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors();
    }
    /**
