...
public enum ServiceIntegrationEndpointGetResponseServiceIntegrationEndpointEndpointType implements ValuedEnum {
    ...
    ServiceIntegrationEndpointGetResponseServiceIntegrationEndpointEndpointType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceIntegrationEndpointGetResponseServiceIntegrationEndpointEndpointType forValue(@jakarta.annotation.Nonnull final String searchValue) {
