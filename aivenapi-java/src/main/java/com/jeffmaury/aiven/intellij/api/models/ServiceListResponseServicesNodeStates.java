...
public class ServiceListResponseServicesNodeStates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesNodeStates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("role", (n) -> { this.setRole(n.getEnumValue(ServiceListResponseServicesNodeStatesRole::forValue)); });
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServiceListResponseServicesNodeStatesState::forValue)); });
     ...
     * @return a java.util.List<ServiceListResponseServicesNodeStatesProgressUpdates>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setProgressUpdates(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesNodeStatesProgressUpdates> value) {
     ...
     */
    public void setRole(@jakarta.annotation.Nullable final ServiceListResponseServicesNodeStatesRole value) {
        this.role = value;
    }
    /**
     ...
     */
    public void setShard(@jakarta.annotation.Nullable final ServiceListResponseServicesNodeStatesShard value) {
        this.shard = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceListResponseServicesNodeStatesState value) {
        this.state = value;
    }
}
