...
public class BillingGroupCreditsClaimResponseCredit implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupCreditsClaimResponseCredit createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(BillingGroupCreditsClaimResponseCreditType::forValue)); });
     ...
     */
    public void setType(@jakarta.annotation.Nullable final BillingGroupCreditsClaimResponseCreditType value) {
        this.type = value;
    }
    /**
