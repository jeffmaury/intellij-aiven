...
public class UserGroupUpdateRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserGroupUpdateRequestBody and sets the default values.
     */
    public UserGroupUpdateRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a UserGroupUpdateRequestBody
     */
    @jakarta.annotation.Nonnull
    public static UserGroupUpdateRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserGroupUpdateRequestBody();
    }
    /**
