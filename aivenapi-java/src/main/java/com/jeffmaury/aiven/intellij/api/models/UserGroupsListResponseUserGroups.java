...
public class UserGroupsListResponseUserGroups implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserGroupsListResponseUserGroups and sets the default values.
     */
    public UserGroupsListResponseUserGroups() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a UserGroupsListResponseUserGroups
     */
    @jakarta.annotation.Nonnull
    public static UserGroupsListResponseUserGroups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserGroupsListResponseUserGroups();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("member_count", (n) -> { this.setMemberCount(n.getIntegerValue()); });
    ...
    /**
     * Gets the member_count property value. Member Count
     * @return a Integer
     */
    @jakarta.annotation.Nullable
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeIntegerValue("member_count", this.getMemberCount());
    ...
    /**
     * Sets the member_count property value. Member Count
