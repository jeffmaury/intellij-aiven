...
public class BillingGroupGetResponseBillingGroupCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupGetResponseBillingGroupCardInfo and sets the default values.
     */
    public BillingGroupGetResponseBillingGroupCardInfo() {
    ...
    public static BillingGroupGetResponseBillingGroupCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupGetResponseBillingGroupCardInfo();
    }
    /**
