...
public class ServiceFlinkCancelApplicationDeploymentResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCancelApplicationDeploymentResponseErrors and sets the default values.
     */
    public ServiceFlinkCancelApplicationDeploymentResponseErrors() {
    ...
    public static ServiceFlinkCancelApplicationDeploymentResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCancelApplicationDeploymentResponseErrors();
    }
    /**
