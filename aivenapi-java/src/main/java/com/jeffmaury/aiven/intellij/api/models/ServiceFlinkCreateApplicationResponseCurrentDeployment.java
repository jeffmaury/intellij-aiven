...
public class ServiceFlinkCreateApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Deployment status
     */
    private ServiceFlinkCreateApplicationResponseCurrentDeploymentStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkCreateApplicationResponseCurrentDeployment and sets the default values.
     */
    public ServiceFlinkCreateApplicationResponseCurrentDeployment() {
    ...
    public static ServiceFlinkCreateApplicationResponseCurrentDeployment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationResponseCurrentDeployment();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkCreateApplicationResponseCurrentDeploymentStatus::forValue)); });
     ...
     * @return a ServiceFlinkCreateApplicationResponseCurrentDeploymentStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkCreateApplicationResponseCurrentDeploymentStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkCreateApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
