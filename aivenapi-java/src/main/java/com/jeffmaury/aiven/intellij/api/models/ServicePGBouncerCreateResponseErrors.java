...
public class ServicePGBouncerCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePGBouncerCreateResponseErrors and sets the default values.
     */
    public ServicePGBouncerCreateResponseErrors() {
    ...
    public static ServicePGBouncerCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePGBouncerCreateResponseErrors();
    }
    /**
