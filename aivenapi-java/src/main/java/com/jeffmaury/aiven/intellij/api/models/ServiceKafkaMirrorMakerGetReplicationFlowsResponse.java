...
public class ServiceKafkaMirrorMakerGetReplicationFlowsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors>
     */
     ...
     * @return a java.util.List<ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     * @param value Value to set for the replication_flows property.
     */
    public void setReplicationFlows(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows> value) {
