...
public class ServicePrivatelinkAWSCreateRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAWSCreateRequestBody and sets the default values.
     */
    public ServicePrivatelinkAWSCreateRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServicePrivatelinkAWSCreateRequestBody
     */
    @jakarta.annotation.Nonnull
    public static ServicePrivatelinkAWSCreateRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAWSCreateRequestBody();
    }
    /**
