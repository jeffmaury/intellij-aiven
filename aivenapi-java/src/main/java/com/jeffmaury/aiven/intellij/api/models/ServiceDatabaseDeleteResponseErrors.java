...
public class ServiceDatabaseDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceDatabaseDeleteResponseErrors and sets the default values.
     */
    public ServiceDatabaseDeleteResponseErrors() {
    ...
    public static ServiceDatabaseDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceDatabaseDeleteResponseErrors();
    }
    /**
