...
public class BillingGroupInvoiceGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupInvoiceGetResponseErrors and sets the default values.
     */
    public BillingGroupInvoiceGetResponseErrors() {
    ...
    public static BillingGroupInvoiceGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupInvoiceGetResponseErrors();
    }
    /**
