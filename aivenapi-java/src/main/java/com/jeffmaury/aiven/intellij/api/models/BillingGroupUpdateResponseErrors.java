...
public class BillingGroupUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupUpdateResponseErrors and sets the default values.
     */
    public BillingGroupUpdateResponseErrors() {
    ...
    public static BillingGroupUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupUpdateResponseErrors();
    }
    /**
