...
public class PGServiceQueryStatisticsDeprecatedResponse implements AdditionalDataHolder, Parsable {
    ...
    public static PGServiceQueryStatisticsDeprecatedResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<PGServiceQueryStatisticsDeprecatedResponseErrors>
     */
     ...
     * @return a java.util.List<PGServiceQueryStatisticsDeprecatedResponseQueries>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<PGServiceQueryStatisticsDeprecatedResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setQueries(@jakarta.annotation.Nullable final java.util.List<PGServiceQueryStatisticsDeprecatedResponseQueries> value) {
        this.queries = value;
    }
}
