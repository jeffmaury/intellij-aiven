...
public class ServiceSchemaRegistrySubjectVersionDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectVersionDeleteResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectVersionDeleteResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectVersionDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectVersionDeleteResponseErrors();
    }
    /**
