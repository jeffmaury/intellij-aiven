...
public class ServiceCreateResponseServiceServiceIntegrationsIntegrationStatusState implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceServiceIntegrationsIntegrationStatusState createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("likely_error_cause", (n) -> { this.setLikelyErrorCause(n.getEnumValue(ServiceCreateResponseServiceServiceIntegrationsIntegrationStatusStateLikelyErrorCause::forValue)); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceCreateResponseServiceServiceIntegrationsIntegrationStatusStateStatus::forValue)); });
     ...
     */
    public void setLikelyErrorCause(@jakarta.annotation.Nullable final ServiceCreateResponseServiceServiceIntegrationsIntegrationStatusStateLikelyErrorCause value) {
     ...
     */
    public void setNodes(@jakarta.annotation.Nullable final ServiceCreateResponseServiceServiceIntegrationsIntegrationStatusStateNodes value) {
        this.nodes = value;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceCreateResponseServiceServiceIntegrationsIntegrationStatusStateStatus value) {
        this.status = value;
    }
}
