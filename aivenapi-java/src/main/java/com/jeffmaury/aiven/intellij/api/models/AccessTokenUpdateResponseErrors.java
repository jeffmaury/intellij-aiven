...
public class AccessTokenUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccessTokenUpdateResponseErrors and sets the default values.
     */
    public AccessTokenUpdateResponseErrors() {
    ...
    public static AccessTokenUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccessTokenUpdateResponseErrors();
    }
    /**
