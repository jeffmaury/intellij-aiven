...
public class ServiceUserCredentialsResetResponseServiceServiceIntegrations implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Integration status
     */
    private ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatus integrationStatus;
    /**
     ...
     */
    private ServiceUserCredentialsResetResponseServiceServiceIntegrationsUserConfig userConfig;
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceServiceIntegrations and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceServiceIntegrations() {
    ...
    public static ServiceUserCredentialsResetResponseServiceServiceIntegrations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceServiceIntegrations();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceUserCredentialsResetResponseServiceServiceIntegrationsUserConfig::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the integration_status property value. Integration status
     * @return a ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatus
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatus getIntegrationStatus() {
     ...
     * @return a ServiceUserCredentialsResetResponseServiceServiceIntegrationsUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceServiceIntegrationsUserConfig getUserConfig() {
     ...
     */
    public void setIntegrationStatus(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatus value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceIntegrationsUserConfig value) {
