...
public class ProjectTicketCreateResponseTicketSubmitter implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTicketCreateResponseTicketSubmitter and sets the default values.
     */
    public ProjectTicketCreateResponseTicketSubmitter() {
    ...
    public static ProjectTicketCreateResponseTicketSubmitter createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTicketCreateResponseTicketSubmitter();
    }
    /**
