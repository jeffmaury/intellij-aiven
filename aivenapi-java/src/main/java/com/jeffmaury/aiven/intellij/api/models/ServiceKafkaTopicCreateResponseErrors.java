...
public class ServiceKafkaTopicCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTopicCreateResponseErrors and sets the default values.
     */
    public ServiceKafkaTopicCreateResponseErrors() {
    ...
    public static ServiceKafkaTopicCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTopicCreateResponseErrors();
    }
    /**
