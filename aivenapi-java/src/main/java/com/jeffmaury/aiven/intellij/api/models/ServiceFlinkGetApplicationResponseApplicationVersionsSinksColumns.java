...
public class ServiceFlinkGetApplicationResponseApplicationVersionsSinksColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationResponseApplicationVersionsSinksColumns and sets the default values.
     */
    public ServiceFlinkGetApplicationResponseApplicationVersionsSinksColumns() {
    ...
    public static ServiceFlinkGetApplicationResponseApplicationVersionsSinksColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationResponseApplicationVersionsSinksColumns();
    }
    /**
