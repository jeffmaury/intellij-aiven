...
public class InvitesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of UserAccountInvitesListResponse
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserAccountInvitesListResponse> get() {
        try {
            final RequestInformation requestInfo = toGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, UserAccountInvitesListResponse::createFromDiscriminatorValue, null);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<UserAccountInvitesListResponse> executionException = new java.util.concurrent.CompletableFuture<UserAccountInvitesListResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserAccountInvitesListResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
