...
public class ServicePrivatelinkAWSGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAWSGetResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAWSGetResponseErrors() {
    ...
    public static ServicePrivatelinkAWSGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAWSGetResponseErrors();
    }
    /**
