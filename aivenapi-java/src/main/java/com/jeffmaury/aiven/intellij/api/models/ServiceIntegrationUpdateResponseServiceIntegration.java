...
public class ServiceIntegrationUpdateResponseServiceIntegration implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Integration status
     */
    private ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatus integrationStatus;
    /**
     ...
     */
    private ServiceIntegrationUpdateResponseServiceIntegrationUserConfig userConfig;
    /**
     * Instantiates a new ServiceIntegrationUpdateResponseServiceIntegration and sets the default values.
     */
    public ServiceIntegrationUpdateResponseServiceIntegration() {
    ...
    public static ServiceIntegrationUpdateResponseServiceIntegration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationUpdateResponseServiceIntegration();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceIntegrationUpdateResponseServiceIntegrationUserConfig::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the integration_status property value. Integration status
     * @return a ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatus
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatus getIntegrationStatus() {
     ...
     * @return a ServiceIntegrationUpdateResponseServiceIntegrationUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationUpdateResponseServiceIntegrationUserConfig getUserConfig() {
     ...
     */
    public void setIntegrationStatus(@jakarta.annotation.Nullable final ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatus value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceIntegrationUpdateResponseServiceIntegrationUserConfig value) {
