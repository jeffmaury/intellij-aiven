...
public class ServiceIntegrationUpdateResponseServiceIntegration implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationUpdateResponseServiceIntegration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationUpdateResponseServiceIntegrationUserConfig value) {
