...
public enum ServiceKafkaMirrorMakerCreateReplicationFlowRequestBodyReplicationPolicyClass implements ValuedEnum {
    ...
    public static ServiceKafkaMirrorMakerCreateReplicationFlowRequestBodyReplicationPolicyClass forValue(@javax.annotation.Nonnull final String searchValue) {
