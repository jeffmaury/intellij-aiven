...
public class ServiceListResponseServicesServiceIntegrations implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Integration status
     */
    private ServiceListResponseServicesServiceIntegrationsIntegrationStatus integrationStatus;
    /**
     ...
     */
    private ServiceListResponseServicesServiceIntegrationsUserConfig userConfig;
    /**
     * Instantiates a new ServiceListResponseServicesServiceIntegrations and sets the default values.
     */
    public ServiceListResponseServicesServiceIntegrations() {
    ...
    public static ServiceListResponseServicesServiceIntegrations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServicesServiceIntegrations();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceListResponseServicesServiceIntegrationsIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceListResponseServicesServiceIntegrationsUserConfig::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesServiceIntegrationsIntegrationStatus getIntegrationStatus() {
     ...
     * @return a ServiceListResponseServicesServiceIntegrationsUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesServiceIntegrationsUserConfig getUserConfig() {
     ...
     */
    public void setIntegrationStatus(@jakarta.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsIntegrationStatus value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsUserConfig value) {
