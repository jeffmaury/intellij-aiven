...
public enum AccountAuthenticationMethodGetResponseAuthenticationMethodAuthenticationMethodType implements ValuedEnum {
    ...
    public static AccountAuthenticationMethodGetResponseAuthenticationMethodAuthenticationMethodType forValue(@jakarta.annotation.Nonnull final String searchValue) {
