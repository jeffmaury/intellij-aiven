...
public class BillingGroupCreateResponseBillingGroup implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupCreateResponseBillingGroup createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a BillingGroupCreateResponseBillingGroupBillingEmails
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingCurrency(@javax.annotation.Nullable final BillingGroupCreateResponseBillingGroupBillingCurrency value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingEmails(@javax.annotation.Nullable final java.util.List<BillingGroupCreateResponseBillingGroupBillingEmails> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCardInfo(@javax.annotation.Nullable final BillingGroupCreateResponseBillingGroupCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPaymentMethod(@javax.annotation.Nullable final BillingGroupCreateResponseBillingGroupPaymentMethod value) {
