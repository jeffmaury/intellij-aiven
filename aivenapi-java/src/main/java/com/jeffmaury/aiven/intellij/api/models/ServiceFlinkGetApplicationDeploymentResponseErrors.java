...
public class ServiceFlinkGetApplicationDeploymentResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationDeploymentResponseErrors and sets the default values.
     */
    public ServiceFlinkGetApplicationDeploymentResponseErrors() {
    ...
    public static ServiceFlinkGetApplicationDeploymentResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationDeploymentResponseErrors();
    }
    /**
