...
public class ServiceKafkaConnectGetAvailableConnectorsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectGetAvailableConnectorsResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectGetAvailableConnectorsResponseErrors() {
    ...
    public static ServiceKafkaConnectGetAvailableConnectorsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectGetAvailableConnectorsResponseErrors();
    }
    /**
