...
public class ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpoint implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpoint createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("endpoint_type", (n) -> { this.setEndpointType(n.getEnumValue(ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointType.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setEndpointConfig(@javax.annotation.Nullable final ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointConfig value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setEndpointType(@javax.annotation.Nullable final ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointType value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointUserConfig value) {
