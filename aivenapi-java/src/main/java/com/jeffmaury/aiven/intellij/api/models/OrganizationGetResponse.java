...
public class OrganizationGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationGetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTier(@javax.annotation.Nullable final OrganizationGetResponseTier value) {
        this.tier = value;
    }
    /**
