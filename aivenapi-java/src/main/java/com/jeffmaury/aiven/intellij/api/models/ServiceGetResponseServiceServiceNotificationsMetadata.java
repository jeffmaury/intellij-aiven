...
public class ServiceGetResponseServiceServiceNotificationsMetadata implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceGetResponseServiceServiceNotificationsMetadata and sets the default values.
     */
    public ServiceGetResponseServiceServiceNotificationsMetadata() {
    ...
    public static ServiceGetResponseServiceServiceNotificationsMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceServiceNotificationsMetadata();
    }
    /**
