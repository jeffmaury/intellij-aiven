...
public class ApplicationRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceFlinkListApplicationsResponse get() {
        return get(null);
    }
    /**
     * Get all Flink Applications
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkListApplicationsResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceFlinkListApplicationsResponse::createFromDiscriminatorValue);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkCreateApplicationResponse post(@jakarta.annotation.Nonnull final ServiceFlinkCreateApplicationRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkCreateApplicationResponse post(@jakarta.annotation.Nonnull final ServiceFlinkCreateApplicationRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceFlinkCreateApplicationResponse::createFromDiscriminatorValue);
    }
    /**
     * Get all Flink Applications
