...
public class ServiceSchemaRegistrySubjectVersionsGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectVersionsGetResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectVersionsGetResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectVersionsGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectVersionsGetResponseErrors();
    }
    /**
