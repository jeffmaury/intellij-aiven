...
public class ServiceUpdateResponseServiceServiceNotificationsMetadata implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateResponseServiceServiceNotificationsMetadata createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
