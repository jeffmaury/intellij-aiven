...
public class ServiceUpdateResponseServiceServiceNotificationsMetadata implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseServiceServiceNotificationsMetadata and sets the default values.
     */
    public ServiceUpdateResponseServiceServiceNotificationsMetadata() {
    ...
    public static ServiceUpdateResponseServiceServiceNotificationsMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseServiceServiceNotificationsMetadata();
    }
    /**
