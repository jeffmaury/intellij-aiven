...
public class ServiceIntegrationEndpointCreateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationEndpointCreateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceIntegrationEndpointCreateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setServiceIntegrationEndpoint(@javax.annotation.Nullable final ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpoint value) {
