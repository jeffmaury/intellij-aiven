...
public enum ServiceKafkaTopicGetResponseTopicConfigLocalRetentionMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigLocalRetentionMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigLocalRetentionMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
