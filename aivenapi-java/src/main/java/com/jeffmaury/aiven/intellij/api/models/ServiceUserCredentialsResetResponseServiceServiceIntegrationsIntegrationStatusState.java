...
public class ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatusState implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatusState createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("likely_error_cause", (n) -> { this.setLikelyErrorCause(n.getEnumValue(ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatusStateLikelyErrorCause::forValue)); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatusStateStatus::forValue)); });
     ...
     */
    public void setLikelyErrorCause(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatusStateLikelyErrorCause value) {
     ...
     */
    public void setNodes(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatusStateNodes value) {
        this.nodes = value;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatusStateStatus value) {
        this.status = value;
    }
}
