...
public class AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlFieldMapping implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlFieldMapping and sets the default values.
     */
    public AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlFieldMapping() {
    ...
    public static AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlFieldMapping createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlFieldMapping();
    }
    /**
