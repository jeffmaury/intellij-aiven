...
public class UserAuthResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserAuthResponseErrors and sets the default values.
     */
    public UserAuthResponseErrors() {
    ...
    public static UserAuthResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAuthResponseErrors();
    }
    /**
