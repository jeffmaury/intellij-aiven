...
public class OrganizationUserListResponseUsers implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUserListResponseUsers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setUserInfo(@jakarta.annotation.Nullable final OrganizationUserListResponseUsersUserInfo value) {
        this.userInfo = value;
    }
}
