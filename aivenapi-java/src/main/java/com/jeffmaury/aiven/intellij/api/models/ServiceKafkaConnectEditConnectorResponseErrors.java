...
public class ServiceKafkaConnectEditConnectorResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectEditConnectorResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectEditConnectorResponseErrors() {
    ...
    public static ServiceKafkaConnectEditConnectorResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectEditConnectorResponseErrors();
    }
    /**
