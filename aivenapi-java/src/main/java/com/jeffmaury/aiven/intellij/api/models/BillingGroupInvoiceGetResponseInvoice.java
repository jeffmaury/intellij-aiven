...
public class BillingGroupInvoiceGetResponseInvoice implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupInvoiceGetResponseInvoice createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @param value Value to set for the invoiceState property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setInvoiceState(@javax.annotation.Nullable final BillingGroupInvoiceGetResponseInvoiceInvoiceState value) {
        this.invoiceState = value;
    }
    /**
     * Sets the local_inc_vat property value. Invoice total in chosen billing currency, after VAT
     * @param value Value to set for the localIncVat property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setLocalIncVat(@javax.annotation.Nullable final String value) {
        this.localIncVat = value;
    }
    /**
     * Sets the local_vat_zero property value. Invoice total in chosen billing currency, before VAT
     * @param value Value to set for the localVatZero property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setLocalVatZero(@javax.annotation.Nullable final String value) {
