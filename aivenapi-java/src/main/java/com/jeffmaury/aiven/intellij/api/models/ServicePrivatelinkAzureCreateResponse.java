...
public class ServicePrivatelinkAzureCreateResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServicePrivatelinkAzureCreateResponseErrors> errors;
    /**
     ...
     */
    private ServicePrivatelinkAzureCreateResponseState state;
    /**
     * Subscription ID allowlist
     */
    private java.util.List<String> userSubscriptionIds;
    /**
     * Instantiates a new ServicePrivatelinkAzureCreateResponse and sets the default values.
     */
    public ServicePrivatelinkAzureCreateResponse() {
    ...
    public static ServicePrivatelinkAzureCreateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureCreateResponse();
    }
    /**
     ...
     * @return a java.util.List<ServicePrivatelinkAzureCreateResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServicePrivatelinkAzureCreateResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(ServicePrivatelinkAzureCreateResponseErrors::createFromDiscriminatorValue)); });
        deserializerMap.put("message", (n) -> { this.setMessage(n.getStringValue()); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServicePrivatelinkAzureCreateResponseState::forValue)); });
     ...
     * @return a ServicePrivatelinkAzureCreateResponseState
     */
    @jakarta.annotation.Nullable
    public ServicePrivatelinkAzureCreateResponseState getState() {
        return this.state;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServicePrivatelinkAzureCreateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServicePrivatelinkAzureCreateResponseState value) {
        this.state = value;
    }
    /**
