...
public class ProjectStaticIPAvailabilityListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectStaticIPAvailabilityListResponseErrors and sets the default values.
     */
    public ProjectStaticIPAvailabilityListResponseErrors() {
    ...
    public static ProjectStaticIPAvailabilityListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectStaticIPAvailabilityListResponseErrors();
    }
    /**
