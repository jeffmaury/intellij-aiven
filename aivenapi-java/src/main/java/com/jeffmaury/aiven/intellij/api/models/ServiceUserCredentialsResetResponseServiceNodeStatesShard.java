...
public class ServiceUserCredentialsResetResponseServiceNodeStatesShard implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceNodeStatesShard createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
