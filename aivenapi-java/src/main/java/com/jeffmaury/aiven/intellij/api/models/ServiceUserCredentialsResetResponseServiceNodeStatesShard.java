...
public class ServiceUserCredentialsResetResponseServiceNodeStatesShard implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceNodeStatesShard and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceNodeStatesShard() {
    ...
    public static ServiceUserCredentialsResetResponseServiceNodeStatesShard createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceNodeStatesShard();
    }
    /**
