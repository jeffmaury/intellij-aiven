...
public class ServiceKafkaQuotaDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaQuotaDeleteResponseErrors and sets the default values.
     */
    public ServiceKafkaQuotaDeleteResponseErrors() {
    ...
    public static ServiceKafkaQuotaDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaQuotaDeleteResponseErrors();
    }
    /**
