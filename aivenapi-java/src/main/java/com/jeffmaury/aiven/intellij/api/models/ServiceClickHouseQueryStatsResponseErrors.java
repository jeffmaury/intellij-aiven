...
public class ServiceClickHouseQueryStatsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceClickHouseQueryStatsResponseErrors and sets the default values.
     */
    public ServiceClickHouseQueryStatsResponseErrors() {
    ...
    public static ServiceClickHouseQueryStatsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceClickHouseQueryStatsResponseErrors();
    }
    /**
