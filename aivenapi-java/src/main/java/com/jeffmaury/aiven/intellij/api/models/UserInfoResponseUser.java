...
public class UserInfoResponseUser implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Feature flags
     */
    private UserInfoResponseUserFeatures features;
    /**
     * Intercom settings
     */
    private UserInfoResponseUserIntercom intercom;
    /**
     * List of pending invitations
     */
    private java.util.List<UserInfoResponseUserInvitations> invitations;
    /**
     * Job title
     */
     ...
     */
    private UserInfoResponseUserProjectMembership projectMembership;
    /**
     * List of project membership and type of membership
     */
    private UserInfoResponseUserProjectMemberships projectMemberships;
    /**
    ...
    /**
     * Instantiates a new UserInfoResponseUser and sets the default values.
     */
    public UserInfoResponseUser() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a UserInfoResponseUser
     */
    @jakarta.annotation.Nonnull
    public static UserInfoResponseUser createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserInfoResponseUser();
    }
    /**
     ...
     * @return a UserInfoResponseUserFeatures
     */
    @jakarta.annotation.Nullable
    public UserInfoResponseUserFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(UserInfoResponseUserFeatures::createFromDiscriminatorValue)); });
        deserializerMap.put("intercom", (n) -> { this.setIntercom(n.getObjectValue(UserInfoResponseUserIntercom::createFromDiscriminatorValue)); });
        deserializerMap.put("invitations", (n) -> { this.setInvitations(n.getCollectionOfObjectValues(UserInfoResponseUserInvitations::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("project_membership", (n) -> { this.setProjectMembership(n.getObjectValue(UserInfoResponseUserProjectMembership::createFromDiscriminatorValue)); });
        deserializerMap.put("project_memberships", (n) -> { this.setProjectMemberships(n.getObjectValue(UserInfoResponseUserProjectMemberships::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public UserInfoResponseUserIntercom getIntercom() {
        return this.intercom;
    }
    /**
     * Gets the invitations property value. List of pending invitations
     * @return a java.util.List<UserInfoResponseUserInvitations>
     */
    @jakarta.annotation.Nullable
    public java.util.List<UserInfoResponseUserInvitations> getInvitations() {
     ...
     */
    @jakarta.annotation.Nullable
    public UserInfoResponseUserProjectMembership getProjectMembership() {
     ...
     */
    @jakarta.annotation.Nullable
    public UserInfoResponseUserProjectMemberships getProjectMemberships() {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final UserInfoResponseUserFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setIntercom(@jakarta.annotation.Nullable final UserInfoResponseUserIntercom value) {
        this.intercom = value;
    }
    /**
     ...
     */
    public void setInvitations(@jakarta.annotation.Nullable final java.util.List<UserInfoResponseUserInvitations> value) {
     ...
     */
    public void setProjectMembership(@jakarta.annotation.Nullable final UserInfoResponseUserProjectMembership value) {
     ...
     */
    public void setProjectMemberships(@jakarta.annotation.Nullable final UserInfoResponseUserProjectMemberships value) {
