...
public class OrganizationProjectsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationProjectsListResponseErrors and sets the default values.
     */
    public OrganizationProjectsListResponseErrors() {
    ...
    public static OrganizationProjectsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationProjectsListResponseErrors();
    }
    /**
