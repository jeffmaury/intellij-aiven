...
public class CheckPasswordStrengthNewUserResponsePasswordStrength implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new CheckPasswordStrengthNewUserResponsePasswordStrength and sets the default values.
     */
    public CheckPasswordStrengthNewUserResponsePasswordStrength() {
    ...
    public static CheckPasswordStrengthNewUserResponsePasswordStrength createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CheckPasswordStrengthNewUserResponsePasswordStrength();
    }
    /**
