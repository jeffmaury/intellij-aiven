...
public class BillingGroupProjectListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupProjectListResponseErrors and sets the default values.
     */
    public BillingGroupProjectListResponseErrors() {
    ...
    public static BillingGroupProjectListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupProjectListResponseErrors();
    }
    /**
