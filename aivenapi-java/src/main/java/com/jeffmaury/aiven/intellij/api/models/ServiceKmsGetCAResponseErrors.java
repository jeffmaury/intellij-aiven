...
public class ServiceKmsGetCAResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKmsGetCAResponseErrors and sets the default values.
     */
    public ServiceKmsGetCAResponseErrors() {
    ...
    public static ServiceKmsGetCAResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKmsGetCAResponseErrors();
    }
    /**
