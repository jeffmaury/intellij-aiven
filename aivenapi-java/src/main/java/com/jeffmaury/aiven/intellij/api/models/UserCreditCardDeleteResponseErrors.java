...
public class UserCreditCardDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserCreditCardDeleteResponseErrors and sets the default values.
     */
    public UserCreditCardDeleteResponseErrors() {
    ...
    public static UserCreditCardDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserCreditCardDeleteResponseErrors();
    }
    /**
