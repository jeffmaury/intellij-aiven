...
public class ServiceKafkaConnectGetConnectorStatusResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectGetConnectorStatusResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectGetConnectorStatusResponseErrors() {
    ...
    public static ServiceKafkaConnectGetConnectorStatusResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectGetConnectorStatusResponseErrors();
    }
    /**
