...
public enum ServiceKafkaTopicGetResponseTopicConfigRemoteStorageEnableSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigRemoteStorageEnableSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigRemoteStorageEnableSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
