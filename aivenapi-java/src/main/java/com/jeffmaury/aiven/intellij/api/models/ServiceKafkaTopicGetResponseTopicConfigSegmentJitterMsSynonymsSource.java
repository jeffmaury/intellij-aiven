...
public enum ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
