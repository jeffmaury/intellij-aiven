...
public class ServiceFlinkUpdateApplicationResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkUpdateApplicationResponseErrors and sets the default values.
     */
    public ServiceFlinkUpdateApplicationResponseErrors() {
    ...
    public static ServiceFlinkUpdateApplicationResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkUpdateApplicationResponseErrors();
    }
    /**
