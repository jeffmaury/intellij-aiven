...
public enum ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
