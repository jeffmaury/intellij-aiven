...
public class AccountTeamProjectAssociateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamProjectAssociateResponseErrors and sets the default values.
     */
    public AccountTeamProjectAssociateResponseErrors() {
    ...
    public static AccountTeamProjectAssociateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamProjectAssociateResponseErrors();
    }
    /**
