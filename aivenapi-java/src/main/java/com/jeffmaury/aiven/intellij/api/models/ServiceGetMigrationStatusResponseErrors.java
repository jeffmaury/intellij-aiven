...
public class ServiceGetMigrationStatusResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceGetMigrationStatusResponseErrors and sets the default values.
     */
    public ServiceGetMigrationStatusResponseErrors() {
    ...
    public static ServiceGetMigrationStatusResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetMigrationStatusResponseErrors();
    }
    /**
