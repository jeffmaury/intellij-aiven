...
public class AccountPaymentMethodsListResponseCards implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String name;
    /**
     * Instantiates a new AccountPaymentMethodsListResponseCards and sets the default values.
     */
    public AccountPaymentMethodsListResponseCards() {
    ...
    public static AccountPaymentMethodsListResponseCards createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountPaymentMethodsListResponseCards();
    }
    /**
