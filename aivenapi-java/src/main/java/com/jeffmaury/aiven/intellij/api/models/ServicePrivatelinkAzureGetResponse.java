...
public class ServicePrivatelinkAzureGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServicePrivatelinkAzureGetResponseErrors> errors;
    /**
     ...
     */
    private ServicePrivatelinkAzureGetResponseState state;
    /**
     * Subscription ID allowlist
     */
    private java.util.List<String> userSubscriptionIds;
    /**
     * Instantiates a new ServicePrivatelinkAzureGetResponse and sets the default values.
     */
    public ServicePrivatelinkAzureGetResponse() {
    ...
    public static ServicePrivatelinkAzureGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureGetResponse();
    }
    /**
     ...
     * @return a java.util.List<ServicePrivatelinkAzureGetResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServicePrivatelinkAzureGetResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(ServicePrivatelinkAzureGetResponseErrors::createFromDiscriminatorValue)); });
        deserializerMap.put("message", (n) -> { this.setMessage(n.getStringValue()); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServicePrivatelinkAzureGetResponseState::forValue)); });
     ...
     * @return a ServicePrivatelinkAzureGetResponseState
     */
    @jakarta.annotation.Nullable
    public ServicePrivatelinkAzureGetResponseState getState() {
        return this.state;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServicePrivatelinkAzureGetResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServicePrivatelinkAzureGetResponseState value) {
        this.state = value;
    }
    /**
