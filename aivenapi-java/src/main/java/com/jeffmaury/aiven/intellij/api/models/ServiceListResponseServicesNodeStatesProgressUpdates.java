...
public class ServiceListResponseServicesNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesNodeStatesProgressUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("phase", (n) -> { this.setPhase(n.getEnumValue(ServiceListResponseServicesNodeStatesProgressUpdatesPhase::forValue)); });
        deserializerMap.put("unit", (n) -> { this.setUnit(n.getEnumValue(ServiceListResponseServicesNodeStatesProgressUpdatesUnit::forValue)); });
     ...
     */
    public void setPhase(@jakarta.annotation.Nullable final ServiceListResponseServicesNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    public void setUnit(@jakarta.annotation.Nullable final ServiceListResponseServicesNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
