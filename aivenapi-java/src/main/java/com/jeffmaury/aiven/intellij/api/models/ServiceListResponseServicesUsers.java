...
public class ServiceListResponseServicesUsers implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceListResponseServicesUsersAccessControl accessControl;
    /**
     ...
     */
    private ServiceListResponseServicesUsersAuthentication authentication;
    /**
    ...
    /**
     * Instantiates a new ServiceListResponseServicesUsers and sets the default values.
     */
    public ServiceListResponseServicesUsers() {
    ...
    public static ServiceListResponseServicesUsers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServicesUsers();
    }
    /**
     ...
     * @return a ServiceListResponseServicesUsersAccessControl
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesUsersAccessControl getAccessControl() {
     ...
     * @return a ServiceListResponseServicesUsersAuthentication
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesUsersAuthentication getAuthentication() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_control", (n) -> { this.setAccessControl(n.getObjectValue(ServiceListResponseServicesUsersAccessControl::createFromDiscriminatorValue)); });
        deserializerMap.put("access_key", (n) -> { this.setAccessKey(n.getStringValue()); });
        deserializerMap.put("authentication", (n) -> { this.setAuthentication(n.getEnumValue(ServiceListResponseServicesUsersAuthentication::forValue)); });
     ...
     */
    public void setAccessControl(@jakarta.annotation.Nullable final ServiceListResponseServicesUsersAccessControl value) {
     ...
     */
    public void setAuthentication(@jakarta.annotation.Nullable final ServiceListResponseServicesUsersAuthentication value) {
