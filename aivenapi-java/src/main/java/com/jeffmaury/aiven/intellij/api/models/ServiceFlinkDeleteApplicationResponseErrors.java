...
public class ServiceFlinkDeleteApplicationResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationResponseErrors and sets the default values.
     */
    public ServiceFlinkDeleteApplicationResponseErrors() {
    ...
    public static ServiceFlinkDeleteApplicationResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationResponseErrors();
    }
    /**
