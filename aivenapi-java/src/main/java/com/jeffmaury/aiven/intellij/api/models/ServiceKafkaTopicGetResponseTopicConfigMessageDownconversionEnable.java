...
public class ServiceKafkaTopicGetResponseTopicConfigMessageDownconversionEnable implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMessageDownconversionEnable createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSource(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMessageDownconversionEnableSource value) {
        this.source = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSynonyms(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigMessageDownconversionEnableSynonyms> value) {
        this.synonyms = value;
    }
    /**
