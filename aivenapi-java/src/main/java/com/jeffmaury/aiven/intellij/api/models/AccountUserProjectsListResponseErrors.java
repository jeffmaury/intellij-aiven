...
public class AccountUserProjectsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountUserProjectsListResponseErrors and sets the default values.
     */
    public AccountUserProjectsListResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountUserProjectsListResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static AccountUserProjectsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountUserProjectsListResponseErrors();
    }
    /**
