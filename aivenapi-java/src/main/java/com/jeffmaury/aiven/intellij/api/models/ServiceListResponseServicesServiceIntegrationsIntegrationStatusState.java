...
public class ServiceListResponseServicesServiceIntegrationsIntegrationStatusState implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesServiceIntegrationsIntegrationStatusState createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setLikelyErrorCause(@jakarta.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsIntegrationStatusStateLikelyErrorCause value) {
     ...
     */
    public void setNodes(@jakarta.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsIntegrationStatusStateNodes value) {
        this.nodes = value;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsIntegrationStatusStateStatus value) {
        this.status = value;
    }
}
