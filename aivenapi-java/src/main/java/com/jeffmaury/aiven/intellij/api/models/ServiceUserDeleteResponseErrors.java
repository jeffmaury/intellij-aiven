...
public class ServiceUserDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserDeleteResponseErrors and sets the default values.
     */
    public ServiceUserDeleteResponseErrors() {
    ...
    public static ServiceUserDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserDeleteResponseErrors();
    }
    /**
