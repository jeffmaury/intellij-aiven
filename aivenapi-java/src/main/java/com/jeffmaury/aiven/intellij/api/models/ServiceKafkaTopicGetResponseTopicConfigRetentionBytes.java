...
public class ServiceKafkaTopicGetResponseTopicConfigRetentionBytes implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigRetentionBytes createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("source", (n) -> { this.setSource(n.getEnumValue(ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSource::forValue)); });
     ...
     * @return a java.util.List<ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSynonyms>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setSource(@jakarta.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSource value) {
        this.source = value;
    }
    /**
     ...
     */
    public void setSynonyms(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSynonyms> value) {
        this.synonyms = value;
    }
    /**
