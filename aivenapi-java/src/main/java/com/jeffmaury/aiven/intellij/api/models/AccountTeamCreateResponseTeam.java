...
public class AccountTeamCreateResponseTeam implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
    ...
    /**
     * Instantiates a new AccountTeamCreateResponseTeam and sets the default values.
     */
    public AccountTeamCreateResponseTeam() {
    ...
    public static AccountTeamCreateResponseTeam createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamCreateResponseTeam();
    }
    /**
