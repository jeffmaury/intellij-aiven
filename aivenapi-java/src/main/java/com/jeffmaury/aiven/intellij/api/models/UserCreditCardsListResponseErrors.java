...
public class UserCreditCardsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserCreditCardsListResponseErrors and sets the default values.
     */
    public UserCreditCardsListResponseErrors() {
    ...
    public static UserCreditCardsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserCreditCardsListResponseErrors();
    }
    /**
