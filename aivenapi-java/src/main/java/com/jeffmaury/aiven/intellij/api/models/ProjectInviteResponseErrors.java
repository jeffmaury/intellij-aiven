...
public class ProjectInviteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectInviteResponseErrors and sets the default values.
     */
    public ProjectInviteResponseErrors() {
    ...
    public static ProjectInviteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectInviteResponseErrors();
    }
    /**
