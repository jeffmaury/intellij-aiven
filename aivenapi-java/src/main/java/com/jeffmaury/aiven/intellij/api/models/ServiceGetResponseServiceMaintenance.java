...
public class ServiceGetResponseServiceMaintenance implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceMaintenance createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dow", (n) -> { this.setDow(n.getEnumValue(ServiceGetResponseServiceMaintenanceDow::forValue)); });
     ...
     * @return a java.util.List<ServiceGetResponseServiceMaintenanceUpdates>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setDow(@jakarta.annotation.Nullable final ServiceGetResponseServiceMaintenanceDow value) {
        this.dow = value;
    }
    /**
     ...
     */
    public void setUpdates(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceMaintenanceUpdates> value) {
        this.updates = value;
    }
}
