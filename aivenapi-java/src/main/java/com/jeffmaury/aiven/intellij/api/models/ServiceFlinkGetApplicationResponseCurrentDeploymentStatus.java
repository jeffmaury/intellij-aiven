...
public enum ServiceFlinkGetApplicationResponseCurrentDeploymentStatus implements ValuedEnum {
    ...
    ServiceFlinkGetApplicationResponseCurrentDeploymentStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceFlinkGetApplicationResponseCurrentDeploymentStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
