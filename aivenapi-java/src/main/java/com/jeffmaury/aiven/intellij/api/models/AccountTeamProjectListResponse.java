...
public class AccountTeamProjectListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountTeamProjectListResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<AccountTeamProjectListResponseErrors>
     */
     ...
     * @return a java.util.List<AccountTeamProjectListResponseProjects>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<AccountTeamProjectListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setProjects(@jakarta.annotation.Nullable final java.util.List<AccountTeamProjectListResponseProjects> value) {
        this.projects = value;
    }
}
