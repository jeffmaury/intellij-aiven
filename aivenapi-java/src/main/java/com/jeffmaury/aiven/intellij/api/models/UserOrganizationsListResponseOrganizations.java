...
public class UserOrganizationsListResponseOrganizations implements AdditionalDataHolder, Parsable {
    ...
    public static UserOrganizationsListResponseOrganizations createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTier(@javax.annotation.Nullable final UserOrganizationsListResponseOrganizationsTier value) {
        this.tier = value;
    }
    /**
