...
public class UserOrganizationsListResponseOrganizations implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private UserOrganizationsListResponseOrganizationsTier tier;
    /**
     * Time of the organization's latest update
     */
    private String updateTime;
    /**
     * Instantiates a new UserOrganizationsListResponseOrganizations and sets the default values.
     */
    public UserOrganizationsListResponseOrganizations() {
    ...
    public static UserOrganizationsListResponseOrganizations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserOrganizationsListResponseOrganizations();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("tier", (n) -> { this.setTier(n.getEnumValue(UserOrganizationsListResponseOrganizationsTier::forValue)); });
     ...
     * @return a UserOrganizationsListResponseOrganizationsTier
     */
    @jakarta.annotation.Nullable
    public UserOrganizationsListResponseOrganizationsTier getTier() {
        return this.tier;
    }
    /**
     ...
     */
    public void setTier(@jakarta.annotation.Nullable final UserOrganizationsListResponseOrganizationsTier value) {
        this.tier = value;
    }
    /**
