...
public class ProjectTagsUpdateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectTagsUpdateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTags(@javax.annotation.Nullable final ProjectTagsUpdateRequestBodyTags value) {
        this.tags = value;
    }
}
