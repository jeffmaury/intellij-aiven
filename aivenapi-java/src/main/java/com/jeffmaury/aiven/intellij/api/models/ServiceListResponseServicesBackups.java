...
public class ServiceListResponseServicesBackups implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceListResponseServicesBackupsAdditionalRegions> additionalRegions;
    /**
    ...
    /**
     * Instantiates a new ServiceListResponseServicesBackups and sets the default values.
     */
    public ServiceListResponseServicesBackups() {
    ...
    public static ServiceListResponseServicesBackups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServicesBackups();
    }
    /**
     ...
     * @return a java.util.List<ServiceListResponseServicesBackupsAdditionalRegions>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesBackupsAdditionalRegions> getAdditionalRegions() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("additional_regions", (n) -> { this.setAdditionalRegions(n.getCollectionOfObjectValues(ServiceListResponseServicesBackupsAdditionalRegions::createFromDiscriminatorValue)); });
     ...
     */
    public void setAdditionalRegions(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesBackupsAdditionalRegions> value) {
