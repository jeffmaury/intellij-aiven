...
public class ServiceListResponseServicesBackups implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesBackups createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceListResponseServicesBackupsAdditionalRegions
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setAdditionalRegions(@javax.annotation.Nullable final java.util.List<ServiceListResponseServicesBackupsAdditionalRegions> value) {
