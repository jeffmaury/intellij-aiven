...
public class ServiceBackupsGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceBackupsGetResponseErrors and sets the default values.
     */
    public ServiceBackupsGetResponseErrors() {
    ...
    public static ServiceBackupsGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceBackupsGetResponseErrors();
    }
    /**
