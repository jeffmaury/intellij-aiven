...
public class MySQLServiceQueryStatisticsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new MySQLServiceQueryStatisticsResponseErrors and sets the default values.
     */
    public MySQLServiceQueryStatisticsResponseErrors() {
    ...
    public static MySQLServiceQueryStatisticsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new MySQLServiceQueryStatisticsResponseErrors();
    }
    /**
