...
public class ServiceFlinkCreateApplicationVersionResponseSinks implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Columns
     */
    private java.util.List<ServiceFlinkCreateApplicationVersionResponseSinksColumns> columns;
    /**
     ...
     * Option
     */
    private ServiceFlinkCreateApplicationVersionResponseSinksOptions options;
    /**
     * Sink ID
     */
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationVersionResponseSinks and sets the default values.
     */
    public ServiceFlinkCreateApplicationVersionResponseSinks() {
    ...
    public static ServiceFlinkCreateApplicationVersionResponseSinks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationVersionResponseSinks();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkCreateApplicationVersionResponseSinksColumns>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkCreateApplicationVersionResponseSinksColumns> getColumns() {
        return this.columns;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { this.setColumns(n.getCollectionOfObjectValues(ServiceFlinkCreateApplicationVersionResponseSinksColumns::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getObjectValue(ServiceFlinkCreateApplicationVersionResponseSinksOptions::createFromDiscriminatorValue)); });
     ...
     * @return a ServiceFlinkCreateApplicationVersionResponseSinksOptions
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkCreateApplicationVersionResponseSinksOptions getOptions() {
        return this.options;
    }
    /**
     ...
     */
    public void setColumns(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationVersionResponseSinksColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final ServiceFlinkCreateApplicationVersionResponseSinksOptions value) {
        this.options = value;
    }
    /**
