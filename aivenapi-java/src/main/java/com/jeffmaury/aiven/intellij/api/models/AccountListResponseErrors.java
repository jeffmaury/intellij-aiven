...
public class AccountListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountListResponseErrors and sets the default values.
     */
    public AccountListResponseErrors() {
    ...
    public static AccountListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountListResponseErrors();
    }
    /**
