...
public class ServiceFlinkDeleteApplicationVersionResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationVersionResponseErrors and sets the default values.
     */
    public ServiceFlinkDeleteApplicationVersionResponseErrors() {
    ...
    public static ServiceFlinkDeleteApplicationVersionResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationVersionResponseErrors();
    }
    /**
