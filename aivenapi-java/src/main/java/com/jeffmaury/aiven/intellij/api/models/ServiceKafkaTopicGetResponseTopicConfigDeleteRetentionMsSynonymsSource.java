...
public enum ServiceKafkaTopicGetResponseTopicConfigDeleteRetentionMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigDeleteRetentionMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigDeleteRetentionMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
