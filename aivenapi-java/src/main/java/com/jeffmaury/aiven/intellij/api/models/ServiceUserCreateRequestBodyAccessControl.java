...
public class ServiceUserCreateRequestBodyAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCreateRequestBodyAccessControl and sets the default values.
     */
    public ServiceUserCreateRequestBodyAccessControl() {
    ...
    public static ServiceUserCreateRequestBodyAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCreateRequestBodyAccessControl();
    }
    /**
