...
public enum ServiceKafkaTopicGetResponseTopicConfigFlushMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigFlushMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigFlushMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
