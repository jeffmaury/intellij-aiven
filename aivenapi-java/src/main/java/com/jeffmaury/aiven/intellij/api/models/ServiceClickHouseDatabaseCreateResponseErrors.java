...
public class ServiceClickHouseDatabaseCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceClickHouseDatabaseCreateResponseErrors and sets the default values.
     */
    public ServiceClickHouseDatabaseCreateResponseErrors() {
    ...
    public static ServiceClickHouseDatabaseCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceClickHouseDatabaseCreateResponseErrors();
    }
    /**
