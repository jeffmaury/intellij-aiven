...
public class ServiceKafkaTopicDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTopicDeleteResponseErrors and sets the default values.
     */
    public ServiceKafkaTopicDeleteResponseErrors() {
    ...
    public static ServiceKafkaTopicDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTopicDeleteResponseErrors();
    }
    /**
