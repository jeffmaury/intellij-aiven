...
public enum VpcGetResponsePeeringConnectionsVpcPeeringConnectionType implements ValuedEnum {
    ...
    VpcGetResponsePeeringConnectionsVpcPeeringConnectionType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcGetResponsePeeringConnectionsVpcPeeringConnectionType forValue(@jakarta.annotation.Nonnull final String searchValue) {
