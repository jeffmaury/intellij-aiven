...
public class ValidateReferralCodeResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ValidateReferralCodeResponseErrors and sets the default values.
     */
    public ValidateReferralCodeResponseErrors() {
    ...
    public static ValidateReferralCodeResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ValidateReferralCodeResponseErrors();
    }
    /**
