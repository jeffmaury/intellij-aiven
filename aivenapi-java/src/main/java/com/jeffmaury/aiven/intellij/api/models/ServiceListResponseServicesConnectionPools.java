...
public class ServiceListResponseServicesConnectionPools implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesConnectionPools createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("pool_mode", (n) -> { this.setPoolMode(n.getEnumValue(ServiceListResponseServicesConnectionPoolsPoolMode.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setPoolMode(@javax.annotation.Nullable final ServiceListResponseServicesConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
