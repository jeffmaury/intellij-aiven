...
public class ProjectGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectGetResponseErrors and sets the default values.
     */
    public ProjectGetResponseErrors() {
    ...
    public static ProjectGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectGetResponseErrors();
    }
    /**
