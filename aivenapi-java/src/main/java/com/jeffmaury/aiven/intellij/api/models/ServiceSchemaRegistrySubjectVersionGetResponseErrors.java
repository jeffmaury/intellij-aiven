...
public class ServiceSchemaRegistrySubjectVersionGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectVersionGetResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectVersionGetResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectVersionGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectVersionGetResponseErrors();
    }
    /**
