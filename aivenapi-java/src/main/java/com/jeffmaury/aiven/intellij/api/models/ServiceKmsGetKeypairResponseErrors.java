...
public class ServiceKmsGetKeypairResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKmsGetKeypairResponseErrors and sets the default values.
     */
    public ServiceKmsGetKeypairResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKmsGetKeypairResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKmsGetKeypairResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKmsGetKeypairResponseErrors();
    }
    /**
