...
public class TeamsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccountProjectsTeamsListResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AccountProjectsTeamsListResponse> executionException = new java.util.concurrent.CompletableFuture<AccountProjectsTeamsListResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AccountProjectsTeamsListResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
