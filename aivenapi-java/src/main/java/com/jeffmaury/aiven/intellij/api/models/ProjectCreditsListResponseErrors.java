...
public class ProjectCreditsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectCreditsListResponseErrors and sets the default values.
     */
    public ProjectCreditsListResponseErrors() {
    ...
    public static ProjectCreditsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectCreditsListResponseErrors();
    }
    /**
