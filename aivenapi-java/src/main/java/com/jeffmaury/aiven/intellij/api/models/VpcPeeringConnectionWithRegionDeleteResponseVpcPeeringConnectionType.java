...
public enum VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType implements ValuedEnum {
    ...
    VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType forValue(@jakarta.annotation.Nonnull final String searchValue) {
