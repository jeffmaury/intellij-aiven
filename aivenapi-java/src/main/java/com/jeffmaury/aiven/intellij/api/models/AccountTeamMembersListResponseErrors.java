...
public class AccountTeamMembersListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamMembersListResponseErrors and sets the default values.
     */
    public AccountTeamMembersListResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountTeamMembersListResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static AccountTeamMembersListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamMembersListResponseErrors();
    }
    /**
