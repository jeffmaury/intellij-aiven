...
public class VpcPeeringConnectionDeleteResponseStateInfoWarnings implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Type of warning
     */
    private VpcPeeringConnectionDeleteResponseStateInfoWarningsType type;
    /**
     * Instantiates a new VpcPeeringConnectionDeleteResponseStateInfoWarnings and sets the default values.
     */
    public VpcPeeringConnectionDeleteResponseStateInfoWarnings() {
    ...
    public static VpcPeeringConnectionDeleteResponseStateInfoWarnings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionDeleteResponseStateInfoWarnings();
    }
    /**
     ...
     * @return a VpcPeeringConnectionDeleteResponseStateInfoWarningsType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionDeleteResponseStateInfoWarningsType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final VpcPeeringConnectionDeleteResponseStateInfoWarningsType value) {
        this.type = value;
    }
}
