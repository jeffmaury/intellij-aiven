...
public class ServiceGetResponseServiceBackups implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceGetResponseServiceBackupsAdditionalRegions> additionalRegions;
    /**
    ...
    /**
     * Instantiates a new ServiceGetResponseServiceBackups and sets the default values.
     */
    public ServiceGetResponseServiceBackups() {
    ...
    public static ServiceGetResponseServiceBackups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceBackups();
    }
    /**
     ...
     * @return a java.util.List<ServiceGetResponseServiceBackupsAdditionalRegions>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceBackupsAdditionalRegions> getAdditionalRegions() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("additional_regions", (n) -> { this.setAdditionalRegions(n.getCollectionOfObjectValues(ServiceGetResponseServiceBackupsAdditionalRegions::createFromDiscriminatorValue)); });
     ...
     */
    public void setAdditionalRegions(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceBackupsAdditionalRegions> value) {
