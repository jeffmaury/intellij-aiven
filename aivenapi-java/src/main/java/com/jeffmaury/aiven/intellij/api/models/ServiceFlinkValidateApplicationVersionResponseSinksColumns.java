...
public class ServiceFlinkValidateApplicationVersionResponseSinksColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkValidateApplicationVersionResponseSinksColumns and sets the default values.
     */
    public ServiceFlinkValidateApplicationVersionResponseSinksColumns() {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseSinksColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkValidateApplicationVersionResponseSinksColumns();
    }
    /**
