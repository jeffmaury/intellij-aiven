...
public class ServiceOpenSearchIndexDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchIndexDeleteResponseErrors and sets the default values.
     */
    public ServiceOpenSearchIndexDeleteResponseErrors() {
    ...
    public static ServiceOpenSearchIndexDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchIndexDeleteResponseErrors();
    }
    /**
