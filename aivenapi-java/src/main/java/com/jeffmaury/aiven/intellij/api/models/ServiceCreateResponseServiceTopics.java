...
public class ServiceCreateResponseServiceTopics implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Topic state
     */
    private ServiceCreateResponseServiceTopicsState state;
    /**
     * Topic name
     */
    private String topicName;
    /**
     * Instantiates a new ServiceCreateResponseServiceTopics and sets the default values.
     */
    public ServiceCreateResponseServiceTopics() {
    ...
    public static ServiceCreateResponseServiceTopics createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceTopics();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServiceCreateResponseServiceTopicsState::forValue)); });
     ...
     * @return a ServiceCreateResponseServiceTopicsState
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceTopicsState getState() {
        return this.state;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceCreateResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
