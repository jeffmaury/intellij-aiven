...
public class ServiceTypesRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ListProjectServiceTypesResponse
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ListProjectServiceTypesResponse> get() {
        try {
            final RequestInformation requestInfo = toGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, ListProjectServiceTypesResponse::createFromDiscriminatorValue, null);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<ListProjectServiceTypesResponse> executionException = new java.util.concurrent.CompletableFuture<ListProjectServiceTypesResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ListProjectServiceTypesResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
