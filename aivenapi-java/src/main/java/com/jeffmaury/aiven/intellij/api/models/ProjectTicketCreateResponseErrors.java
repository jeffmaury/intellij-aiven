...
public class ProjectTicketCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTicketCreateResponseErrors and sets the default values.
     */
    public ProjectTicketCreateResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ProjectTicketCreateResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ProjectTicketCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTicketCreateResponseErrors();
    }
    /**
