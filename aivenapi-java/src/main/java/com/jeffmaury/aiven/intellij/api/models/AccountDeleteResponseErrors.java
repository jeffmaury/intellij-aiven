...
public class AccountDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountDeleteResponseErrors and sets the default values.
     */
    public AccountDeleteResponseErrors() {
    ...
    public static AccountDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountDeleteResponseErrors();
    }
    /**
