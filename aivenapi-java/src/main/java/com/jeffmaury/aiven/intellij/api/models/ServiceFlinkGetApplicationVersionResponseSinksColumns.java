...
public class ServiceFlinkGetApplicationVersionResponseSinksColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationVersionResponseSinksColumns and sets the default values.
     */
    public ServiceFlinkGetApplicationVersionResponseSinksColumns() {
    ...
    public static ServiceFlinkGetApplicationVersionResponseSinksColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationVersionResponseSinksColumns();
    }
    /**
