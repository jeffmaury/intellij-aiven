...
public class BillingGroupProjectAssignResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupProjectAssignResponseErrors and sets the default values.
     */
    public BillingGroupProjectAssignResponseErrors() {
    ...
    public static BillingGroupProjectAssignResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupProjectAssignResponseErrors();
    }
    /**
