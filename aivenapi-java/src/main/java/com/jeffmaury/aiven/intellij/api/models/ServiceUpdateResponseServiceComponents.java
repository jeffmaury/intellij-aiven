...
public class ServiceUpdateResponseServiceComponents implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("kafka_authentication_method", (n) -> { this.setKafkaAuthenticationMethod(n.getEnumValue(ServiceUpdateResponseServiceComponentsKafkaAuthenticationMethod::forValue)); });
        ...
        deserializerMap.put("route", (n) -> { this.setRoute(n.getEnumValue(ServiceUpdateResponseServiceComponentsRoute::forValue)); });
        deserializerMap.put("ssl", (n) -> { this.setSsl(n.getBooleanValue()); });
        deserializerMap.put("usage", (n) -> { this.setUsage(n.getEnumValue(ServiceUpdateResponseServiceComponentsUsage::forValue)); });
