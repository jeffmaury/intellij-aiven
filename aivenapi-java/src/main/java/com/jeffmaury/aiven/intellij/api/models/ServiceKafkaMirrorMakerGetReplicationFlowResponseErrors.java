...
public class ServiceKafkaMirrorMakerGetReplicationFlowResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaMirrorMakerGetReplicationFlowResponseErrors and sets the default values.
     */
    public ServiceKafkaMirrorMakerGetReplicationFlowResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaMirrorMakerGetReplicationFlowResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaMirrorMakerGetReplicationFlowResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaMirrorMakerGetReplicationFlowResponseErrors();
    }
    /**
