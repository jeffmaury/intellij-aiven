...
public class ServiceEnableWritesResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceEnableWritesResponseErrors and sets the default values.
     */
    public ServiceEnableWritesResponseErrors() {
    ...
    public static ServiceEnableWritesResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceEnableWritesResponseErrors();
    }
    /**
