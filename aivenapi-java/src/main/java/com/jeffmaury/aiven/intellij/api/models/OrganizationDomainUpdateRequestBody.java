...
public class OrganizationDomainUpdateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationDomainUpdateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setVerificationType(@javax.annotation.Nullable final OrganizationDomainUpdateRequestBodyVerificationType value) {
