...
public class UserUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserUpdateResponseErrors and sets the default values.
     */
    public UserUpdateResponseErrors() {
    ...
    public static UserUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserUpdateResponseErrors();
    }
    /**
