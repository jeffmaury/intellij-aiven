...
public class AccountAuthenticationMethodUpdateResponseAuthenticationMethod implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodUpdateResponseAuthenticationMethod createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authentication_method_type", (n) -> { this.setAuthenticationMethodType(n.getEnumValue(AccountAuthenticationMethodUpdateResponseAuthenticationMethodAuthenticationMethodType::forValue)); });
        ...
        deserializerMap.put("saml_cert", (n) -> { this.setSamlCert(n.getEnumValue(AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlCert::forValue)); });
        ...
        deserializerMap.put("saml_digest_algorithm", (n) -> { this.setSamlDigestAlgorithm(n.getEnumValue(AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlDigestAlgorithm::forValue)); });
        ...
        deserializerMap.put("saml_signature_algorithm", (n) -> { this.setSamlSignatureAlgorithm(n.getEnumValue(AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlSignatureAlgorithm::forValue)); });
        deserializerMap.put("saml_sp_certificate", (n) -> { this.setSamlSpCertificate(n.getStringValue()); });
        deserializerMap.put("saml_variant", (n) -> { this.setSamlVariant(n.getEnumValue(AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlVariant::forValue)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(AccountAuthenticationMethodUpdateResponseAuthenticationMethodState::forValue)); });
     ...
     */
    public void setAuthenticationMethodType(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethodAuthenticationMethodType value) {
     ...
     */
    public void setSamlCert(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlCert value) {
        this.samlCert = value;
    }
    /**
     ...
     */
    public void setSamlDigestAlgorithm(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlDigestAlgorithm value) {
     ...
     */
    public void setSamlFieldMapping(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlFieldMapping value) {
     ...
     */
    public void setSamlSignatureAlgorithm(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlSignatureAlgorithm value) {
     ...
     */
    public void setSamlVariant(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethodSamlVariant value) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethodState value) {
        this.state = value;
    }
    /**
