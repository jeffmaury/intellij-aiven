...
public class OrganizationProjectsListResponseProjects implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
     ...
     * Billing currency
     */
    private OrganizationProjectsListResponseProjectsBillingCurrency billingCurrency;
    /**
     * List of project billing email addresses
     */
    private java.util.List<OrganizationProjectsListResponseProjectsBillingEmails> billingEmails;
    /**
     ...
     */
    private OrganizationProjectsListResponseProjectsCardInfo cardInfo;
    /**
     * Address city
     */
    private String city;
     ...
     */
    private OrganizationProjectsListResponseProjectsEndOfLifeExtension endOfLifeExtension;
    /**
     ...
     * Feature flags
     */
    private OrganizationProjectsListResponseProjectsFeatures features;
    /**
     * Organization ID
     */
     ...
     */
    private OrganizationProjectsListResponseProjectsTags tags;
    /**
     * List of project tech email addresses
     */
    private java.util.List<OrganizationProjectsListResponseProjectsTechEmails> techEmails;
    /**
     * Tenant ID
     */
    ...
    /**
     * Instantiates a new OrganizationProjectsListResponseProjects and sets the default values.
     */
    public OrganizationProjectsListResponseProjects() {
    ...
    public static OrganizationProjectsListResponseProjects createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationProjectsListResponseProjects();
    }
    /**
     ...
     * @return a OrganizationProjectsListResponseProjectsBillingCurrency
     */
    @jakarta.annotation.Nullable
    public OrganizationProjectsListResponseProjectsBillingCurrency getBillingCurrency() {
        return this.billingCurrency;
    }
    /**
     * Gets the billing_emails property value. List of project billing email addresses
     * @return a java.util.List<OrganizationProjectsListResponseProjectsBillingEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<OrganizationProjectsListResponseProjectsBillingEmails> getBillingEmails() {
     ...
     * @return a OrganizationProjectsListResponseProjectsCardInfo
     */
    @jakarta.annotation.Nullable
    public OrganizationProjectsListResponseProjectsCardInfo getCardInfo() {
     ...
     * @return a OrganizationProjectsListResponseProjectsEndOfLifeExtension
     */
    @jakarta.annotation.Nullable
    public OrganizationProjectsListResponseProjectsEndOfLifeExtension getEndOfLifeExtension() {
     ...
     * @return a OrganizationProjectsListResponseProjectsFeatures
     */
    @jakarta.annotation.Nullable
    public OrganizationProjectsListResponseProjectsFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_currency", (n) -> { this.setBillingCurrency(n.getEnumValue(OrganizationProjectsListResponseProjectsBillingCurrency::forValue)); });
        deserializerMap.put("billing_emails", (n) -> { this.setBillingEmails(n.getCollectionOfObjectValues(OrganizationProjectsListResponseProjectsBillingEmails::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("card_info", (n) -> { this.setCardInfo(n.getObjectValue(OrganizationProjectsListResponseProjectsCardInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("end_of_life_extension", (n) -> { this.setEndOfLifeExtension(n.getObjectValue(OrganizationProjectsListResponseProjectsEndOfLifeExtension::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(OrganizationProjectsListResponseProjectsFeatures::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("tags", (n) -> { this.setTags(n.getObjectValue(OrganizationProjectsListResponseProjectsTags::createFromDiscriminatorValue)); });
        deserializerMap.put("tech_emails", (n) -> { this.setTechEmails(n.getCollectionOfObjectValues(OrganizationProjectsListResponseProjectsTechEmails::createFromDiscriminatorValue)); });
     ...
     * @return a OrganizationProjectsListResponseProjectsTags
     */
    @jakarta.annotation.Nullable
    public OrganizationProjectsListResponseProjectsTags getTags() {
        return this.tags;
    }
    /**
     * Gets the tech_emails property value. List of project tech email addresses
     * @return a java.util.List<OrganizationProjectsListResponseProjectsTechEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<OrganizationProjectsListResponseProjectsTechEmails> getTechEmails() {
     ...
     */
    public void setBillingCurrency(@jakarta.annotation.Nullable final OrganizationProjectsListResponseProjectsBillingCurrency value) {
     ...
     */
    public void setBillingEmails(@jakarta.annotation.Nullable final java.util.List<OrganizationProjectsListResponseProjectsBillingEmails> value) {
     ...
     */
    public void setCardInfo(@jakarta.annotation.Nullable final OrganizationProjectsListResponseProjectsCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    public void setEndOfLifeExtension(@jakarta.annotation.Nullable final OrganizationProjectsListResponseProjectsEndOfLifeExtension value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final OrganizationProjectsListResponseProjectsFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setTags(@jakarta.annotation.Nullable final OrganizationProjectsListResponseProjectsTags value) {
        this.tags = value;
    }
    /**
     ...
     */
    public void setTechEmails(@jakarta.annotation.Nullable final java.util.List<OrganizationProjectsListResponseProjectsTechEmails> value) {
