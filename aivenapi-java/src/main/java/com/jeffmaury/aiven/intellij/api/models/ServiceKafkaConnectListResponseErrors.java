...
public class ServiceKafkaConnectListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectListResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectListResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaConnectListResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaConnectListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectListResponseErrors();
    }
    /**
