...
public class AccountAttachPaymentMethodResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountAttachPaymentMethodResponseErrors and sets the default values.
     */
    public AccountAttachPaymentMethodResponseErrors() {
    ...
    public static AccountAttachPaymentMethodResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAttachPaymentMethodResponseErrors();
    }
    /**
