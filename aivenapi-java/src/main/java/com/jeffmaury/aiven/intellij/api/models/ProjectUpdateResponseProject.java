...
public class ProjectUpdateResponseProject implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
     ...
     * Billing currency
     */
    private ProjectUpdateResponseProjectBillingCurrency billingCurrency;
    /**
     * List of project billing email addresses
     */
    private java.util.List<ProjectUpdateResponseProjectBillingEmails> billingEmails;
    /**
     ...
     */
    private ProjectUpdateResponseProjectCardInfo cardInfo;
    /**
     * Address city
     */
    private String city;
     ...
     */
    private ProjectUpdateResponseProjectEndOfLifeExtension endOfLifeExtension;
    /**
     ...
     * Feature flags
     */
    private ProjectUpdateResponseProjectFeatures features;
    /**
     * Organization ID
     */
     ...
     */
    private ProjectUpdateResponseProjectTags tags;
    /**
     * List of project tech email addresses
     */
    private java.util.List<ProjectUpdateResponseProjectTechEmails> techEmails;
    /**
     * Tenant ID
     */
    ...
    /**
     * Instantiates a new ProjectUpdateResponseProject and sets the default values.
     */
    public ProjectUpdateResponseProject() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ProjectUpdateResponseProject
     */
    @jakarta.annotation.Nonnull
    public static ProjectUpdateResponseProject createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectUpdateResponseProject();
    }
    /**
     ...
     * @return a ProjectUpdateResponseProjectBillingCurrency
     */
    @jakarta.annotation.Nullable
    public ProjectUpdateResponseProjectBillingCurrency getBillingCurrency() {
        return this.billingCurrency;
    }
    /**
     * Gets the billing_emails property value. List of project billing email addresses
     * @return a java.util.List<ProjectUpdateResponseProjectBillingEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ProjectUpdateResponseProjectBillingEmails> getBillingEmails() {
     ...
     * @return a ProjectUpdateResponseProjectCardInfo
     */
    @jakarta.annotation.Nullable
    public ProjectUpdateResponseProjectCardInfo getCardInfo() {
     ...
     * @return a ProjectUpdateResponseProjectEndOfLifeExtension
     */
    @jakarta.annotation.Nullable
    public ProjectUpdateResponseProjectEndOfLifeExtension getEndOfLifeExtension() {
     ...
     * @return a ProjectUpdateResponseProjectFeatures
     */
    @jakarta.annotation.Nullable
    public ProjectUpdateResponseProjectFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_currency", (n) -> { this.setBillingCurrency(n.getEnumValue(ProjectUpdateResponseProjectBillingCurrency::forValue)); });
        deserializerMap.put("billing_emails", (n) -> { this.setBillingEmails(n.getCollectionOfObjectValues(ProjectUpdateResponseProjectBillingEmails::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("card_info", (n) -> { this.setCardInfo(n.getObjectValue(ProjectUpdateResponseProjectCardInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("end_of_life_extension", (n) -> { this.setEndOfLifeExtension(n.getObjectValue(ProjectUpdateResponseProjectEndOfLifeExtension::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(ProjectUpdateResponseProjectFeatures::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("tags", (n) -> { this.setTags(n.getObjectValue(ProjectUpdateResponseProjectTags::createFromDiscriminatorValue)); });
        deserializerMap.put("tech_emails", (n) -> { this.setTechEmails(n.getCollectionOfObjectValues(ProjectUpdateResponseProjectTechEmails::createFromDiscriminatorValue)); });
     ...
     * @return a ProjectUpdateResponseProjectTags
     */
    @jakarta.annotation.Nullable
    public ProjectUpdateResponseProjectTags getTags() {
        return this.tags;
    }
    /**
     * Gets the tech_emails property value. List of project tech email addresses
     * @return a java.util.List<ProjectUpdateResponseProjectTechEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ProjectUpdateResponseProjectTechEmails> getTechEmails() {
     ...
     */
    public void setBillingCurrency(@jakarta.annotation.Nullable final ProjectUpdateResponseProjectBillingCurrency value) {
     ...
     */
    public void setBillingEmails(@jakarta.annotation.Nullable final java.util.List<ProjectUpdateResponseProjectBillingEmails> value) {
     ...
     */
    public void setCardInfo(@jakarta.annotation.Nullable final ProjectUpdateResponseProjectCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    public void setEndOfLifeExtension(@jakarta.annotation.Nullable final ProjectUpdateResponseProjectEndOfLifeExtension value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final ProjectUpdateResponseProjectFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setTags(@jakarta.annotation.Nullable final ProjectUpdateResponseProjectTags value) {
        this.tags = value;
    }
    /**
     ...
     */
    public void setTechEmails(@jakarta.annotation.Nullable final java.util.List<ProjectUpdateResponseProjectTechEmails> value) {
