...
public class OrganizationUserSetResponseUserInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationUserSetResponseUserInfo and sets the default values.
     */
    public OrganizationUserSetResponseUserInfo() {
    ...
    public static OrganizationUserSetResponseUserInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationUserSetResponseUserInfo();
    }
    /**
