...
public class ProjectUpdateResponseProjectCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectUpdateResponseProjectCardInfo and sets the default values.
     */
    public ProjectUpdateResponseProjectCardInfo() {
    ...
    public static ProjectUpdateResponseProjectCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectUpdateResponseProjectCardInfo();
    }
    /**
