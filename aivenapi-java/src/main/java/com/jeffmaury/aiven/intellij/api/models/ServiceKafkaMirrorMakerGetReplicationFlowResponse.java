...
public class ServiceKafkaMirrorMakerGetReplicationFlowResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaMirrorMakerGetReplicationFlowResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setReplicationFlow(@javax.annotation.Nullable final ServiceKafkaMirrorMakerGetReplicationFlowResponseReplicationFlow value) {
