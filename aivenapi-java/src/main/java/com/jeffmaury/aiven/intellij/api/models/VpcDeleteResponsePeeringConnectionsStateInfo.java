...
public class VpcDeleteResponsePeeringConnectionsStateInfo implements AdditionalDataHolder, Parsable {
    ...
    public static VpcDeleteResponsePeeringConnectionsStateInfo createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setWarnings(@javax.annotation.Nullable final java.util.List<VpcDeleteResponsePeeringConnectionsStateInfoWarnings> value) {
        this.warnings = value;
    }
}
