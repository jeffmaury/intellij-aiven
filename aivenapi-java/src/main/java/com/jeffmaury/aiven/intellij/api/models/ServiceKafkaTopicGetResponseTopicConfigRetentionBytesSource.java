...
public enum ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
