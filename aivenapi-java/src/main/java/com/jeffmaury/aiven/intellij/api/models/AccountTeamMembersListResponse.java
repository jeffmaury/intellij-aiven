...
public class AccountTeamMembersListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountTeamMembersListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<AccountTeamMembersListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setMembers(@javax.annotation.Nullable final java.util.List<AccountTeamMembersListResponseMembers> value) {
        this.members = value;
    }
    /**
