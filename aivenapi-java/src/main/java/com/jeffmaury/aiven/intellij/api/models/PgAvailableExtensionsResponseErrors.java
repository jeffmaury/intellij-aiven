...
public class PgAvailableExtensionsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PgAvailableExtensionsResponseErrors and sets the default values.
     */
    public PgAvailableExtensionsResponseErrors() {
    ...
    public static PgAvailableExtensionsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PgAvailableExtensionsResponseErrors();
    }
    /**
