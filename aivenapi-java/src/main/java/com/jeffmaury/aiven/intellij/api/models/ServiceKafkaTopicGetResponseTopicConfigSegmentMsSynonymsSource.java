...
public enum ServiceKafkaTopicGetResponseTopicConfigSegmentMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigSegmentMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigSegmentMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
