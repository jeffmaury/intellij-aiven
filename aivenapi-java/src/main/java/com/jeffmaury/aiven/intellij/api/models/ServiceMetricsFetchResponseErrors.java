...
public class ServiceMetricsFetchResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceMetricsFetchResponseErrors and sets the default values.
     */
    public ServiceMetricsFetchResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceMetricsFetchResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceMetricsFetchResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceMetricsFetchResponseErrors();
    }
    /**
