...
public class ServiceKafkaAclAddResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaAclAddResponseErrors and sets the default values.
     */
    public ServiceKafkaAclAddResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaAclAddResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaAclAddResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaAclAddResponseErrors();
    }
    /**
