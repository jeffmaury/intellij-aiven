...
public class ServiceFlinkValidateApplicationVersionResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkValidateApplicationVersionResponseErrors and sets the default values.
     */
    public ServiceFlinkValidateApplicationVersionResponseErrors() {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkValidateApplicationVersionResponseErrors();
    }
    /**
