...
public class OrganizationTicketListResponseTicketsSubmitter implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationTicketListResponseTicketsSubmitter and sets the default values.
     */
    public OrganizationTicketListResponseTicketsSubmitter() {
    ...
    public static OrganizationTicketListResponseTicketsSubmitter createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationTicketListResponseTicketsSubmitter();
    }
    /**
