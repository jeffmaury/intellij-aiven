...
public class BillingGroupCreditsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupCreditsListResponseErrors and sets the default values.
     */
    public BillingGroupCreditsListResponseErrors() {
    ...
    public static BillingGroupCreditsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupCreditsListResponseErrors();
    }
    /**
