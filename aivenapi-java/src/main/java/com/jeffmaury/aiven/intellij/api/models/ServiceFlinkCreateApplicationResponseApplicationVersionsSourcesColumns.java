...
public class ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns and sets the default values.
     */
    public ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns() {
    ...
    public static ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns();
    }
    /**
