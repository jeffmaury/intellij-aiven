...
public class ServiceGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceGetResponseErrors and sets the default values.
     */
    public ServiceGetResponseErrors() {
    ...
    public static ServiceGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseErrors();
    }
    /**
