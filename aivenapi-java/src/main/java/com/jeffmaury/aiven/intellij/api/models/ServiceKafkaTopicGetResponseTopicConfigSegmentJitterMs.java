...
public class ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMs implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMs createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("source", (n) -> { this.setSource(n.getEnumValue(ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSource::forValue)); });
     ...
     * @return a java.util.List<ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSynonyms>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setSource(@jakarta.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSource value) {
        this.source = value;
    }
    /**
     ...
     */
    public void setSynonyms(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSynonyms> value) {
        this.synonyms = value;
    }
    /**
