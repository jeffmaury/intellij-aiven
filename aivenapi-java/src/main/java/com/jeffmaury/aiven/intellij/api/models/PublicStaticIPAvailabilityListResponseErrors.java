...
public class PublicStaticIPAvailabilityListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PublicStaticIPAvailabilityListResponseErrors and sets the default values.
     */
    public PublicStaticIPAvailabilityListResponseErrors() {
    ...
    public static PublicStaticIPAvailabilityListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PublicStaticIPAvailabilityListResponseErrors();
    }
    /**
