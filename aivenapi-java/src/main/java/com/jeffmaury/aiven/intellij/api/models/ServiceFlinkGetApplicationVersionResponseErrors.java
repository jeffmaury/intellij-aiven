...
public class ServiceFlinkGetApplicationVersionResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationVersionResponseErrors and sets the default values.
     */
    public ServiceFlinkGetApplicationVersionResponseErrors() {
    ...
    public static ServiceFlinkGetApplicationVersionResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationVersionResponseErrors();
    }
    /**
