...
public class AccountAuthenticationMethodCreateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodCreateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthenticationMethod(@javax.annotation.Nullable final AccountAuthenticationMethodCreateResponseAuthenticationMethod value) {
