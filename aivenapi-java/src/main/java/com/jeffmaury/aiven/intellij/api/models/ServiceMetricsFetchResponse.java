...
public class ServiceMetricsFetchResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceMetricsFetchResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceMetricsFetchResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setMetrics(@javax.annotation.Nullable final ServiceMetricsFetchResponseMetrics value) {
        this.metrics = value;
    }
}
