...
public class ServiceFlinkGetApplicationVersionResponseSourcesColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationVersionResponseSourcesColumns and sets the default values.
     */
    public ServiceFlinkGetApplicationVersionResponseSourcesColumns() {
    ...
    public static ServiceFlinkGetApplicationVersionResponseSourcesColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationVersionResponseSourcesColumns();
    }
    /**
