...
public class ProjectServiceTagsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectServiceTagsListResponseErrors and sets the default values.
     */
    public ProjectServiceTagsListResponseErrors() {
    ...
    public static ProjectServiceTagsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectServiceTagsListResponseErrors();
    }
    /**
