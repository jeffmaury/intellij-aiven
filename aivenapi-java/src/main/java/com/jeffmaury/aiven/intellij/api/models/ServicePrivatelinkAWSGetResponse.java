...
public class ServicePrivatelinkAWSGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServicePrivatelinkAWSGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServicePrivatelinkAWSGetResponseErrors>
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServicePrivatelinkAWSGetResponseState::forValue)); });
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServicePrivatelinkAWSGetResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServicePrivatelinkAWSGetResponseState value) {
        this.state = value;
    }
}
