...
public class AccountProjectsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountProjectsListResponseErrors and sets the default values.
     */
    public AccountProjectsListResponseErrors() {
    ...
    public static AccountProjectsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountProjectsListResponseErrors();
    }
    /**
