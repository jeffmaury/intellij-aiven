...
public class AccountUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountUpdateResponseErrors and sets the default values.
     */
    public AccountUpdateResponseErrors() {
    ...
    public static AccountUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountUpdateResponseErrors();
    }
    /**
