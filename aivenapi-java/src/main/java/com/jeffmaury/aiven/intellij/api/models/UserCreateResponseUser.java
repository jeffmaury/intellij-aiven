...
public class UserCreateResponseUser implements AdditionalDataHolder, Parsable {
    ...
    public static UserCreateResponseUser createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<UserCreateResponseUserInvitations>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final UserCreateResponseUserFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setInvitations(@jakarta.annotation.Nullable final java.util.List<UserCreateResponseUserInvitations> value) {
     ...
     */
    public void setProjectMembership(@jakarta.annotation.Nullable final UserCreateResponseUserProjectMembership value) {
     ...
     */
    public void setProjectMemberships(@jakarta.annotation.Nullable final UserCreateResponseUserProjectMemberships value) {
