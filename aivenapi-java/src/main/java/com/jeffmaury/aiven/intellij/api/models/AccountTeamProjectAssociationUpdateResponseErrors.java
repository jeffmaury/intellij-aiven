...
public class AccountTeamProjectAssociationUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamProjectAssociationUpdateResponseErrors and sets the default values.
     */
    public AccountTeamProjectAssociationUpdateResponseErrors() {
    ...
    public static AccountTeamProjectAssociationUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamProjectAssociationUpdateResponseErrors();
    }
    /**
