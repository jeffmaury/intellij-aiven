...
public class BillingGroupListResponseBillingGroupsCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupListResponseBillingGroupsCardInfo and sets the default values.
     */
    public BillingGroupListResponseBillingGroupsCardInfo() {
    ...
    public static BillingGroupListResponseBillingGroupsCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupListResponseBillingGroupsCardInfo();
    }
    /**
