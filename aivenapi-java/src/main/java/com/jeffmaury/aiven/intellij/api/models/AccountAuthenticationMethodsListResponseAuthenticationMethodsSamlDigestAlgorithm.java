...
public enum AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm implements ValuedEnum {
    ...
    public static AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm forValue(@jakarta.annotation.Nonnull final String searchValue) {
