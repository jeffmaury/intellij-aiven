...
public class ProjectDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectDeleteResponseErrors and sets the default values.
     */
    public ProjectDeleteResponseErrors() {
    ...
    public static ProjectDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectDeleteResponseErrors();
    }
    /**
