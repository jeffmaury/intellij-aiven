...
public class ServicePrivatelinkAzureGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAzureGetResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAzureGetResponseErrors() {
    ...
    public static ServicePrivatelinkAzureGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureGetResponseErrors();
    }
    /**
