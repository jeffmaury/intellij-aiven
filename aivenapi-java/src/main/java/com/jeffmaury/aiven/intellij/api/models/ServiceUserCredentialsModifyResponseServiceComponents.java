...
public class ServiceUserCredentialsModifyResponseServiceComponents implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceUserCredentialsModifyResponseServiceComponentsKafkaAuthenticationMethod kafkaAuthenticationMethod;
    /**
     ...
     */
    private ServiceUserCredentialsModifyResponseServiceComponentsRoute route;
    /**
     ...
     * DNS usage name
     */
    private ServiceUserCredentialsModifyResponseServiceComponentsUsage usage;
    /**
     * Instantiates a new ServiceUserCredentialsModifyResponseServiceComponents and sets the default values.
     */
    public ServiceUserCredentialsModifyResponseServiceComponents() {
    ...
    public static ServiceUserCredentialsModifyResponseServiceComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsModifyResponseServiceComponents();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("kafka_authentication_method", (n) -> { this.setKafkaAuthenticationMethod(n.getEnumValue(ServiceUserCredentialsModifyResponseServiceComponentsKafkaAuthenticationMethod::forValue)); });
        ...
        deserializerMap.put("route", (n) -> { this.setRoute(n.getEnumValue(ServiceUserCredentialsModifyResponseServiceComponentsRoute::forValue)); });
        deserializerMap.put("ssl", (n) -> { this.setSsl(n.getBooleanValue()); });
        deserializerMap.put("usage", (n) -> { this.setUsage(n.getEnumValue(ServiceUserCredentialsModifyResponseServiceComponentsUsage::forValue)); });
     ...
     * @return a ServiceUserCredentialsModifyResponseServiceComponentsKafkaAuthenticationMethod
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsModifyResponseServiceComponentsKafkaAuthenticationMethod getKafkaAuthenticationMethod() {
     ...
     * @return a ServiceUserCredentialsModifyResponseServiceComponentsRoute
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsModifyResponseServiceComponentsRoute getRoute() {
        return this.route;
    }
    /**
     ...
     * @return a ServiceUserCredentialsModifyResponseServiceComponentsUsage
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsModifyResponseServiceComponentsUsage getUsage() {
        return this.usage;
    }
    /**
     ...
     */
    public void setKafkaAuthenticationMethod(@jakarta.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceComponentsKafkaAuthenticationMethod value) {
     ...
     */
    public void setRoute(@jakarta.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceComponentsRoute value) {
        this.route = value;
    }
    /**
     ...
     */
    public void setUsage(@jakarta.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceComponentsUsage value) {
        this.usage = value;
    }
}
