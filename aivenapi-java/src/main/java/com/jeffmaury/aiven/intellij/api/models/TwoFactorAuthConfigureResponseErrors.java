...
public class TwoFactorAuthConfigureResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new TwoFactorAuthConfigureResponseErrors and sets the default values.
     */
    public TwoFactorAuthConfigureResponseErrors() {
    ...
    public static TwoFactorAuthConfigureResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new TwoFactorAuthConfigureResponseErrors();
    }
    /**
