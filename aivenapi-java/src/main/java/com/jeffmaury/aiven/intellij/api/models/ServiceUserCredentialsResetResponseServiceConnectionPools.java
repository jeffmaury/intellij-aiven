...
public class ServiceUserCredentialsResetResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceConnectionPools createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPoolMode(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
