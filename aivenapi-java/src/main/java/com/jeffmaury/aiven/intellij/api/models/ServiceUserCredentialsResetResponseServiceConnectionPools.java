...
public class ServiceUserCredentialsResetResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    /**
     ...
     * PGBouncer pool mode
     */
    private ServiceUserCredentialsResetResponseServiceConnectionPoolsPoolMode poolMode;
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceConnectionPools and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceConnectionPools() {
    ...
    public static ServiceUserCredentialsResetResponseServiceConnectionPools createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceConnectionPools();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("pool_mode", (n) -> { this.setPoolMode(n.getEnumValue(ServiceUserCredentialsResetResponseServiceConnectionPoolsPoolMode::forValue)); });
     ...
     * @return a ServiceUserCredentialsResetResponseServiceConnectionPoolsPoolMode
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceConnectionPoolsPoolMode getPoolMode() {
     ...
     */
    public void setPoolMode(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
