...
public class StaticIPListResponseStaticIps implements AdditionalDataHolder, Parsable {
    ...
    public static StaticIPListResponseStaticIps createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final StaticIPListResponseStaticIpsState value) {
        this.state = value;
    }
    /**
