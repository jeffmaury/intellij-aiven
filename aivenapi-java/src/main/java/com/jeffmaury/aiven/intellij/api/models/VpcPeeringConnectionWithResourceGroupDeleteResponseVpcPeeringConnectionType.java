...
public enum VpcPeeringConnectionWithResourceGroupDeleteResponseVpcPeeringConnectionType implements ValuedEnum {
    ...
    VpcPeeringConnectionWithResourceGroupDeleteResponseVpcPeeringConnectionType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcPeeringConnectionWithResourceGroupDeleteResponseVpcPeeringConnectionType forValue(@jakarta.annotation.Nonnull final String searchValue) {
