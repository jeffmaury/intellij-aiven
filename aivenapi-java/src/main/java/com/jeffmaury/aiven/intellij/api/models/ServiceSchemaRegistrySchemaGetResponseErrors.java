...
public class ServiceSchemaRegistrySchemaGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySchemaGetResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySchemaGetResponseErrors() {
    ...
    public static ServiceSchemaRegistrySchemaGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySchemaGetResponseErrors();
    }
    /**
