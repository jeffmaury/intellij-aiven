...
public class ProjectAlertsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectAlertsListResponseErrors and sets the default values.
     */
    public ProjectAlertsListResponseErrors() {
    ...
    public static ProjectAlertsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectAlertsListResponseErrors();
    }
    /**
