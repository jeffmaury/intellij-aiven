...
public enum ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigRetentionBytesSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
