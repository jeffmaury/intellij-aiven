...
public class ProjectCreateResponseProjectCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectCreateResponseProjectCardInfo and sets the default values.
     */
    public ProjectCreateResponseProjectCardInfo() {
    ...
    public static ProjectCreateResponseProjectCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectCreateResponseProjectCardInfo();
    }
    /**
