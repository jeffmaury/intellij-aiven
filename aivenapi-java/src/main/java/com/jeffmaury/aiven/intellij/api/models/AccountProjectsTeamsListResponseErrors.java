...
public class AccountProjectsTeamsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountProjectsTeamsListResponseErrors and sets the default values.
     */
    public AccountProjectsTeamsListResponseErrors() {
    ...
    public static AccountProjectsTeamsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountProjectsTeamsListResponseErrors();
    }
    /**
