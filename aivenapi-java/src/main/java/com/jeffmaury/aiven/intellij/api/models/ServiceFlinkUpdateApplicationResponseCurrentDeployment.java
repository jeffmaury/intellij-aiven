...
public class ServiceFlinkUpdateApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Deployment status
     */
    private ServiceFlinkUpdateApplicationResponseCurrentDeploymentStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkUpdateApplicationResponseCurrentDeployment and sets the default values.
     */
    public ServiceFlinkUpdateApplicationResponseCurrentDeployment() {
    ...
    public static ServiceFlinkUpdateApplicationResponseCurrentDeployment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkUpdateApplicationResponseCurrentDeployment();
    }
    /**
     ...
     * @return a ServiceFlinkUpdateApplicationResponseCurrentDeploymentStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkUpdateApplicationResponseCurrentDeploymentStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkUpdateApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
