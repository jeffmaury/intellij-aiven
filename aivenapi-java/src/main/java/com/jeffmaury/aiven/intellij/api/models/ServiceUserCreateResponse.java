...
public class ServiceUserCreateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCreateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceUserCreateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUser(@javax.annotation.Nullable final ServiceUserCreateResponseUser value) {
        this.user = value;
    }
}
