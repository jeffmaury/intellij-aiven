...
public class ServiceCancelQueryResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceCancelQueryResponseErrors and sets the default values.
     */
    public ServiceCancelQueryResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceCancelQueryResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceCancelQueryResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCancelQueryResponseErrors();
    }
    /**
