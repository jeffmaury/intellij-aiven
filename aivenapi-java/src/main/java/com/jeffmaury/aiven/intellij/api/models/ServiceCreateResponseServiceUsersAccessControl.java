...
public class ServiceCreateResponseServiceUsersAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceCreateResponseServiceUsersAccessControl and sets the default values.
     */
    public ServiceCreateResponseServiceUsersAccessControl() {
    ...
    public static ServiceCreateResponseServiceUsersAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceUsersAccessControl();
    }
    /**
