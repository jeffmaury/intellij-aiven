...
public class BillingGroupEventListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupEventListResponseErrors and sets the default values.
     */
    public BillingGroupEventListResponseErrors() {
    ...
    public static BillingGroupEventListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupEventListResponseErrors();
    }
    /**
