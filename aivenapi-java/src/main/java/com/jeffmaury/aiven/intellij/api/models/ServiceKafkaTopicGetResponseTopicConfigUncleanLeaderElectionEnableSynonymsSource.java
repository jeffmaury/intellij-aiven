...
public enum ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
