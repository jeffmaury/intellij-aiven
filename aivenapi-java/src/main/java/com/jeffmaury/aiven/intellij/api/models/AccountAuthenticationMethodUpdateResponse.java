...
public class AccountAuthenticationMethodUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodUpdateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setAuthenticationMethod(@jakarta.annotation.Nullable final AccountAuthenticationMethodUpdateResponseAuthenticationMethod value) {
