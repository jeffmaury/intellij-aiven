...
public class ProjectInvoiceListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectInvoiceListResponseErrors and sets the default values.
     */
    public ProjectInvoiceListResponseErrors() {
    ...
    public static ProjectInvoiceListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectInvoiceListResponseErrors();
    }
    /**
