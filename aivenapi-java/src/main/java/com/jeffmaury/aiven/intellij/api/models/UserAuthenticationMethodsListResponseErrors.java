...
public class UserAuthenticationMethodsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserAuthenticationMethodsListResponseErrors and sets the default values.
     */
    public UserAuthenticationMethodsListResponseErrors() {
    ...
    public static UserAuthenticationMethodsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAuthenticationMethodsListResponseErrors();
    }
    /**
