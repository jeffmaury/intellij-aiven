...
public class ProjectStaticIPDissociateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectStaticIPDissociateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ProjectStaticIPDissociateResponseErrors>
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ProjectStaticIPDissociateResponseState::forValue)); });
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ProjectStaticIPDissociateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ProjectStaticIPDissociateResponseState value) {
        this.state = value;
    }
    /**
