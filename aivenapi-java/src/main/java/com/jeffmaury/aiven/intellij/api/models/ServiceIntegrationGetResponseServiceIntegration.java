...
public class ServiceIntegrationGetResponseServiceIntegration implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Integration status
     */
    private ServiceIntegrationGetResponseServiceIntegrationIntegrationStatus integrationStatus;
    /**
     ...
     */
    private ServiceIntegrationGetResponseServiceIntegrationUserConfig userConfig;
    /**
     * Instantiates a new ServiceIntegrationGetResponseServiceIntegration and sets the default values.
     */
    public ServiceIntegrationGetResponseServiceIntegration() {
    ...
    public static ServiceIntegrationGetResponseServiceIntegration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationGetResponseServiceIntegration();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceIntegrationGetResponseServiceIntegrationIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceIntegrationGetResponseServiceIntegrationUserConfig::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the integration_status property value. Integration status
     * @return a ServiceIntegrationGetResponseServiceIntegrationIntegrationStatus
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationGetResponseServiceIntegrationIntegrationStatus getIntegrationStatus() {
     ...
     * @return a ServiceIntegrationGetResponseServiceIntegrationUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationGetResponseServiceIntegrationUserConfig getUserConfig() {
     ...
     */
    public void setIntegrationStatus(@jakarta.annotation.Nullable final ServiceIntegrationGetResponseServiceIntegrationIntegrationStatus value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceIntegrationGetResponseServiceIntegrationUserConfig value) {
