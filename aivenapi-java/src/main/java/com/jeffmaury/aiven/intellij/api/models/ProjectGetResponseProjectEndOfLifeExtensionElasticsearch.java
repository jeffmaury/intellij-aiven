...
public class ProjectGetResponseProjectEndOfLifeExtensionElasticsearch implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectGetResponseProjectEndOfLifeExtensionElasticsearch createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
