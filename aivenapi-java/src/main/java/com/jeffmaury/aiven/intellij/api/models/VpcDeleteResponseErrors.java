...
public class VpcDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcDeleteResponseErrors and sets the default values.
     */
    public VpcDeleteResponseErrors() {
    ...
    public static VpcDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcDeleteResponseErrors();
    }
    /**
