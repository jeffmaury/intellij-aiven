...
public class ServiceTaskGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceTaskGetResponseErrors and sets the default values.
     */
    public ServiceTaskGetResponseErrors() {
    ...
    public static ServiceTaskGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceTaskGetResponseErrors();
    }
    /**
