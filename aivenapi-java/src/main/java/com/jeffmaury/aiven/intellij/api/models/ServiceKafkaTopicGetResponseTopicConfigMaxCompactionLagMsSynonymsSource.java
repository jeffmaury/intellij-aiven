...
public enum ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
