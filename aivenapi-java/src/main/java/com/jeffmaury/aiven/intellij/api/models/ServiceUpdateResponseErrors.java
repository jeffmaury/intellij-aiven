...
public class ServiceUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseErrors and sets the default values.
     */
    public ServiceUpdateResponseErrors() {
    ...
    public static ServiceUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseErrors();
    }
    /**
