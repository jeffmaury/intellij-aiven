...
public class StaticIPCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new StaticIPCreateResponseErrors and sets the default values.
     */
    public StaticIPCreateResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a StaticIPCreateResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static StaticIPCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new StaticIPCreateResponseErrors();
    }
    /**
