...
public class AccountTeamListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamListResponseErrors and sets the default values.
     */
    public AccountTeamListResponseErrors() {
    ...
    public static AccountTeamListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamListResponseErrors();
    }
    /**
