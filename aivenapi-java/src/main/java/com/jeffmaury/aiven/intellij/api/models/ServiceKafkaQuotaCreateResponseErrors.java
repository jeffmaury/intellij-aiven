...
public class ServiceKafkaQuotaCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaQuotaCreateResponseErrors and sets the default values.
     */
    public ServiceKafkaQuotaCreateResponseErrors() {
    ...
    public static ServiceKafkaQuotaCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaQuotaCreateResponseErrors();
    }
    /**
