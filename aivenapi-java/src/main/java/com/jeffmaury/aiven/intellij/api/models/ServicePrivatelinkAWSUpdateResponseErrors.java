...
public class ServicePrivatelinkAWSUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAWSUpdateResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAWSUpdateResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServicePrivatelinkAWSUpdateResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServicePrivatelinkAWSUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAWSUpdateResponseErrors();
    }
    /**
