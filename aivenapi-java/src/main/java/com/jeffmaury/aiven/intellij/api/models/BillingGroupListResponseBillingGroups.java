...
public class BillingGroupListResponseBillingGroups implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupListResponseBillingGroups createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a BillingGroupListResponseBillingGroupsBillingEmails
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingCurrency(@javax.annotation.Nullable final BillingGroupListResponseBillingGroupsBillingCurrency value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingEmails(@javax.annotation.Nullable final java.util.List<BillingGroupListResponseBillingGroupsBillingEmails> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCardInfo(@javax.annotation.Nullable final BillingGroupListResponseBillingGroupsCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPaymentMethod(@javax.annotation.Nullable final BillingGroupListResponseBillingGroupsPaymentMethod value) {
