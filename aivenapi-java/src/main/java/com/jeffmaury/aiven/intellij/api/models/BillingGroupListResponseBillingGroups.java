...
public class BillingGroupListResponseBillingGroups implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
     ...
     * Billing currency
     */
    private BillingGroupListResponseBillingGroupsBillingCurrency billingCurrency;
    /**
     * List of project billing email addresses
     */
    private java.util.List<BillingGroupListResponseBillingGroupsBillingEmails> billingEmails;
    /**
     ...
     */
    private BillingGroupListResponseBillingGroupsCardInfo cardInfo;
    /**
     * Address city
     */
    private String city;
     ...
     * Payment method
     */
    private BillingGroupListResponseBillingGroupsPaymentMethod paymentMethod;
    /**
     * Address state
     */
    ...
    /**
     * Instantiates a new BillingGroupListResponseBillingGroups and sets the default values.
     */
    public BillingGroupListResponseBillingGroups() {
    ...
    public static BillingGroupListResponseBillingGroups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupListResponseBillingGroups();
    }
    /**
     ...
     * @return a BillingGroupListResponseBillingGroupsBillingCurrency
     */
    @jakarta.annotation.Nullable
    public BillingGroupListResponseBillingGroupsBillingCurrency getBillingCurrency() {
        return this.billingCurrency;
    }
    /**
     * Gets the billing_emails property value. List of project billing email addresses
     * @return a java.util.List<BillingGroupListResponseBillingGroupsBillingEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<BillingGroupListResponseBillingGroupsBillingEmails> getBillingEmails() {
     ...
     * @return a BillingGroupListResponseBillingGroupsCardInfo
     */
    @jakarta.annotation.Nullable
    public BillingGroupListResponseBillingGroupsCardInfo getCardInfo() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_currency", (n) -> { this.setBillingCurrency(n.getEnumValue(BillingGroupListResponseBillingGroupsBillingCurrency::forValue)); });
        deserializerMap.put("billing_emails", (n) -> { this.setBillingEmails(n.getCollectionOfObjectValues(BillingGroupListResponseBillingGroupsBillingEmails::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("card_info", (n) -> { this.setCardInfo(n.getObjectValue(BillingGroupListResponseBillingGroupsCardInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("payment_method", (n) -> { this.setPaymentMethod(n.getEnumValue(BillingGroupListResponseBillingGroupsPaymentMethod::forValue)); });
     ...
     * @return a BillingGroupListResponseBillingGroupsPaymentMethod
     */
    @jakarta.annotation.Nullable
    public BillingGroupListResponseBillingGroupsPaymentMethod getPaymentMethod() {
     ...
     */
    public void setBillingCurrency(@jakarta.annotation.Nullable final BillingGroupListResponseBillingGroupsBillingCurrency value) {
     ...
     */
    public void setBillingEmails(@jakarta.annotation.Nullable final java.util.List<BillingGroupListResponseBillingGroupsBillingEmails> value) {
     ...
     */
    public void setCardInfo(@jakarta.annotation.Nullable final BillingGroupListResponseBillingGroupsCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    public void setPaymentMethod(@jakarta.annotation.Nullable final BillingGroupListResponseBillingGroupsPaymentMethod value) {
