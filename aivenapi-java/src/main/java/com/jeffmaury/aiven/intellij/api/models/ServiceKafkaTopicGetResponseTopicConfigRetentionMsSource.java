...
public enum ServiceKafkaTopicGetResponseTopicConfigRetentionMsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigRetentionMsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigRetentionMsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
