...
public class ProjectStaticIPDissociateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectStaticIPDissociateResponseErrors and sets the default values.
     */
    public ProjectStaticIPDissociateResponseErrors() {
    ...
    public static ProjectStaticIPDissociateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectStaticIPDissociateResponseErrors();
    }
    /**
