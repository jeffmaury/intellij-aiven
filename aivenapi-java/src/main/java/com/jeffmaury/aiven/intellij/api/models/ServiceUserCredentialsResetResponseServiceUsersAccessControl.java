...
public class ServiceUserCredentialsResetResponseServiceUsersAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceUsersAccessControl and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceUsersAccessControl() {
    ...
    public static ServiceUserCredentialsResetResponseServiceUsersAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceUsersAccessControl();
    }
    /**
