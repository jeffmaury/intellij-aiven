...
public class ServiceSchemaRegistryCompatibilityResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistryCompatibilityResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistryCompatibilityResponseErrors() {
    ...
    public static ServiceSchemaRegistryCompatibilityResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistryCompatibilityResponseErrors();
    }
    /**
