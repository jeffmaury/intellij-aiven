...
public class ServicePGBouncerUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePGBouncerUpdateResponseErrors and sets the default values.
     */
    public ServicePGBouncerUpdateResponseErrors() {
    ...
    public static ServicePGBouncerUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePGBouncerUpdateResponseErrors();
    }
    /**
