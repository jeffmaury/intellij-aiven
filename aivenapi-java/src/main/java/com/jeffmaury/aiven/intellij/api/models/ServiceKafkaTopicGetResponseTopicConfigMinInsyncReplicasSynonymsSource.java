...
public enum ServiceKafkaTopicGetResponseTopicConfigMinInsyncReplicasSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMinInsyncReplicasSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMinInsyncReplicasSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
