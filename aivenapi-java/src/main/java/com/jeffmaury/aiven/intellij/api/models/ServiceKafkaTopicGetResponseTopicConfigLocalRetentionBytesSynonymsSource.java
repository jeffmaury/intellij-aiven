...
public enum ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
