...
public enum VpcPeeringConnectionUpdateResponsePeeringConnectionsState implements ValuedEnum {
    ACTIVE("ACTIVE"),
    APPROVED("APPROVED"),
    ...
    VpcPeeringConnectionUpdateResponsePeeringConnectionsState(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcPeeringConnectionUpdateResponsePeeringConnectionsState forValue(@jakarta.annotation.Nonnull final String searchValue) {
