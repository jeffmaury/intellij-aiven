...
public class ValidateCreditCodeResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ValidateCreditCodeResponseErrors and sets the default values.
     */
    public ValidateCreditCodeResponseErrors() {
    ...
    public static ValidateCreditCodeResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ValidateCreditCodeResponseErrors();
    }
    /**
