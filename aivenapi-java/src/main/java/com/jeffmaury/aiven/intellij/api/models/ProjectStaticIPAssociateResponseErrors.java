...
public class ProjectStaticIPAssociateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectStaticIPAssociateResponseErrors and sets the default values.
     */
    public ProjectStaticIPAssociateResponseErrors() {
    ...
    public static ProjectStaticIPAssociateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectStaticIPAssociateResponseErrors();
    }
    /**
