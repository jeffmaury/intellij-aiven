...
public class ServiceListResponseServices implements AdditionalDataHolder, Parsable {
    /**
     * List of Kafka ACL entries
     */
    private java.util.List<ServiceListResponseServicesAcl> acl;
    /**
     ...
     */
    private java.util.List<ServiceListResponseServicesBackups> backups;
    /**
     ...
     */
    private java.util.List<ServiceListResponseServicesComponents> components;
    /**
     * Service-specific connection information properties
     */
    private ServiceListResponseServicesConnectionInfo connectionInfo;
    /**
     * PostgreSQL PGBouncer connection pools
     */
    private java.util.List<ServiceListResponseServicesConnectionPools> connectionPools;
    /**
     ...
     * Feature flags
     */
    private ServiceListResponseServicesFeatures features;
    /**
     ...
     */
    private ServiceListResponseServicesMaintenance maintenance;
    /**
     * Service type specific metadata
     */
    private ServiceListResponseServicesMetadata metadata;
    /**
     ...
     */
    private java.util.List<ServiceListResponseServicesNodeStates> nodeStates;
    /**
     * Subscription plan
     */
    private String plan;
     ...
     */
    private java.util.List<ServiceListResponseServicesSchemaRegistryAcl> schemaRegistryAcl;
    /**
     * Integrations with other services
     */
    private java.util.List<ServiceListResponseServicesServiceIntegrations> serviceIntegrations;
    /**
     * Service name
     */
     ...
     */
    private java.util.List<ServiceListResponseServicesServiceNotifications> serviceNotifications;
    /**
     * Service type code
     */
     ...
     */
    private ServiceListResponseServicesServiceUriParams serviceUriParams;
    /**
     * State of the service
     */
    private ServiceListResponseServicesState state;
    /**
     * Set of resource tags
     */
    private ServiceListResponseServicesTags tags;
    /**
     ...
     */
    private java.util.List<ServiceListResponseServicesTopics> topics;
    /**
     ...
     */
    private ServiceListResponseServicesUserConfig userConfig;
    /**
     * List of service users
     */
    private java.util.List<ServiceListResponseServicesUsers> users;
    /**
     * Instantiates a new ServiceListResponseServices and sets the default values.
     */
    public ServiceListResponseServices() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceListResponseServices
     */
    @jakarta.annotation.Nonnull
    public static ServiceListResponseServices createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServices();
    }
    /**
     * Gets the acl property value. List of Kafka ACL entries
     * @return a java.util.List<ServiceListResponseServicesAcl>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesAcl> getAcl() {
        return this.acl;
    }
    /**
     ...
     * @return a java.util.List<ServiceListResponseServicesBackups>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesBackups> getBackups() {
        return this.backups;
    }
    /**
     ...
     * @return a java.util.List<ServiceListResponseServicesComponents>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesComponents> getComponents() {
        return this.components;
    }
    /**
     * Gets the connection_info property value. Service-specific connection information properties
     * @return a ServiceListResponseServicesConnectionInfo
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesConnectionInfo getConnectionInfo() {
        return this.connectionInfo;
    }
    /**
     * Gets the connection_pools property value. PostgreSQL PGBouncer connection pools
     * @return a java.util.List<ServiceListResponseServicesConnectionPools>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesConnectionPools> getConnectionPools() {
     ...
     * @return a ServiceListResponseServicesFeatures
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acl", (n) -> { this.setAcl(n.getCollectionOfObjectValues(ServiceListResponseServicesAcl::createFromDiscriminatorValue)); });
        deserializerMap.put("backups", (n) -> { this.setBackups(n.getCollectionOfObjectValues(ServiceListResponseServicesBackups::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("components", (n) -> { this.setComponents(n.getCollectionOfObjectValues(ServiceListResponseServicesComponents::createFromDiscriminatorValue)); });
        deserializerMap.put("connection_info", (n) -> { this.setConnectionInfo(n.getObjectValue(ServiceListResponseServicesConnectionInfo::createFromDiscriminatorValue)); });
        deserializerMap.put("connection_pools", (n) -> { this.setConnectionPools(n.getCollectionOfObjectValues(ServiceListResponseServicesConnectionPools::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(ServiceListResponseServicesFeatures::createFromDiscriminatorValue)); });
        deserializerMap.put("group_list", (n) -> { this.setGroupList(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("maintenance", (n) -> { this.setMaintenance(n.getObjectValue(ServiceListResponseServicesMaintenance::createFromDiscriminatorValue)); });
        deserializerMap.put("metadata", (n) -> { this.setMetadata(n.getObjectValue(ServiceListResponseServicesMetadata::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("node_states", (n) -> { this.setNodeStates(n.getCollectionOfObjectValues(ServiceListResponseServicesNodeStates::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("schema_registry_acl", (n) -> { this.setSchemaRegistryAcl(n.getCollectionOfObjectValues(ServiceListResponseServicesSchemaRegistryAcl::createFromDiscriminatorValue)); });
        deserializerMap.put("service_integrations", (n) -> { this.setServiceIntegrations(n.getCollectionOfObjectValues(ServiceListResponseServicesServiceIntegrations::createFromDiscriminatorValue)); });
        deserializerMap.put("service_name", (n) -> { this.setServiceName(n.getStringValue()); });
        deserializerMap.put("service_notifications", (n) -> { this.setServiceNotifications(n.getCollectionOfObjectValues(ServiceListResponseServicesServiceNotifications::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceListResponseServicesUserConfig::createFromDiscriminatorValue)); });
        deserializerMap.put("users", (n) -> { this.setUsers(n.getCollectionOfObjectValues(ServiceListResponseServicesUsers::createFromDiscriminatorValue)); });
     ...
     * @return a ServiceListResponseServicesMaintenance
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesMaintenance getMaintenance() {
        return this.maintenance;
    }
    /**
     * Gets the metadata property value. Service type specific metadata
     * @return a ServiceListResponseServicesMetadata
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesMetadata getMetadata() {
     ...
     * @return a java.util.List<ServiceListResponseServicesNodeStates>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesNodeStates> getNodeStates() {
     ...
     * @return a java.util.List<ServiceListResponseServicesSchemaRegistryAcl>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesSchemaRegistryAcl> getSchemaRegistryAcl() {
        return this.schemaRegistryAcl;
    }
    /**
     * Gets the service_integrations property value. Integrations with other services
     * @return a java.util.List<ServiceListResponseServicesServiceIntegrations>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesServiceIntegrations> getServiceIntegrations() {
     ...
     * @return a java.util.List<ServiceListResponseServicesServiceNotifications>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesServiceNotifications> getServiceNotifications() {
     ...
     * @return a ServiceListResponseServicesServiceUriParams
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesServiceUriParams getServiceUriParams() {
        return this.serviceUriParams;
    }
    /**
     * Gets the state property value. State of the service
     * @return a ServiceListResponseServicesState
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesState getState() {
        return this.state;
    }
    /**
     * Gets the tags property value. Set of resource tags
     * @return a ServiceListResponseServicesTags
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesTags getTags() {
        return this.tags;
    }
    /**
     ...
     * @return a java.util.List<ServiceListResponseServicesTopics>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesTopics> getTopics() {
        return this.topics;
    }
    /**
     ...
     * @return a ServiceListResponseServicesUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceListResponseServicesUserConfig getUserConfig() {
        return this.userConfig;
    }
    /**
     * Gets the users property value. List of service users
     * @return a java.util.List<ServiceListResponseServicesUsers>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceListResponseServicesUsers> getUsers() {
        return this.users;
    }
    /**
     ...
     */
    public void setAcl(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesAcl> value) {
        this.acl = value;
    }
    /**
     ...
     */
    public void setBackups(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesBackups> value) {
        this.backups = value;
    }
    /**
     ...
     */
    public void setComponents(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesComponents> value) {
     ...
     */
    public void setConnectionInfo(@jakarta.annotation.Nullable final ServiceListResponseServicesConnectionInfo value) {
     ...
     */
    public void setConnectionPools(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesConnectionPools> value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final ServiceListResponseServicesFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setMaintenance(@jakarta.annotation.Nullable final ServiceListResponseServicesMaintenance value) {
     ...
     */
    public void setMetadata(@jakarta.annotation.Nullable final ServiceListResponseServicesMetadata value) {
        this.metadata = value;
    }
    /**
     ...
     */
    public void setNodeStates(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesNodeStates> value) {
     ...
     */
    public void setSchemaRegistryAcl(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesSchemaRegistryAcl> value) {
     ...
     */
    public void setServiceIntegrations(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesServiceIntegrations> value) {
     ...
     */
    public void setServiceNotifications(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesServiceNotifications> value) {
     ...
     */
    public void setServiceUriParams(@jakarta.annotation.Nullable final ServiceListResponseServicesServiceUriParams value) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceListResponseServicesState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setTags(@jakarta.annotation.Nullable final ServiceListResponseServicesTags value) {
        this.tags = value;
    }
    /**
     ...
     */
    public void setTopics(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesTopics> value) {
        this.topics = value;
    }
    /**
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceListResponseServicesUserConfig value) {
     ...
     */
    public void setUsers(@jakarta.annotation.Nullable final java.util.List<ServiceListResponseServicesUsers> value) {
        this.users = value;
    }
}
