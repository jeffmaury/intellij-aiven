...
public class ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointConfig endpointConfig;
    /**
     ...
     */
    private ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointType endpointType;
    /**
     * Service integration settings
     */
    private ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointUserConfig userConfig;
    /**
     * Instantiates a new ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint and sets the default values.
     */
    public ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint
     */
    @jakarta.annotation.Nonnull
    public static ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint();
    }
    /**
     ...
     * @return a ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointConfig
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointConfig getEndpointConfig() {
     ...
     * @return a ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointType
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointType getEndpointType() {
     ...
     * @return a ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointUserConfig getUserConfig() {
     ...
     */
    public void setEndpointConfig(@jakarta.annotation.Nullable final ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointConfig value) {
     ...
     */
    public void setEndpointType(@jakarta.annotation.Nullable final ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointType value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointUserConfig value) {
