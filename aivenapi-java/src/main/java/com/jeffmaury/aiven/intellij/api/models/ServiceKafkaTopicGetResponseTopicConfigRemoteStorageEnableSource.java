...
public enum ServiceKafkaTopicGetResponseTopicConfigRemoteStorageEnableSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigRemoteStorageEnableSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigRemoteStorageEnableSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
