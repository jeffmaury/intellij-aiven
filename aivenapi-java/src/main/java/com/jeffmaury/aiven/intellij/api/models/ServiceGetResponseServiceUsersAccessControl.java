...
public class ServiceGetResponseServiceUsersAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceGetResponseServiceUsersAccessControl and sets the default values.
     */
    public ServiceGetResponseServiceUsersAccessControl() {
    ...
    public static ServiceGetResponseServiceUsersAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceUsersAccessControl();
    }
    /**
