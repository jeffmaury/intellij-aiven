...
public class AccountEventListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountEventListResponseErrors and sets the default values.
     */
    public AccountEventListResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountEventListResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static AccountEventListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountEventListResponseErrors();
    }
    /**
