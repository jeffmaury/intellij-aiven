...
public enum ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointType implements ValuedEnum {
    ...
    public static ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointType forValue(@javax.annotation.Nonnull final String searchValue) {
