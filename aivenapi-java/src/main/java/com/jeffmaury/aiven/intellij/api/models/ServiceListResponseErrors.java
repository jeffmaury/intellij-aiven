...
public class ServiceListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceListResponseErrors and sets the default values.
     */
    public ServiceListResponseErrors() {
    ...
    public static ServiceListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseErrors();
    }
    /**
