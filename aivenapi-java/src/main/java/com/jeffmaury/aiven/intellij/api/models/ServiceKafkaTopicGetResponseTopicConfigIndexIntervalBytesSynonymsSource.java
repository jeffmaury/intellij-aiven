...
public enum ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
