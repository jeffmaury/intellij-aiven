...
public class ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesPhase phase;
    /**
     * Unit for current/min/max values. New units may be added. If null should be treated as generic unit
     */
    private ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesUnit unit;
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates
     */
    @jakarta.annotation.Nonnull
    public static ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("phase", (n) -> { this.setPhase(n.getEnumValue(ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesPhase::forValue)); });
        deserializerMap.put("unit", (n) -> { this.setUnit(n.getEnumValue(ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesUnit::forValue)); });
     ...
     * @return a ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesPhase
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesPhase getPhase() {
        return this.phase;
    }
    /**
     ...
     * @return a ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesUnit
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesUnit getUnit() {
        return this.unit;
    }
    /**
     ...
     */
    public void setPhase(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    public void setUnit(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
