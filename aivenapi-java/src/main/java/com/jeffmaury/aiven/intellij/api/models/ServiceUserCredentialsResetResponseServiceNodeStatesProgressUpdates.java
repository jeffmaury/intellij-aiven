...
public class ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPhase(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUnit(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
