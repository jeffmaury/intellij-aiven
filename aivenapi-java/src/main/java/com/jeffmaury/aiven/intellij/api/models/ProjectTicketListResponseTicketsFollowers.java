...
public class ProjectTicketListResponseTicketsFollowers implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTicketListResponseTicketsFollowers and sets the default values.
     */
    public ProjectTicketListResponseTicketsFollowers() {
    ...
    public static ProjectTicketListResponseTicketsFollowers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTicketListResponseTicketsFollowers();
    }
    /**
