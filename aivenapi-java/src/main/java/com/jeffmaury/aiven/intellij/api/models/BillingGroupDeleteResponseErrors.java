...
public class BillingGroupDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupDeleteResponseErrors and sets the default values.
     */
    public BillingGroupDeleteResponseErrors() {
    ...
    public static BillingGroupDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupDeleteResponseErrors();
    }
    /**
