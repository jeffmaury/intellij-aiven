...
public class MetricsRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceMetricsFetchResponse post(@jakarta.annotation.Nonnull final ServiceMetricsFetchRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceMetricsFetchResponse post(@jakarta.annotation.Nonnull final ServiceMetricsFetchRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceMetricsFetchResponse::createFromDiscriminatorValue);
    }
    /**
     * Fetch service metrics
     * @param body ServiceMetricsFetchRequestBody
