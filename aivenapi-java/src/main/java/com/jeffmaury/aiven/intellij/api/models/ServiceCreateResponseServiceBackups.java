...
public class ServiceCreateResponseServiceBackups implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceBackups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceCreateResponseServiceBackupsAdditionalRegions>
     */
     ...
     */
    public void setAdditionalRegions(@jakarta.annotation.Nullable final java.util.List<ServiceCreateResponseServiceBackupsAdditionalRegions> value) {
