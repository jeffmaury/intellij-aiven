...
public class ListProjectServiceTypesResponseServiceTypesANYServicePlans implements AdditionalDataHolder, Parsable {
    ...
    public static ListProjectServiceTypesResponseServiceTypesANYServicePlans createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setBackupConfig(@javax.annotation.Nullable final ListProjectServiceTypesResponseServiceTypesANYServicePlansBackupConfig value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRegions(@javax.annotation.Nullable final ListProjectServiceTypesResponseServiceTypesANYServicePlansRegions value) {
        this.regions = value;
    }
    /**
