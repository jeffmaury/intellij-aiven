...
public enum ListProjectVpcPeeringConnectionTypesResponseVpcPeeringConnectionTypesVpcPeeringConnectionType implements ValuedEnum {
    ...
    ListProjectVpcPeeringConnectionTypesResponseVpcPeeringConnectionTypesVpcPeeringConnectionType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ListProjectVpcPeeringConnectionTypesResponseVpcPeeringConnectionTypesVpcPeeringConnectionType forValue(@jakarta.annotation.Nonnull final String searchValue) {
