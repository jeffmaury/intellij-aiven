...
public class IntegrationRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceIntegrationCreateResponse post(@jakarta.annotation.Nonnull final ServiceIntegrationCreateRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationCreateResponse post(@jakarta.annotation.Nonnull final ServiceIntegrationCreateRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceIntegrationCreateResponse::createFromDiscriminatorValue);
    }
    /**
     * Create a new service integration
     * @param body ServiceIntegrationCreateRequestBody
