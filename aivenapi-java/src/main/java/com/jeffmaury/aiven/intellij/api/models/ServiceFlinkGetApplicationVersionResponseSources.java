...
public class ServiceFlinkGetApplicationVersionResponseSources implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Columns
     */
    private java.util.List<ServiceFlinkGetApplicationVersionResponseSourcesColumns> columns;
    /**
     ...
     * Option
     */
    private ServiceFlinkGetApplicationVersionResponseSourcesOptions options;
    /**
     * Source ID
     */
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationVersionResponseSources and sets the default values.
     */
    public ServiceFlinkGetApplicationVersionResponseSources() {
    ...
    public static ServiceFlinkGetApplicationVersionResponseSources createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationVersionResponseSources();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkGetApplicationVersionResponseSourcesColumns>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkGetApplicationVersionResponseSourcesColumns> getColumns() {
        return this.columns;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { this.setColumns(n.getCollectionOfObjectValues(ServiceFlinkGetApplicationVersionResponseSourcesColumns::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getObjectValue(ServiceFlinkGetApplicationVersionResponseSourcesOptions::createFromDiscriminatorValue)); });
     ...
     * @return a ServiceFlinkGetApplicationVersionResponseSourcesOptions
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkGetApplicationVersionResponseSourcesOptions getOptions() {
        return this.options;
    }
    /**
     ...
     */
    public void setColumns(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkGetApplicationVersionResponseSourcesColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final ServiceFlinkGetApplicationVersionResponseSourcesOptions value) {
        this.options = value;
    }
    /**
