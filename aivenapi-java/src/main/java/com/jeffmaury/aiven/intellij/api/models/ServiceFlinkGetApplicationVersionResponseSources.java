...
public class ServiceFlinkGetApplicationVersionResponseSources implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkGetApplicationVersionResponseSources createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkGetApplicationVersionResponseSourcesColumns
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setColumns(@javax.annotation.Nullable final java.util.List<ServiceFlinkGetApplicationVersionResponseSourcesColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setOptions(@javax.annotation.Nullable final ServiceFlinkGetApplicationVersionResponseSourcesOptions value) {
        this.options = value;
    }
    /**
