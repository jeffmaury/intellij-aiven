...
public enum ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersionValue implements ValuedEnum {
    ZeroEightZero("0.8.0"),
    ZeroEightOne("0.8.1"),
    ZeroEightTwo("0.8.2"),
    ZeroNineZero("0.9.0"),
    ...
    ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersionValue(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersionValue forValue(@jakarta.annotation.Nonnull final String searchValue) {
