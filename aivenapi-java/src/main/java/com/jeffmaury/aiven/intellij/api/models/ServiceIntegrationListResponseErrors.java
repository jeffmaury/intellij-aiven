...
public class ServiceIntegrationListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationListResponseErrors and sets the default values.
     */
    public ServiceIntegrationListResponseErrors() {
    ...
    public static ServiceIntegrationListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationListResponseErrors();
    }
    /**
