...
public class UserLogoutResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserLogoutResponseErrors and sets the default values.
     */
    public UserLogoutResponseErrors() {
    ...
    public static UserLogoutResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserLogoutResponseErrors();
    }
    /**
