...
public class ServiceIntegrationEndpointTypesResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationEndpointTypesResponseErrors and sets the default values.
     */
    public ServiceIntegrationEndpointTypesResponseErrors() {
    ...
    public static ServiceIntegrationEndpointTypesResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationEndpointTypesResponseErrors();
    }
    /**
