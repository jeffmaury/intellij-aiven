...
public class ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation offsetSyncsTopicLocation;
    /**
     * Replication policy class
     */
    private ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass replicationPolicyClass;
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows and sets the default values.
     */
    public ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows() {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("offset_syncs_topic_location", (n) -> { this.setOffsetSyncsTopicLocation(n.getEnumValue(ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation::forValue)); });
        deserializerMap.put("replication_policy_class", (n) -> { this.setReplicationPolicyClass(n.getEnumValue(ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass::forValue)); });
     ...
     * @return a ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation
     */
    @jakarta.annotation.Nullable
    public ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation getOffsetSyncsTopicLocation() {
        return this.offsetSyncsTopicLocation;
    }
    /**
     * Gets the replication_policy_class property value. Replication policy class
     * @return a ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass
     */
    @jakarta.annotation.Nullable
    public ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass getReplicationPolicyClass() {
     ...
     */
    public void setOffsetSyncsTopicLocation(@jakarta.annotation.Nullable final ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation value) {
     ...
     */
    public void setReplicationPolicyClass(@jakarta.annotation.Nullable final ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass value) {
