...
public class ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns and sets the default values.
     */
    public ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns() {
    ...
    public static ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns();
    }
    /**
