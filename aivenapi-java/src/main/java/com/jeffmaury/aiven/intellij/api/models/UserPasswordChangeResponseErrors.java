...
public class UserPasswordChangeResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserPasswordChangeResponseErrors and sets the default values.
     */
    public UserPasswordChangeResponseErrors() {
    ...
    public static UserPasswordChangeResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserPasswordChangeResponseErrors();
    }
    /**
