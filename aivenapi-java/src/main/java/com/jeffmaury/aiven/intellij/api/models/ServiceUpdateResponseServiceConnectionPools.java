...
public class ServiceUpdateResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    /**
     ...
     * PGBouncer pool mode
     */
    private ServiceUpdateResponseServiceConnectionPoolsPoolMode poolMode;
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseServiceConnectionPools and sets the default values.
     */
    public ServiceUpdateResponseServiceConnectionPools() {
    ...
    public static ServiceUpdateResponseServiceConnectionPools createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseServiceConnectionPools();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("pool_mode", (n) -> { this.setPoolMode(n.getEnumValue(ServiceUpdateResponseServiceConnectionPoolsPoolMode::forValue)); });
     ...
     * @return a ServiceUpdateResponseServiceConnectionPoolsPoolMode
     */
    @jakarta.annotation.Nullable
    public ServiceUpdateResponseServiceConnectionPoolsPoolMode getPoolMode() {
     ...
     */
    public void setPoolMode(@jakarta.annotation.Nullable final ServiceUpdateResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
