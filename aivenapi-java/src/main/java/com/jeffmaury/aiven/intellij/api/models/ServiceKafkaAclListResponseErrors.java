...
public class ServiceKafkaAclListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaAclListResponseErrors and sets the default values.
     */
    public ServiceKafkaAclListResponseErrors() {
    ...
    public static ServiceKafkaAclListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaAclListResponseErrors();
    }
    /**
