...
public class ServiceListResponseServicesNodeStatesShard implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceListResponseServicesNodeStatesShard and sets the default values.
     */
    public ServiceListResponseServicesNodeStatesShard() {
    ...
    public static ServiceListResponseServicesNodeStatesShard createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServicesNodeStatesShard();
    }
    /**
