...
public enum ServiceKafkaTopicGetResponseTopicConfigFileDeleteDelayMsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigFileDeleteDelayMsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigFileDeleteDelayMsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
