...
public class ServiceFlinkCreateApplicationVersionRequestBodySources implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationVersionRequestBodySources createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
