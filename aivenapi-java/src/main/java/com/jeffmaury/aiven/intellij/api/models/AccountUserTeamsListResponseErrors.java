...
public class AccountUserTeamsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountUserTeamsListResponseErrors and sets the default values.
     */
    public AccountUserTeamsListResponseErrors() {
    ...
    public static AccountUserTeamsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountUserTeamsListResponseErrors();
    }
    /**
