...
public enum ServiceKafkaTopicGetResponseTopicConfigPreallocateSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigPreallocateSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigPreallocateSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
