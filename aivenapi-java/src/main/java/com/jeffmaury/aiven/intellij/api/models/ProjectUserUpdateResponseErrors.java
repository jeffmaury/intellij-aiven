...
public class ProjectUserUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectUserUpdateResponseErrors and sets the default values.
     */
    public ProjectUserUpdateResponseErrors() {
    ...
    public static ProjectUserUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectUserUpdateResponseErrors();
    }
    /**
