...
public class ServiceIntegrationEndpointListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationEndpointListResponseErrors and sets the default values.
     */
    public ServiceIntegrationEndpointListResponseErrors() {
    ...
    public static ServiceIntegrationEndpointListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationEndpointListResponseErrors();
    }
    /**
