...
public class ServiceUserCredentialsResetResponseServiceServiceNotifications implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceServiceNotifications createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("level", (n) -> { this.setLevel(n.getEnumValue(ServiceUserCredentialsResetResponseServiceServiceNotificationsLevel::forValue)); });
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(ServiceUserCredentialsResetResponseServiceServiceNotificationsType::forValue)); });
     ...
     */
    public void setLevel(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceNotificationsLevel value) {
        this.level = value;
    }
    /**
     ...
     */
    public void setMetadata(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceNotificationsMetadata value) {
        this.metadata = value;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceNotificationsType value) {
        this.type = value;
    }
}
