...
public class ServiceFlinkStopApplicationDeploymentResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkStopApplicationDeploymentResponseErrors and sets the default values.
     */
    public ServiceFlinkStopApplicationDeploymentResponseErrors() {
    ...
    public static ServiceFlinkStopApplicationDeploymentResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkStopApplicationDeploymentResponseErrors();
    }
    /**
