...
public class ServiceFlinkListApplicationsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkListApplicationsResponseErrors and sets the default values.
     */
    public ServiceFlinkListApplicationsResponseErrors() {
    ...
    public static ServiceFlinkListApplicationsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkListApplicationsResponseErrors();
    }
    /**
