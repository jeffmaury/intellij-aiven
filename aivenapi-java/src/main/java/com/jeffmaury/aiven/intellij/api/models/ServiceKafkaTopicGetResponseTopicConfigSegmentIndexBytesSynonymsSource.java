...
public enum ServiceKafkaTopicGetResponseTopicConfigSegmentIndexBytesSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigSegmentIndexBytesSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigSegmentIndexBytesSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
