...
public class AccountTeamMembersInviteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamMembersInviteResponseErrors and sets the default values.
     */
    public AccountTeamMembersInviteResponseErrors() {
    ...
    public static AccountTeamMembersInviteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamMembersInviteResponseErrors();
    }
    /**
