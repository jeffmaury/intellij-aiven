...
public class ServiceOpenSearchAclSetRequestBodyOpensearchAclConfigAcls implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchAclSetRequestBodyOpensearchAclConfigAcls createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRules(@javax.annotation.Nullable final java.util.List<ServiceOpenSearchAclSetRequestBodyOpensearchAclConfigAclsRules> value) {
        this.rules = value;
    }
    /**
