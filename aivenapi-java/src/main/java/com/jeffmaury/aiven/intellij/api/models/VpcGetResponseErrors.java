...
public class VpcGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcGetResponseErrors and sets the default values.
     */
    public VpcGetResponseErrors() {
    ...
    public static VpcGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcGetResponseErrors();
    }
    /**
