...
public enum ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus implements ValuedEnum {
    ...
    ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
