...
public class ProjectTagsUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTagsUpdateResponseErrors and sets the default values.
     */
    public ProjectTagsUpdateResponseErrors() {
    ...
    public static ProjectTagsUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTagsUpdateResponseErrors();
    }
    /**
