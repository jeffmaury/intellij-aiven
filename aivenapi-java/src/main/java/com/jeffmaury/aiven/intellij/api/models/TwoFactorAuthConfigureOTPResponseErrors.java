...
public class TwoFactorAuthConfigureOTPResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new TwoFactorAuthConfigureOTPResponseErrors and sets the default values.
     */
    public TwoFactorAuthConfigureOTPResponseErrors() {
    ...
    public static TwoFactorAuthConfigureOTPResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new TwoFactorAuthConfigureOTPResponseErrors();
    }
    /**
