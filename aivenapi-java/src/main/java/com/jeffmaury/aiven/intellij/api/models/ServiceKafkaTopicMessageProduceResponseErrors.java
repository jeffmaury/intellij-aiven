...
public class ServiceKafkaTopicMessageProduceResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTopicMessageProduceResponseErrors and sets the default values.
     */
    public ServiceKafkaTopicMessageProduceResponseErrors() {
    ...
    public static ServiceKafkaTopicMessageProduceResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTopicMessageProduceResponseErrors();
    }
    /**
