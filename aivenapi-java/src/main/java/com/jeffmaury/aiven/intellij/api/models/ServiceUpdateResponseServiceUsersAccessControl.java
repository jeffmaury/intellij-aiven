...
public class ServiceUpdateResponseServiceUsersAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseServiceUsersAccessControl and sets the default values.
     */
    public ServiceUpdateResponseServiceUsersAccessControl() {
    ...
    public static ServiceUpdateResponseServiceUsersAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseServiceUsersAccessControl();
    }
    /**
