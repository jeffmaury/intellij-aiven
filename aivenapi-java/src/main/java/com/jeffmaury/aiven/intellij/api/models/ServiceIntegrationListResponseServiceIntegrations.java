...
public class ServiceIntegrationListResponseServiceIntegrations implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Integration status
     */
    private ServiceIntegrationListResponseServiceIntegrationsIntegrationStatus integrationStatus;
    /**
     ...
     */
    private ServiceIntegrationListResponseServiceIntegrationsUserConfig userConfig;
    /**
     * Instantiates a new ServiceIntegrationListResponseServiceIntegrations and sets the default values.
     */
    public ServiceIntegrationListResponseServiceIntegrations() {
    ...
    public static ServiceIntegrationListResponseServiceIntegrations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationListResponseServiceIntegrations();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceIntegrationListResponseServiceIntegrationsIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceIntegrationListResponseServiceIntegrationsUserConfig::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the integration_status property value. Integration status
     * @return a ServiceIntegrationListResponseServiceIntegrationsIntegrationStatus
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationListResponseServiceIntegrationsIntegrationStatus getIntegrationStatus() {
     ...
     * @return a ServiceIntegrationListResponseServiceIntegrationsUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationListResponseServiceIntegrationsUserConfig getUserConfig() {
     ...
     */
    public void setIntegrationStatus(@jakarta.annotation.Nullable final ServiceIntegrationListResponseServiceIntegrationsIntegrationStatus value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceIntegrationListResponseServiceIntegrationsUserConfig value) {
