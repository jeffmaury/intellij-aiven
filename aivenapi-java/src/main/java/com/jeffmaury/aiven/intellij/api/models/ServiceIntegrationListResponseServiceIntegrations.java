...
public class ServiceIntegrationListResponseServiceIntegrations implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationListResponseServiceIntegrations createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceIntegrationListResponseServiceIntegrationsIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationListResponseServiceIntegrationsUserConfig value) {
