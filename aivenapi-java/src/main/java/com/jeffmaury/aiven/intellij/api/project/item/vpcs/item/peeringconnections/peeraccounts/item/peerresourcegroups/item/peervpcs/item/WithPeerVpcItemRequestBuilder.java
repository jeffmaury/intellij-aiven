...
public class WithPeerVpcItemRequestBuilder extends BaseRequestBuilder {
    ...
    public VpcPeeringConnectionWithResourceGroupDeleteResponse delete() {
        return delete(null);
    }
    /**
     * Delete a peering connection for a project VPC
     ...
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionWithResourceGroupDeleteResponse delete(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toDeleteRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, VpcPeeringConnectionWithResourceGroupDeleteResponse::createFromDiscriminatorValue);
    }
    /**
     * Delete a peering connection for a project VPC
