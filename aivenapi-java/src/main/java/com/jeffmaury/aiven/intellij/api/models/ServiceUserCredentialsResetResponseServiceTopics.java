...
public class ServiceUserCredentialsResetResponseServiceTopics implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceTopics createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
