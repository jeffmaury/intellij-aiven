...
public class ServiceUserCredentialsResetResponseServiceTopics implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Topic state
     */
    private ServiceUserCredentialsResetResponseServiceTopicsState state;
    /**
     * Topic name
     */
    private String topicName;
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceTopics and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceTopics() {
    ...
    public static ServiceUserCredentialsResetResponseServiceTopics createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceTopics();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServiceUserCredentialsResetResponseServiceTopicsState::forValue)); });
     ...
     * @return a ServiceUserCredentialsResetResponseServiceTopicsState
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceTopicsState getState() {
        return this.state;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
