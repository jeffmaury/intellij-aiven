...
public class PGServiceAvailableExtensionsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PGServiceAvailableExtensionsResponseErrors and sets the default values.
     */
    public PGServiceAvailableExtensionsResponseErrors() {
    ...
    public static PGServiceAvailableExtensionsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PGServiceAvailableExtensionsResponseErrors();
    }
    /**
