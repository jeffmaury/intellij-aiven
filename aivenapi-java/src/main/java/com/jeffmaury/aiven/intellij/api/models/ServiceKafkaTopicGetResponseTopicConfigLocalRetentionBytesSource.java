...
public enum ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
