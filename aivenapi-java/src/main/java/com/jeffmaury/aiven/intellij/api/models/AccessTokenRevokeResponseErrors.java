...
public class AccessTokenRevokeResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccessTokenRevokeResponseErrors and sets the default values.
     */
    public AccessTokenRevokeResponseErrors() {
    ...
    public static AccessTokenRevokeResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccessTokenRevokeResponseErrors();
    }
    /**
