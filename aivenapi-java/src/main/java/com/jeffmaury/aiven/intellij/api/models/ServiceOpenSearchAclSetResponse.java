...
public class ServiceOpenSearchAclSetResponse implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("opensearch_acl_config", (n) -> { this.setOpensearchAclConfig(n.getObjectValue(ServiceOpenSearchAclSetResponseOpensearchAclConfig::createFromDiscriminatorValue)); });
