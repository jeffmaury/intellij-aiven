...
public class ServiceUserGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserGetResponseErrors and sets the default values.
     */
    public ServiceUserGetResponseErrors() {
    ...
    public static ServiceUserGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserGetResponseErrors();
    }
    /**
