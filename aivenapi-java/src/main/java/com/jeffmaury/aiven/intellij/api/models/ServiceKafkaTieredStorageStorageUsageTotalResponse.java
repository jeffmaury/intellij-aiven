...
public class ServiceKafkaTieredStorageStorageUsageTotalResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTieredStorageStorageUsageTotalResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceKafkaTieredStorageStorageUsageTotalResponseErrors>
     */
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaTieredStorageStorageUsageTotalResponseErrors> value) {
        this.errors = value;
    }
    /**
