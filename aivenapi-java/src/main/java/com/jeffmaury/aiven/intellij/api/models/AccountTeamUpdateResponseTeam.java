...
public class AccountTeamUpdateResponseTeam implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
    ...
    /**
     * Instantiates a new AccountTeamUpdateResponseTeam and sets the default values.
     */
    public AccountTeamUpdateResponseTeam() {
    ...
    public static AccountTeamUpdateResponseTeam createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamUpdateResponseTeam();
    }
    /**
