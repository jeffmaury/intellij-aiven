...
public class ServiceFlinkListApplicationsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkListApplicationsResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceFlinkListApplicationsResponseApplications>
     */
     ...
     * @return a java.util.List<ServiceFlinkListApplicationsResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setApplications(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkListApplicationsResponseApplications> value) {
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkListApplicationsResponseErrors> value) {
        this.errors = value;
    }
    /**
