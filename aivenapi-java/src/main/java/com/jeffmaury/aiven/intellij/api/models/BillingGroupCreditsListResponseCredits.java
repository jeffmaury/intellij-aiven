...
public class BillingGroupCreditsListResponseCredits implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Credit type
     */
    private BillingGroupCreditsListResponseCreditsType type;
    /**
     * Original credit value, or for expired credits, the consumed credit value
     */
    private String value;
    /**
     * Instantiates a new BillingGroupCreditsListResponseCredits and sets the default values.
     */
    public BillingGroupCreditsListResponseCredits() {
    ...
    public static BillingGroupCreditsListResponseCredits createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupCreditsListResponseCredits();
    }
    /**
     ...
     * @return a BillingGroupCreditsListResponseCreditsType
     */
    @jakarta.annotation.Nullable
    public BillingGroupCreditsListResponseCreditsType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final BillingGroupCreditsListResponseCreditsType value) {
        this.type = value;
    }
    /**
