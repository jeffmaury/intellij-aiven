...
public class ServiceSchemaRegistryGlobalConfigGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistryGlobalConfigGetResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistryGlobalConfigGetResponseErrors() {
    ...
    public static ServiceSchemaRegistryGlobalConfigGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistryGlobalConfigGetResponseErrors();
    }
    /**
