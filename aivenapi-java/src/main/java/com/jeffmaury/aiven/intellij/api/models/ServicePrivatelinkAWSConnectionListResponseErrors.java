...
public class ServicePrivatelinkAWSConnectionListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAWSConnectionListResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAWSConnectionListResponseErrors() {
    ...
    public static ServicePrivatelinkAWSConnectionListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAWSConnectionListResponseErrors();
    }
    /**
