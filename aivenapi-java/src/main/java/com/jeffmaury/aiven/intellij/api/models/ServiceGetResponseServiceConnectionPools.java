...
public class ServiceGetResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    /**
     ...
     * PGBouncer pool mode
     */
    private ServiceGetResponseServiceConnectionPoolsPoolMode poolMode;
    /**
    ...
    /**
     * Instantiates a new ServiceGetResponseServiceConnectionPools and sets the default values.
     */
    public ServiceGetResponseServiceConnectionPools() {
    ...
    public static ServiceGetResponseServiceConnectionPools createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceConnectionPools();
    }
    /**
     ...
     * @return a ServiceGetResponseServiceConnectionPoolsPoolMode
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceConnectionPoolsPoolMode getPoolMode() {
     ...
     */
    public void setPoolMode(@jakarta.annotation.Nullable final ServiceGetResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
