...
public class AccountUsersSearchResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountUsersSearchResponseErrors and sets the default values.
     */
    public AccountUsersSearchResponseErrors() {
    ...
    public static AccountUsersSearchResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountUsersSearchResponseErrors();
    }
    /**
