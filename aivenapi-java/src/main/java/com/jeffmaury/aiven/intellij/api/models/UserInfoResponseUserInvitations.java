...
public class UserInfoResponseUserInvitations implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserInfoResponseUserInvitations and sets the default values.
     */
    public UserInfoResponseUserInvitations() {
    ...
    public static UserInfoResponseUserInvitations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserInfoResponseUserInvitations();
    }
    /**
