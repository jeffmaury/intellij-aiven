...
public class LogoutRequestBuilder extends BaseRequestBuilder {
    ...
    public UserLogoutResponse post() {
        return post(null);
    }
    /**
     * Logout user, removing current authentication token
     ...
     */
    @jakarta.annotation.Nullable
    public UserLogoutResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, UserLogoutResponse::createFromDiscriminatorValue);
    }
    /**
     * Logout user, removing current authentication token
