...
public class ConnectionPoolRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServicePGBouncerCreateResponse> post(@jakarta.annotation.Nonnull final ServicePGBouncerCreateRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServicePGBouncerCreateResponse> post(@jakarta.annotation.Nonnull final ServicePGBouncerCreateRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
