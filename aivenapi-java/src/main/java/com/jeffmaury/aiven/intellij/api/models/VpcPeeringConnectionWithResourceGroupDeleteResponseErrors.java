...
public class VpcPeeringConnectionWithResourceGroupDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcPeeringConnectionWithResourceGroupDeleteResponseErrors and sets the default values.
     */
    public VpcPeeringConnectionWithResourceGroupDeleteResponseErrors() {
    ...
    public static VpcPeeringConnectionWithResourceGroupDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionWithResourceGroupDeleteResponseErrors();
    }
    /**
