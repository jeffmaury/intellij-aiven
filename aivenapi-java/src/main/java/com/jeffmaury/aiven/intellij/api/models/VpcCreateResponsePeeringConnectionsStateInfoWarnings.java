...
public class VpcCreateResponsePeeringConnectionsStateInfoWarnings implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Type of warning
     */
    private VpcCreateResponsePeeringConnectionsStateInfoWarningsType type;
    /**
     * Instantiates a new VpcCreateResponsePeeringConnectionsStateInfoWarnings and sets the default values.
     */
    public VpcCreateResponsePeeringConnectionsStateInfoWarnings() {
    ...
    public static VpcCreateResponsePeeringConnectionsStateInfoWarnings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcCreateResponsePeeringConnectionsStateInfoWarnings();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(VpcCreateResponsePeeringConnectionsStateInfoWarningsType::forValue)); });
     ...
     * @return a VpcCreateResponsePeeringConnectionsStateInfoWarningsType
     */
    @jakarta.annotation.Nullable
    public VpcCreateResponsePeeringConnectionsStateInfoWarningsType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final VpcCreateResponsePeeringConnectionsStateInfoWarningsType value) {
        this.type = value;
    }
}
