...
public enum ServiceKafkaTopicGetResponseTopicConfigFileDeleteDelayMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigFileDeleteDelayMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigFileDeleteDelayMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
