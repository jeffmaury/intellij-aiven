...
public class ServiceFlinkStopApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceFlinkStopApplicationDeploymentResponseErrors> errors;
    /**
     * Deployment ID
     */
    private String id;
     ...
     * Deployment status
     */
    private ServiceFlinkStopApplicationDeploymentResponseStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkStopApplicationDeploymentResponse and sets the default values.
     */
    public ServiceFlinkStopApplicationDeploymentResponse() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceFlinkStopApplicationDeploymentResponse
     */
    @jakarta.annotation.Nonnull
    public static ServiceFlinkStopApplicationDeploymentResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkStopApplicationDeploymentResponse();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkStopApplicationDeploymentResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkStopApplicationDeploymentResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(ServiceFlinkStopApplicationDeploymentResponseErrors::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkStopApplicationDeploymentResponseStatus::forValue)); });
     ...
     * @return a ServiceFlinkStopApplicationDeploymentResponseStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkStopApplicationDeploymentResponseStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkStopApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkStopApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
