...
public class PGServiceQueryStatisticsDeprecatedRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PGServiceQueryStatisticsDeprecatedRequestBody and sets the default values.
     */
    public PGServiceQueryStatisticsDeprecatedRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a PGServiceQueryStatisticsDeprecatedRequestBody
     */
    @jakarta.annotation.Nonnull
    public static PGServiceQueryStatisticsDeprecatedRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PGServiceQueryStatisticsDeprecatedRequestBody();
    }
    /**
