...
public class ServiceUserCredentialsResetResponseServiceBackups implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions> additionalRegions;
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceBackups and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceBackups() {
    ...
    public static ServiceUserCredentialsResetResponseServiceBackups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceBackups();
    }
    /**
     ...
     * @return a java.util.List<ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions> getAdditionalRegions() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("additional_regions", (n) -> { this.setAdditionalRegions(n.getCollectionOfObjectValues(ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions::createFromDiscriminatorValue)); });
     ...
     */
    public void setAdditionalRegions(@jakarta.annotation.Nullable final java.util.List<ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions> value) {
