...
public class ServiceUserCredentialsResetResponseServiceBackups implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceBackups createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setAdditionalRegions(@javax.annotation.Nullable final java.util.List<ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions> value) {
