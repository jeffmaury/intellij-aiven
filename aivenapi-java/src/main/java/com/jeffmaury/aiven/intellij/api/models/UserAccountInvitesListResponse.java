...
public class UserAccountInvitesListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static UserAccountInvitesListResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAccountInvitesListResponse();
    }
    /**
     * Gets the account_invites property value. List of invites
     * @return a java.util.List<UserAccountInvitesListResponseAccountInvites>
     */
     ...
     * @return a java.util.List<UserAccountInvitesListResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setAccountInvites(@jakarta.annotation.Nullable final java.util.List<UserAccountInvitesListResponseAccountInvites> value) {
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<UserAccountInvitesListResponseErrors> value) {
        this.errors = value;
    }
    /**
