...
public class ServiceKafkaConnectResumeConnectorResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectResumeConnectorResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectResumeConnectorResponseErrors() {
    ...
    public static ServiceKafkaConnectResumeConnectorResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectResumeConnectorResponseErrors();
    }
    /**
