...
public class AccountBillingGroupListResponseAccountBillingGroupsCardInfo implements AdditionalDataHolder, Parsable {
    ...
    public static AccountBillingGroupListResponseAccountBillingGroupsCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
