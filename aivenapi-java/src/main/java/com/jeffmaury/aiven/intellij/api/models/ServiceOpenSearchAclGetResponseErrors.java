...
public class ServiceOpenSearchAclGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchAclGetResponseErrors and sets the default values.
     */
    public ServiceOpenSearchAclGetResponseErrors() {
    ...
    public static ServiceOpenSearchAclGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchAclGetResponseErrors();
    }
    /**
