...
public class ServiceKafkaTopicGetResponseTopicConfigMessageTimestampType implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMessageTimestampType createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceKafkaTopicGetResponseTopicConfigMessageTimestampTypeSynonyms>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setSource(@jakarta.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMessageTimestampTypeSource value) {
        this.source = value;
    }
    /**
     ...
     */
    public void setSynonyms(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigMessageTimestampTypeSynonyms> value) {
        this.synonyms = value;
    }
    /**
     ...
     */
    public void setValue(@jakarta.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMessageTimestampTypeValue value) {
        this.value = value;
    }
}
