...
public enum ServiceKafkaTopicGetResponseTopicConfigPreallocateSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigPreallocateSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigPreallocateSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
