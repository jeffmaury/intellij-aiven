...
public class ProjectGenerateSbomDownloadUrlResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectGenerateSbomDownloadUrlResponseErrors and sets the default values.
     */
    public ProjectGenerateSbomDownloadUrlResponseErrors() {
    ...
    public static ProjectGenerateSbomDownloadUrlResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectGenerateSbomDownloadUrlResponseErrors();
    }
    /**
