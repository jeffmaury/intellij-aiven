...
public class ServiceOpenSearchIndexListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchIndexListResponseErrors and sets the default values.
     */
    public ServiceOpenSearchIndexListResponseErrors() {
    ...
    public static ServiceOpenSearchIndexListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchIndexListResponseErrors();
    }
    /**
