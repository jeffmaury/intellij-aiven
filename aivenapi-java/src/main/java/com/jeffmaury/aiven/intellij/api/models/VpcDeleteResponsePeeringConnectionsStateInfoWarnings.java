...
public class VpcDeleteResponsePeeringConnectionsStateInfoWarnings implements AdditionalDataHolder, Parsable {
    ...
    public static VpcDeleteResponsePeeringConnectionsStateInfoWarnings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(VpcDeleteResponsePeeringConnectionsStateInfoWarningsType::forValue)); });
     ...
     */
    public void setType(@jakarta.annotation.Nullable final VpcDeleteResponsePeeringConnectionsStateInfoWarningsType value) {
        this.type = value;
    }
}
