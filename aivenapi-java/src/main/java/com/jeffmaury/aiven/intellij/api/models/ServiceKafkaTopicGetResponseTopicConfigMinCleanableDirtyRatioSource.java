...
public enum ServiceKafkaTopicGetResponseTopicConfigMinCleanableDirtyRatioSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMinCleanableDirtyRatioSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMinCleanableDirtyRatioSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
