...
public class StaticIpAvailabilityRequestBuilder extends BaseRequestBuilder {
    ...
    public ProjectStaticIPAvailabilityListResponse get() {
        return get(null);
    }
    /**
     * List static IP address cloud availability and prices for a project
     ...
     */
    @jakarta.annotation.Nullable
    public ProjectStaticIPAvailabilityListResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ProjectStaticIPAvailabilityListResponse::createFromDiscriminatorValue);
    }
    /**
     * List static IP address cloud availability and prices for a project
