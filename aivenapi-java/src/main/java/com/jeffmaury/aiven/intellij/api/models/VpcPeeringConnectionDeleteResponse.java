...
public class VpcPeeringConnectionDeleteResponse implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionDeleteResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a VpcPeeringConnectionDeleteResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<VpcPeeringConnectionDeleteResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final VpcPeeringConnectionDeleteResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStateInfo(@javax.annotation.Nullable final VpcPeeringConnectionDeleteResponseStateInfo value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setVpcPeeringConnectionType(@javax.annotation.Nullable final VpcPeeringConnectionDeleteResponseVpcPeeringConnectionType value) {
