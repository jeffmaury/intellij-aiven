...
public class VpcPeeringConnectionDeleteResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<VpcPeeringConnectionDeleteResponseErrors> errors;
    /**
     ...
     */
    private VpcPeeringConnectionDeleteResponseState state;
    /**
     * State-specific help or error information
     */
    private VpcPeeringConnectionDeleteResponseStateInfo stateInfo;
    /**
     ...
     */
    private VpcPeeringConnectionDeleteResponseVpcPeeringConnectionType vpcPeeringConnectionType;
    /**
     * Instantiates a new VpcPeeringConnectionDeleteResponse and sets the default values.
     */
    public VpcPeeringConnectionDeleteResponse() {
    ...
    public static VpcPeeringConnectionDeleteResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionDeleteResponse();
    }
    /**
     ...
     * @return a java.util.List<VpcPeeringConnectionDeleteResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<VpcPeeringConnectionDeleteResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(VpcPeeringConnectionDeleteResponseErrors::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(VpcPeeringConnectionDeleteResponseState::forValue)); });
        deserializerMap.put("state_info", (n) -> { this.setStateInfo(n.getObjectValue(VpcPeeringConnectionDeleteResponseStateInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("vpc_peering_connection_type", (n) -> { this.setVpcPeeringConnectionType(n.getEnumValue(VpcPeeringConnectionDeleteResponseVpcPeeringConnectionType::forValue)); });
     ...
     * @return a VpcPeeringConnectionDeleteResponseState
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionDeleteResponseState getState() {
        return this.state;
    }
    /**
     * Gets the state_info property value. State-specific help or error information
     * @return a VpcPeeringConnectionDeleteResponseStateInfo
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionDeleteResponseStateInfo getStateInfo() {
     ...
     * @return a VpcPeeringConnectionDeleteResponseVpcPeeringConnectionType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionDeleteResponseVpcPeeringConnectionType getVpcPeeringConnectionType() {
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<VpcPeeringConnectionDeleteResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final VpcPeeringConnectionDeleteResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setStateInfo(@jakarta.annotation.Nullable final VpcPeeringConnectionDeleteResponseStateInfo value) {
     ...
     */
    public void setVpcPeeringConnectionType(@jakarta.annotation.Nullable final VpcPeeringConnectionDeleteResponseVpcPeeringConnectionType value) {
