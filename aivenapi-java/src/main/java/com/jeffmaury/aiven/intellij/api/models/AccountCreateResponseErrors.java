...
public class AccountCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountCreateResponseErrors and sets the default values.
     */
    public AccountCreateResponseErrors() {
    ...
    public static AccountCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountCreateResponseErrors();
    }
    /**
