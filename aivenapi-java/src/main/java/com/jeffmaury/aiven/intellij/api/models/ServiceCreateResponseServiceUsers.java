...
public class ServiceCreateResponseServiceUsers implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceUsers createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessControl(@javax.annotation.Nullable final ServiceCreateResponseServiceUsersAccessControl value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthentication(@javax.annotation.Nullable final ServiceCreateResponseServiceUsersAuthentication value) {
