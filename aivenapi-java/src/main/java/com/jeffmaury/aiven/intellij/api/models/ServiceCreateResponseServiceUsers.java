...
public class ServiceCreateResponseServiceUsers implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceCreateResponseServiceUsersAccessControl accessControl;
    /**
     ...
     */
    private ServiceCreateResponseServiceUsersAuthentication authentication;
    /**
    ...
    /**
     * Instantiates a new ServiceCreateResponseServiceUsers and sets the default values.
     */
    public ServiceCreateResponseServiceUsers() {
    ...
    public static ServiceCreateResponseServiceUsers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceUsers();
    }
    /**
     ...
     * @return a ServiceCreateResponseServiceUsersAccessControl
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceUsersAccessControl getAccessControl() {
     ...
     * @return a ServiceCreateResponseServiceUsersAuthentication
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceUsersAuthentication getAuthentication() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_control", (n) -> { this.setAccessControl(n.getObjectValue(ServiceCreateResponseServiceUsersAccessControl::createFromDiscriminatorValue)); });
        deserializerMap.put("access_key", (n) -> { this.setAccessKey(n.getStringValue()); });
        deserializerMap.put("authentication", (n) -> { this.setAuthentication(n.getEnumValue(ServiceCreateResponseServiceUsersAuthentication::forValue)); });
     ...
     */
    public void setAccessControl(@jakarta.annotation.Nullable final ServiceCreateResponseServiceUsersAccessControl value) {
     ...
     */
    public void setAuthentication(@jakarta.annotation.Nullable final ServiceCreateResponseServiceUsersAuthentication value) {
