...
public class ServiceKafkaConnectRestartConnectorTaskResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectRestartConnectorTaskResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectRestartConnectorTaskResponseErrors() {
    ...
    public static ServiceKafkaConnectRestartConnectorTaskResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectRestartConnectorTaskResponseErrors();
    }
    /**
