...
public class ServiceSchemaRegistrySubjectConfigPutResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectConfigPutResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectConfigPutResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectConfigPutResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectConfigPutResponseErrors();
    }
    /**
