...
public class ProjectTicketCreateResponseTicket implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
     ...
     * Ticket followers
     */
    private java.util.List<ProjectTicketCreateResponseTicketFollowers> followers;
    /**
     ...
     * Severity level
     */
    private ProjectTicketCreateResponseTicketSeverity severity;
    /**
     * Is ticket open or closed
     */
    private ProjectTicketCreateResponseTicketState state;
    /**
     * User information
     */
    private ProjectTicketCreateResponseTicketSubmitter submitter;
    /**
     * Ticket ID
     */
    ...
    /**
     * Instantiates a new ProjectTicketCreateResponseTicket and sets the default values.
     */
    public ProjectTicketCreateResponseTicket() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ProjectTicketCreateResponseTicket
     */
    @jakarta.annotation.Nonnull
    public static ProjectTicketCreateResponseTicket createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTicketCreateResponseTicket();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("followers", (n) -> { this.setFollowers(n.getCollectionOfObjectValues(ProjectTicketCreateResponseTicketFollowers::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("severity", (n) -> { this.setSeverity(n.getEnumValue(ProjectTicketCreateResponseTicketSeverity::forValue)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ProjectTicketCreateResponseTicketState::forValue)); });
        deserializerMap.put("submitter", (n) -> { this.setSubmitter(n.getObjectValue(ProjectTicketCreateResponseTicketSubmitter::createFromDiscriminatorValue)); });
     ...
     * @return a java.util.List<ProjectTicketCreateResponseTicketFollowers>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ProjectTicketCreateResponseTicketFollowers> getFollowers() {
     ...
     * @return a ProjectTicketCreateResponseTicketSeverity
     */
    @jakarta.annotation.Nullable
    public ProjectTicketCreateResponseTicketSeverity getSeverity() {
        return this.severity;
    }
    /**
     * Gets the state property value. Is ticket open or closed
     * @return a ProjectTicketCreateResponseTicketState
     */
    @jakarta.annotation.Nullable
    public ProjectTicketCreateResponseTicketState getState() {
        return this.state;
    }
    /**
     * Gets the submitter property value. User information
     * @return a ProjectTicketCreateResponseTicketSubmitter
     */
    @jakarta.annotation.Nullable
    public ProjectTicketCreateResponseTicketSubmitter getSubmitter() {
     ...
     */
    public void setFollowers(@jakarta.annotation.Nullable final java.util.List<ProjectTicketCreateResponseTicketFollowers> value) {
     ...
     */
    public void setSeverity(@jakarta.annotation.Nullable final ProjectTicketCreateResponseTicketSeverity value) {
        this.severity = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ProjectTicketCreateResponseTicketState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setSubmitter(@jakarta.annotation.Nullable final ProjectTicketCreateResponseTicketSubmitter value) {
