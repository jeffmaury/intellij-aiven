...
public class ProjectTicketCreateResponseTicket implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectTicketCreateResponseTicket createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ProjectTicketCreateResponseTicketFollowers
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setFollowers(@javax.annotation.Nullable final java.util.List<ProjectTicketCreateResponseTicketFollowers> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSeverity(@javax.annotation.Nullable final ProjectTicketCreateResponseTicketSeverity value) {
        this.severity = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ProjectTicketCreateResponseTicketState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSubmitter(@javax.annotation.Nullable final ProjectTicketCreateResponseTicketSubmitter value) {
