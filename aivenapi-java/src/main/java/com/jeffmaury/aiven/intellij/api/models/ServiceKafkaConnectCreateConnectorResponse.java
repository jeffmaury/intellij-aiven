...
public class ServiceKafkaConnectCreateConnectorResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectCreateConnectorResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setConnector(@javax.annotation.Nullable final ServiceKafkaConnectCreateConnectorResponseConnector value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaConnectCreateConnectorResponseErrors> value) {
        this.errors = value;
    }
    /**
