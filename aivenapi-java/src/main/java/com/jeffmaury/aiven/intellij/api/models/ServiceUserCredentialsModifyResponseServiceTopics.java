...
public class ServiceUserCredentialsModifyResponseServiceTopics implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceTopics createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServiceUserCredentialsModifyResponseServiceTopicsState::forValue)); });
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
