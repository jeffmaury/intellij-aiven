...
public class AccountTeamUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamUpdateResponseErrors and sets the default values.
     */
    public AccountTeamUpdateResponseErrors() {
    ...
    public static AccountTeamUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamUpdateResponseErrors();
    }
    /**
