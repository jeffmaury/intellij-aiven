...
public class BillingGroupInvoiceLinesListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupInvoiceLinesListResponseErrors and sets the default values.
     */
    public BillingGroupInvoiceLinesListResponseErrors() {
    ...
    public static BillingGroupInvoiceLinesListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupInvoiceLinesListResponseErrors();
    }
    /**
