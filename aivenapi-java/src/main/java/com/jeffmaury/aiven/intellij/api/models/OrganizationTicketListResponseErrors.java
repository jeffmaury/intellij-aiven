...
public class OrganizationTicketListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationTicketListResponseErrors and sets the default values.
     */
    public OrganizationTicketListResponseErrors() {
    ...
    public static OrganizationTicketListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationTicketListResponseErrors();
    }
    /**
