...
public class EventsRequestBuilder extends BaseRequestBuilder {
    ...
    public ProjectGetEventLogsResponse get() {
        return get(null);
    }
    /**
     * Get project event log entries
     ...
     */
    @jakarta.annotation.Nullable
    public ProjectGetEventLogsResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ProjectGetEventLogsResponse::createFromDiscriminatorValue);
    }
    /**
     * Get project event log entries
