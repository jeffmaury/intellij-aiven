...
public class EventsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ProjectGetEventLogsResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ProjectGetEventLogsResponse> executionException = new java.util.concurrent.CompletableFuture<ProjectGetEventLogsResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ProjectGetEventLogsResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
