...
public class ProjectTagsReplaceResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTagsReplaceResponseErrors and sets the default values.
     */
    public ProjectTagsReplaceResponseErrors() {
    ...
    public static ProjectTagsReplaceResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTagsReplaceResponseErrors();
    }
    /**
