...
public class ServiceCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceCreateResponseErrors and sets the default values.
     */
    public ServiceCreateResponseErrors() {
    ...
    public static ServiceCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseErrors();
    }
    /**
