...
public class ServiceFlinkValidateApplicationVersionRequestBodySinks implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkValidateApplicationVersionRequestBodySinks and sets the default values.
     */
    public ServiceFlinkValidateApplicationVersionRequestBodySinks() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceFlinkValidateApplicationVersionRequestBodySinks
     */
    @jakarta.annotation.Nonnull
    public static ServiceFlinkValidateApplicationVersionRequestBodySinks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkValidateApplicationVersionRequestBodySinks();
    }
    /**
