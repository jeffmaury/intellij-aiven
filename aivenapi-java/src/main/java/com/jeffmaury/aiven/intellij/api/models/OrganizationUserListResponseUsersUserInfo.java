...
public class OrganizationUserListResponseUsersUserInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationUserListResponseUsersUserInfo and sets the default values.
     */
    public OrganizationUserListResponseUsersUserInfo() {
    ...
    public static OrganizationUserListResponseUsersUserInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationUserListResponseUsersUserInfo();
    }
    /**
