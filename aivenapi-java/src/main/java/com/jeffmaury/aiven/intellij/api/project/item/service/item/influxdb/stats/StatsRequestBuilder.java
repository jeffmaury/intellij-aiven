...
public class StatsRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceInfluxDBStatsResponse get() {
        return get(null);
    }
    /**
     * List stats for influxdb
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceInfluxDBStatsResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceInfluxDBStatsResponse::createFromDiscriminatorValue);
    }
    /**
     * List stats for influxdb
