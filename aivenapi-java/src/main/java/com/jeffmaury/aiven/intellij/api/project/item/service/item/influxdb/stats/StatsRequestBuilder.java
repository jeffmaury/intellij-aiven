...
public class StatsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ServiceInfluxDBStatsResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ServiceInfluxDBStatsResponse> executionException = new java.util.concurrent.CompletableFuture<ServiceInfluxDBStatsResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceInfluxDBStatsResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
