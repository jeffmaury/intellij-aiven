...
public class ServiceIntegrationEndpointCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationEndpointCreateResponseErrors and sets the default values.
     */
    public ServiceIntegrationEndpointCreateResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceIntegrationEndpointCreateResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceIntegrationEndpointCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationEndpointCreateResponseErrors();
    }
    /**
