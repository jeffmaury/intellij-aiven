...
public class VpcPeeringConnectionCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcPeeringConnectionCreateResponseErrors and sets the default values.
     */
    public VpcPeeringConnectionCreateResponseErrors() {
    ...
    public static VpcPeeringConnectionCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionCreateResponseErrors();
    }
    /**
