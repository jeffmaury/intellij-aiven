...
public class ServiceKafkaQuotaListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaQuotaListResponseErrors and sets the default values.
     */
    public ServiceKafkaQuotaListResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaQuotaListResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaQuotaListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaQuotaListResponseErrors();
    }
    /**
