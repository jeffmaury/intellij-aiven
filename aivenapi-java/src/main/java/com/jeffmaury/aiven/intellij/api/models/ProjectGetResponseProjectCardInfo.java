...
public class ProjectGetResponseProjectCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectGetResponseProjectCardInfo and sets the default values.
     */
    public ProjectGetResponseProjectCardInfo() {
    ...
    public static ProjectGetResponseProjectCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectGetResponseProjectCardInfo();
    }
    /**
