...
public class ServiceUserCredentialsModifyResponseServiceServiceIntegrations implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceServiceIntegrations createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceServiceIntegrationsIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceServiceIntegrationsUserConfig value) {
