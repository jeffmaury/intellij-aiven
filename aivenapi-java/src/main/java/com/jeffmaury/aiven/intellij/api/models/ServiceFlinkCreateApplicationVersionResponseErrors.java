...
public class ServiceFlinkCreateApplicationVersionResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationVersionResponseErrors and sets the default values.
     */
    public ServiceFlinkCreateApplicationVersionResponseErrors() {
    ...
    public static ServiceFlinkCreateApplicationVersionResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationVersionResponseErrors();
    }
    /**
