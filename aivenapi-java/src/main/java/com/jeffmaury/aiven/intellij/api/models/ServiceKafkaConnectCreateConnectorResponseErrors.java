...
public class ServiceKafkaConnectCreateConnectorResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectCreateConnectorResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectCreateConnectorResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaConnectCreateConnectorResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaConnectCreateConnectorResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectCreateConnectorResponseErrors();
    }
    /**
