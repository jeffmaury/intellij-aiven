package com.jeffmaury.aiven.intellij.api.project.item.downloadsbom.item;

import com.jeffmaury.aiven.intellij.api.project.item.downloadsbom.item.item.WithDownloadCookieItemRequestBuilder;
import com.microsoft.kiota.BaseRequestBuilder;
import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
/**
 * Builds and executes requests for operations under /project/{project}/download-sbom/{file_format}
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class WithFileFormatItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the com.jeffmaury.aiven.intellij.api.project.item.downloadSbom.item.item collection
    ...
    public WithFileFormatItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/project/{project}/download-sbom/{file_format}", pathParameters);
    }
    /**
     * Instantiates a new WithFile_formatItemRequestBuilder and sets the default values.
    ...
    public WithFileFormatItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/project/{project}/download-sbom/{file_format}", rawUrl);
    }
}
