...
public class ServiceKafkaTopicMessageListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTopicMessageListResponseErrors and sets the default values.
     */
    public ServiceKafkaTopicMessageListResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaTopicMessageListResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaTopicMessageListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTopicMessageListResponseErrors();
    }
    /**
