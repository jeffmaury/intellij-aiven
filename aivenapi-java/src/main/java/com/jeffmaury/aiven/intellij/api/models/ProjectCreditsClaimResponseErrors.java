...
public class ProjectCreditsClaimResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectCreditsClaimResponseErrors and sets the default values.
     */
    public ProjectCreditsClaimResponseErrors() {
    ...
    public static ProjectCreditsClaimResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectCreditsClaimResponseErrors();
    }
    /**
