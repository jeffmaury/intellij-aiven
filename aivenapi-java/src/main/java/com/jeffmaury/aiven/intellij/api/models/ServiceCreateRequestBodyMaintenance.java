...
public class ServiceCreateRequestBodyMaintenance implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateRequestBodyMaintenance createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setDow(@jakarta.annotation.Nullable final ServiceCreateRequestBodyMaintenanceDow value) {
        this.dow = value;
    }
    /**
