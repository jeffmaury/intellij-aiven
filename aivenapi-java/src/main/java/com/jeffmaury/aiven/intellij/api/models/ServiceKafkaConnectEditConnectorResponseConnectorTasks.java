...
public class ServiceKafkaConnectEditConnectorResponseConnectorTasks implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectEditConnectorResponseConnectorTasks and sets the default values.
     */
    public ServiceKafkaConnectEditConnectorResponseConnectorTasks() {
    ...
    public static ServiceKafkaConnectEditConnectorResponseConnectorTasks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectEditConnectorResponseConnectorTasks();
    }
    /**
