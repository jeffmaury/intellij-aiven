...
public class ServiceFlinkValidateApplicationVersionResponseStatementErrorPosition implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseStatementErrorPosition createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
