...
public class ServiceSchemaRegistrySubjectsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectsResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectsResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceSchemaRegistrySubjectsResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceSchemaRegistrySubjectsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectsResponseErrors();
    }
    /**
