...
public class PublicPrivatelinkAvailabilityListResponsePrivatelinkAvailability implements AdditionalDataHolder, Parsable {
    ...
    public static PublicPrivatelinkAvailabilityListResponsePrivatelinkAvailability createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
