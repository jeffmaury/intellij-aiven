...
public class PublicPrivatelinkAvailabilityListResponsePrivatelinkAvailability implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PublicPrivatelinkAvailabilityListResponsePrivatelinkAvailability and sets the default values.
     */
    public PublicPrivatelinkAvailabilityListResponsePrivatelinkAvailability() {
    ...
    public static PublicPrivatelinkAvailabilityListResponsePrivatelinkAvailability createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PublicPrivatelinkAvailabilityListResponsePrivatelinkAvailability();
    }
    /**
