...
public class ServiceFlinkCreateApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationDeploymentResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceFlinkCreateApplicationDeploymentResponseErrors>
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkCreateApplicationDeploymentResponseStatus::forValue)); });
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkCreateApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
