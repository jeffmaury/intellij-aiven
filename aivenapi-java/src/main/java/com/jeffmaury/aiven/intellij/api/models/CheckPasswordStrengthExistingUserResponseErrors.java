...
public class CheckPasswordStrengthExistingUserResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new CheckPasswordStrengthExistingUserResponseErrors and sets the default values.
     */
    public CheckPasswordStrengthExistingUserResponseErrors() {
    ...
    public static CheckPasswordStrengthExistingUserResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CheckPasswordStrengthExistingUserResponseErrors();
    }
    /**
