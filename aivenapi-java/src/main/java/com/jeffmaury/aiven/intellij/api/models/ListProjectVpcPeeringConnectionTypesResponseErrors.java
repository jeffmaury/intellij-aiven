...
public class ListProjectVpcPeeringConnectionTypesResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ListProjectVpcPeeringConnectionTypesResponseErrors and sets the default values.
     */
    public ListProjectVpcPeeringConnectionTypesResponseErrors() {
    ...
    public static ListProjectVpcPeeringConnectionTypesResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ListProjectVpcPeeringConnectionTypesResponseErrors();
    }
    /**
