...
public enum VpcGetResponsePeeringConnectionsState implements ValuedEnum {
    ACTIVE("ACTIVE"),
    APPROVED("APPROVED"),
    ...
    VpcGetResponsePeeringConnectionsState(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcGetResponsePeeringConnectionsState forValue(@jakarta.annotation.Nonnull final String searchValue) {
