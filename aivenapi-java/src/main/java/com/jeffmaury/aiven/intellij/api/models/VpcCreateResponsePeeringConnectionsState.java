...
public enum VpcCreateResponsePeeringConnectionsState implements ValuedEnum {
    ACTIVE("ACTIVE"),
    APPROVED("APPROVED"),
    ...
    VpcCreateResponsePeeringConnectionsState(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcCreateResponsePeeringConnectionsState forValue(@jakarta.annotation.Nonnull final String searchValue) {
