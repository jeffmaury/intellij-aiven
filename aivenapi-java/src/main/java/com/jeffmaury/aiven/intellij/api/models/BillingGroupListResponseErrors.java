...
public class BillingGroupListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupListResponseErrors and sets the default values.
     */
    public BillingGroupListResponseErrors() {
    ...
    public static BillingGroupListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupListResponseErrors();
    }
    /**
