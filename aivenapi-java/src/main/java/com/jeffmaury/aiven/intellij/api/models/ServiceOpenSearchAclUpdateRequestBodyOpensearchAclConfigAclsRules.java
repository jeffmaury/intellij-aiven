...
public class ServiceOpenSearchAclUpdateRequestBodyOpensearchAclConfigAclsRules implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchAclUpdateRequestBodyOpensearchAclConfigAclsRules createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("permission", (n) -> { this.setPermission(n.getEnumValue(ServiceOpenSearchAclUpdateRequestBodyOpensearchAclConfigAclsRulesPermission::forValue)); });
     ...
     */
    public void setPermission(@jakarta.annotation.Nullable final ServiceOpenSearchAclUpdateRequestBodyOpensearchAclConfigAclsRulesPermission value) {
