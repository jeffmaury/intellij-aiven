...
public class ServiceListResponseServicesServiceNotificationsMetadata implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesServiceNotificationsMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
