...
public class ServiceKafkaConnectRestartConnectorResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectRestartConnectorResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectRestartConnectorResponseErrors() {
    ...
    public static ServiceKafkaConnectRestartConnectorResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectRestartConnectorResponseErrors();
    }
    /**
