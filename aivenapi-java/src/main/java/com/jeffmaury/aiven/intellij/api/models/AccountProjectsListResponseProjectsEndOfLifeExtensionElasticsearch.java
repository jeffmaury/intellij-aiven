...
public class AccountProjectsListResponseProjectsEndOfLifeExtensionElasticsearch implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountProjectsListResponseProjectsEndOfLifeExtensionElasticsearch and sets the default values.
     */
    public AccountProjectsListResponseProjectsEndOfLifeExtensionElasticsearch() {
    ...
    public static AccountProjectsListResponseProjectsEndOfLifeExtensionElasticsearch createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountProjectsListResponseProjectsEndOfLifeExtensionElasticsearch();
    }
    /**
