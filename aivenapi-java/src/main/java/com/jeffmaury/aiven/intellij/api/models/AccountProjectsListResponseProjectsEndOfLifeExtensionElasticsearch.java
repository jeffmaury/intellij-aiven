...
public class AccountProjectsListResponseProjectsEndOfLifeExtensionElasticsearch implements AdditionalDataHolder, Parsable {
    ...
    public static AccountProjectsListResponseProjectsEndOfLifeExtensionElasticsearch createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
