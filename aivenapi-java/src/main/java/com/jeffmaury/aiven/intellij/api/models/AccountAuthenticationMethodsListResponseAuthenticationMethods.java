...
public class AccountAuthenticationMethodsListResponseAuthenticationMethods implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authentication_method_type", (n) -> { this.setAuthenticationMethodType(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsAuthenticationMethodType.class)); });
        ...
        deserializerMap.put("saml_cert", (n) -> { this.setSamlCert(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlCert.class)); });
        ...
        deserializerMap.put("saml_digest_algorithm", (n) -> { this.setSamlDigestAlgorithm(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm.class)); });
        ...
        deserializerMap.put("saml_signature_algorithm", (n) -> { this.setSamlSignatureAlgorithm(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlSignatureAlgorithm.class)); });
        deserializerMap.put("saml_sp_certificate", (n) -> { this.setSamlSpCertificate(n.getStringValue()); });
        deserializerMap.put("saml_variant", (n) -> { this.setSamlVariant(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlVariant.class)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsState.class)); });
