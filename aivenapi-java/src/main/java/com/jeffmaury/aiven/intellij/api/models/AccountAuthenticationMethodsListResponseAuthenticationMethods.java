...
public class AccountAuthenticationMethodsListResponseAuthenticationMethods implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
     ...
     */
    private AccountAuthenticationMethodsListResponseAuthenticationMethodsAuthenticationMethodType authenticationMethodType;
    /**
     ...
     * SAMLVariant
     */
    private AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlCert samlCert;
    /**
     ...
     */
    private AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm samlDigestAlgorithm;
    /**
     * Saml Entity ID
     */
     ...
     * SAMLFieldMapping
     */
    private AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping samlFieldMapping;
    /**
     ...
     */
    private AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlSignatureAlgorithm samlSignatureAlgorithm;
    /**
     * Saml Sp Certificate
     */
     ...
     * SAMLVariant
     */
    private AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlVariant samlVariant;
    /**
     * AuthenticationMethodState
     */
    private AccountAuthenticationMethodsListResponseAuthenticationMethodsState state;
    /**
     * Update Time
     */
    private String updateTime;
    /**
     * Instantiates a new AccountAuthenticationMethodsListResponseAuthenticationMethods and sets the default values.
     */
    public AccountAuthenticationMethodsListResponseAuthenticationMethods() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethods
     */
    @jakarta.annotation.Nonnull
    public static AccountAuthenticationMethodsListResponseAuthenticationMethods createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAuthenticationMethodsListResponseAuthenticationMethods();
    }
    /**
     ...
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethodsAuthenticationMethodType
     */
    @jakarta.annotation.Nullable
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsAuthenticationMethodType getAuthenticationMethodType() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authentication_method_type", (n) -> { this.setAuthenticationMethodType(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsAuthenticationMethodType::forValue)); });
        ...
        deserializerMap.put("saml_cert", (n) -> { this.setSamlCert(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlCert::forValue)); });
        ...
        deserializerMap.put("saml_digest_algorithm", (n) -> { this.setSamlDigestAlgorithm(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm::forValue)); });
        deserializerMap.put("saml_entity_id", (n) -> { this.setSamlEntityId(n.getStringValue()); });
        deserializerMap.put("saml_field_mapping", (n) -> { this.setSamlFieldMapping(n.getObjectValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("saml_signature_algorithm", (n) -> { this.setSamlSignatureAlgorithm(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlSignatureAlgorithm::forValue)); });
        deserializerMap.put("saml_sp_certificate", (n) -> { this.setSamlSpCertificate(n.getStringValue()); });
        deserializerMap.put("saml_variant", (n) -> { this.setSamlVariant(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlVariant::forValue)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(AccountAuthenticationMethodsListResponseAuthenticationMethodsState::forValue)); });
     ...
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlCert
     */
    @jakarta.annotation.Nullable
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlCert getSamlCert() {
     ...
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm
     */
    @jakarta.annotation.Nullable
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm getSamlDigestAlgorithm() {
     ...
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping
     */
    @jakarta.annotation.Nullable
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping getSamlFieldMapping() {
     ...
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlSignatureAlgorithm
     */
    @jakarta.annotation.Nullable
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlSignatureAlgorithm getSamlSignatureAlgorithm() {
     ...
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlVariant
     */
    @jakarta.annotation.Nullable
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlVariant getSamlVariant() {
        return this.samlVariant;
    }
    /**
     * Gets the state property value. AuthenticationMethodState
     * @return a AccountAuthenticationMethodsListResponseAuthenticationMethodsState
     */
    @jakarta.annotation.Nullable
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsState getState() {
        return this.state;
    }
    /**
     ...
     */
    public void setAuthenticationMethodType(@jakarta.annotation.Nullable final AccountAuthenticationMethodsListResponseAuthenticationMethodsAuthenticationMethodType value) {
     ...
     */
    public void setSamlCert(@jakarta.annotation.Nullable final AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlCert value) {
        this.samlCert = value;
    }
    /**
     ...
     */
    public void setSamlDigestAlgorithm(@jakarta.annotation.Nullable final AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlDigestAlgorithm value) {
     ...
     */
    public void setSamlFieldMapping(@jakarta.annotation.Nullable final AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping value) {
     ...
     */
    public void setSamlSignatureAlgorithm(@jakarta.annotation.Nullable final AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlSignatureAlgorithm value) {
     ...
     */
    public void setSamlVariant(@jakarta.annotation.Nullable final AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlVariant value) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final AccountAuthenticationMethodsListResponseAuthenticationMethodsState value) {
        this.state = value;
    }
    /**
