...
public class ServiceGetResponseService implements AdditionalDataHolder, Parsable {
    /**
     * List of Kafka ACL entries
     */
    private java.util.List<ServiceGetResponseServiceAcl> acl;
    /**
     ...
     */
    private java.util.List<ServiceGetResponseServiceBackups> backups;
    /**
     ...
     */
    private java.util.List<ServiceGetResponseServiceComponents> components;
    /**
     * Service-specific connection information properties
     */
    private ServiceGetResponseServiceConnectionInfo connectionInfo;
    /**
     * PostgreSQL PGBouncer connection pools
     */
    private java.util.List<ServiceGetResponseServiceConnectionPools> connectionPools;
    /**
     ...
     * Feature flags
     */
    private ServiceGetResponseServiceFeatures features;
    /**
     ...
     */
    private ServiceGetResponseServiceMaintenance maintenance;
    /**
     * Service type specific metadata
     */
    private ServiceGetResponseServiceMetadata metadata;
    /**
     ...
     */
    private java.util.List<ServiceGetResponseServiceNodeStates> nodeStates;
    /**
     * Subscription plan
     */
    private String plan;
     ...
     */
    private java.util.List<ServiceGetResponseServiceSchemaRegistryAcl> schemaRegistryAcl;
    /**
     * Integrations with other services
     */
    private java.util.List<ServiceGetResponseServiceServiceIntegrations> serviceIntegrations;
    /**
     * Service name
     */
     ...
     */
    private java.util.List<ServiceGetResponseServiceServiceNotifications> serviceNotifications;
    /**
     * Service type code
     */
     ...
     */
    private ServiceGetResponseServiceServiceUriParams serviceUriParams;
    /**
     * State of the service
     */
    private ServiceGetResponseServiceState state;
    /**
     * Set of resource tags
     */
    private ServiceGetResponseServiceTags tags;
    /**
     ...
     */
    private java.util.List<ServiceGetResponseServiceTopics> topics;
    /**
     ...
     */
    private ServiceGetResponseServiceUserConfig userConfig;
    /**
     * List of service users
     */
    private java.util.List<ServiceGetResponseServiceUsers> users;
    /**
     * Instantiates a new ServiceGetResponseService and sets the default values.
     */
    public ServiceGetResponseService() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceGetResponseService
     */
    @jakarta.annotation.Nonnull
    public static ServiceGetResponseService createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseService();
    }
    /**
     * Gets the acl property value. List of Kafka ACL entries
     * @return a java.util.List<ServiceGetResponseServiceAcl>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceAcl> getAcl() {
        return this.acl;
    }
    /**
     ...
     * @return a java.util.List<ServiceGetResponseServiceBackups>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceBackups> getBackups() {
        return this.backups;
    }
    /**
     ...
     * @return a java.util.List<ServiceGetResponseServiceComponents>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceComponents> getComponents() {
        return this.components;
    }
    /**
     * Gets the connection_info property value. Service-specific connection information properties
     * @return a ServiceGetResponseServiceConnectionInfo
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceConnectionInfo getConnectionInfo() {
        return this.connectionInfo;
    }
    /**
     * Gets the connection_pools property value. PostgreSQL PGBouncer connection pools
     * @return a java.util.List<ServiceGetResponseServiceConnectionPools>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceConnectionPools> getConnectionPools() {
     ...
     * @return a ServiceGetResponseServiceFeatures
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("acl", (n) -> { this.setAcl(n.getCollectionOfObjectValues(ServiceGetResponseServiceAcl::createFromDiscriminatorValue)); });
        deserializerMap.put("backups", (n) -> { this.setBackups(n.getCollectionOfObjectValues(ServiceGetResponseServiceBackups::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("components", (n) -> { this.setComponents(n.getCollectionOfObjectValues(ServiceGetResponseServiceComponents::createFromDiscriminatorValue)); });
        deserializerMap.put("connection_info", (n) -> { this.setConnectionInfo(n.getObjectValue(ServiceGetResponseServiceConnectionInfo::createFromDiscriminatorValue)); });
        deserializerMap.put("connection_pools", (n) -> { this.setConnectionPools(n.getCollectionOfObjectValues(ServiceGetResponseServiceConnectionPools::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(ServiceGetResponseServiceFeatures::createFromDiscriminatorValue)); });
        deserializerMap.put("group_list", (n) -> { this.setGroupList(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("maintenance", (n) -> { this.setMaintenance(n.getObjectValue(ServiceGetResponseServiceMaintenance::createFromDiscriminatorValue)); });
        deserializerMap.put("metadata", (n) -> { this.setMetadata(n.getObjectValue(ServiceGetResponseServiceMetadata::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("node_states", (n) -> { this.setNodeStates(n.getCollectionOfObjectValues(ServiceGetResponseServiceNodeStates::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("schema_registry_acl", (n) -> { this.setSchemaRegistryAcl(n.getCollectionOfObjectValues(ServiceGetResponseServiceSchemaRegistryAcl::createFromDiscriminatorValue)); });
        deserializerMap.put("service_integrations", (n) -> { this.setServiceIntegrations(n.getCollectionOfObjectValues(ServiceGetResponseServiceServiceIntegrations::createFromDiscriminatorValue)); });
        deserializerMap.put("service_name", (n) -> { this.setServiceName(n.getStringValue()); });
        deserializerMap.put("service_notifications", (n) -> { this.setServiceNotifications(n.getCollectionOfObjectValues(ServiceGetResponseServiceServiceNotifications::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("service_uri_params", (n) -> { this.setServiceUriParams(n.getObjectValue(ServiceGetResponseServiceServiceUriParams::createFromDiscriminatorValue)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServiceGetResponseServiceState::forValue)); });
        deserializerMap.put("tags", (n) -> { this.setTags(n.getObjectValue(ServiceGetResponseServiceTags::createFromDiscriminatorValue)); });
        deserializerMap.put("termination_protection", (n) -> { this.setTerminationProtection(n.getBooleanValue()); });
        deserializerMap.put("topics", (n) -> { this.setTopics(n.getCollectionOfObjectValues(ServiceGetResponseServiceTopics::createFromDiscriminatorValue)); });
        deserializerMap.put("update_time", (n) -> { this.setUpdateTime(n.getStringValue()); });
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceGetResponseServiceUserConfig::createFromDiscriminatorValue)); });
        deserializerMap.put("users", (n) -> { this.setUsers(n.getCollectionOfObjectValues(ServiceGetResponseServiceUsers::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceMaintenance getMaintenance() {
        return this.maintenance;
    }
    /**
     * Gets the metadata property value. Service type specific metadata
     * @return a ServiceGetResponseServiceMetadata
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceMetadata getMetadata() {
     ...
     * @return a java.util.List<ServiceGetResponseServiceNodeStates>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceNodeStates> getNodeStates() {
     ...
     * @return a java.util.List<ServiceGetResponseServiceSchemaRegistryAcl>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceSchemaRegistryAcl> getSchemaRegistryAcl() {
        return this.schemaRegistryAcl;
    }
    /**
     * Gets the service_integrations property value. Integrations with other services
     * @return a java.util.List<ServiceGetResponseServiceServiceIntegrations>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceServiceIntegrations> getServiceIntegrations() {
     ...
     * @return a java.util.List<ServiceGetResponseServiceServiceNotifications>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceServiceNotifications> getServiceNotifications() {
     ...
     * @return a ServiceGetResponseServiceServiceUriParams
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceServiceUriParams getServiceUriParams() {
        return this.serviceUriParams;
    }
    /**
     * Gets the state property value. State of the service
     * @return a ServiceGetResponseServiceState
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceState getState() {
        return this.state;
    }
    /**
     * Gets the tags property value. Set of resource tags
     * @return a ServiceGetResponseServiceTags
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceTags getTags() {
        return this.tags;
    }
    /**
     ...
     * @return a java.util.List<ServiceGetResponseServiceTopics>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceTopics> getTopics() {
        return this.topics;
    }
    /**
     ...
     * @return a ServiceGetResponseServiceUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceUserConfig getUserConfig() {
        return this.userConfig;
    }
    /**
     * Gets the users property value. List of service users
     * @return a java.util.List<ServiceGetResponseServiceUsers>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceGetResponseServiceUsers> getUsers() {
        return this.users;
    }
    /**
     ...
     */
    public void setAcl(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceAcl> value) {
        this.acl = value;
    }
    /**
     ...
     */
    public void setBackups(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceBackups> value) {
        this.backups = value;
    }
    /**
     ...
     */
    public void setComponents(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceComponents> value) {
     ...
     */
    public void setConnectionInfo(@jakarta.annotation.Nullable final ServiceGetResponseServiceConnectionInfo value) {
     ...
     */
    public void setConnectionPools(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceConnectionPools> value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final ServiceGetResponseServiceFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setMaintenance(@jakarta.annotation.Nullable final ServiceGetResponseServiceMaintenance value) {
     ...
     */
    public void setMetadata(@jakarta.annotation.Nullable final ServiceGetResponseServiceMetadata value) {
        this.metadata = value;
    }
    /**
     ...
     */
    public void setNodeStates(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceNodeStates> value) {
     ...
     */
    public void setSchemaRegistryAcl(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceSchemaRegistryAcl> value) {
     ...
     */
    public void setServiceIntegrations(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceServiceIntegrations> value) {
     ...
     */
    public void setServiceNotifications(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceServiceNotifications> value) {
     ...
     */
    public void setServiceUriParams(@jakarta.annotation.Nullable final ServiceGetResponseServiceServiceUriParams value) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceGetResponseServiceState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setTags(@jakarta.annotation.Nullable final ServiceGetResponseServiceTags value) {
        this.tags = value;
    }
    /**
     ...
     */
    public void setTopics(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceTopics> value) {
        this.topics = value;
    }
    /**
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceGetResponseServiceUserConfig value) {
     ...
     */
    public void setUsers(@jakarta.annotation.Nullable final java.util.List<ServiceGetResponseServiceUsers> value) {
        this.users = value;
    }
}
