...
public enum AccountAuthenticationMethodCreateResponseAuthenticationMethodAuthenticationMethodType implements ValuedEnum {
    ...
    public static AccountAuthenticationMethodCreateResponseAuthenticationMethodAuthenticationMethodType forValue(@jakarta.annotation.Nonnull final String searchValue) {
