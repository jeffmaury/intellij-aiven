...
public class AccountBillingGroupListResponseAccountBillingGroups implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
     ...
     * Billing currency
     */
    private AccountBillingGroupListResponseAccountBillingGroupsBillingCurrency billingCurrency;
    /**
     * List of project billing email addresses
     */
    private java.util.List<AccountBillingGroupListResponseAccountBillingGroupsBillingEmails> billingEmails;
    /**
     ...
     */
    private AccountBillingGroupListResponseAccountBillingGroupsCardInfo cardInfo;
    /**
     * Address city
     */
    private String city;
     ...
     * Payment method
     */
    private AccountBillingGroupListResponseAccountBillingGroupsPaymentMethod paymentMethod;
    /**
     * Address state
     */
    ...
    /**
     * Instantiates a new AccountBillingGroupListResponseAccountBillingGroups and sets the default values.
     */
    public AccountBillingGroupListResponseAccountBillingGroups() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountBillingGroupListResponseAccountBillingGroups
     */
    @jakarta.annotation.Nonnull
    public static AccountBillingGroupListResponseAccountBillingGroups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountBillingGroupListResponseAccountBillingGroups();
    }
    /**
     ...
     * @return a AccountBillingGroupListResponseAccountBillingGroupsBillingCurrency
     */
    @jakarta.annotation.Nullable
    public AccountBillingGroupListResponseAccountBillingGroupsBillingCurrency getBillingCurrency() {
        return this.billingCurrency;
    }
    /**
     * Gets the billing_emails property value. List of project billing email addresses
     * @return a java.util.List<AccountBillingGroupListResponseAccountBillingGroupsBillingEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<AccountBillingGroupListResponseAccountBillingGroupsBillingEmails> getBillingEmails() {
     ...
     */
    @jakarta.annotation.Nullable
    public AccountBillingGroupListResponseAccountBillingGroupsCardInfo getCardInfo() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_currency", (n) -> { this.setBillingCurrency(n.getEnumValue(AccountBillingGroupListResponseAccountBillingGroupsBillingCurrency::forValue)); });
        deserializerMap.put("billing_emails", (n) -> { this.setBillingEmails(n.getCollectionOfObjectValues(AccountBillingGroupListResponseAccountBillingGroupsBillingEmails::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("card_info", (n) -> { this.setCardInfo(n.getObjectValue(AccountBillingGroupListResponseAccountBillingGroupsCardInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("payment_method", (n) -> { this.setPaymentMethod(n.getEnumValue(AccountBillingGroupListResponseAccountBillingGroupsPaymentMethod::forValue)); });
     ...
     * @return a AccountBillingGroupListResponseAccountBillingGroupsPaymentMethod
     */
    @jakarta.annotation.Nullable
    public AccountBillingGroupListResponseAccountBillingGroupsPaymentMethod getPaymentMethod() {
     ...
     */
    public void setBillingCurrency(@jakarta.annotation.Nullable final AccountBillingGroupListResponseAccountBillingGroupsBillingCurrency value) {
     ...
     */
    public void setBillingEmails(@jakarta.annotation.Nullable final java.util.List<AccountBillingGroupListResponseAccountBillingGroupsBillingEmails> value) {
     ...
     */
    public void setCardInfo(@jakarta.annotation.Nullable final AccountBillingGroupListResponseAccountBillingGroupsCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    public void setPaymentMethod(@jakarta.annotation.Nullable final AccountBillingGroupListResponseAccountBillingGroupsPaymentMethod value) {
