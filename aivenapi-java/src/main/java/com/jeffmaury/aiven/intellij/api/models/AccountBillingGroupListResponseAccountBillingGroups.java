...
public class AccountBillingGroupListResponseAccountBillingGroups implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_currency", (n) -> { this.setBillingCurrency(n.getEnumValue(AccountBillingGroupListResponseAccountBillingGroupsBillingCurrency.class)); });
        ...
        deserializerMap.put("payment_method", (n) -> { this.setPaymentMethod(n.getEnumValue(AccountBillingGroupListResponseAccountBillingGroupsPaymentMethod.class)); });
