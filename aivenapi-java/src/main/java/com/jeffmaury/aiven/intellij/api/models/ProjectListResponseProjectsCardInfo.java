...
public class ProjectListResponseProjectsCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectListResponseProjectsCardInfo and sets the default values.
     */
    public ProjectListResponseProjectsCardInfo() {
    ...
    public static ProjectListResponseProjectsCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectListResponseProjectsCardInfo();
    }
    /**
