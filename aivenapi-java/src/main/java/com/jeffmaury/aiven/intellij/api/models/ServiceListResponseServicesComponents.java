...
public class ServiceListResponseServicesComponents implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("kafka_authentication_method", (n) -> { this.setKafkaAuthenticationMethod(n.getEnumValue(ServiceListResponseServicesComponentsKafkaAuthenticationMethod::forValue)); });
        ...
        deserializerMap.put("route", (n) -> { this.setRoute(n.getEnumValue(ServiceListResponseServicesComponentsRoute::forValue)); });
        deserializerMap.put("ssl", (n) -> { this.setSsl(n.getBooleanValue()); });
        deserializerMap.put("usage", (n) -> { this.setUsage(n.getEnumValue(ServiceListResponseServicesComponentsUsage::forValue)); });
     ...
     */
    public void setKafkaAuthenticationMethod(@jakarta.annotation.Nullable final ServiceListResponseServicesComponentsKafkaAuthenticationMethod value) {
     ...
     */
    public void setRoute(@jakarta.annotation.Nullable final ServiceListResponseServicesComponentsRoute value) {
        this.route = value;
    }
    /**
     ...
     */
    public void setUsage(@jakarta.annotation.Nullable final ServiceListResponseServicesComponentsUsage value) {
        this.usage = value;
    }
}
