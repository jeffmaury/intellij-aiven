...
public class ServiceKafkaTopicUpdateRequestBodyConfig implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicUpdateRequestBodyConfig createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("cleanup_policy", (n) -> { this.setCleanupPolicy(n.getEnumValue(ServiceKafkaTopicUpdateRequestBodyConfigCleanupPolicy.class)); });
        deserializerMap.put("compression_type", (n) -> { this.setCompressionType(n.getEnumValue(ServiceKafkaTopicUpdateRequestBodyConfigCompressionType.class)); });
        ...
        deserializerMap.put("message_format_version", (n) -> { this.setMessageFormatVersion(n.getEnumValue(ServiceKafkaTopicUpdateRequestBodyConfigMessageFormatVersion.class)); });
        deserializerMap.put("message_timestamp_difference_max_ms", (n) -> { this.setMessageTimestampDifferenceMaxMs(n.getIntegerValue()); });
        deserializerMap.put("message_timestamp_type", (n) -> { this.setMessageTimestampType(n.getEnumValue(ServiceKafkaTopicUpdateRequestBodyConfigMessageTimestampType.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setCleanupPolicy(@javax.annotation.Nullable final ServiceKafkaTopicUpdateRequestBodyConfigCleanupPolicy value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCompressionType(@javax.annotation.Nullable final ServiceKafkaTopicUpdateRequestBodyConfigCompressionType value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setMessageFormatVersion(@javax.annotation.Nullable final ServiceKafkaTopicUpdateRequestBodyConfigMessageFormatVersion value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setMessageTimestampType(@javax.annotation.Nullable final ServiceKafkaTopicUpdateRequestBodyConfigMessageTimestampType value) {
