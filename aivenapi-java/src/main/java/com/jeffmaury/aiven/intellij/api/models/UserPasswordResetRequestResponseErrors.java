...
public class UserPasswordResetRequestResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserPasswordResetRequestResponseErrors and sets the default values.
     */
    public UserPasswordResetRequestResponseErrors() {
    ...
    public static UserPasswordResetRequestResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserPasswordResetRequestResponseErrors();
    }
    /**
