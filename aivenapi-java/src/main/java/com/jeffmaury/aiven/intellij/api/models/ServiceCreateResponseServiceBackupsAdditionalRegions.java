...
public class ServiceCreateResponseServiceBackupsAdditionalRegions implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceCreateResponseServiceBackupsAdditionalRegions and sets the default values.
     */
    public ServiceCreateResponseServiceBackupsAdditionalRegions() {
    ...
    public static ServiceCreateResponseServiceBackupsAdditionalRegions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceBackupsAdditionalRegions();
    }
    /**
