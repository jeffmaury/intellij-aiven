...
public class ServiceKafkaMirrorMakerPatchReplicationFlowResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaMirrorMakerPatchReplicationFlowResponseErrors and sets the default values.
     */
    public ServiceKafkaMirrorMakerPatchReplicationFlowResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaMirrorMakerPatchReplicationFlowResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaMirrorMakerPatchReplicationFlowResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaMirrorMakerPatchReplicationFlowResponseErrors();
    }
    /**
