...
public class ServiceFlinkGetApplicationResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationResponseErrors and sets the default values.
     */
    public ServiceFlinkGetApplicationResponseErrors() {
    ...
    public static ServiceFlinkGetApplicationResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationResponseErrors();
    }
    /**
