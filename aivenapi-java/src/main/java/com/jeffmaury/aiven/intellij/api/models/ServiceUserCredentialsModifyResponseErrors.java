...
public class ServiceUserCredentialsModifyResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsModifyResponseErrors and sets the default values.
     */
    public ServiceUserCredentialsModifyResponseErrors() {
    ...
    public static ServiceUserCredentialsModifyResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsModifyResponseErrors();
    }
    /**
