...
public enum VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType implements ValuedEnum {
    ...
    VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType forValue(@jakarta.annotation.Nonnull final String searchValue) {
