...
public class MessagesRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ServiceKafkaTopicMessageListResponse> post(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageListRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceKafkaTopicMessageListResponse> post(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageListRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
