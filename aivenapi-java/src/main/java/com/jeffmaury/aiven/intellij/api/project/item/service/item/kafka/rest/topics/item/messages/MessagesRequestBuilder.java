...
public class MessagesRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceKafkaTopicMessageListResponse post(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageListRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceKafkaTopicMessageListResponse post(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageListRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceKafkaTopicMessageListResponse::createFromDiscriminatorValue);
    }
    /**
     * List kafka topic messages
     * @param body ServiceKafkaTopicMessageListRequestBody
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageListRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final ServiceKafkaTopicMessageListRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
