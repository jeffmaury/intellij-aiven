...
public class AccountTeamInvitesListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamInvitesListResponseErrors and sets the default values.
     */
    public AccountTeamInvitesListResponseErrors() {
    ...
    public static AccountTeamInvitesListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamInvitesListResponseErrors();
    }
    /**
