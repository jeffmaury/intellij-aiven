...
public class ServiceSchemaRegistryGlobalConfigPutResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistryGlobalConfigPutResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistryGlobalConfigPutResponseErrors() {
    ...
    public static ServiceSchemaRegistryGlobalConfigPutResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistryGlobalConfigPutResponseErrors();
    }
    /**
