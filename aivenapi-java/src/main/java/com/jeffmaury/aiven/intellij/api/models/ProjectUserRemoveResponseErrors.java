...
public class ProjectUserRemoveResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectUserRemoveResponseErrors and sets the default values.
     */
    public ProjectUserRemoveResponseErrors() {
    ...
    public static ProjectUserRemoveResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectUserRemoveResponseErrors();
    }
    /**
