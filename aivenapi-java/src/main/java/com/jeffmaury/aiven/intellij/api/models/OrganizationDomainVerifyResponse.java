...
public class OrganizationDomainVerifyResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private OrganizationDomainVerifyResponseState state;
    /**
     * Type of verification to be made
     */
    private OrganizationDomainVerifyResponseVerificationType verificationType;
    /**
     * Instantiates a new OrganizationDomainVerifyResponse and sets the default values.
     */
    public OrganizationDomainVerifyResponse() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a OrganizationDomainVerifyResponse
     */
    @jakarta.annotation.Nonnull
    public static OrganizationDomainVerifyResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationDomainVerifyResponse();
    }
    /**
     ...
     * @return a OrganizationDomainVerifyResponseState
     */
    @jakarta.annotation.Nullable
    public OrganizationDomainVerifyResponseState getState() {
        return this.state;
    }
    /**
     * Gets the verification_type property value. Type of verification to be made
     * @return a OrganizationDomainVerifyResponseVerificationType
     */
    @jakarta.annotation.Nullable
    public OrganizationDomainVerifyResponseVerificationType getVerificationType() {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final OrganizationDomainVerifyResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setVerificationType(@jakarta.annotation.Nullable final OrganizationDomainVerifyResponseVerificationType value) {
