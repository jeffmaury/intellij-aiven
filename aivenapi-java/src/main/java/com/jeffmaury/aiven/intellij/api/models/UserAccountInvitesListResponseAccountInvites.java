...
public class UserAccountInvitesListResponseAccountInvites implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
    ...
    /**
     * Instantiates a new UserAccountInvitesListResponseAccountInvites and sets the default values.
     */
    public UserAccountInvitesListResponseAccountInvites() {
    ...
    public static UserAccountInvitesListResponseAccountInvites createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAccountInvitesListResponseAccountInvites();
    }
    /**
