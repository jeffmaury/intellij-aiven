...
public class ServiceKafkaConnectPauseConnectorResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectPauseConnectorResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectPauseConnectorResponseErrors() {
    ...
    public static ServiceKafkaConnectPauseConnectorResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectPauseConnectorResponseErrors();
    }
    /**
