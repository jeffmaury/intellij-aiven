...
public class ServiceGetResponseServiceServiceNotifications implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceServiceNotifications createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setLevel(@jakarta.annotation.Nullable final ServiceGetResponseServiceServiceNotificationsLevel value) {
        this.level = value;
    }
    /**
     ...
     */
    public void setMetadata(@jakarta.annotation.Nullable final ServiceGetResponseServiceServiceNotificationsMetadata value) {
        this.metadata = value;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final ServiceGetResponseServiceServiceNotificationsType value) {
        this.type = value;
    }
}
