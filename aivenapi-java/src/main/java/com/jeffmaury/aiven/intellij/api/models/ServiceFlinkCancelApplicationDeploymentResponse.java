...
public class ServiceFlinkCancelApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceFlinkCancelApplicationDeploymentResponseErrors> errors;
    /**
     * Deployment ID
     */
    private String id;
     ...
     * Deployment status
     */
    private ServiceFlinkCancelApplicationDeploymentResponseStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkCancelApplicationDeploymentResponse and sets the default values.
     */
    public ServiceFlinkCancelApplicationDeploymentResponse() {
    ...
    public static ServiceFlinkCancelApplicationDeploymentResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCancelApplicationDeploymentResponse();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkCancelApplicationDeploymentResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkCancelApplicationDeploymentResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(ServiceFlinkCancelApplicationDeploymentResponseErrors::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkCancelApplicationDeploymentResponseStatus::forValue)); });
     ...
     * @return a ServiceFlinkCancelApplicationDeploymentResponseStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkCancelApplicationDeploymentResponseStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkCancelApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkCancelApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
