...
public class AccountAttachPaymentMethodResponseCard implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountAttachPaymentMethodResponseCard and sets the default values.
     */
    public AccountAttachPaymentMethodResponseCard() {
    ...
    public static AccountAttachPaymentMethodResponseCard createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAttachPaymentMethodResponseCard();
    }
    /**
