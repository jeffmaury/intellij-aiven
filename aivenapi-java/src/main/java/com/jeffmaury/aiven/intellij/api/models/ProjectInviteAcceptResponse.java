...
public class ProjectInviteAcceptResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectInviteAcceptResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ProjectInviteAcceptResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ProjectInviteAcceptResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setInviteDetails(@javax.annotation.Nullable final ProjectInviteAcceptResponseInviteDetails value) {
