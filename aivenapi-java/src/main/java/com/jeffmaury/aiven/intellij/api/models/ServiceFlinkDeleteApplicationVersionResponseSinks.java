...
public class ServiceFlinkDeleteApplicationVersionResponseSinks implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Columns
     */
    private java.util.List<ServiceFlinkDeleteApplicationVersionResponseSinksColumns> columns;
    /**
     ...
     * Option
     */
    private ServiceFlinkDeleteApplicationVersionResponseSinksOptions options;
    /**
     * Sink ID
     */
    ...
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationVersionResponseSinks and sets the default values.
     */
    public ServiceFlinkDeleteApplicationVersionResponseSinks() {
    ...
    public static ServiceFlinkDeleteApplicationVersionResponseSinks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationVersionResponseSinks();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkDeleteApplicationVersionResponseSinksColumns>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkDeleteApplicationVersionResponseSinksColumns> getColumns() {
        return this.columns;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { this.setColumns(n.getCollectionOfObjectValues(ServiceFlinkDeleteApplicationVersionResponseSinksColumns::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getObjectValue(ServiceFlinkDeleteApplicationVersionResponseSinksOptions::createFromDiscriminatorValue)); });
     ...
     * @return a ServiceFlinkDeleteApplicationVersionResponseSinksOptions
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkDeleteApplicationVersionResponseSinksOptions getOptions() {
        return this.options;
    }
    /**
     ...
     */
    public void setColumns(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkDeleteApplicationVersionResponseSinksColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final ServiceFlinkDeleteApplicationVersionResponseSinksOptions value) {
        this.options = value;
    }
    /**
