...
public class ServiceFlinkDeleteApplicationDeploymentResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationDeploymentResponseErrors and sets the default values.
     */
    public ServiceFlinkDeleteApplicationDeploymentResponseErrors() {
    ...
    public static ServiceFlinkDeleteApplicationDeploymentResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationDeploymentResponseErrors();
    }
    /**
