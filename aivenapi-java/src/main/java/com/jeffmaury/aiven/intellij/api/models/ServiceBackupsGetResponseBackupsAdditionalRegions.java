...
public class ServiceBackupsGetResponseBackupsAdditionalRegions implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceBackupsGetResponseBackupsAdditionalRegions and sets the default values.
     */
    public ServiceBackupsGetResponseBackupsAdditionalRegions() {
    ...
    public static ServiceBackupsGetResponseBackupsAdditionalRegions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceBackupsGetResponseBackupsAdditionalRegions();
    }
    /**
