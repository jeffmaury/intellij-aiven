...
public enum VpcPeeringConnectionCreateResponseState implements ValuedEnum {
    ACTIVE("ACTIVE"),
    APPROVED("APPROVED"),
    ...
    VpcPeeringConnectionCreateResponseState(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcPeeringConnectionCreateResponseState forValue(@jakarta.annotation.Nonnull final String searchValue) {
