...
public class ServiceTaskCreateResponseTaskResultCodes implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceTaskCreateResponseTaskResultCodes and sets the default values.
     */
    public ServiceTaskCreateResponseTaskResultCodes() {
    ...
    public static ServiceTaskCreateResponseTaskResultCodes createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceTaskCreateResponseTaskResultCodes();
    }
    /**
