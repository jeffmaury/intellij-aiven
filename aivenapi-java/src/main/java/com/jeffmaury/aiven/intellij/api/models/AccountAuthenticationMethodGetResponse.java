...
public class AccountAuthenticationMethodGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodGetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthenticationMethod(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethod value) {
