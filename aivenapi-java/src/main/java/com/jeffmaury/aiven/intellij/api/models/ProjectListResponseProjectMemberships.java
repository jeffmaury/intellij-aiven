...
public class ProjectListResponseProjectMemberships implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectListResponseProjectMemberships and sets the default values.
     */
    public ProjectListResponseProjectMemberships() {
    ...
    public static ProjectListResponseProjectMemberships createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectListResponseProjectMemberships();
    }
    /**
