...
public class ProjectPrivatelinkAvailabilityListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectPrivatelinkAvailabilityListResponseErrors and sets the default values.
     */
    public ProjectPrivatelinkAvailabilityListResponseErrors() {
    ...
    public static ProjectPrivatelinkAvailabilityListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectPrivatelinkAvailabilityListResponseErrors();
    }
    /**
