...
public class StatsRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<PGServiceQueryStatisticsResponse> post(@jakarta.annotation.Nonnull final PGServiceQueryStatisticsRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PGServiceQueryStatisticsResponse> post(@jakarta.annotation.Nonnull final PGServiceQueryStatisticsRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
