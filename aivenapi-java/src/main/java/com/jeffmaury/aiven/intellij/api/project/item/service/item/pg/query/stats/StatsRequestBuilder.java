...
public class StatsRequestBuilder extends BaseRequestBuilder {
    ...
    public PGServiceQueryStatisticsResponse post(@jakarta.annotation.Nonnull final PGServiceQueryStatisticsRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PGServiceQueryStatisticsResponse post(@jakarta.annotation.Nonnull final PGServiceQueryStatisticsRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, PGServiceQueryStatisticsResponse::createFromDiscriminatorValue);
    }
    /**
     * Fetch PostgreSQL service query statistics
     * @param body PGServiceQueryStatisticsRequestBody
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PGServiceQueryStatisticsRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final PGServiceQueryStatisticsRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
