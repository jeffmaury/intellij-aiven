...
public class ServiceUpdateResponseServiceServiceIntegrations implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceUpdateResponseServiceServiceIntegrationsIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceUpdateResponseServiceServiceIntegrationsUserConfig::createFromDiscriminatorValue)); });
