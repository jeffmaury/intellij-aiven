...
public class ServiceIntegrationEndpointCreateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationEndpointCreateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setEndpointType(@javax.annotation.Nullable final ServiceIntegrationEndpointCreateRequestBodyEndpointType value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationEndpointCreateRequestBodyUserConfig value) {
