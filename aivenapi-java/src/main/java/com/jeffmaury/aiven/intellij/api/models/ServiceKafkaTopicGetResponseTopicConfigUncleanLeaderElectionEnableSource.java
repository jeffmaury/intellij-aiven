...
public enum ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
