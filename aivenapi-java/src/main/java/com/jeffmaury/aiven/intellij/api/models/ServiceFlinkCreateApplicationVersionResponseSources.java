...
public class ServiceFlinkCreateApplicationVersionResponseSources implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getObjectValue(ServiceFlinkCreateApplicationVersionResponseSourcesOptions::createFromDiscriminatorValue)); });
