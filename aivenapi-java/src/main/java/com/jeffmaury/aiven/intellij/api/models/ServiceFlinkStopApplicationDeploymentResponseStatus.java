...
public enum ServiceFlinkStopApplicationDeploymentResponseStatus implements ValuedEnum {
    ...
    ServiceFlinkStopApplicationDeploymentResponseStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceFlinkStopApplicationDeploymentResponseStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
