...
public enum ProjectInvoiceListResponseInvoicesState implements ValuedEnum {
    Accrual("accrual"),
    ...
    ProjectInvoiceListResponseInvoicesState(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ProjectInvoiceListResponseInvoicesState forValue(@jakarta.annotation.Nonnull final String searchValue) {
