...
public class ServiceGetResponseServiceServiceIntegrationsIntegrationStatus implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceServiceIntegrationsIntegrationStatus createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceGetResponseServiceServiceIntegrationsIntegrationStatusState value) {
        this.state = value;
    }
    /**
