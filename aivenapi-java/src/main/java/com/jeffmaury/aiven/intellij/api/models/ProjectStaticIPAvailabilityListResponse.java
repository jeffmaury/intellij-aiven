...
public class ProjectStaticIPAvailabilityListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectStaticIPAvailabilityListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ProjectStaticIPAvailabilityListResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ProjectStaticIPAvailabilityListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStaticIpAddressAvailability(@javax.annotation.Nullable final java.util.List<ProjectStaticIPAvailabilityListResponseStaticIpAddressAvailability> value) {
