...
public class AccountListResponseAccounts implements AdditionalDataHolder, Parsable {
    ...
    public static AccountListResponseAccounts createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessSource(@javax.annotation.Nullable final AccountListResponseAccountsAccessSource value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setFeatures(@javax.annotation.Nullable final AccountListResponseAccountsFeatures value) {
        this.features = value;
    }
    /**
