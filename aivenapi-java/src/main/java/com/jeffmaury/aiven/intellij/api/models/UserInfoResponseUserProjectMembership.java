...
public class UserInfoResponseUserProjectMembership implements AdditionalDataHolder, Parsable {
    ...
    public static UserInfoResponseUserProjectMembership createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("ANY", (n) -> { this.setANY(n.getEnumValue(UserInfoResponseUserProjectMembershipANY.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setANY(@javax.annotation.Nullable final UserInfoResponseUserProjectMembershipANY value) {
        this.aNY = value;
    }
}
