...
public class VpcPeeringConnectionCreateRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcPeeringConnectionCreateRequestBody and sets the default values.
     */
    public VpcPeeringConnectionCreateRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a VpcPeeringConnectionCreateRequestBody
     */
    @jakarta.annotation.Nonnull
    public static VpcPeeringConnectionCreateRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionCreateRequestBody();
    }
    /**
