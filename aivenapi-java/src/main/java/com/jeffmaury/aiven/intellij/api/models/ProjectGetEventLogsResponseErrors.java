...
public class ProjectGetEventLogsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectGetEventLogsResponseErrors and sets the default values.
     */
    public ProjectGetEventLogsResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ProjectGetEventLogsResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ProjectGetEventLogsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectGetEventLogsResponseErrors();
    }
    /**
