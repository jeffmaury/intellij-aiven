...
public class ServiceSchemaRegistryAclDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistryAclDeleteResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistryAclDeleteResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceSchemaRegistryAclDeleteResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceSchemaRegistryAclDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistryAclDeleteResponseErrors();
    }
    /**
