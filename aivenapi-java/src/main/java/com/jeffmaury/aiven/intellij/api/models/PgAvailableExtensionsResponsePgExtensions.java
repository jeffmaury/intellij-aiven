...
public class PgAvailableExtensionsResponsePgExtensions implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PgAvailableExtensionsResponsePgExtensions and sets the default values.
     */
    public PgAvailableExtensionsResponsePgExtensions() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a PgAvailableExtensionsResponsePgExtensions
     */
    @jakarta.annotation.Nonnull
    public static PgAvailableExtensionsResponsePgExtensions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PgAvailableExtensionsResponsePgExtensions();
    }
    /**
