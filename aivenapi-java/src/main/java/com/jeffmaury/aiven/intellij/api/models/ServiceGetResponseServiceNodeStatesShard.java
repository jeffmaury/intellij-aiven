...
public class ServiceGetResponseServiceNodeStatesShard implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceGetResponseServiceNodeStatesShard and sets the default values.
     */
    public ServiceGetResponseServiceNodeStatesShard() {
    ...
    public static ServiceGetResponseServiceNodeStatesShard createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceNodeStatesShard();
    }
    /**
