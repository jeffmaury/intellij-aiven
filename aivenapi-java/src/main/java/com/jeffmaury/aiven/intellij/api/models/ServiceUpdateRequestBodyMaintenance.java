...
public class ServiceUpdateRequestBodyMaintenance implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateRequestBodyMaintenance createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("dow", (n) -> { this.setDow(n.getEnumValue(ServiceUpdateRequestBodyMaintenanceDow.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setDow(@javax.annotation.Nullable final ServiceUpdateRequestBodyMaintenanceDow value) {
        this.dow = value;
    }
    /**
