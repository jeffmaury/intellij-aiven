...
public class ReportRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceBackupToAnotherRegionReportResponse post(@jakarta.annotation.Nonnull final ServiceBackupToAnotherRegionReportRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceBackupToAnotherRegionReportResponse post(@jakarta.annotation.Nonnull final ServiceBackupToAnotherRegionReportRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceBackupToAnotherRegionReportResponse::createFromDiscriminatorValue);
    }
    /**
     * Get service's backup to another region information
     * @param body ServiceBackupToAnotherRegionReportRequestBody
