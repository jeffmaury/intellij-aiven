...
public enum ServiceKafkaTopicGetResponseTopicConfigMessageDownconversionEnableSynonymsSource implements ValuedEnum {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMessageDownconversionEnableSynonymsSource forValue(@javax.annotation.Nonnull final String searchValue) {
