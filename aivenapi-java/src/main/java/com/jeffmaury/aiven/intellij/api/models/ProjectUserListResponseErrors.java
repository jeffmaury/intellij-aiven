...
public class ProjectUserListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectUserListResponseErrors and sets the default values.
     */
    public ProjectUserListResponseErrors() {
    ...
    public static ProjectUserListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectUserListResponseErrors();
    }
    /**
