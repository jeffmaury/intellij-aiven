...
public enum ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusStateStatus implements ValuedEnum {
    ...
    public static ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusStateStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
