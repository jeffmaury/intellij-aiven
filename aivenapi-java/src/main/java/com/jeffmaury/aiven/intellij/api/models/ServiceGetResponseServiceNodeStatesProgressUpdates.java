...
public class ServiceGetResponseServiceNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceGetResponseServiceNodeStatesProgressUpdatesPhase phase;
    /**
     * Unit for current/min/max values. New units may be added. If null should be treated as generic unit
     */
    private ServiceGetResponseServiceNodeStatesProgressUpdatesUnit unit;
    /**
     * Instantiates a new ServiceGetResponseServiceNodeStatesProgressUpdates and sets the default values.
     */
    public ServiceGetResponseServiceNodeStatesProgressUpdates() {
    ...
    public static ServiceGetResponseServiceNodeStatesProgressUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceNodeStatesProgressUpdates();
    }
    /**
     ...
     * @return a ServiceGetResponseServiceNodeStatesProgressUpdatesPhase
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceNodeStatesProgressUpdatesPhase getPhase() {
        return this.phase;
    }
    /**
     ...
     * @return a ServiceGetResponseServiceNodeStatesProgressUpdatesUnit
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceNodeStatesProgressUpdatesUnit getUnit() {
        return this.unit;
    }
    /**
     ...
     */
    public void setPhase(@jakarta.annotation.Nullable final ServiceGetResponseServiceNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    public void setUnit(@jakarta.annotation.Nullable final ServiceGetResponseServiceNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
