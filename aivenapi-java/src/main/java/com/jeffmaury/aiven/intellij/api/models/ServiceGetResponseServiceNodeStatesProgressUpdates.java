...
public class ServiceGetResponseServiceNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceNodeStatesProgressUpdates createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPhase(@javax.annotation.Nullable final ServiceGetResponseServiceNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUnit(@javax.annotation.Nullable final ServiceGetResponseServiceNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
