...
public class BillingGroupUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupUpdateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a BillingGroupUpdateResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingGroup(@javax.annotation.Nullable final BillingGroupUpdateResponseBillingGroup value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<BillingGroupUpdateResponseErrors> value) {
        this.errors = value;
    }
    /**
