...
public class ListCloudsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ListCloudsResponseErrors and sets the default values.
     */
    public ListCloudsResponseErrors() {
    ...
    public static ListCloudsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ListCloudsResponseErrors();
    }
    /**
