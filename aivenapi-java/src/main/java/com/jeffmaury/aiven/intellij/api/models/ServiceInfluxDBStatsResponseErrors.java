...
public class ServiceInfluxDBStatsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceInfluxDBStatsResponseErrors and sets the default values.
     */
    public ServiceInfluxDBStatsResponseErrors() {
    ...
    public static ServiceInfluxDBStatsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceInfluxDBStatsResponseErrors();
    }
    /**
