...
public class ProjectUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectUpdateResponseErrors and sets the default values.
     */
    public ProjectUpdateResponseErrors() {
    ...
    public static ProjectUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectUpdateResponseErrors();
    }
    /**
