...
public class ServiceFlinkJobDetailsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkJobDetailsResponseErrors and sets the default values.
     */
    public ServiceFlinkJobDetailsResponseErrors() {
    ...
    public static ServiceFlinkJobDetailsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkJobDetailsResponseErrors();
    }
    /**
