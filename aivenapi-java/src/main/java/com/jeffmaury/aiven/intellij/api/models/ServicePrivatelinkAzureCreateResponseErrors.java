...
public class ServicePrivatelinkAzureCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAzureCreateResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAzureCreateResponseErrors() {
    ...
    public static ServicePrivatelinkAzureCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureCreateResponseErrors();
    }
    /**
