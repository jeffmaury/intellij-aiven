...
public class WithFileFormatItemRequestBuilder extends BaseRequestBuilder {
    ...
    public ProjectGenerateSbomDownloadUrlResponse get() {
        return get(null);
    }
    /**
     * Generate SBOM for project
     ...
     */
    @jakarta.annotation.Nullable
    public ProjectGenerateSbomDownloadUrlResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ProjectGenerateSbomDownloadUrlResponse::createFromDiscriminatorValue);
    }
    /**
     * Generate SBOM for project
