...
public class UserUpdateResponseUserInvitations implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserUpdateResponseUserInvitations and sets the default values.
     */
    public UserUpdateResponseUserInvitations() {
    ...
    public static UserUpdateResponseUserInvitations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserUpdateResponseUserInvitations();
    }
    /**
