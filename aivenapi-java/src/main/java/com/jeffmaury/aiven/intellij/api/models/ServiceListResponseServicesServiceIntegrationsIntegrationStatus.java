...
public class ServiceListResponseServicesServiceIntegrationsIntegrationStatus implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesServiceIntegrationsIntegrationStatus createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsIntegrationStatusState value) {
        this.state = value;
    }
    /**
