...
public enum ServiceKafkaTopicGetResponseTopicConfigSegmentMsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigSegmentMsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigSegmentMsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
