...
public class ServiceKafkaConnectListResponseConnectorsPlugin implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectListResponseConnectorsPlugin createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setType(@jakarta.annotation.Nullable final ServiceKafkaConnectListResponseConnectorsPluginType value) {
        this.type = value;
    }
    /**
