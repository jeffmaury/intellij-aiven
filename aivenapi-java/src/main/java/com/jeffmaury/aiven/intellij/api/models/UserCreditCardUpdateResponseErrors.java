...
public class UserCreditCardUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserCreditCardUpdateResponseErrors and sets the default values.
     */
    public UserCreditCardUpdateResponseErrors() {
    ...
    public static UserCreditCardUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserCreditCardUpdateResponseErrors();
    }
    /**
