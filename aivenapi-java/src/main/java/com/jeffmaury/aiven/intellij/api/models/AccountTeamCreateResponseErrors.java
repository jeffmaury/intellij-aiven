...
public class AccountTeamCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamCreateResponseErrors and sets the default values.
     */
    public AccountTeamCreateResponseErrors() {
    ...
    public static AccountTeamCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamCreateResponseErrors();
    }
    /**
