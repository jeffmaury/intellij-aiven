...
public class ServiceFlinkCreateApplicationRequestBodyApplicationVersionSources implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationRequestBodyApplicationVersionSources and sets the default values.
     */
    public ServiceFlinkCreateApplicationRequestBodyApplicationVersionSources() {
    ...
    public static ServiceFlinkCreateApplicationRequestBodyApplicationVersionSources createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationRequestBodyApplicationVersionSources();
    }
    /**
