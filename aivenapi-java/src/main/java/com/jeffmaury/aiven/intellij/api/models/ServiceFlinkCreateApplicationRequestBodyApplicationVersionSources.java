...
public class ServiceFlinkCreateApplicationRequestBodyApplicationVersionSources implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationRequestBodyApplicationVersionSources createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
