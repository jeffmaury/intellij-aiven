...
public class ServicePrivatelinkAzureConnectionListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAzureConnectionListResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAzureConnectionListResponseErrors() {
    ...
    public static ServicePrivatelinkAzureConnectionListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureConnectionListResponseErrors();
    }
    /**
