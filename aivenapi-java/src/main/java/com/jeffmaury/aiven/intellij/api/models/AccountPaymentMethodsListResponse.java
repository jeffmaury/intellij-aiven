...
public class AccountPaymentMethodsListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountPaymentMethodsListResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<AccountPaymentMethodsListResponseCards>
     */
     ...
     * @return a java.util.List<AccountPaymentMethodsListResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setCards(@jakarta.annotation.Nullable final java.util.List<AccountPaymentMethodsListResponseCards> value) {
        this.cards = value;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<AccountPaymentMethodsListResponseErrors> value) {
        this.errors = value;
    }
    /**
