...
public class ServiceAlertsListResponseAlerts implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceAlertsListResponseAlerts and sets the default values.
     */
    public ServiceAlertsListResponseAlerts() {
    ...
    public static ServiceAlertsListResponseAlerts createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceAlertsListResponseAlerts();
    }
    /**
