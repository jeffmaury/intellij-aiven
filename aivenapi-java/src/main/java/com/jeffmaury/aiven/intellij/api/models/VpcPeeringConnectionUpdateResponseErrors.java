...
public class VpcPeeringConnectionUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcPeeringConnectionUpdateResponseErrors and sets the default values.
     */
    public VpcPeeringConnectionUpdateResponseErrors() {
    ...
    public static VpcPeeringConnectionUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionUpdateResponseErrors();
    }
    /**
