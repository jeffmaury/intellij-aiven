...
public class AccountEventListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountEventListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<AccountEventListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setEvents(@javax.annotation.Nullable final java.util.List<AccountEventListResponseEvents> value) {
        this.events = value;
    }
    /**
