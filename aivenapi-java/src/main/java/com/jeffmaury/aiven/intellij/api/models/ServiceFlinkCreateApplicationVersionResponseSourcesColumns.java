...
public class ServiceFlinkCreateApplicationVersionResponseSourcesColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationVersionResponseSourcesColumns and sets the default values.
     */
    public ServiceFlinkCreateApplicationVersionResponseSourcesColumns() {
    ...
    public static ServiceFlinkCreateApplicationVersionResponseSourcesColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationVersionResponseSourcesColumns();
    }
    /**
