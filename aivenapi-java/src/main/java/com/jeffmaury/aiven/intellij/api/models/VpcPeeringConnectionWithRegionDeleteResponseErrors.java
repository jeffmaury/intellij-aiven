...
public class VpcPeeringConnectionWithRegionDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcPeeringConnectionWithRegionDeleteResponseErrors and sets the default values.
     */
    public VpcPeeringConnectionWithRegionDeleteResponseErrors() {
    ...
    public static VpcPeeringConnectionWithRegionDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionWithRegionDeleteResponseErrors();
    }
    /**
