...
public class ProjectInviteAcceptResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectInviteAcceptResponseErrors and sets the default values.
     */
    public ProjectInviteAcceptResponseErrors() {
    ...
    public static ProjectInviteAcceptResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectInviteAcceptResponseErrors();
    }
    /**
