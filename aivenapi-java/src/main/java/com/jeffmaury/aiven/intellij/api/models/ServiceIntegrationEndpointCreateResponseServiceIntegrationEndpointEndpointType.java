...
public enum ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointType implements ValuedEnum {
    ...
    ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointType forValue(@jakarta.annotation.Nonnull final String searchValue) {
