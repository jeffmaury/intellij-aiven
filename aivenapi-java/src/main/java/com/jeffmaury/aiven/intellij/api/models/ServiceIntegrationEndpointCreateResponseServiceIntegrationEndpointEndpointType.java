...
public enum ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointType implements ValuedEnum {
    ...
    public static ServiceIntegrationEndpointCreateResponseServiceIntegrationEndpointEndpointType forValue(@javax.annotation.Nonnull final String searchValue) {
