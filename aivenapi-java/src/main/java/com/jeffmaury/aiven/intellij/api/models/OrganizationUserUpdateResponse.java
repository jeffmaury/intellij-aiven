...
public class OrganizationUserUpdateResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private OrganizationUserUpdateResponseUserInfo userInfo;
    /**
     * Instantiates a new OrganizationUserUpdateResponse and sets the default values.
     */
    public OrganizationUserUpdateResponse() {
    ...
    public static OrganizationUserUpdateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationUserUpdateResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("user_info", (n) -> { this.setUserInfo(n.getObjectValue(OrganizationUserUpdateResponseUserInfo::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationUserUpdateResponseUserInfo getUserInfo() {
     ...
     */
    public void setUserInfo(@jakarta.annotation.Nullable final OrganizationUserUpdateResponseUserInfo value) {
        this.userInfo = value;
    }
}
