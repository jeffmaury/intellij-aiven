...
public class SecurityRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceOpenSearchSecurityGetResponse get() {
        return get(null);
    }
    /**
     * Show Opensearch security configuration status
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceOpenSearchSecurityGetResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceOpenSearchSecurityGetResponse::createFromDiscriminatorValue);
    }
    /**
     * Show Opensearch security configuration status
