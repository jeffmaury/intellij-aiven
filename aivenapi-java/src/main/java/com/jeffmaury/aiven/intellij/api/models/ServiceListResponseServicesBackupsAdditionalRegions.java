...
public class ServiceListResponseServicesBackupsAdditionalRegions implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceListResponseServicesBackupsAdditionalRegions and sets the default values.
     */
    public ServiceListResponseServicesBackupsAdditionalRegions() {
    ...
    public static ServiceListResponseServicesBackupsAdditionalRegions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServicesBackupsAdditionalRegions();
    }
    /**
