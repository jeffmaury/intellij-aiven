...
public class AccountListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountListResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountListResponse();
    }
    /**
     * Gets the accounts property value. List of accounts
     * @return a java.util.List<AccountListResponseAccounts>
     */
     ...
     * @return a java.util.List<AccountListResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setAccounts(@jakarta.annotation.Nullable final java.util.List<AccountListResponseAccounts> value) {
        this.accounts = value;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<AccountListResponseErrors> value) {
        this.errors = value;
    }
    /**
