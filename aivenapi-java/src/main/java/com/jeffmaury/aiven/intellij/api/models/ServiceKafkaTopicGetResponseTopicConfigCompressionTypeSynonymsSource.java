...
public enum ServiceKafkaTopicGetResponseTopicConfigCompressionTypeSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigCompressionTypeSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigCompressionTypeSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
