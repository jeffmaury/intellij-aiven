...
public enum ServiceKafkaMirrorMakerCreateReplicationFlowRequestBodyOffsetSyncsTopicLocation implements ValuedEnum {
    ...
    public static ServiceKafkaMirrorMakerCreateReplicationFlowRequestBodyOffsetSyncsTopicLocation forValue(@javax.annotation.Nonnull final String searchValue) {
