...
public class ServiceKafkaAclDeleteResponseAcl implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaAclDeleteResponseAcl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("permission", (n) -> { this.setPermission(n.getEnumValue(ServiceKafkaAclDeleteResponseAclPermission::forValue)); });
     ...
     */
    public void setPermission(@jakarta.annotation.Nullable final ServiceKafkaAclDeleteResponseAclPermission value) {
