...
public class ServiceSchemaRegistrySubjectConfigGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectConfigGetResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectConfigGetResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectConfigGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectConfigGetResponseErrors();
    }
    /**
