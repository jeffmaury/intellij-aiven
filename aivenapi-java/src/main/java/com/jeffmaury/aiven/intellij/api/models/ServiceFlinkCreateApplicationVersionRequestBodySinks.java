...
public class ServiceFlinkCreateApplicationVersionRequestBodySinks implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationVersionRequestBodySinks and sets the default values.
     */
    public ServiceFlinkCreateApplicationVersionRequestBodySinks() {
    ...
    public static ServiceFlinkCreateApplicationVersionRequestBodySinks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationVersionRequestBodySinks();
    }
    /**
