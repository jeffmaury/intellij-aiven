...
public class ServiceKafkaTieredStorageStorageUsageTotalResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTieredStorageStorageUsageTotalResponseErrors and sets the default values.
     */
    public ServiceKafkaTieredStorageStorageUsageTotalResponseErrors() {
    ...
    public static ServiceKafkaTieredStorageStorageUsageTotalResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTieredStorageStorageUsageTotalResponseErrors();
    }
    /**
