...
public enum ServiceKafkaTopicGetResponseTopicConfigMinCleanableDirtyRatioSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMinCleanableDirtyRatioSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMinCleanableDirtyRatioSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
