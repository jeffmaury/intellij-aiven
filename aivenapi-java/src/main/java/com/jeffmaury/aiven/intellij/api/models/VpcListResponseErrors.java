...
public class VpcListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcListResponseErrors and sets the default values.
     */
    public VpcListResponseErrors() {
    ...
    public static VpcListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcListResponseErrors();
    }
    /**
