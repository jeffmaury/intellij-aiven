...
public class ProjectCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectCreateResponseErrors and sets the default values.
     */
    public ProjectCreateResponseErrors() {
    ...
    public static ProjectCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectCreateResponseErrors();
    }
    /**
