...
public class ServiceFlinkCreateApplicationResponseApplicationVersionsSources implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Columns
     */
    private java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns> columns;
    /**
     ...
     * Option
     */
    private ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesOptions options;
    /**
     * Source ID
     */
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationResponseApplicationVersionsSources and sets the default values.
     */
    public ServiceFlinkCreateApplicationResponseApplicationVersionsSources() {
    ...
    public static ServiceFlinkCreateApplicationResponseApplicationVersionsSources createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationResponseApplicationVersionsSources();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns> getColumns() {
        return this.columns;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { this.setColumns(n.getCollectionOfObjectValues(ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getObjectValue(ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesOptions::createFromDiscriminatorValue)); });
     ...
     * @return a ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesOptions
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesOptions getOptions() {
        return this.options;
    }
    /**
     ...
     */
    public void setColumns(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesOptions value) {
        this.options = value;
    }
    /**
