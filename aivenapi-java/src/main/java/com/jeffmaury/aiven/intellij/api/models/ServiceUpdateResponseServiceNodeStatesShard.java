...
public class ServiceUpdateResponseServiceNodeStatesShard implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseServiceNodeStatesShard and sets the default values.
     */
    public ServiceUpdateResponseServiceNodeStatesShard() {
    ...
    public static ServiceUpdateResponseServiceNodeStatesShard createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseServiceNodeStatesShard();
    }
    /**
