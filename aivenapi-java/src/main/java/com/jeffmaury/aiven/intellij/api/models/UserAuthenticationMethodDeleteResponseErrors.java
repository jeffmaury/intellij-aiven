...
public class UserAuthenticationMethodDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserAuthenticationMethodDeleteResponseErrors and sets the default values.
     */
    public UserAuthenticationMethodDeleteResponseErrors() {
    ...
    public static UserAuthenticationMethodDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAuthenticationMethodDeleteResponseErrors();
    }
    /**
