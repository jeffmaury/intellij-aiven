...
public class BillingGroupUpdateResponseBillingGroupCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupUpdateResponseBillingGroupCardInfo and sets the default values.
     */
    public BillingGroupUpdateResponseBillingGroupCardInfo() {
    ...
    public static BillingGroupUpdateResponseBillingGroupCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupUpdateResponseBillingGroupCardInfo();
    }
    /**
