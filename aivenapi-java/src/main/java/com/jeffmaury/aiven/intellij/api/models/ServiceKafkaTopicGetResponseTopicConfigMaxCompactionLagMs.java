...
public class ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMs implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMs createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("source", (n) -> { this.setSource(n.getEnumValue(ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSource::forValue)); });
     ...
     * @return a java.util.List<ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSynonyms>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setSource(@jakarta.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSource value) {
        this.source = value;
    }
    /**
     ...
     */
    public void setSynonyms(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSynonyms> value) {
        this.synonyms = value;
    }
    /**
