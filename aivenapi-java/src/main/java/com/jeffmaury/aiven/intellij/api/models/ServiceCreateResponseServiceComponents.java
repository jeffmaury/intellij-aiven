...
public class ServiceCreateResponseServiceComponents implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceComponents createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setKafkaAuthenticationMethod(@javax.annotation.Nullable final ServiceCreateResponseServiceComponentsKafkaAuthenticationMethod value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRoute(@javax.annotation.Nullable final ServiceCreateResponseServiceComponentsRoute value) {
        this.route = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUsage(@javax.annotation.Nullable final ServiceCreateResponseServiceComponentsUsage value) {
        this.usage = value;
    }
}
