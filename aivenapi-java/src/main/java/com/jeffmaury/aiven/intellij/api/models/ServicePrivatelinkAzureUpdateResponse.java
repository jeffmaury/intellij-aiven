...
public class ServicePrivatelinkAzureUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServicePrivatelinkAzureUpdateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServicePrivatelinkAzureUpdateResponseErrors>
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServicePrivatelinkAzureUpdateResponseState::forValue)); });
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServicePrivatelinkAzureUpdateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServicePrivatelinkAzureUpdateResponseState value) {
        this.state = value;
    }
    /**
