...
public class AccessTokenCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccessTokenCreateResponseErrors and sets the default values.
     */
    public AccessTokenCreateResponseErrors() {
    ...
    public static AccessTokenCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccessTokenCreateResponseErrors();
    }
    /**
