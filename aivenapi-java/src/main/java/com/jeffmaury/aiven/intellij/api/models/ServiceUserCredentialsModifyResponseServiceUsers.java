...
public class ServiceUserCredentialsModifyResponseServiceUsers implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceUserCredentialsModifyResponseServiceUsersAccessControl accessControl;
    /**
     ...
     */
    private ServiceUserCredentialsModifyResponseServiceUsersAuthentication authentication;
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsModifyResponseServiceUsers and sets the default values.
     */
    public ServiceUserCredentialsModifyResponseServiceUsers() {
    ...
    public static ServiceUserCredentialsModifyResponseServiceUsers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsModifyResponseServiceUsers();
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsModifyResponseServiceUsersAccessControl getAccessControl() {
     ...
     * @return a ServiceUserCredentialsModifyResponseServiceUsersAuthentication
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsModifyResponseServiceUsersAuthentication getAuthentication() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_control", (n) -> { this.setAccessControl(n.getObjectValue(ServiceUserCredentialsModifyResponseServiceUsersAccessControl::createFromDiscriminatorValue)); });
        deserializerMap.put("access_key", (n) -> { this.setAccessKey(n.getStringValue()); });
        deserializerMap.put("authentication", (n) -> { this.setAuthentication(n.getEnumValue(ServiceUserCredentialsModifyResponseServiceUsersAuthentication::forValue)); });
     ...
     */
    public void setAccessControl(@jakarta.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceUsersAccessControl value) {
     ...
     */
    public void setAuthentication(@jakarta.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceUsersAuthentication value) {
