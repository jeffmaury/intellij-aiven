...
public class ServiceUserCredentialsModifyResponseServiceUsers implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceUsers createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessControl(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceUsersAccessControl value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthentication(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceUsersAuthentication value) {
