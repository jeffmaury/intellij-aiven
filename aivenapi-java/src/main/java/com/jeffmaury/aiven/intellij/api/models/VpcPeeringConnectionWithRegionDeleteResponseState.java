...
public enum VpcPeeringConnectionWithRegionDeleteResponseState implements ValuedEnum {
    ACTIVE("ACTIVE"),
    APPROVED("APPROVED"),
    ...
    VpcPeeringConnectionWithRegionDeleteResponseState(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcPeeringConnectionWithRegionDeleteResponseState forValue(@jakarta.annotation.Nonnull final String searchValue) {
