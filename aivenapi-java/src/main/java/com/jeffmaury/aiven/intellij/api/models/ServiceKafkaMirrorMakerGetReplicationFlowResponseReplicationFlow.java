...
public class ServiceKafkaMirrorMakerGetReplicationFlowResponseReplicationFlow implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowResponseReplicationFlow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("offset_syncs_topic_location", (n) -> { this.setOffsetSyncsTopicLocation(n.getEnumValue(ServiceKafkaMirrorMakerGetReplicationFlowResponseReplicationFlowOffsetSyncsTopicLocation::forValue)); });
        deserializerMap.put("replication_policy_class", (n) -> { this.setReplicationPolicyClass(n.getEnumValue(ServiceKafkaMirrorMakerGetReplicationFlowResponseReplicationFlowReplicationPolicyClass::forValue)); });
     ...
     */
    public void setOffsetSyncsTopicLocation(@jakarta.annotation.Nullable final ServiceKafkaMirrorMakerGetReplicationFlowResponseReplicationFlowOffsetSyncsTopicLocation value) {
     ...
     */
    public void setReplicationPolicyClass(@jakarta.annotation.Nullable final ServiceKafkaMirrorMakerGetReplicationFlowResponseReplicationFlowReplicationPolicyClass value) {
