...
public class UserAccountInvitesAcceptResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserAccountInvitesAcceptResponseErrors and sets the default values.
     */
    public UserAccountInvitesAcceptResponseErrors() {
    ...
    public static UserAccountInvitesAcceptResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAccountInvitesAcceptResponseErrors();
    }
    /**
