...
public class ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfigRecoveryMode recoveryMode;
    /**
     * Instantiates a new ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig and sets the default values.
     */
    public ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig() {
    ...
    public static ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("recovery_mode", (n) -> { this.setRecoveryMode(n.getEnumValue(ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfigRecoveryMode::forValue)); });
     ...
     * @return a ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfigRecoveryMode
     */
    @jakarta.annotation.Nullable
    public ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfigRecoveryMode getRecoveryMode() {
     ...
     */
    public void setRecoveryMode(@jakarta.annotation.Nullable final ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfigRecoveryMode value) {
