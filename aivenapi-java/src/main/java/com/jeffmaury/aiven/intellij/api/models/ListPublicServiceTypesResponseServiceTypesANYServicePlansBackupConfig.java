...
public class ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig implements AdditionalDataHolder, Parsable {
    ...
    public static ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfig createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRecoveryMode(@javax.annotation.Nullable final ListPublicServiceTypesResponseServiceTypesANYServicePlansBackupConfigRecoveryMode value) {
