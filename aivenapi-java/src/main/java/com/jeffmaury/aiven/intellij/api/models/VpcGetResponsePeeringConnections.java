...
public class VpcGetResponsePeeringConnections implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private VpcGetResponsePeeringConnectionsState state;
    /**
     * State-specific help or error information
     */
    private VpcGetResponsePeeringConnectionsStateInfo stateInfo;
    /**
     ...
     */
    private VpcGetResponsePeeringConnectionsVpcPeeringConnectionType vpcPeeringConnectionType;
    /**
     * Instantiates a new VpcGetResponsePeeringConnections and sets the default values.
     */
    public VpcGetResponsePeeringConnections() {
    ...
    public static VpcGetResponsePeeringConnections createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcGetResponsePeeringConnections();
    }
    /**
     ...
     * @return a VpcGetResponsePeeringConnectionsState
     */
    @jakarta.annotation.Nullable
    public VpcGetResponsePeeringConnectionsState getState() {
        return this.state;
    }
    /**
     * Gets the state_info property value. State-specific help or error information
     * @return a VpcGetResponsePeeringConnectionsStateInfo
     */
    @jakarta.annotation.Nullable
    public VpcGetResponsePeeringConnectionsStateInfo getStateInfo() {
     ...
     * @return a VpcGetResponsePeeringConnectionsVpcPeeringConnectionType
     */
    @jakarta.annotation.Nullable
    public VpcGetResponsePeeringConnectionsVpcPeeringConnectionType getVpcPeeringConnectionType() {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final VpcGetResponsePeeringConnectionsState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setStateInfo(@jakarta.annotation.Nullable final VpcGetResponsePeeringConnectionsStateInfo value) {
     ...
     */
    public void setVpcPeeringConnectionType(@jakarta.annotation.Nullable final VpcGetResponsePeeringConnectionsVpcPeeringConnectionType value) {
