...
public class VpcGetResponsePeeringConnections implements AdditionalDataHolder, Parsable {
    ...
    public static VpcGetResponsePeeringConnections createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final VpcGetResponsePeeringConnectionsState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStateInfo(@javax.annotation.Nullable final VpcGetResponsePeeringConnectionsStateInfo value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setVpcPeeringConnectionType(@javax.annotation.Nullable final VpcGetResponsePeeringConnectionsVpcPeeringConnectionType value) {
