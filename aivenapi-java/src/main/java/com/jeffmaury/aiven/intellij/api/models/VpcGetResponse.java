...
public class VpcGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static VpcGetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a VpcGetResponsePeeringConnections
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<VpcGetResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPeeringConnections(@javax.annotation.Nullable final java.util.List<VpcGetResponsePeeringConnections> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final VpcGetResponseState value) {
        this.state = value;
    }
    /**
