...
public class VpcGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<VpcGetResponseErrors> errors;
    /**
     ...
     */
    private java.util.List<VpcGetResponsePeeringConnections> peeringConnections;
    /**
     ...
     * Project VPC state
     */
    private VpcGetResponseState state;
    /**
     * Timestamp of last change to VPC
     */
    private String updateTime;
    /**
     * Instantiates a new VpcGetResponse and sets the default values.
     */
    public VpcGetResponse() {
    ...
    public static VpcGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcGetResponse();
    }
    /**
     ...
     * @return a java.util.List<VpcGetResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<VpcGetResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(VpcGetResponseErrors::createFromDiscriminatorValue)); });
        deserializerMap.put("message", (n) -> { this.setMessage(n.getStringValue()); });
        deserializerMap.put("network_cidr", (n) -> { this.setNetworkCidr(n.getStringValue()); });
        deserializerMap.put("peering_connections", (n) -> { this.setPeeringConnections(n.getCollectionOfObjectValues(VpcGetResponsePeeringConnections::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(VpcGetResponseState::forValue)); });
     ...
     * @return a java.util.List<VpcGetResponsePeeringConnections>
     */
    @jakarta.annotation.Nullable
    public java.util.List<VpcGetResponsePeeringConnections> getPeeringConnections() {
     ...
     * @return a VpcGetResponseState
     */
    @jakarta.annotation.Nullable
    public VpcGetResponseState getState() {
        return this.state;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<VpcGetResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setPeeringConnections(@jakarta.annotation.Nullable final java.util.List<VpcGetResponsePeeringConnections> value) {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final VpcGetResponseState value) {
        this.state = value;
    }
    /**
