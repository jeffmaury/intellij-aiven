...
public class ServiceUpdateResponseServiceUsers implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceUpdateResponseServiceUsersAccessControl accessControl;
    /**
     ...
     */
    private ServiceUpdateResponseServiceUsersAuthentication authentication;
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseServiceUsers and sets the default values.
     */
    public ServiceUpdateResponseServiceUsers() {
    ...
    public static ServiceUpdateResponseServiceUsers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseServiceUsers();
    }
    /**
     ...
     * @return a ServiceUpdateResponseServiceUsersAccessControl
     */
    @jakarta.annotation.Nullable
    public ServiceUpdateResponseServiceUsersAccessControl getAccessControl() {
     ...
     * @return a ServiceUpdateResponseServiceUsersAuthentication
     */
    @jakarta.annotation.Nullable
    public ServiceUpdateResponseServiceUsersAuthentication getAuthentication() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_control", (n) -> { this.setAccessControl(n.getObjectValue(ServiceUpdateResponseServiceUsersAccessControl::createFromDiscriminatorValue)); });
        deserializerMap.put("access_key", (n) -> { this.setAccessKey(n.getStringValue()); });
        deserializerMap.put("authentication", (n) -> { this.setAuthentication(n.getEnumValue(ServiceUpdateResponseServiceUsersAuthentication::forValue)); });
     ...
     */
    public void setAccessControl(@jakarta.annotation.Nullable final ServiceUpdateResponseServiceUsersAccessControl value) {
     ...
     */
    public void setAuthentication(@jakarta.annotation.Nullable final ServiceUpdateResponseServiceUsersAuthentication value) {
