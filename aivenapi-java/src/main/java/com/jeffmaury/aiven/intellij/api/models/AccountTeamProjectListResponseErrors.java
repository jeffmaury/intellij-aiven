...
public class AccountTeamProjectListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamProjectListResponseErrors and sets the default values.
     */
    public AccountTeamProjectListResponseErrors() {
    ...
    public static AccountTeamProjectListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamProjectListResponseErrors();
    }
    /**
