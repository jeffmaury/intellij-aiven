...
public class ServiceKafkaConnectCreateConnectorResponseConnectorPlugin implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectCreateConnectorResponseConnectorPlugin createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(ServiceKafkaConnectCreateConnectorResponseConnectorPluginType::forValue)); });
     ...
     */
    public void setType(@jakarta.annotation.Nullable final ServiceKafkaConnectCreateConnectorResponseConnectorPluginType value) {
        this.type = value;
    }
    /**
