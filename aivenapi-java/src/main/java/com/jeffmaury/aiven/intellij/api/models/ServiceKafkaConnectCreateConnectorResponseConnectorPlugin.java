 ...
 */
public class ServiceKafkaConnectCreateConnectorResponseConnectorPlugin implements AdditionalDataHolder, Parsable {
    ...
    private ServiceKafkaConnectCreateConnectorResponseConnectorPluginType type;
    /** Connector version number */
    private String version;
    /**
     * Instantiates a new ServiceKafkaConnectCreateConnectorResponseConnectorPlugin and sets the default values.
     * @return a void
     */
    @javax.annotation.Nullable
    public ServiceKafkaConnectCreateConnectorResponseConnectorPlugin() {
    ...
    public static ServiceKafkaConnectCreateConnectorResponseConnectorPlugin createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectCreateConnectorResponseConnectorPlugin();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(ServiceKafkaConnectCreateConnectorResponseConnectorPluginType.class)); });
     ...
     * @return a ServiceKafkaConnectCreateConnectorResponseConnectorPluginType
     */
    @javax.annotation.Nullable
    public ServiceKafkaConnectCreateConnectorResponseConnectorPluginType getType() {
        return this.type;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setDocURL(@javax.annotation.Nullable final String value) {
        this.docURL = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPreview(@javax.annotation.Nullable final Boolean value) {
        this.preview = value;
    }
    /**
     * Sets the preview_info property value. Information about beta stage of connector
     * @param value Value to set for the previewInfo property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setPreviewInfo(@javax.annotation.Nullable final String value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final ServiceKafkaConnectCreateConnectorResponseConnectorPluginType value) {
        this.type = value;
    }
    /**
