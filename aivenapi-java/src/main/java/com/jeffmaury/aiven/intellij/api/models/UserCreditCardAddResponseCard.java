...
public class UserCreditCardAddResponseCard implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserCreditCardAddResponseCard and sets the default values.
     */
    public UserCreditCardAddResponseCard() {
    ...
    public static UserCreditCardAddResponseCard createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserCreditCardAddResponseCard();
    }
    /**
