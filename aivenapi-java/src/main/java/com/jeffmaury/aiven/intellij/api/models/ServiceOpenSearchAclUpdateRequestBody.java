...
public class ServiceOpenSearchAclUpdateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchAclUpdateRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setOpensearchAclConfig(@jakarta.annotation.Nullable final ServiceOpenSearchAclUpdateRequestBodyOpensearchAclConfig value) {
