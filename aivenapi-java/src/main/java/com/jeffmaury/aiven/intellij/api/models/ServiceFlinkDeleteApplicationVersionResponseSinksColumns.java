...
public class ServiceFlinkDeleteApplicationVersionResponseSinksColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationVersionResponseSinksColumns and sets the default values.
     */
    public ServiceFlinkDeleteApplicationVersionResponseSinksColumns() {
    ...
    public static ServiceFlinkDeleteApplicationVersionResponseSinksColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationVersionResponseSinksColumns();
    }
    /**
