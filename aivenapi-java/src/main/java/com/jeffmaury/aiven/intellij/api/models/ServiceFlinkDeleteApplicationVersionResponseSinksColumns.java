...
public class ServiceFlinkDeleteApplicationVersionResponseSinksColumns implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationVersionResponseSinksColumns createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
