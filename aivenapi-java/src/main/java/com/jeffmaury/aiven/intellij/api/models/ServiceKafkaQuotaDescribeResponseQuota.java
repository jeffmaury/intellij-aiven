...
public class ServiceKafkaQuotaDescribeResponseQuota implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String user;
    /**
     * Instantiates a new ServiceKafkaQuotaDescribeResponseQuota and sets the default values.
     */
    public ServiceKafkaQuotaDescribeResponseQuota() {
    ...
    public static ServiceKafkaQuotaDescribeResponseQuota createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaQuotaDescribeResponseQuota();
    }
    /**
