...
public class ServiceUpdateResponseServiceBackups implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceUpdateResponseServiceBackupsAdditionalRegions> additionalRegions;
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseServiceBackups and sets the default values.
     */
    public ServiceUpdateResponseServiceBackups() {
    ...
    public static ServiceUpdateResponseServiceBackups createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseServiceBackups();
    }
    /**
     ...
     * @return a java.util.List<ServiceUpdateResponseServiceBackupsAdditionalRegions>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceUpdateResponseServiceBackupsAdditionalRegions> getAdditionalRegions() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("additional_regions", (n) -> { this.setAdditionalRegions(n.getCollectionOfObjectValues(ServiceUpdateResponseServiceBackupsAdditionalRegions::createFromDiscriminatorValue)); });
     ...
     */
    public void setAdditionalRegions(@jakarta.annotation.Nullable final java.util.List<ServiceUpdateResponseServiceBackupsAdditionalRegions> value) {
