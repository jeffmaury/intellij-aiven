...
public class ProjectListResponseProjectMembership implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectListResponseProjectMembership createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setANY(@jakarta.annotation.Nullable final ProjectListResponseProjectMembershipANY value) {
        this.aNY = value;
    }
}
