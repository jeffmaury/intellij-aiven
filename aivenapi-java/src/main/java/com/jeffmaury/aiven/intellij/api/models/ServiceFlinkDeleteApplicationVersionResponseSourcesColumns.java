...
public class ServiceFlinkDeleteApplicationVersionResponseSourcesColumns implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationVersionResponseSourcesColumns createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
