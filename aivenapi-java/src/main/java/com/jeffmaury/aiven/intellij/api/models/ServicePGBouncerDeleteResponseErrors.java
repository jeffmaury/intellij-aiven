...
public class ServicePGBouncerDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePGBouncerDeleteResponseErrors and sets the default values.
     */
    public ServicePGBouncerDeleteResponseErrors() {
    ...
    public static ServicePGBouncerDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePGBouncerDeleteResponseErrors();
    }
    /**
