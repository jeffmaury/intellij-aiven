...
public enum ServiceUserCredentialsModifyResponseServiceComponentsKafkaAuthenticationMethod implements ValuedEnum {
    ...
    public static ServiceUserCredentialsModifyResponseServiceComponentsKafkaAuthenticationMethod forValue(@jakarta.annotation.Nonnull final String searchValue) {
