...
public class ServiceKafkaTopicMessageListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicMessageListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicMessageListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setMessages(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicMessageListResponseMessages> value) {
        this.messages = value;
    }
}
