...
public enum VpcPeeringConnectionCreateResponseVpcPeeringConnectionType implements ValuedEnum {
    ...
    VpcPeeringConnectionCreateResponseVpcPeeringConnectionType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static VpcPeeringConnectionCreateResponseVpcPeeringConnectionType forValue(@jakarta.annotation.Nonnull final String searchValue) {
