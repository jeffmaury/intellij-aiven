...
public class AccountAuthenticationMethodUpdateRequestBodySamlFieldMapping implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountAuthenticationMethodUpdateRequestBodySamlFieldMapping and sets the default values.
     */
    public AccountAuthenticationMethodUpdateRequestBodySamlFieldMapping() {
    ...
    public static AccountAuthenticationMethodUpdateRequestBodySamlFieldMapping createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAuthenticationMethodUpdateRequestBodySamlFieldMapping();
    }
    /**
