...
public enum ServiceKafkaMirrorMakerPatchReplicationFlowRequestBodyReplicationPolicyClass implements ValuedEnum {
    ...
    ServiceKafkaMirrorMakerPatchReplicationFlowRequestBodyReplicationPolicyClass(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaMirrorMakerPatchReplicationFlowRequestBodyReplicationPolicyClass forValue(@jakarta.annotation.Nonnull final String searchValue) {
