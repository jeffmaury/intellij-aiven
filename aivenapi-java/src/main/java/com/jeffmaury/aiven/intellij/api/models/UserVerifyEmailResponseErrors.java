...
public class UserVerifyEmailResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserVerifyEmailResponseErrors and sets the default values.
     */
    public UserVerifyEmailResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a UserVerifyEmailResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static UserVerifyEmailResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserVerifyEmailResponseErrors();
    }
    /**
