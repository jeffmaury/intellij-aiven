...
public class ServiceMaintenanceStartResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceMaintenanceStartResponseErrors and sets the default values.
     */
    public ServiceMaintenanceStartResponseErrors() {
    ...
    public static ServiceMaintenanceStartResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceMaintenanceStartResponseErrors();
    }
    /**
