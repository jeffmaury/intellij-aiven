...
public class ListPublicServiceTypesResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ListPublicServiceTypesResponseErrors and sets the default values.
     */
    public ListPublicServiceTypesResponseErrors() {
    ...
    public static ListPublicServiceTypesResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ListPublicServiceTypesResponseErrors();
    }
    /**
