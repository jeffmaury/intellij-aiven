...
public class VpcPeeringConnectionCreateResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<VpcPeeringConnectionCreateResponseErrors> errors;
    /**
     ...
     */
    private VpcPeeringConnectionCreateResponseState state;
    /**
     * State-specific help or error information
     */
    private VpcPeeringConnectionCreateResponseStateInfo stateInfo;
    /**
     ...
     */
    private VpcPeeringConnectionCreateResponseVpcPeeringConnectionType vpcPeeringConnectionType;
    /**
     * Instantiates a new VpcPeeringConnectionCreateResponse and sets the default values.
     */
    public VpcPeeringConnectionCreateResponse() {
    ...
    public static VpcPeeringConnectionCreateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionCreateResponse();
    }
    /**
     ...
     * @return a java.util.List<VpcPeeringConnectionCreateResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<VpcPeeringConnectionCreateResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(VpcPeeringConnectionCreateResponseErrors::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(VpcPeeringConnectionCreateResponseState::forValue)); });
        deserializerMap.put("state_info", (n) -> { this.setStateInfo(n.getObjectValue(VpcPeeringConnectionCreateResponseStateInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("vpc_peering_connection_type", (n) -> { this.setVpcPeeringConnectionType(n.getEnumValue(VpcPeeringConnectionCreateResponseVpcPeeringConnectionType::forValue)); });
     ...
     * @return a VpcPeeringConnectionCreateResponseState
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionCreateResponseState getState() {
        return this.state;
    }
    /**
     * Gets the state_info property value. State-specific help or error information
     * @return a VpcPeeringConnectionCreateResponseStateInfo
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionCreateResponseStateInfo getStateInfo() {
     ...
     * @return a VpcPeeringConnectionCreateResponseVpcPeeringConnectionType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionCreateResponseVpcPeeringConnectionType getVpcPeeringConnectionType() {
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<VpcPeeringConnectionCreateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final VpcPeeringConnectionCreateResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setStateInfo(@jakarta.annotation.Nullable final VpcPeeringConnectionCreateResponseStateInfo value) {
     ...
     */
    public void setVpcPeeringConnectionType(@jakarta.annotation.Nullable final VpcPeeringConnectionCreateResponseVpcPeeringConnectionType value) {
