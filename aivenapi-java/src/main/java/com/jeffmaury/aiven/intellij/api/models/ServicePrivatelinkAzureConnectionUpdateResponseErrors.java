...
public class ServicePrivatelinkAzureConnectionUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAzureConnectionUpdateResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAzureConnectionUpdateResponseErrors() {
    ...
    public static ServicePrivatelinkAzureConnectionUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureConnectionUpdateResponseErrors();
    }
    /**
