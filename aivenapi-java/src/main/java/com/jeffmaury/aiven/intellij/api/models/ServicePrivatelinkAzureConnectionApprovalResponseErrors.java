...
public class ServicePrivatelinkAzureConnectionApprovalResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAzureConnectionApprovalResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAzureConnectionApprovalResponseErrors() {
    ...
    public static ServicePrivatelinkAzureConnectionApprovalResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureConnectionApprovalResponseErrors();
    }
    /**
