...
public class ServiceQueryActivityResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceQueryActivityResponseErrors and sets the default values.
     */
    public ServiceQueryActivityResponseErrors() {
    ...
    public static ServiceQueryActivityResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceQueryActivityResponseErrors();
    }
    /**
