...
public class ServiceKafkaTopicListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTopicListResponseErrors and sets the default values.
     */
    public ServiceKafkaTopicListResponseErrors() {
    ...
    public static ServiceKafkaTopicListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTopicListResponseErrors();
    }
    /**
