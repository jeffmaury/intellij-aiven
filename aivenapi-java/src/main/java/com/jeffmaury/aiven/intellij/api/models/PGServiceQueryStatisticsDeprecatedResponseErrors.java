...
public class PGServiceQueryStatisticsDeprecatedResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PGServiceQueryStatisticsDeprecatedResponseErrors and sets the default values.
     */
    public PGServiceQueryStatisticsDeprecatedResponseErrors() {
    ...
    public static PGServiceQueryStatisticsDeprecatedResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PGServiceQueryStatisticsDeprecatedResponseErrors();
    }
    /**
