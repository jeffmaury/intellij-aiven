...
public class AccessTokenUpdateResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<AccessTokenUpdateResponseErrors> errors;
    /**
    ...
    /**
     * Instantiates a new AccessTokenUpdateResponse and sets the default values.
     */
    public AccessTokenUpdateResponse() {
    ...
    public static AccessTokenUpdateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccessTokenUpdateResponse();
    }
    /**
     ...
     * @return a java.util.List<AccessTokenUpdateResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<AccessTokenUpdateResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(AccessTokenUpdateResponseErrors::createFromDiscriminatorValue)); });
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<AccessTokenUpdateResponseErrors> value) {
        this.errors = value;
    }
    /**
