...
public class AccessTokenUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccessTokenUpdateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a AccessTokenUpdateResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<AccessTokenUpdateResponseErrors> value) {
        this.errors = value;
    }
    /**
