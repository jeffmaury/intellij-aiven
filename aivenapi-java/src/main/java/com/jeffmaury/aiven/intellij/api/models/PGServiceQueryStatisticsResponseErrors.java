...
public class PGServiceQueryStatisticsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PGServiceQueryStatisticsResponseErrors and sets the default values.
     */
    public PGServiceQueryStatisticsResponseErrors() {
    ...
    public static PGServiceQueryStatisticsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PGServiceQueryStatisticsResponseErrors();
    }
    /**
