...
public class ServiceSchemaRegistrySubjectVersionPostResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectVersionPostResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectVersionPostResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectVersionPostResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectVersionPostResponseErrors();
    }
    /**
