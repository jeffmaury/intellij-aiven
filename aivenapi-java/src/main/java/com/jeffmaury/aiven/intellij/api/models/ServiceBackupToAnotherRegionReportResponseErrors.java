...
public class ServiceBackupToAnotherRegionReportResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceBackupToAnotherRegionReportResponseErrors and sets the default values.
     */
    public ServiceBackupToAnotherRegionReportResponseErrors() {
    ...
    public static ServiceBackupToAnotherRegionReportResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceBackupToAnotherRegionReportResponseErrors();
    }
    /**
