...
public class AccessTokenCreateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccessTokenCreateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<AccessTokenCreateResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<AccessTokenCreateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     * @param value Value to set for the full_token property.
     */
    public void setFullToken(@jakarta.annotation.Nullable final String value) {
