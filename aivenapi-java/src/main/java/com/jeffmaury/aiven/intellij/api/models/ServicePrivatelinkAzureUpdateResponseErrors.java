...
public class ServicePrivatelinkAzureUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAzureUpdateResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAzureUpdateResponseErrors() {
    ...
    public static ServicePrivatelinkAzureUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureUpdateResponseErrors();
    }
    /**
