...
public class ServiceKmsGetKeypairResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKmsGetKeypairResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKmsGetKeypairResponseErrors> value) {
        this.errors = value;
    }
    /**
