...
public class ServiceUpdateResponseServiceServiceNotifications implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateResponseServiceServiceNotifications createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("level", (n) -> { this.setLevel(n.getEnumValue(ServiceUpdateResponseServiceServiceNotificationsLevel::forValue)); });
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(ServiceUpdateResponseServiceServiceNotificationsType::forValue)); });
     ...
     */
    public void setLevel(@jakarta.annotation.Nullable final ServiceUpdateResponseServiceServiceNotificationsLevel value) {
        this.level = value;
    }
    /**
     ...
     */
    public void setMetadata(@jakarta.annotation.Nullable final ServiceUpdateResponseServiceServiceNotificationsMetadata value) {
        this.metadata = value;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final ServiceUpdateResponseServiceServiceNotificationsType value) {
        this.type = value;
    }
}
