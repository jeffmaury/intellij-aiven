...
public class ListProjectCloudsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ListProjectCloudsResponseErrors and sets the default values.
     */
    public ListProjectCloudsResponseErrors() {
    ...
    public static ListProjectCloudsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ListProjectCloudsResponseErrors();
    }
    /**
