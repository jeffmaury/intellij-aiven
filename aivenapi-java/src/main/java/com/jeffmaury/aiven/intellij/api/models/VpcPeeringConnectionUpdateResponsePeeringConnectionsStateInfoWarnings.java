...
public class VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Type of warning
     */
    private VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarningsType type;
    /**
     * Instantiates a new VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings and sets the default values.
     */
    public VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings() {
    ...
    public static VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarningsType::forValue)); });
     ...
     * @return a VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarningsType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarningsType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarningsType value) {
        this.type = value;
    }
}
