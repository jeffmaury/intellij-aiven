...
public class ServiceCreateResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    /**
     ...
     * PGBouncer pool mode
     */
    private ServiceCreateResponseServiceConnectionPoolsPoolMode poolMode;
    /**
    ...
    /**
     * Instantiates a new ServiceCreateResponseServiceConnectionPools and sets the default values.
     */
    public ServiceCreateResponseServiceConnectionPools() {
    ...
    public static ServiceCreateResponseServiceConnectionPools createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceConnectionPools();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("pool_mode", (n) -> { this.setPoolMode(n.getEnumValue(ServiceCreateResponseServiceConnectionPoolsPoolMode::forValue)); });
     ...
     * @return a ServiceCreateResponseServiceConnectionPoolsPoolMode
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceConnectionPoolsPoolMode getPoolMode() {
     ...
     */
    public void setPoolMode(@jakarta.annotation.Nullable final ServiceCreateResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
