...
public enum ServiceKafkaTopicGetResponseTopicConfigMinInsyncReplicasSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMinInsyncReplicasSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMinInsyncReplicasSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
