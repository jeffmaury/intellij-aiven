...
public class ServiceOpenSearchSecuritySetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchSecuritySetResponseErrors and sets the default values.
     */
    public ServiceOpenSearchSecuritySetResponseErrors() {
    ...
    public static ServiceOpenSearchSecuritySetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchSecuritySetResponseErrors();
    }
    /**
