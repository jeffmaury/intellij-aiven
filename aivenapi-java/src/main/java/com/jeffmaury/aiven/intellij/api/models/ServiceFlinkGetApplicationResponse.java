...
public class ServiceFlinkGetApplicationResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkGetApplicationResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkGetApplicationResponseApplicationVersions
     */
    @javax.annotation.Nullable
     ...
     * @return a ServiceFlinkGetApplicationResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setApplicationVersions(@javax.annotation.Nullable final java.util.List<ServiceFlinkGetApplicationResponseApplicationVersions> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCurrentDeployment(@javax.annotation.Nullable final ServiceFlinkGetApplicationResponseCurrentDeployment value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkGetApplicationResponseErrors> value) {
        this.errors = value;
    }
    /**
