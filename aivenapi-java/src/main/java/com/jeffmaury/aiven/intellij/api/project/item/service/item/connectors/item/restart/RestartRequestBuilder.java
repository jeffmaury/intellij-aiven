...
public class RestartRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceKafkaConnectRestartConnectorResponse post() {
        return post(null);
    }
    /**
     * Restart a Kafka Connect Connector
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceKafkaConnectRestartConnectorResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceKafkaConnectRestartConnectorResponse::createFromDiscriminatorValue);
    }
    /**
     * Restart a Kafka Connect Connector
