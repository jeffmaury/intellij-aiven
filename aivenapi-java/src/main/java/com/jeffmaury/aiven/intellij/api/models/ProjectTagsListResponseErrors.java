...
public class ProjectTagsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTagsListResponseErrors and sets the default values.
     */
    public ProjectTagsListResponseErrors() {
    ...
    public static ProjectTagsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTagsListResponseErrors();
    }
    /**
