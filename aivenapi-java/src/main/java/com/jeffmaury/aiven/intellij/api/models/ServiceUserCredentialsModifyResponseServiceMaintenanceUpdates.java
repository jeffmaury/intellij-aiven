...
public class ServiceUserCredentialsModifyResponseServiceMaintenanceUpdates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceMaintenanceUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
