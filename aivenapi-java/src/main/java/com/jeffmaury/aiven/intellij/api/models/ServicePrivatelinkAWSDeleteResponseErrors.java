...
public class ServicePrivatelinkAWSDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAWSDeleteResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAWSDeleteResponseErrors() {
    ...
    public static ServicePrivatelinkAWSDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAWSDeleteResponseErrors();
    }
    /**
