...
public class ServiceIntegrationCreateResponseServiceIntegration implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Integration status
     */
    private ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatus integrationStatus;
    /**
     ...
     */
    private ServiceIntegrationCreateResponseServiceIntegrationUserConfig userConfig;
    /**
     * Instantiates a new ServiceIntegrationCreateResponseServiceIntegration and sets the default values.
     */
    public ServiceIntegrationCreateResponseServiceIntegration() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceIntegrationCreateResponseServiceIntegration
     */
    @jakarta.annotation.Nonnull
    public static ServiceIntegrationCreateResponseServiceIntegration createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationCreateResponseServiceIntegration();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_status", (n) -> { this.setIntegrationStatus(n.getObjectValue(ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatus::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("user_config", (n) -> { this.setUserConfig(n.getObjectValue(ServiceIntegrationCreateResponseServiceIntegrationUserConfig::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the integration_status property value. Integration status
     * @return a ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatus
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatus getIntegrationStatus() {
     ...
     * @return a ServiceIntegrationCreateResponseServiceIntegrationUserConfig
     */
    @jakarta.annotation.Nullable
    public ServiceIntegrationCreateResponseServiceIntegrationUserConfig getUserConfig() {
     ...
     */
    public void setIntegrationStatus(@jakarta.annotation.Nullable final ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatus value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceIntegrationCreateResponseServiceIntegrationUserConfig value) {
