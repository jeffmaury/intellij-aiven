...
public class AccountMoveResponseAccount implements AdditionalDataHolder, Parsable {
    /**
     * Describe the source of the account
     */
    private AccountMoveResponseAccountAccessSource accessSource;
    /**
     * Account ID
     */
     ...
     * Feature flags
     */
    private AccountMoveResponseAccountFeatures features;
    /**
    ...
    /**
     * Instantiates a new AccountMoveResponseAccount and sets the default values.
     */
    public AccountMoveResponseAccount() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountMoveResponseAccount
     */
    @jakarta.annotation.Nonnull
    public static AccountMoveResponseAccount createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountMoveResponseAccount();
    }
    /**
     * Gets the access_source property value. Describe the source of the account
     * @return a AccountMoveResponseAccountAccessSource
     */
    @jakarta.annotation.Nullable
    public AccountMoveResponseAccountAccessSource getAccessSource() {
     ...
     * @return a AccountMoveResponseAccountFeatures
     */
    @jakarta.annotation.Nullable
    public AccountMoveResponseAccountFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_source", (n) -> { this.setAccessSource(n.getEnumValue(AccountMoveResponseAccountAccessSource::forValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(AccountMoveResponseAccountFeatures::createFromDiscriminatorValue)); });
     ...
     */
    public void setAccessSource(@jakarta.annotation.Nullable final AccountMoveResponseAccountAccessSource value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final AccountMoveResponseAccountFeatures value) {
        this.features = value;
    }
    /**
