...
public class AccountMoveResponseAccount implements AdditionalDataHolder, Parsable {
    ...
    public static AccountMoveResponseAccount createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessSource(@javax.annotation.Nullable final AccountMoveResponseAccountAccessSource value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setFeatures(@javax.annotation.Nullable final AccountMoveResponseAccountFeatures value) {
        this.features = value;
    }
    /**
