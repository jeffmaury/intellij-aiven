...
public class BillingGroupInvoiceListResponseInvoices implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupInvoiceListResponseInvoices createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_group_state", (n) -> { this.setBillingGroupState(n.getEnumValue(BillingGroupInvoiceListResponseInvoicesBillingGroupState::forValue)); });
        deserializerMap.put("currency", (n) -> { this.setCurrency(n.getEnumValue(BillingGroupInvoiceListResponseInvoicesCurrency::forValue)); });
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(BillingGroupInvoiceListResponseInvoicesState::forValue)); });
     ...
     */
    public void setBillingGroupState(@jakarta.annotation.Nullable final BillingGroupInvoiceListResponseInvoicesBillingGroupState value) {
     ...
     */
    public void setCurrency(@jakarta.annotation.Nullable final BillingGroupInvoiceListResponseInvoicesCurrency value) {
        this.currency = value;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final BillingGroupInvoiceListResponseInvoicesState value) {
        this.state = value;
    }
    /**
