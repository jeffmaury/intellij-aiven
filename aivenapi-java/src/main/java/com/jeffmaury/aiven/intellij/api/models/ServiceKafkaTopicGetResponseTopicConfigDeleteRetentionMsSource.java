...
public enum ServiceKafkaTopicGetResponseTopicConfigDeleteRetentionMsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigDeleteRetentionMsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigDeleteRetentionMsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
