...
public class OrganizationProjectsListResponseProjectsCardInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationProjectsListResponseProjectsCardInfo and sets the default values.
     */
    public OrganizationProjectsListResponseProjectsCardInfo() {
    ...
    public static OrganizationProjectsListResponseProjectsCardInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationProjectsListResponseProjectsCardInfo();
    }
    /**
