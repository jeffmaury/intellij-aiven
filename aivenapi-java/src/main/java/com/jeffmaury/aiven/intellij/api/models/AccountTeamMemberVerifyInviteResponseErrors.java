...
public class AccountTeamMemberVerifyInviteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamMemberVerifyInviteResponseErrors and sets the default values.
     */
    public AccountTeamMemberVerifyInviteResponseErrors() {
    ...
    public static AccountTeamMemberVerifyInviteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamMemberVerifyInviteResponseErrors();
    }
    /**
