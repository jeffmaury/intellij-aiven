...
public class AccountTeamMembersDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamMembersDeleteResponseErrors and sets the default values.
     */
    public AccountTeamMembersDeleteResponseErrors() {
    ...
    public static AccountTeamMembersDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamMembersDeleteResponseErrors();
    }
    /**
