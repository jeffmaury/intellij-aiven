...
public enum ServiceFlinkCancelApplicationDeploymentResponseStatus implements ValuedEnum {
    ...
    ServiceFlinkCancelApplicationDeploymentResponseStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceFlinkCancelApplicationDeploymentResponseStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
