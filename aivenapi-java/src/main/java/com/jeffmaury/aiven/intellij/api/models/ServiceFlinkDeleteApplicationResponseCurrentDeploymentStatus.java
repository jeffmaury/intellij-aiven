...
public enum ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus implements ValuedEnum {
    ...
    ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
