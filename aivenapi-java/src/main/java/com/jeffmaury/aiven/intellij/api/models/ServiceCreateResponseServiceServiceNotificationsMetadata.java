...
public class ServiceCreateResponseServiceServiceNotificationsMetadata implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceCreateResponseServiceServiceNotificationsMetadata and sets the default values.
     */
    public ServiceCreateResponseServiceServiceNotificationsMetadata() {
    ...
    public static ServiceCreateResponseServiceServiceNotificationsMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceServiceNotificationsMetadata();
    }
    /**
