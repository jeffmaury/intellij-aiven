...
public class VpcGetResponsePeeringConnectionsStateInfoWarnings implements AdditionalDataHolder, Parsable {
    ...
    public static VpcGetResponsePeeringConnectionsStateInfoWarnings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final VpcGetResponsePeeringConnectionsStateInfoWarningsType value) {
        this.type = value;
    }
}
