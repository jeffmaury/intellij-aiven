...
public class VpcGetResponsePeeringConnectionsStateInfoWarnings implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Type of warning
     */
    private VpcGetResponsePeeringConnectionsStateInfoWarningsType type;
    /**
     * Instantiates a new VpcGetResponsePeeringConnectionsStateInfoWarnings and sets the default values.
     */
    public VpcGetResponsePeeringConnectionsStateInfoWarnings() {
    ...
    public static VpcGetResponsePeeringConnectionsStateInfoWarnings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcGetResponsePeeringConnectionsStateInfoWarnings();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(VpcGetResponsePeeringConnectionsStateInfoWarningsType::forValue)); });
     ...
     * @return a VpcGetResponsePeeringConnectionsStateInfoWarningsType
     */
    @jakarta.annotation.Nullable
    public VpcGetResponsePeeringConnectionsStateInfoWarningsType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final VpcGetResponsePeeringConnectionsStateInfoWarningsType value) {
        this.type = value;
    }
}
