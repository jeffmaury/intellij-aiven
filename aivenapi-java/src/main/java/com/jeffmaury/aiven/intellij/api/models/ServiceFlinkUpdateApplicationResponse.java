...
public class ServiceFlinkUpdateApplicationResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkUpdateApplicationResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkUpdateApplicationResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setApplicationVersions(@javax.annotation.Nullable final java.util.List<ServiceFlinkUpdateApplicationResponseApplicationVersions> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCurrentDeployment(@javax.annotation.Nullable final ServiceFlinkUpdateApplicationResponseCurrentDeployment value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkUpdateApplicationResponseErrors> value) {
        this.errors = value;
    }
    /**
