...
public class UserauthRequestBuilder extends BaseRequestBuilder {
    ...
    public UserAuthResponse post(@jakarta.annotation.Nonnull final UserAuthRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public UserAuthResponse post(@jakarta.annotation.Nonnull final UserAuthRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, UserAuthResponse::createFromDiscriminatorValue);
    }
    /**
     * <p>Authenticate user and return token for following authorizations</p>
     * @param body UserAuthRequestBody
