...
public class ServiceOpenSearchSecurityResetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchSecurityResetResponseErrors and sets the default values.
     */
    public ServiceOpenSearchSecurityResetResponseErrors() {
    ...
    public static ServiceOpenSearchSecurityResetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchSecurityResetResponseErrors();
    }
    /**
