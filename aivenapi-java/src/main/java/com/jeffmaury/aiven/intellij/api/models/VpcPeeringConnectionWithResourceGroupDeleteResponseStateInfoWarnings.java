...
public class VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Type of warning
     */
    private VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarningsType type;
    /**
     * Instantiates a new VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings and sets the default values.
     */
    public VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings
     */
    @jakarta.annotation.Nonnull
    public static VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarningsType::forValue)); });
     ...
     * @return a VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarningsType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarningsType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarningsType value) {
        this.type = value;
    }
}
