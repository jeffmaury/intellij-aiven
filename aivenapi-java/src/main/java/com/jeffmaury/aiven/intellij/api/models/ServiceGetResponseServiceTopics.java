...
public class ServiceGetResponseServiceTopics implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Topic state
     */
    private ServiceGetResponseServiceTopicsState state;
    /**
     * Topic name
     */
    private String topicName;
    /**
     * Instantiates a new ServiceGetResponseServiceTopics and sets the default values.
     */
    public ServiceGetResponseServiceTopics() {
    ...
    public static ServiceGetResponseServiceTopics createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceTopics();
    }
    /**
     ...
     * @return a ServiceGetResponseServiceTopicsState
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceTopicsState getState() {
        return this.state;
    }
    /**
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceGetResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
