...
public class ServiceGetResponseServiceTopics implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceTopics createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceGetResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
