...
public class ServiceKafkaMirrorMakerCreateReplicationFlowResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaMirrorMakerCreateReplicationFlowResponseErrors and sets the default values.
     */
    public ServiceKafkaMirrorMakerCreateReplicationFlowResponseErrors() {
    ...
    public static ServiceKafkaMirrorMakerCreateReplicationFlowResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaMirrorMakerCreateReplicationFlowResponseErrors();
    }
    /**
