...
public class ServiceKafkaMirrorMakerCreateReplicationFlowResponseErrors implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerCreateReplicationFlowResponseErrors createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
