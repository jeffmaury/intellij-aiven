...
public class ServiceFlinkGetApplicationResponseApplicationVersionsSourcesColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkGetApplicationResponseApplicationVersionsSourcesColumns and sets the default values.
     */
    public ServiceFlinkGetApplicationResponseApplicationVersionsSourcesColumns() {
    ...
    public static ServiceFlinkGetApplicationResponseApplicationVersionsSourcesColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationResponseApplicationVersionsSourcesColumns();
    }
    /**
