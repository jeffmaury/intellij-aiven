...
public class ServiceSchemaRegistryAclListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistryAclListResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistryAclListResponse();
    }
    /**
     * Gets the acl property value. List of Schema Registry ACL entries
     * @return a java.util.List<ServiceSchemaRegistryAclListResponseAcl>
     */
     ...
     * @return a java.util.List<ServiceSchemaRegistryAclListResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setAcl(@jakarta.annotation.Nullable final java.util.List<ServiceSchemaRegistryAclListResponseAcl> value) {
        this.acl = value;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceSchemaRegistryAclListResponseErrors> value) {
        this.errors = value;
    }
    /**
