...
public class PauseRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceKafkaConnectPauseConnectorResponse post() {
        return post(null);
    }
    /**
     * Pause a Kafka Connect Connector
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceKafkaConnectPauseConnectorResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceKafkaConnectPauseConnectorResponse::createFromDiscriminatorValue);
    }
    /**
     * Pause a Kafka Connect Connector
