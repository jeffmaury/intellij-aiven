...
public class ServiceClickHouseDatabaseDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceClickHouseDatabaseDeleteResponseErrors and sets the default values.
     */
    public ServiceClickHouseDatabaseDeleteResponseErrors() {
    ...
    public static ServiceClickHouseDatabaseDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceClickHouseDatabaseDeleteResponseErrors();
    }
    /**
