...
public class VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfo implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setWarnings(@jakarta.annotation.Nullable final java.util.List<VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings> value) {
        this.warnings = value;
    }
}
