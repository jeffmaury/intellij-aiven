...
public class AccountUsersSearchResponseUsers implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new AccountUsersSearchResponseUsers and sets the default values.
     * @return a void
     */
    @javax.annotation.Nullable
    public AccountUsersSearchResponseUsers() {
    ...
    public static AccountUsersSearchResponseUsers createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountUsersSearchResponseUsers();
    }
    /**
