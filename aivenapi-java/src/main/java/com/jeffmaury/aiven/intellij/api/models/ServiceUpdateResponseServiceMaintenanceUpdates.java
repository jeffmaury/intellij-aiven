...
public class ServiceUpdateResponseServiceMaintenanceUpdates implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUpdateResponseServiceMaintenanceUpdates and sets the default values.
     */
    public ServiceUpdateResponseServiceMaintenanceUpdates() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceUpdateResponseServiceMaintenanceUpdates
     */
    @jakarta.annotation.Nonnull
    public static ServiceUpdateResponseServiceMaintenanceUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUpdateResponseServiceMaintenanceUpdates();
    }
    /**
