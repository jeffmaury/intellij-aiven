...
public class JobRequestBuilder extends BaseRequestBuilder {
    ...
    public ServiceFlinkJobsListResponse get() {
        return get(null);
    }
    /**
     * Get all Flink jobs
     ...
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkJobsListResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, ServiceFlinkJobsListResponse::createFromDiscriminatorValue);
    }
    /**
     * Get all Flink jobs
