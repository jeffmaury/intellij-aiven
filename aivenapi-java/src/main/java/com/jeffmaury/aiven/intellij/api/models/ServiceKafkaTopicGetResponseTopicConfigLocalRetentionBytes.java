...
public class ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytes implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytes createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("source", (n) -> { this.setSource(n.getEnumValue(ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSource.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setSource(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSource value) {
        this.source = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSynonyms(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigLocalRetentionBytesSynonyms> value) {
        this.synonyms = value;
    }
    /**
