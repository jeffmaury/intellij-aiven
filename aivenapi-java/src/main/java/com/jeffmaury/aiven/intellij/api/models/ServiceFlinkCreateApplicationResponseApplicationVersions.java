...
public class ServiceFlinkCreateApplicationResponseApplicationVersions implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationResponseApplicationVersions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSinks>
     */
    @jakarta.annotation.Nullable
     ...
     * @return a java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSources>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setSinks(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSinks> value) {
        this.sinks = value;
    }
    /**
     ...
     */
    public void setSources(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSources> value) {
        this.sources = value;
    }
    /**
