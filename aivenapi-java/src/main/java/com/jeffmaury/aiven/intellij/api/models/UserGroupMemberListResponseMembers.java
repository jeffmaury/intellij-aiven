...
public class UserGroupMemberListResponseMembers implements AdditionalDataHolder, Parsable {
    ...
    public static UserGroupMemberListResponseMembers createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserInfo(@javax.annotation.Nullable final UserGroupMemberListResponseMembersUserInfo value) {
        this.userInfo = value;
    }
}
