...
public class ServiceKafkaTieredStorageSummaryResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaTieredStorageSummaryResponseErrors and sets the default values.
     */
    public ServiceKafkaTieredStorageSummaryResponseErrors() {
    ...
    public static ServiceKafkaTieredStorageSummaryResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaTieredStorageSummaryResponseErrors();
    }
    /**
