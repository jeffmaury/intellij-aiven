...
public class ServiceOpenSearchAclSetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchAclSetResponseErrors and sets the default values.
     */
    public ServiceOpenSearchAclSetResponseErrors() {
    ...
    public static ServiceOpenSearchAclSetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchAclSetResponseErrors();
    }
    /**
