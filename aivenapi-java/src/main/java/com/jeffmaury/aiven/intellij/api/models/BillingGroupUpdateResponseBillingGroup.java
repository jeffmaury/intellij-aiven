...
public class BillingGroupUpdateResponseBillingGroup implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupUpdateResponseBillingGroup createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<BillingGroupUpdateResponseBillingGroupBillingEmails>
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_currency", (n) -> { this.setBillingCurrency(n.getEnumValue(BillingGroupUpdateResponseBillingGroupBillingCurrency::forValue)); });
        ...
        deserializerMap.put("payment_method", (n) -> { this.setPaymentMethod(n.getEnumValue(BillingGroupUpdateResponseBillingGroupPaymentMethod::forValue)); });
     ...
     */
    public void setBillingCurrency(@jakarta.annotation.Nullable final BillingGroupUpdateResponseBillingGroupBillingCurrency value) {
     ...
     */
    public void setBillingEmails(@jakarta.annotation.Nullable final java.util.List<BillingGroupUpdateResponseBillingGroupBillingEmails> value) {
     ...
     */
    public void setCardInfo(@jakarta.annotation.Nullable final BillingGroupUpdateResponseBillingGroupCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    public void setPaymentMethod(@jakarta.annotation.Nullable final BillingGroupUpdateResponseBillingGroupPaymentMethod value) {
