...
public class UserCreditCardAddResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserCreditCardAddResponseErrors and sets the default values.
     */
    public UserCreditCardAddResponseErrors() {
    ...
    public static UserCreditCardAddResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserCreditCardAddResponseErrors();
    }
    /**
