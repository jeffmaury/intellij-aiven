...
public class ServiceCreateResponseServiceNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceCreateResponseServiceNodeStatesProgressUpdatesPhase phase;
    /**
     * Unit for current/min/max values. New units may be added. If null should be treated as generic unit
     */
    private ServiceCreateResponseServiceNodeStatesProgressUpdatesUnit unit;
    /**
     * Instantiates a new ServiceCreateResponseServiceNodeStatesProgressUpdates and sets the default values.
     */
    public ServiceCreateResponseServiceNodeStatesProgressUpdates() {
    ...
    public static ServiceCreateResponseServiceNodeStatesProgressUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceNodeStatesProgressUpdates();
    }
    /**
     ...
     * @return a ServiceCreateResponseServiceNodeStatesProgressUpdatesPhase
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceNodeStatesProgressUpdatesPhase getPhase() {
        return this.phase;
    }
    /**
     ...
     * @return a ServiceCreateResponseServiceNodeStatesProgressUpdatesUnit
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceNodeStatesProgressUpdatesUnit getUnit() {
        return this.unit;
    }
    /**
     ...
     */
    public void setPhase(@jakarta.annotation.Nullable final ServiceCreateResponseServiceNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    public void setUnit(@jakarta.annotation.Nullable final ServiceCreateResponseServiceNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
