...
public class ListServiceVersionsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ListServiceVersionsResponseErrors and sets the default values.
     */
    public ListServiceVersionsResponseErrors() {
    ...
    public static ListServiceVersionsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ListServiceVersionsResponseErrors();
    }
    /**
