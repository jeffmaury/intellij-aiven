...
public class ServiceFlinkValidateApplicationVersionResponseSourcesColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkValidateApplicationVersionResponseSourcesColumns and sets the default values.
     */
    public ServiceFlinkValidateApplicationVersionResponseSourcesColumns() {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseSourcesColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkValidateApplicationVersionResponseSourcesColumns();
    }
    /**
