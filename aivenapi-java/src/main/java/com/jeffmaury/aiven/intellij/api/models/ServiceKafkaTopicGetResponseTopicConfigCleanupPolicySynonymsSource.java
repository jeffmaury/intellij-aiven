...
public enum ServiceKafkaTopicGetResponseTopicConfigCleanupPolicySynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigCleanupPolicySynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigCleanupPolicySynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
