...
public class OrganizationUpdateResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private OrganizationUpdateResponseTier tier;
    /**
     * Time of the organization's latest update
     */
    private String updateTime;
    /**
     * Instantiates a new OrganizationUpdateResponse and sets the default values.
     */
    public OrganizationUpdateResponse() {
    ...
    public static OrganizationUpdateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("tier", (n) -> { this.setTier(n.getEnumValue(OrganizationUpdateResponseTier::forValue)); });
     ...
     * @return a OrganizationUpdateResponseTier
     */
    @jakarta.annotation.Nullable
    public OrganizationUpdateResponseTier getTier() {
        return this.tier;
    }
    /**
     ...
     */
    public void setTier(@jakarta.annotation.Nullable final OrganizationUpdateResponseTier value) {
        this.tier = value;
    }
    /**
