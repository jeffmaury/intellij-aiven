...
public class OrganizationUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUpdateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTier(@javax.annotation.Nullable final OrganizationUpdateResponseTier value) {
        this.tier = value;
    }
    /**
