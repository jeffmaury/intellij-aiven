...
public enum ServiceKafkaTopicGetResponseTopicConfigRetentionMsSynonymsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigRetentionMsSynonymsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigRetentionMsSynonymsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
