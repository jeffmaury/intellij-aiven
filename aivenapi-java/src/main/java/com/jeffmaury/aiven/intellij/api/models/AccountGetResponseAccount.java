...
public class AccountGetResponseAccount implements AdditionalDataHolder, Parsable {
    /**
     * Describe the source of the account
     */
    private AccountGetResponseAccountAccessSource accessSource;
    /**
     * Account ID
     */
     ...
     * Feature flags
     */
    private AccountGetResponseAccountFeatures features;
    /**
    ...
    /**
     * Instantiates a new AccountGetResponseAccount and sets the default values.
     */
    public AccountGetResponseAccount() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountGetResponseAccount
     */
    @jakarta.annotation.Nonnull
    public static AccountGetResponseAccount createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountGetResponseAccount();
    }
    /**
     * Gets the access_source property value. Describe the source of the account
     * @return a AccountGetResponseAccountAccessSource
     */
    @jakarta.annotation.Nullable
    public AccountGetResponseAccountAccessSource getAccessSource() {
     ...
     * @return a AccountGetResponseAccountFeatures
     */
    @jakarta.annotation.Nullable
    public AccountGetResponseAccountFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_source", (n) -> { this.setAccessSource(n.getEnumValue(AccountGetResponseAccountAccessSource::forValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(AccountGetResponseAccountFeatures::createFromDiscriminatorValue)); });
     ...
     */
    public void setAccessSource(@jakarta.annotation.Nullable final AccountGetResponseAccountAccessSource value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final AccountGetResponseAccountFeatures value) {
        this.features = value;
    }
    /**
