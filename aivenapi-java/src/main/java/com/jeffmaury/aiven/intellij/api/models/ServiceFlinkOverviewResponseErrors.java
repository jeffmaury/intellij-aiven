...
public class ServiceFlinkOverviewResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkOverviewResponseErrors and sets the default values.
     */
    public ServiceFlinkOverviewResponseErrors() {
    ...
    public static ServiceFlinkOverviewResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkOverviewResponseErrors();
    }
    /**
