...
public class WithVerificationCodeItemRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserPasswordResetResponse> post(@javax.annotation.Nonnull final UserPasswordResetRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserPasswordResetResponse> executionException = new java.util.concurrent.CompletableFuture<UserPasswordResetResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserPasswordResetResponse> post(@javax.annotation.Nonnull final UserPasswordResetRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserPasswordResetRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final UserPasswordResetRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
