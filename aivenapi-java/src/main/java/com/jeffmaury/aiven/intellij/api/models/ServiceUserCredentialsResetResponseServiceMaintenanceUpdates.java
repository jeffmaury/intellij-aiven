...
public class ServiceUserCredentialsResetResponseServiceMaintenanceUpdates implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceMaintenanceUpdates and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceMaintenanceUpdates() {
    ...
    public static ServiceUserCredentialsResetResponseServiceMaintenanceUpdates createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceMaintenanceUpdates();
    }
    /**
