...
public class OrganizationTicketListResponseTicketsFollowers implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new OrganizationTicketListResponseTicketsFollowers and sets the default values.
     */
    public OrganizationTicketListResponseTicketsFollowers() {
    ...
    public static OrganizationTicketListResponseTicketsFollowers createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationTicketListResponseTicketsFollowers();
    }
    /**
