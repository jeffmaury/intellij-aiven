...
public class AccountPaymentMethodsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountPaymentMethodsListResponseErrors and sets the default values.
     */
    public AccountPaymentMethodsListResponseErrors() {
    ...
    public static AccountPaymentMethodsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountPaymentMethodsListResponseErrors();
    }
    /**
