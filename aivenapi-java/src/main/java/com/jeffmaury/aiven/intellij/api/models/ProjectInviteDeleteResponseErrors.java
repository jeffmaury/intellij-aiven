...
public class ProjectInviteDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectInviteDeleteResponseErrors and sets the default values.
     */
    public ProjectInviteDeleteResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ProjectInviteDeleteResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ProjectInviteDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectInviteDeleteResponseErrors();
    }
    /**
