...
public class AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping and sets the default values.
     */
    public AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping() {
    ...
    public static AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping();
    }
    /**
