...
public class ProjectGetResponseProject implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectGetResponseProject createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ProjectGetResponseProjectBillingEmails>
     */
    @jakarta.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_currency", (n) -> { this.setBillingCurrency(n.getEnumValue(ProjectGetResponseProjectBillingCurrency::forValue)); });
     ...
     * @return a java.util.List<ProjectGetResponseProjectTechEmails>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setBillingCurrency(@jakarta.annotation.Nullable final ProjectGetResponseProjectBillingCurrency value) {
     ...
     */
    public void setBillingEmails(@jakarta.annotation.Nullable final java.util.List<ProjectGetResponseProjectBillingEmails> value) {
     ...
     */
    public void setCardInfo(@jakarta.annotation.Nullable final ProjectGetResponseProjectCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    public void setEndOfLifeExtension(@jakarta.annotation.Nullable final ProjectGetResponseProjectEndOfLifeExtension value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final ProjectGetResponseProjectFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setTags(@jakarta.annotation.Nullable final ProjectGetResponseProjectTags value) {
        this.tags = value;
    }
    /**
     ...
     */
    public void setTechEmails(@jakarta.annotation.Nullable final java.util.List<ProjectGetResponseProjectTechEmails> value) {
