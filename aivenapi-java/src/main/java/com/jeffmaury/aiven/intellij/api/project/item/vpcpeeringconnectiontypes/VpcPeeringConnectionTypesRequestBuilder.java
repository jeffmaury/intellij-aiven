...
public class VpcPeeringConnectionTypesRequestBuilder extends BaseRequestBuilder {
    ...
    public VpcPeeringConnectionTypesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public VpcPeeringConnectionTypesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<ListProjectVpcPeeringConnectionTypesResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ListProjectVpcPeeringConnectionTypesResponse> executionException = new java.util.concurrent.CompletableFuture<ListProjectVpcPeeringConnectionTypesResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ListProjectVpcPeeringConnectionTypesResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
