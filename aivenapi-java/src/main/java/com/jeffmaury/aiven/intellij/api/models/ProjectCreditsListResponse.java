...
public class ProjectCreditsListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectCreditsListResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ProjectCreditsListResponseCredits>
     */
     ...
     * @return a java.util.List<ProjectCreditsListResponseErrors>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setCredits(@jakarta.annotation.Nullable final java.util.List<ProjectCreditsListResponseCredits> value) {
        this.credits = value;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ProjectCreditsListResponseErrors> value) {
        this.errors = value;
    }
    /**
