...
public class PublicPrivatelinkAvailabilityListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new PublicPrivatelinkAvailabilityListResponseErrors and sets the default values.
     */
    public PublicPrivatelinkAvailabilityListResponseErrors() {
    ...
    public static PublicPrivatelinkAvailabilityListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PublicPrivatelinkAvailabilityListResponseErrors();
    }
    /**
