...
public class ServiceUserCredentialsResetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseErrors and sets the default values.
     */
    public ServiceUserCredentialsResetResponseErrors() {
    ...
    public static ServiceUserCredentialsResetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseErrors();
    }
    /**
