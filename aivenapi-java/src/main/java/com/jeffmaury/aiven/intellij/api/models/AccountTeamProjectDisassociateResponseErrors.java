...
public class AccountTeamProjectDisassociateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamProjectDisassociateResponseErrors and sets the default values.
     */
    public AccountTeamProjectDisassociateResponseErrors() {
    ...
    public static AccountTeamProjectDisassociateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamProjectDisassociateResponseErrors();
    }
    /**
