...
public class ProjectServiceTagsUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectServiceTagsUpdateResponseErrors and sets the default values.
     */
    public ProjectServiceTagsUpdateResponseErrors() {
    ...
    public static ProjectServiceTagsUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectServiceTagsUpdateResponseErrors();
    }
    /**
