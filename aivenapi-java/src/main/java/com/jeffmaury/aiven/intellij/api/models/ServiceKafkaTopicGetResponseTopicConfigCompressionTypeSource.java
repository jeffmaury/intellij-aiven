...
public enum ServiceKafkaTopicGetResponseTopicConfigCompressionTypeSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigCompressionTypeSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigCompressionTypeSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
