...
public class ServiceFlinkDeleteApplicationVersionResponseSources implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Columns
     */
    private java.util.List<ServiceFlinkDeleteApplicationVersionResponseSourcesColumns> columns;
    /**
     ...
     * Option
     */
    private ServiceFlinkDeleteApplicationVersionResponseSourcesOptions options;
    /**
     * Source ID
     */
    ...
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationVersionResponseSources and sets the default values.
     */
    public ServiceFlinkDeleteApplicationVersionResponseSources() {
    ...
    public static ServiceFlinkDeleteApplicationVersionResponseSources createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationVersionResponseSources();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkDeleteApplicationVersionResponseSourcesColumns>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkDeleteApplicationVersionResponseSourcesColumns> getColumns() {
        return this.columns;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { this.setColumns(n.getCollectionOfObjectValues(ServiceFlinkDeleteApplicationVersionResponseSourcesColumns::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getObjectValue(ServiceFlinkDeleteApplicationVersionResponseSourcesOptions::createFromDiscriminatorValue)); });
     ...
     * @return a ServiceFlinkDeleteApplicationVersionResponseSourcesOptions
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkDeleteApplicationVersionResponseSourcesOptions getOptions() {
        return this.options;
    }
    /**
     ...
     */
    public void setColumns(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkDeleteApplicationVersionResponseSourcesColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final ServiceFlinkDeleteApplicationVersionResponseSourcesOptions value) {
        this.options = value;
    }
    /**
