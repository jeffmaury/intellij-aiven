...
public class ServiceFlinkDeleteApplicationResponseApplicationVersionsSourcesColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationResponseApplicationVersionsSourcesColumns and sets the default values.
     */
    public ServiceFlinkDeleteApplicationResponseApplicationVersionsSourcesColumns() {
    ...
    public static ServiceFlinkDeleteApplicationResponseApplicationVersionsSourcesColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationResponseApplicationVersionsSourcesColumns();
    }
    /**
