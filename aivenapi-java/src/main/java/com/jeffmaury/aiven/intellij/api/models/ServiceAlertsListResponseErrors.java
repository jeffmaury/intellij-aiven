...
public class ServiceAlertsListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceAlertsListResponseErrors and sets the default values.
     */
    public ServiceAlertsListResponseErrors() {
    ...
    public static ServiceAlertsListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceAlertsListResponseErrors();
    }
    /**
