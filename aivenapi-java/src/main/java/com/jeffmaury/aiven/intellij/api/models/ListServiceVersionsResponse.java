...
public class ListServiceVersionsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ListServiceVersionsResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ListServiceVersionsResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ListServiceVersionsResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     * @param value Value to set for the serviceVersions property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setServiceVersions(@javax.annotation.Nullable final java.util.List<ListServiceVersionsResponseServiceVersions> value) {
