...
public class ServiceCreateRequestBodyServiceIntegrations implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateRequestBodyServiceIntegrations createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("integration_type", (n) -> { this.setIntegrationType(n.getEnumValue(ServiceCreateRequestBodyServiceIntegrationsIntegrationType::forValue)); });
     ...
     */
    public void setIntegrationType(@jakarta.annotation.Nullable final ServiceCreateRequestBodyServiceIntegrationsIntegrationType value) {
     ...
     */
    public void setUserConfig(@jakarta.annotation.Nullable final ServiceCreateRequestBodyServiceIntegrationsUserConfig value) {
