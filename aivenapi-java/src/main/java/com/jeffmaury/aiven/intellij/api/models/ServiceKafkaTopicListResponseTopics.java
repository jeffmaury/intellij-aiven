...
public class ServiceKafkaTopicListResponseTopics implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicListResponseTopics createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceKafkaTopicListResponseTopicsTags>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setState(@jakarta.annotation.Nullable final ServiceKafkaTopicListResponseTopicsState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setTags(@jakarta.annotation.Nullable final java.util.List<ServiceKafkaTopicListResponseTopicsTags> value) {
        this.tags = value;
    }
    /**
