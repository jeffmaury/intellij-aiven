...
public class AccountAuthenticationMethodCreateRequestBodySamlFieldMapping implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodCreateRequestBodySamlFieldMapping createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
