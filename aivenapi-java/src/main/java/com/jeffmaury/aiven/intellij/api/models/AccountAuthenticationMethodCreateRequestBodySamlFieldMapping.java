...
public class AccountAuthenticationMethodCreateRequestBodySamlFieldMapping implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountAuthenticationMethodCreateRequestBodySamlFieldMapping and sets the default values.
     */
    public AccountAuthenticationMethodCreateRequestBodySamlFieldMapping() {
    ...
    public static AccountAuthenticationMethodCreateRequestBodySamlFieldMapping createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountAuthenticationMethodCreateRequestBodySamlFieldMapping();
    }
    /**
