...
public class ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions and sets the default values.
     */
    public ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions
     */
    @jakarta.annotation.Nonnull
    public static ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions();
    }
    /**
