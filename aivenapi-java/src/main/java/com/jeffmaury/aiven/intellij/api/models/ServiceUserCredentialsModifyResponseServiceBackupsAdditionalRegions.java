...
public class ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceBackupsAdditionalRegions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
