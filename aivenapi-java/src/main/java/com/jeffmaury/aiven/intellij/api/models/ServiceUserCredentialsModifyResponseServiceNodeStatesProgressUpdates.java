...
public class ServiceUserCredentialsModifyResponseServiceNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceNodeStatesProgressUpdates createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPhase(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUnit(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
