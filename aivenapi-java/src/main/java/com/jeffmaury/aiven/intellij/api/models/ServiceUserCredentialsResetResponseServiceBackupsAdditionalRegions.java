...
public class ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions() {
    ...
    public static ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions();
    }
    /**
