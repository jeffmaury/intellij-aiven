...
public class ServiceSchemaRegistryGlobalConfigPutRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistryGlobalConfigPutRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCompatibility(@javax.annotation.Nullable final ServiceSchemaRegistryGlobalConfigPutRequestBodyCompatibility value) {
