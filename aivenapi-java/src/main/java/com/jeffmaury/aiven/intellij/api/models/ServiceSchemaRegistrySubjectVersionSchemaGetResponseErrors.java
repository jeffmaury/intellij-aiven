...
public class ServiceSchemaRegistrySubjectVersionSchemaGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectVersionSchemaGetResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectVersionSchemaGetResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectVersionSchemaGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectVersionSchemaGetResponseErrors();
    }
    /**
