...
public class ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatusState implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatusState createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setLikelyErrorCause(@javax.annotation.Nullable final ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatusStateLikelyErrorCause value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setNodes(@javax.annotation.Nullable final ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatusStateNodes value) {
        this.nodes = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceIntegrationUpdateResponseServiceIntegrationIntegrationStatusStateStatus value) {
        this.status = value;
    }
}
