...
public class VpcPeeringConnectionUpdateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionUpdateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAdd(@javax.annotation.Nullable final java.util.List<VpcPeeringConnectionUpdateRequestBodyAdd> value) {
        this.add = value;
    }
    /**
