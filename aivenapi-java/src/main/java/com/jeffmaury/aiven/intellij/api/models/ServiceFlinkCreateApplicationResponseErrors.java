...
public class ServiceFlinkCreateApplicationResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationResponseErrors and sets the default values.
     */
    public ServiceFlinkCreateApplicationResponseErrors() {
    ...
    public static ServiceFlinkCreateApplicationResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationResponseErrors();
    }
    /**
