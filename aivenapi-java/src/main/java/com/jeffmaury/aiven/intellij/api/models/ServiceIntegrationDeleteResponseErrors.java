...
public class ServiceIntegrationDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationDeleteResponseErrors and sets the default values.
     */
    public ServiceIntegrationDeleteResponseErrors() {
    ...
    public static ServiceIntegrationDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationDeleteResponseErrors();
    }
    /**
