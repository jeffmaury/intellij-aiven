...
public class AccountAuthenticationMethodCreateResponseAuthenticationMethod implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("authentication_method_type", (n) -> { this.setAuthenticationMethodType(n.getEnumValue(AccountAuthenticationMethodCreateResponseAuthenticationMethodAuthenticationMethodType.class)); });
        ...
        deserializerMap.put("saml_cert", (n) -> { this.setSamlCert(n.getEnumValue(AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlCert.class)); });
        ...
        deserializerMap.put("saml_digest_algorithm", (n) -> { this.setSamlDigestAlgorithm(n.getEnumValue(AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlDigestAlgorithm.class)); });
        ...
        deserializerMap.put("saml_signature_algorithm", (n) -> { this.setSamlSignatureAlgorithm(n.getEnumValue(AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlSignatureAlgorithm.class)); });
        deserializerMap.put("saml_sp_certificate", (n) -> { this.setSamlSpCertificate(n.getStringValue()); });
        deserializerMap.put("saml_variant", (n) -> { this.setSamlVariant(n.getEnumValue(AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlVariant.class)); });
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(AccountAuthenticationMethodCreateResponseAuthenticationMethodState.class)); });
