...
public class ServiceSchemaRegistrySubjectDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceSchemaRegistrySubjectDeleteResponseErrors and sets the default values.
     */
    public ServiceSchemaRegistrySubjectDeleteResponseErrors() {
    ...
    public static ServiceSchemaRegistrySubjectDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceSchemaRegistrySubjectDeleteResponseErrors();
    }
    /**
