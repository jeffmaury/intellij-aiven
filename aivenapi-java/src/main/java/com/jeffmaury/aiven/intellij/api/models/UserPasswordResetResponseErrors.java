...
public class UserPasswordResetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserPasswordResetResponseErrors and sets the default values.
     */
    public UserPasswordResetResponseErrors() {
    ...
    public static UserPasswordResetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserPasswordResetResponseErrors();
    }
    /**
