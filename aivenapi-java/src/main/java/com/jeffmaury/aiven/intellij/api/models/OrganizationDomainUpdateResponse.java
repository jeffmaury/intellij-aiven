...
public class OrganizationDomainUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationDomainUpdateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final OrganizationDomainUpdateResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setVerificationType(@javax.annotation.Nullable final OrganizationDomainUpdateResponseVerificationType value) {
