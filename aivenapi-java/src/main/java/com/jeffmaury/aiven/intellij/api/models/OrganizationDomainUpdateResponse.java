...
public class OrganizationDomainUpdateResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private OrganizationDomainUpdateResponseState state;
    /**
     * Type of verification to be made
     */
    private OrganizationDomainUpdateResponseVerificationType verificationType;
    /**
     * Instantiates a new OrganizationDomainUpdateResponse and sets the default values.
     */
    public OrganizationDomainUpdateResponse() {
    ...
    public static OrganizationDomainUpdateResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationDomainUpdateResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(OrganizationDomainUpdateResponseState::forValue)); });
        deserializerMap.put("verification_type", (n) -> { this.setVerificationType(n.getEnumValue(OrganizationDomainUpdateResponseVerificationType::forValue)); });
     ...
     * @return a OrganizationDomainUpdateResponseState
     */
    @jakarta.annotation.Nullable
    public OrganizationDomainUpdateResponseState getState() {
        return this.state;
    }
    /**
     * Gets the verification_type property value. Type of verification to be made
     * @return a OrganizationDomainUpdateResponseVerificationType
     */
    @jakarta.annotation.Nullable
    public OrganizationDomainUpdateResponseVerificationType getVerificationType() {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final OrganizationDomainUpdateResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setVerificationType(@jakarta.annotation.Nullable final OrganizationDomainUpdateResponseVerificationType value) {
