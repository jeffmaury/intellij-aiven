...
public class ServiceQueryStatisticsResetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceQueryStatisticsResetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceQueryStatisticsResetResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setQueries(@javax.annotation.Nullable final java.util.List<ServiceQueryStatisticsResetResponseQueries> value) {
        this.queries = value;
    }
}
