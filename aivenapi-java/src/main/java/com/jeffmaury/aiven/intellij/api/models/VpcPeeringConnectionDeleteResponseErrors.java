...
public class VpcPeeringConnectionDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new VpcPeeringConnectionDeleteResponseErrors and sets the default values.
     */
    public VpcPeeringConnectionDeleteResponseErrors() {
    ...
    public static VpcPeeringConnectionDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionDeleteResponseErrors();
    }
    /**
