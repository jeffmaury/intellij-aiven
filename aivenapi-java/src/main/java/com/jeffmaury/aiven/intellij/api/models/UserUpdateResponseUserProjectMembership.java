...
public class UserUpdateResponseUserProjectMembership implements AdditionalDataHolder, Parsable {
    ...
    public static UserUpdateResponseUserProjectMembership createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setANY(@javax.annotation.Nullable final UserUpdateResponseUserProjectMembershipANY value) {
        this.aNY = value;
    }
}
