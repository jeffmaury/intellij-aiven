...
public class ServiceOpenSearchSecurityGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceOpenSearchSecurityGetResponseErrors> errors;
    /**
    ...
    /**
     * Instantiates a new ServiceOpenSearchSecurityGetResponse and sets the default values.
     */
    public ServiceOpenSearchSecurityGetResponse() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceOpenSearchSecurityGetResponse
     */
    @jakarta.annotation.Nonnull
    public static ServiceOpenSearchSecurityGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceOpenSearchSecurityGetResponse();
    }
    /**
     ...
     * @return a java.util.List<ServiceOpenSearchSecurityGetResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceOpenSearchSecurityGetResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(ServiceOpenSearchSecurityGetResponseErrors::createFromDiscriminatorValue)); });
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceOpenSearchSecurityGetResponseErrors> value) {
        this.errors = value;
    }
    /**
