...
public class ServiceCreateResponseServiceAcl implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Kafka permission
     */
    private ServiceCreateResponseServiceAclPermission permission;
    /**
     * Topic name pattern
     */
    ...
    /**
     * Instantiates a new ServiceCreateResponseServiceAcl and sets the default values.
     */
    public ServiceCreateResponseServiceAcl() {
    ...
    public static ServiceCreateResponseServiceAcl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceCreateResponseServiceAcl();
    }
    /**
     ...
     * @return a ServiceCreateResponseServiceAclPermission
     */
    @jakarta.annotation.Nullable
    public ServiceCreateResponseServiceAclPermission getPermission() {
     ...
     */
    public void setPermission(@jakarta.annotation.Nullable final ServiceCreateResponseServiceAclPermission value) {
