...
public class ServiceCreateResponseServiceAcl implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceAcl createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPermission(@javax.annotation.Nullable final ServiceCreateResponseServiceAclPermission value) {
