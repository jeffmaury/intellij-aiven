...
public class OrganizationUserGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private OrganizationUserGetResponseUserInfo userInfo;
    /**
     * Instantiates a new OrganizationUserGetResponse and sets the default values.
     */
    public OrganizationUserGetResponse() {
    ...
    public static OrganizationUserGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationUserGetResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("user_info", (n) -> { this.setUserInfo(n.getObjectValue(OrganizationUserGetResponseUserInfo::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationUserGetResponseUserInfo getUserInfo() {
     ...
     */
    public void setUserInfo(@jakarta.annotation.Nullable final OrganizationUserGetResponseUserInfo value) {
        this.userInfo = value;
    }
}
