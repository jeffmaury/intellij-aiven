...
public class OrganizationUserGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUserGetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserInfo(@javax.annotation.Nullable final OrganizationUserGetResponseUserInfo value) {
        this.userInfo = value;
    }
}
