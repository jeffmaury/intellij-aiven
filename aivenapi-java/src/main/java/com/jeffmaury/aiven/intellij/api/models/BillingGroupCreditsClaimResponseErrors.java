...
public class BillingGroupCreditsClaimResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupCreditsClaimResponseErrors and sets the default values.
     */
    public BillingGroupCreditsClaimResponseErrors() {
    ...
    public static BillingGroupCreditsClaimResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupCreditsClaimResponseErrors();
    }
    /**
