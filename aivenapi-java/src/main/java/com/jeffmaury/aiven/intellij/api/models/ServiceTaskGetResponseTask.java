...
public class ServiceTaskGetResponseTask implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("result_codes", (n) -> { this.setResultCodes(n.getCollectionOfObjectValues(ServiceTaskGetResponseTaskResultCodes::createFromDiscriminatorValue)); });
