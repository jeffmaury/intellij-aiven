...
public class ServiceFlinkDeleteApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Deployment status
     */
    private ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkDeleteApplicationResponseCurrentDeployment and sets the default values.
     */
    public ServiceFlinkDeleteApplicationResponseCurrentDeployment() {
    ...
    public static ServiceFlinkDeleteApplicationResponseCurrentDeployment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkDeleteApplicationResponseCurrentDeployment();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus::forValue)); });
     ...
     * @return a ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
