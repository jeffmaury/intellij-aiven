...
public class ServiceFlinkDeleteApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationResponseCurrentDeployment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkDeleteApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
