...
public class ServiceKafkaTopicCreateRequestBodyConfig implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicCreateRequestBodyConfig createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setCleanupPolicy(@jakarta.annotation.Nullable final ServiceKafkaTopicCreateRequestBodyConfigCleanupPolicy value) {
     ...
     */
    public void setCompressionType(@jakarta.annotation.Nullable final ServiceKafkaTopicCreateRequestBodyConfigCompressionType value) {
     ...
     */
    public void setMessageFormatVersion(@jakarta.annotation.Nullable final ServiceKafkaTopicCreateRequestBodyConfigMessageFormatVersion value) {
     ...
     */
    public void setMessageTimestampType(@jakarta.annotation.Nullable final ServiceKafkaTopicCreateRequestBodyConfigMessageTimestampType value) {
