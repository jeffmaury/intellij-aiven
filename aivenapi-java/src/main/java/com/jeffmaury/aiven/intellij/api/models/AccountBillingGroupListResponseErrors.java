...
public class AccountBillingGroupListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountBillingGroupListResponseErrors and sets the default values.
     */
    public AccountBillingGroupListResponseErrors() {
    ...
    public static AccountBillingGroupListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountBillingGroupListResponseErrors();
    }
    /**
