...
public class ServiceKafkaQuotaDescribeResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaQuotaDescribeResponseErrors and sets the default values.
     */
    public ServiceKafkaQuotaDescribeResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaQuotaDescribeResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaQuotaDescribeResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaQuotaDescribeResponseErrors();
    }
    /**
