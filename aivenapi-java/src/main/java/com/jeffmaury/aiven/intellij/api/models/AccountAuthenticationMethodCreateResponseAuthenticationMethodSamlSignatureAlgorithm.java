...
public enum AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlSignatureAlgorithm implements ValuedEnum {
    ...
    public static AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlSignatureAlgorithm forValue(@jakarta.annotation.Nonnull final String searchValue) {
