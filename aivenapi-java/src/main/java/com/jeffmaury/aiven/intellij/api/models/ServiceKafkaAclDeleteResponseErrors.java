...
public class ServiceKafkaAclDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaAclDeleteResponseErrors and sets the default values.
     */
    public ServiceKafkaAclDeleteResponseErrors() {
    ...
    public static ServiceKafkaAclDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaAclDeleteResponseErrors();
    }
    /**
