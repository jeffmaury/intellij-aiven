...
public class ServiceListResponseServicesUsersAccessControl implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceListResponseServicesUsersAccessControl and sets the default values.
     */
    public ServiceListResponseServicesUsersAccessControl() {
    ...
    public static ServiceListResponseServicesUsersAccessControl createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceListResponseServicesUsersAccessControl();
    }
    /**
