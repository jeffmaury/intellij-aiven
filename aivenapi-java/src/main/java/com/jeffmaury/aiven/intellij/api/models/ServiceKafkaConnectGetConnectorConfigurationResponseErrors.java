...
public class ServiceKafkaConnectGetConnectorConfigurationResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceKafkaConnectGetConnectorConfigurationResponseErrors and sets the default values.
     */
    public ServiceKafkaConnectGetConnectorConfigurationResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceKafkaConnectGetConnectorConfigurationResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceKafkaConnectGetConnectorConfigurationResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceKafkaConnectGetConnectorConfigurationResponseErrors();
    }
    /**
