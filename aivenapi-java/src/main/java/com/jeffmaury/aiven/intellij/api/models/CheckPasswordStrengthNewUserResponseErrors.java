...
public class CheckPasswordStrengthNewUserResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new CheckPasswordStrengthNewUserResponseErrors and sets the default values.
     */
    public CheckPasswordStrengthNewUserResponseErrors() {
    ...
    public static CheckPasswordStrengthNewUserResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CheckPasswordStrengthNewUserResponseErrors();
    }
    /**
