...
public class UserAccountInvitesListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new UserAccountInvitesListResponseErrors and sets the default values.
     */
    public UserAccountInvitesListResponseErrors() {
    ...
    public static UserAccountInvitesListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserAccountInvitesListResponseErrors();
    }
    /**
