...
public class ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesColumns and sets the default values.
     */
    public ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesColumns() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesColumns
     */
    @jakarta.annotation.Nonnull
    public static ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesColumns();
    }
    /**
