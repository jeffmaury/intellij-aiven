...
public class AccountTeamProjectListResponseProjects implements AdditionalDataHolder, Parsable {
    ...
    public static AccountTeamProjectListResponseProjects createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    public void setTeamType(@jakarta.annotation.Nullable final AccountTeamProjectListResponseProjectsTeamType value) {
        this.teamType = value;
    }
}
