...
public enum ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigSegmentJitterMsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
