...
public class ProjectsRequestBuilder extends BaseRequestBuilder {
    ...
    public AccountProjectsListResponse get() {
        return get(null);
    }
    /**
     * List projects belonging to account
     ...
     */
    @jakarta.annotation.Nullable
    public AccountProjectsListResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, AccountProjectsListResponse::createFromDiscriminatorValue);
    }
    /**
     * List projects belonging to account
