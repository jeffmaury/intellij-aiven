...
public class ServiceFlinkValidateApplicationVersionResponseSourcesPosition implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseSourcesPosition createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
