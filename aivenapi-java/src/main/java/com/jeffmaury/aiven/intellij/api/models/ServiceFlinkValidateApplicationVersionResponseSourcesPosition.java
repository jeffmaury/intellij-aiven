...
public class ServiceFlinkValidateApplicationVersionResponseSourcesPosition implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkValidateApplicationVersionResponseSourcesPosition and sets the default values.
     */
    public ServiceFlinkValidateApplicationVersionResponseSourcesPosition() {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseSourcesPosition createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkValidateApplicationVersionResponseSourcesPosition();
    }
    /**
