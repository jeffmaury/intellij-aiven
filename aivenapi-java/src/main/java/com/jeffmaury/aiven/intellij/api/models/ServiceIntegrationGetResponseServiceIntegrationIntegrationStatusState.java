...
public class ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusState implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusState createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setLikelyErrorCause(@javax.annotation.Nullable final ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusStateLikelyErrorCause value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setNodes(@javax.annotation.Nullable final ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusStateNodes value) {
        this.nodes = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusStateStatus value) {
        this.status = value;
    }
}
