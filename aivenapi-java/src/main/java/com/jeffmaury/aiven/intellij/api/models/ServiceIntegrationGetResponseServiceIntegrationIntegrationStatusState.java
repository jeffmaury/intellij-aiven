...
public class ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusState implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("likely_error_cause", (n) -> { this.setLikelyErrorCause(n.getEnumValue(ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusStateLikelyErrorCause::forValue)); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceIntegrationGetResponseServiceIntegrationIntegrationStatusStateStatus::forValue)); });
