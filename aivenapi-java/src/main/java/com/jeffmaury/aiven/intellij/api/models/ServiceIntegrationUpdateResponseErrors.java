...
public class ServiceIntegrationUpdateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationUpdateResponseErrors and sets the default values.
     */
    public ServiceIntegrationUpdateResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceIntegrationUpdateResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceIntegrationUpdateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationUpdateResponseErrors();
    }
    /**
