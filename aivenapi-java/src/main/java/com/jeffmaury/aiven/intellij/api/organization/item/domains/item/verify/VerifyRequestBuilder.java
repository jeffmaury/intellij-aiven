...
public class VerifyRequestBuilder extends BaseRequestBuilder {
    ...
    public OrganizationDomainVerifyResponse post() {
        return post(null);
    }
    /**
     * <p>Verifies a domain in an organization. If a user signs up to the Aiven platform with a verified domain, they are automatically added as managed users to the organization that has this domain verified.</p>
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationDomainVerifyResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toPostRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, OrganizationDomainVerifyResponse::createFromDiscriminatorValue);
    }
    /**
     * <p>Verifies a domain in an organization. If a user signs up to the Aiven platform with a verified domain, they are automatically added as managed users to the organization that has this domain verified.</p>
