...
public class ServiceIntegrationEndpointListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationEndpointListResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a java.util.List<ServiceIntegrationEndpointListResponseErrors>
     */
     ...
     * @return a java.util.List<ServiceIntegrationEndpointListResponseServiceIntegrationEndpoints>
     */
    @jakarta.annotation.Nullable
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceIntegrationEndpointListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     * @param value Value to set for the service_integration_endpoints property.
     */
    public void setServiceIntegrationEndpoints(@jakarta.annotation.Nullable final java.util.List<ServiceIntegrationEndpointListResponseServiceIntegrationEndpoints> value) {
