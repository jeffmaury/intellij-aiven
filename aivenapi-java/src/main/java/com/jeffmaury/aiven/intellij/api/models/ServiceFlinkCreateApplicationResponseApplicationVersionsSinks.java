...
public class ServiceFlinkCreateApplicationResponseApplicationVersionsSinks implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Columns
     */
    private java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns> columns;
    /**
     ...
     * Option
     */
    private ServiceFlinkCreateApplicationResponseApplicationVersionsSinksOptions options;
    /**
     * Sink ID
     */
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationResponseApplicationVersionsSinks and sets the default values.
     */
    public ServiceFlinkCreateApplicationResponseApplicationVersionsSinks() {
    ...
    public static ServiceFlinkCreateApplicationResponseApplicationVersionsSinks createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationResponseApplicationVersionsSinks();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns> getColumns() {
        return this.columns;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("columns", (n) -> { this.setColumns(n.getCollectionOfObjectValues(ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("options", (n) -> { this.setOptions(n.getObjectValue(ServiceFlinkCreateApplicationResponseApplicationVersionsSinksOptions::createFromDiscriminatorValue)); });
     ...
     * @return a ServiceFlinkCreateApplicationResponseApplicationVersionsSinksOptions
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkCreateApplicationResponseApplicationVersionsSinksOptions getOptions() {
        return this.options;
    }
    /**
     ...
     */
    public void setColumns(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    public void setOptions(@jakarta.annotation.Nullable final ServiceFlinkCreateApplicationResponseApplicationVersionsSinksOptions value) {
        this.options = value;
    }
    /**
