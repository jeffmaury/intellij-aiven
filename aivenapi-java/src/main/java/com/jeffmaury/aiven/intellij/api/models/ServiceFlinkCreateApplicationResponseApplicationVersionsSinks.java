...
public class ServiceFlinkCreateApplicationResponseApplicationVersionsSinks implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationResponseApplicationVersionsSinks createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setColumns(@javax.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSinksColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setOptions(@javax.annotation.Nullable final ServiceFlinkCreateApplicationResponseApplicationVersionsSinksOptions value) {
        this.options = value;
    }
    /**
