...
public class ServiceFlinkListApplicationDeploymentsResponseDeployments implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkListApplicationDeploymentsResponseDeployments createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus value) {
        this.status = value;
    }
    /**
