...
public class ServiceFlinkListApplicationDeploymentsResponseDeployments implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Deployment status
     */
    private ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkListApplicationDeploymentsResponseDeployments and sets the default values.
     */
    public ServiceFlinkListApplicationDeploymentsResponseDeployments() {
    ...
    public static ServiceFlinkListApplicationDeploymentsResponseDeployments createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkListApplicationDeploymentsResponseDeployments();
    }
    /**
     ...
     * @return a ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkListApplicationDeploymentsResponseDeploymentsStatus value) {
        this.status = value;
    }
    /**
