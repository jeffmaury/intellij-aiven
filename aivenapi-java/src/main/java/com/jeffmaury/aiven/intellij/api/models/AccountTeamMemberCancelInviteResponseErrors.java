...
public class AccountTeamMemberCancelInviteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new AccountTeamMemberCancelInviteResponseErrors and sets the default values.
     */
    public AccountTeamMemberCancelInviteResponseErrors() {
    ...
    public static AccountTeamMemberCancelInviteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountTeamMemberCancelInviteResponseErrors();
    }
    /**
