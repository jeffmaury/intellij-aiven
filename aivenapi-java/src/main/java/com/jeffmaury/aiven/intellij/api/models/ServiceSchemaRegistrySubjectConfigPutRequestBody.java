...
public class ServiceSchemaRegistrySubjectConfigPutRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistrySubjectConfigPutRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("compatibility", (n) -> { this.setCompatibility(n.getEnumValue(ServiceSchemaRegistrySubjectConfigPutRequestBodyCompatibility::forValue)); });
     ...
     */
    public void setCompatibility(@jakarta.annotation.Nullable final ServiceSchemaRegistrySubjectConfigPutRequestBodyCompatibility value) {
