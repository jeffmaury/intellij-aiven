...
public class ServiceFlinkListApplicationDeploymentsResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkListApplicationDeploymentsResponseErrors and sets the default values.
     */
    public ServiceFlinkListApplicationDeploymentsResponseErrors() {
    ...
    public static ServiceFlinkListApplicationDeploymentsResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkListApplicationDeploymentsResponseErrors();
    }
    /**
