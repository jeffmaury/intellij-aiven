...
public enum ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
