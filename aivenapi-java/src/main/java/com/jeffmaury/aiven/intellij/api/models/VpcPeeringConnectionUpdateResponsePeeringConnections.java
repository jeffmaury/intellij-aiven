...
public class VpcPeeringConnectionUpdateResponsePeeringConnections implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private VpcPeeringConnectionUpdateResponsePeeringConnectionsState state;
    /**
     * State-specific help or error information
     */
    private VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfo stateInfo;
    /**
     ...
     */
    private VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType vpcPeeringConnectionType;
    /**
     * Instantiates a new VpcPeeringConnectionUpdateResponsePeeringConnections and sets the default values.
     */
    public VpcPeeringConnectionUpdateResponsePeeringConnections() {
    ...
    public static VpcPeeringConnectionUpdateResponsePeeringConnections createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionUpdateResponsePeeringConnections();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(VpcPeeringConnectionUpdateResponsePeeringConnectionsState::forValue)); });
        deserializerMap.put("state_info", (n) -> { this.setStateInfo(n.getObjectValue(VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("vpc_peering_connection_type", (n) -> { this.setVpcPeeringConnectionType(n.getEnumValue(VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType::forValue)); });
     ...
     * @return a VpcPeeringConnectionUpdateResponsePeeringConnectionsState
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionUpdateResponsePeeringConnectionsState getState() {
        return this.state;
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfo getStateInfo() {
     ...
     * @return a VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType getVpcPeeringConnectionType() {
     ...
     */
    public void setState(@jakarta.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsState value) {
        this.state = value;
    }
    /**
     ...
     */
    public void setStateInfo(@jakarta.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfo value) {
     ...
     */
    public void setVpcPeeringConnectionType(@jakarta.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType value) {
