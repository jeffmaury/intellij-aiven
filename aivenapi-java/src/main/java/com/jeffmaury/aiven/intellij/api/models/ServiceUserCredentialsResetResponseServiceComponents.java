...
public class ServiceUserCredentialsResetResponseServiceComponents implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceUserCredentialsResetResponseServiceComponentsKafkaAuthenticationMethod kafkaAuthenticationMethod;
    /**
     ...
     */
    private ServiceUserCredentialsResetResponseServiceComponentsRoute route;
    /**
     ...
     * DNS usage name
     */
    private ServiceUserCredentialsResetResponseServiceComponentsUsage usage;
    /**
     * Instantiates a new ServiceUserCredentialsResetResponseServiceComponents and sets the default values.
     */
    public ServiceUserCredentialsResetResponseServiceComponents() {
    ...
    public static ServiceUserCredentialsResetResponseServiceComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceUserCredentialsResetResponseServiceComponents();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("kafka_authentication_method", (n) -> { this.setKafkaAuthenticationMethod(n.getEnumValue(ServiceUserCredentialsResetResponseServiceComponentsKafkaAuthenticationMethod::forValue)); });
        ...
        deserializerMap.put("route", (n) -> { this.setRoute(n.getEnumValue(ServiceUserCredentialsResetResponseServiceComponentsRoute::forValue)); });
        deserializerMap.put("ssl", (n) -> { this.setSsl(n.getBooleanValue()); });
        deserializerMap.put("usage", (n) -> { this.setUsage(n.getEnumValue(ServiceUserCredentialsResetResponseServiceComponentsUsage::forValue)); });
     ...
     * @return a ServiceUserCredentialsResetResponseServiceComponentsKafkaAuthenticationMethod
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceComponentsKafkaAuthenticationMethod getKafkaAuthenticationMethod() {
     ...
     * @return a ServiceUserCredentialsResetResponseServiceComponentsRoute
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceComponentsRoute getRoute() {
        return this.route;
    }
    /**
     ...
     * @return a ServiceUserCredentialsResetResponseServiceComponentsUsage
     */
    @jakarta.annotation.Nullable
    public ServiceUserCredentialsResetResponseServiceComponentsUsage getUsage() {
        return this.usage;
    }
    /**
     ...
     */
    public void setKafkaAuthenticationMethod(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceComponentsKafkaAuthenticationMethod value) {
     ...
     */
    public void setRoute(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceComponentsRoute value) {
        this.route = value;
    }
    /**
     ...
     */
    public void setUsage(@jakarta.annotation.Nullable final ServiceUserCredentialsResetResponseServiceComponentsUsage value) {
        this.usage = value;
    }
}
