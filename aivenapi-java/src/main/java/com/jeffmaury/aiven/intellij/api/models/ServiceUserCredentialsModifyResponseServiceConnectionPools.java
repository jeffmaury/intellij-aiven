...
public class ServiceUserCredentialsModifyResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceConnectionPools createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("pool_mode", (n) -> { this.setPoolMode(n.getEnumValue(ServiceUserCredentialsModifyResponseServiceConnectionPoolsPoolMode::forValue)); });
     ...
     */
    public void setPoolMode(@jakarta.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
