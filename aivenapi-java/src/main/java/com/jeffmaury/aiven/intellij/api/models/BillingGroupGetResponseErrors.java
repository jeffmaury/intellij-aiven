...
public class BillingGroupGetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new BillingGroupGetResponseErrors and sets the default values.
     */
    public BillingGroupGetResponseErrors() {
    ...
    public static BillingGroupGetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BillingGroupGetResponseErrors();
    }
    /**
