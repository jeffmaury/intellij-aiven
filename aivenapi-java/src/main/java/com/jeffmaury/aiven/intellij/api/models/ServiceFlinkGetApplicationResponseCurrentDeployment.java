...
public class ServiceFlinkGetApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkGetApplicationResponseCurrentDeployment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkGetApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
