...
public class ServiceFlinkGetApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Deployment status
     */
    private ServiceFlinkGetApplicationResponseCurrentDeploymentStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkGetApplicationResponseCurrentDeployment and sets the default values.
     */
    public ServiceFlinkGetApplicationResponseCurrentDeployment() {
    ...
    public static ServiceFlinkGetApplicationResponseCurrentDeployment createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationResponseCurrentDeployment();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkGetApplicationResponseCurrentDeploymentStatus::forValue)); });
     ...
     * @return a ServiceFlinkGetApplicationResponseCurrentDeploymentStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkGetApplicationResponseCurrentDeploymentStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkGetApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
