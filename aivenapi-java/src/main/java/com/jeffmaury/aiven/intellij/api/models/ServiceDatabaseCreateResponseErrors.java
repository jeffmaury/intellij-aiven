...
public class ServiceDatabaseCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceDatabaseCreateResponseErrors and sets the default values.
     */
    public ServiceDatabaseCreateResponseErrors() {
    ...
    public static ServiceDatabaseCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceDatabaseCreateResponseErrors();
    }
    /**
