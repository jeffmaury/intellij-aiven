...
public class ServicePrivatelinkAzureDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServicePrivatelinkAzureDeleteResponseErrors and sets the default values.
     */
    public ServicePrivatelinkAzureDeleteResponseErrors() {
    ...
    public static ServicePrivatelinkAzureDeleteResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServicePrivatelinkAzureDeleteResponseErrors();
    }
    /**
