...
public class ServiceGetResponseServiceComponents implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private ServiceGetResponseServiceComponentsKafkaAuthenticationMethod kafkaAuthenticationMethod;
    /**
     ...
     */
    private ServiceGetResponseServiceComponentsRoute route;
    /**
     ...
     * DNS usage name
     */
    private ServiceGetResponseServiceComponentsUsage usage;
    /**
     * Instantiates a new ServiceGetResponseServiceComponents and sets the default values.
     */
    public ServiceGetResponseServiceComponents() {
    ...
    public static ServiceGetResponseServiceComponents createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceGetResponseServiceComponents();
    }
    /**
     ...
     * @return a ServiceGetResponseServiceComponentsKafkaAuthenticationMethod
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceComponentsKafkaAuthenticationMethod getKafkaAuthenticationMethod() {
     ...
     * @return a ServiceGetResponseServiceComponentsRoute
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceComponentsRoute getRoute() {
        return this.route;
    }
    /**
     ...
     * @return a ServiceGetResponseServiceComponentsUsage
     */
    @jakarta.annotation.Nullable
    public ServiceGetResponseServiceComponentsUsage getUsage() {
        return this.usage;
    }
    /**
     ...
     */
    public void setKafkaAuthenticationMethod(@jakarta.annotation.Nullable final ServiceGetResponseServiceComponentsKafkaAuthenticationMethod value) {
     ...
     */
    public void setRoute(@jakarta.annotation.Nullable final ServiceGetResponseServiceComponentsRoute value) {
        this.route = value;
    }
    /**
     ...
     */
    public void setUsage(@jakarta.annotation.Nullable final ServiceGetResponseServiceComponentsUsage value) {
        this.usage = value;
    }
}
