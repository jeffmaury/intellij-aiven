...
public class AccountCreateResponseAccount implements AdditionalDataHolder, Parsable {
    /**
     * Describe the source of the account
     */
    private AccountCreateResponseAccountAccessSource accessSource;
    /**
     * Account ID
     */
     ...
     * Feature flags
     */
    private AccountCreateResponseAccountFeatures features;
    /**
    ...
    /**
     * Instantiates a new AccountCreateResponseAccount and sets the default values.
     */
    public AccountCreateResponseAccount() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a AccountCreateResponseAccount
     */
    @jakarta.annotation.Nonnull
    public static AccountCreateResponseAccount createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountCreateResponseAccount();
    }
    /**
     * Gets the access_source property value. Describe the source of the account
     * @return a AccountCreateResponseAccountAccessSource
     */
    @jakarta.annotation.Nullable
    public AccountCreateResponseAccountAccessSource getAccessSource() {
     ...
     * @return a AccountCreateResponseAccountFeatures
     */
    @jakarta.annotation.Nullable
    public AccountCreateResponseAccountFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("access_source", (n) -> { this.setAccessSource(n.getEnumValue(AccountCreateResponseAccountAccessSource::forValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(AccountCreateResponseAccountFeatures::createFromDiscriminatorValue)); });
     ...
     */
    public void setAccessSource(@jakarta.annotation.Nullable final AccountCreateResponseAccountAccessSource value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final AccountCreateResponseAccountFeatures value) {
        this.features = value;
    }
    /**
