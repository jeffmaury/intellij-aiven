...
public class AccountProjectsListResponseProjects implements AdditionalDataHolder, Parsable {
    /**
     * Account ID
     */
     ...
     * Billing currency
     */
    private AccountProjectsListResponseProjectsBillingCurrency billingCurrency;
    /**
     * List of project billing email addresses
     */
    private java.util.List<AccountProjectsListResponseProjectsBillingEmails> billingEmails;
    /**
     ...
     */
    private AccountProjectsListResponseProjectsCardInfo cardInfo;
    /**
     * Address city
     */
    private String city;
     ...
     */
    private AccountProjectsListResponseProjectsEndOfLifeExtension endOfLifeExtension;
    /**
     ...
     * Feature flags
     */
    private AccountProjectsListResponseProjectsFeatures features;
    /**
     * Organization ID
     */
     ...
     */
    private AccountProjectsListResponseProjectsTags tags;
    /**
     * List of project tech email addresses
     */
    private java.util.List<AccountProjectsListResponseProjectsTechEmails> techEmails;
    /**
     * Tenant ID
     */
    ...
    /**
     * Instantiates a new AccountProjectsListResponseProjects and sets the default values.
     */
    public AccountProjectsListResponseProjects() {
    ...
    public static AccountProjectsListResponseProjects createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AccountProjectsListResponseProjects();
    }
    /**
     ...
     * @return a AccountProjectsListResponseProjectsBillingCurrency
     */
    @jakarta.annotation.Nullable
    public AccountProjectsListResponseProjectsBillingCurrency getBillingCurrency() {
        return this.billingCurrency;
    }
    /**
     * Gets the billing_emails property value. List of project billing email addresses
     * @return a java.util.List<AccountProjectsListResponseProjectsBillingEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<AccountProjectsListResponseProjectsBillingEmails> getBillingEmails() {
     ...
     */
    @jakarta.annotation.Nullable
    public AccountProjectsListResponseProjectsCardInfo getCardInfo() {
     ...
     */
    @jakarta.annotation.Nullable
    public AccountProjectsListResponseProjectsEndOfLifeExtension getEndOfLifeExtension() {
     ...
     * @return a AccountProjectsListResponseProjectsFeatures
     */
    @jakarta.annotation.Nullable
    public AccountProjectsListResponseProjectsFeatures getFeatures() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("card_info", (n) -> { this.setCardInfo(n.getObjectValue(AccountProjectsListResponseProjectsCardInfo::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("end_of_life_extension", (n) -> { this.setEndOfLifeExtension(n.getObjectValue(AccountProjectsListResponseProjectsEndOfLifeExtension::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("features", (n) -> { this.setFeatures(n.getObjectValue(AccountProjectsListResponseProjectsFeatures::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("tags", (n) -> { this.setTags(n.getObjectValue(AccountProjectsListResponseProjectsTags::createFromDiscriminatorValue)); });
        deserializerMap.put("tech_emails", (n) -> { this.setTechEmails(n.getCollectionOfObjectValues(AccountProjectsListResponseProjectsTechEmails::createFromDiscriminatorValue)); });
     ...
     * @return a AccountProjectsListResponseProjectsTags
     */
    @jakarta.annotation.Nullable
    public AccountProjectsListResponseProjectsTags getTags() {
        return this.tags;
    }
    /**
     * Gets the tech_emails property value. List of project tech email addresses
     * @return a java.util.List<AccountProjectsListResponseProjectsTechEmails>
     */
    @jakarta.annotation.Nullable
    public java.util.List<AccountProjectsListResponseProjectsTechEmails> getTechEmails() {
     ...
     */
    public void setBillingCurrency(@jakarta.annotation.Nullable final AccountProjectsListResponseProjectsBillingCurrency value) {
     ...
     */
    public void setBillingEmails(@jakarta.annotation.Nullable final java.util.List<AccountProjectsListResponseProjectsBillingEmails> value) {
     ...
     */
    public void setCardInfo(@jakarta.annotation.Nullable final AccountProjectsListResponseProjectsCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    public void setEndOfLifeExtension(@jakarta.annotation.Nullable final AccountProjectsListResponseProjectsEndOfLifeExtension value) {
     ...
     */
    public void setFeatures(@jakarta.annotation.Nullable final AccountProjectsListResponseProjectsFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    public void setTags(@jakarta.annotation.Nullable final AccountProjectsListResponseProjectsTags value) {
        this.tags = value;
    }
    /**
     ...
     */
    public void setTechEmails(@jakarta.annotation.Nullable final java.util.List<AccountProjectsListResponseProjectsTechEmails> value) {
