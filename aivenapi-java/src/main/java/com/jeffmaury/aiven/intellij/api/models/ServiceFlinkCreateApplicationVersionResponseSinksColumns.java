...
public class ServiceFlinkCreateApplicationVersionResponseSinksColumns implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationVersionResponseSinksColumns createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
