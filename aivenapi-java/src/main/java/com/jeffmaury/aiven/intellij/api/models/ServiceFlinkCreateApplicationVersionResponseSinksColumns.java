...
public class ServiceFlinkCreateApplicationVersionResponseSinksColumns implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceFlinkCreateApplicationVersionResponseSinksColumns and sets the default values.
     */
    public ServiceFlinkCreateApplicationVersionResponseSinksColumns() {
    ...
    public static ServiceFlinkCreateApplicationVersionResponseSinksColumns createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkCreateApplicationVersionResponseSinksColumns();
    }
    /**
