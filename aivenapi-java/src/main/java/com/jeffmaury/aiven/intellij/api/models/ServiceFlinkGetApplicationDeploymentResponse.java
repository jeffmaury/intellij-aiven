...
public class ServiceFlinkGetApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ServiceFlinkGetApplicationDeploymentResponseErrors> errors;
    /**
     * Deployment ID
     */
    private String id;
     ...
     * Deployment status
     */
    private ServiceFlinkGetApplicationDeploymentResponseStatus status;
    /**
     * ApplicationVersion ID
     */
    private String versionId;
    /**
     * Instantiates a new ServiceFlinkGetApplicationDeploymentResponse and sets the default values.
     */
    public ServiceFlinkGetApplicationDeploymentResponse() {
    ...
    public static ServiceFlinkGetApplicationDeploymentResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceFlinkGetApplicationDeploymentResponse();
    }
    /**
     ...
     * @return a java.util.List<ServiceFlinkGetApplicationDeploymentResponseErrors>
     */
    @jakarta.annotation.Nullable
    public java.util.List<ServiceFlinkGetApplicationDeploymentResponseErrors> getErrors() {
        return this.errors;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("errors", (n) -> { this.setErrors(n.getCollectionOfObjectValues(ServiceFlinkGetApplicationDeploymentResponseErrors::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkGetApplicationDeploymentResponseStatus::forValue)); });
     ...
     * @return a ServiceFlinkGetApplicationDeploymentResponseStatus
     */
    @jakarta.annotation.Nullable
    public ServiceFlinkGetApplicationDeploymentResponseStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    public void setErrors(@jakarta.annotation.Nullable final java.util.List<ServiceFlinkGetApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final ServiceFlinkGetApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
