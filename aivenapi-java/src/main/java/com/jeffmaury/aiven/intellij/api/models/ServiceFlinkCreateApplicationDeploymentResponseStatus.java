...
public enum ServiceFlinkCreateApplicationDeploymentResponseStatus implements ValuedEnum {
    ...
    ServiceFlinkCreateApplicationDeploymentResponseStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceFlinkCreateApplicationDeploymentResponseStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
