...
public class ProjectListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectListResponseErrors and sets the default values.
     */
    public ProjectListResponseErrors() {
    ...
    public static ProjectListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectListResponseErrors();
    }
    /**
