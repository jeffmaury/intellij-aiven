...
public class ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSynonyms implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSynonyms createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("source", (n) -> { this.setSource(n.getEnumValue(ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSynonymsSource::forValue)); });
     ...
     */
    public void setSource(@jakarta.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSynonymsSource value) {
        this.source = value;
    }
    /**
