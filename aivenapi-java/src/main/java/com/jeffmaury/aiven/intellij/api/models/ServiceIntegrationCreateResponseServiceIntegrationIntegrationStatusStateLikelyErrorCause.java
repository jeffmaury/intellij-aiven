...
public enum ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatusStateLikelyErrorCause implements ValuedEnum {
    ...
    public static ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatusStateLikelyErrorCause forValue(@jakarta.annotation.Nonnull final String searchValue) {
