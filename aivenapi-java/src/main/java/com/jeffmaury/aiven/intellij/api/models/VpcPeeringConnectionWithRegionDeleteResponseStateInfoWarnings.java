...
public class VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarnings implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarnings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarningsType value) {
        this.type = value;
    }
}
