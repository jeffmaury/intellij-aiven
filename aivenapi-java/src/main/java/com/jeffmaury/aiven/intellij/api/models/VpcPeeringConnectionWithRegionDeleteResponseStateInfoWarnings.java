...
public class VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarnings implements AdditionalDataHolder, Parsable {
    /**
     ...
     * Type of warning
     */
    private VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarningsType type;
    /**
     * Instantiates a new VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarnings and sets the default values.
     */
    public VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarnings() {
    ...
    public static VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarnings createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarnings();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("type", (n) -> { this.setType(n.getEnumValue(VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarningsType::forValue)); });
     ...
     * @return a VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarningsType
     */
    @jakarta.annotation.Nullable
    public VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarningsType getType() {
        return this.type;
    }
    /**
     ...
     */
    public void setType(@jakarta.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseStateInfoWarningsType value) {
        this.type = value;
    }
}
