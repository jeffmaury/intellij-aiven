...
public class ServiceIntegrationTypesResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationTypesResponseErrors and sets the default values.
     */
    public ServiceIntegrationTypesResponseErrors() {
    ...
    public static ServiceIntegrationTypesResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationTypesResponseErrors();
    }
    /**
