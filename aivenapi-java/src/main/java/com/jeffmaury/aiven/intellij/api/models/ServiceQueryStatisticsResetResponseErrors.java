...
public class ServiceQueryStatisticsResetResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceQueryStatisticsResetResponseErrors and sets the default values.
     */
    public ServiceQueryStatisticsResetResponseErrors() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a ServiceQueryStatisticsResetResponseErrors
     */
    @jakarta.annotation.Nonnull
    public static ServiceQueryStatisticsResetResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceQueryStatisticsResetResponseErrors();
    }
    /**
