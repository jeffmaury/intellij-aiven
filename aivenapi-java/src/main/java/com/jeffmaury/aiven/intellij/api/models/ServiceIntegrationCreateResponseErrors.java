...
public class ServiceIntegrationCreateResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ServiceIntegrationCreateResponseErrors and sets the default values.
     */
    public ServiceIntegrationCreateResponseErrors() {
    ...
    public static ServiceIntegrationCreateResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ServiceIntegrationCreateResponseErrors();
    }
    /**
