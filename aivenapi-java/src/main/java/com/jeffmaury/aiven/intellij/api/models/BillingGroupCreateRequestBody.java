...
public class BillingGroupCreateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("copy_from_billing_group", (n) -> { this.setCopyFromBillingGroup(n.getStringValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("copy_from_billing_group", this.getCopyFromBillingGroup());
