...
public enum ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMaxCompactionLagMsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
