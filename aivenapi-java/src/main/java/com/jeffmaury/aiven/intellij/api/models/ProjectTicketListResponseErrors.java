...
public class ProjectTicketListResponseErrors implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new ProjectTicketListResponseErrors and sets the default values.
     */
    public ProjectTicketListResponseErrors() {
    ...
    public static ProjectTicketListResponseErrors createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ProjectTicketListResponseErrors();
    }
    /**
