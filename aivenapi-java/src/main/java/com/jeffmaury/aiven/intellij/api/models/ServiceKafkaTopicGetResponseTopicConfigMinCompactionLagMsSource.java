...
public enum ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSource implements ValuedEnum {
    ...
    ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSource(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static ServiceKafkaTopicGetResponseTopicConfigMinCompactionLagMsSource forValue(@jakarta.annotation.Nonnull final String searchValue) {
