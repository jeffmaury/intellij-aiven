...
public class AccountAuthenticationMethodGetResponseAuthenticationMethod implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodGetResponseAuthenticationMethod createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthenticationMethodType(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethodAuthenticationMethodType value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSamlCert(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethodSamlCert value) {
        this.samlCert = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSamlDigestAlgorithm(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethodSamlDigestAlgorithm value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSamlFieldMapping(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSamlSignatureAlgorithm(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethodSamlSignatureAlgorithm value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSamlVariant(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethodSamlVariant value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final AccountAuthenticationMethodGetResponseAuthenticationMethodState value) {
        this.state = value;
    }
    /**
