...
public class ProjectStaticIPPatchResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectStaticIPPatchResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ProjectStaticIPPatchResponseErrors
     */
    @javax.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ProjectStaticIPPatchResponseState.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ProjectStaticIPPatchResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ProjectStaticIPPatchResponseState value) {
        this.state = value;
    }
    /**
