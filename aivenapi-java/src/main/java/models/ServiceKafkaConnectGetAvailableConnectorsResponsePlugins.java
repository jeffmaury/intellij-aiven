...
public class ServiceKafkaConnectGetAvailableConnectorsResponsePlugins implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectGetAvailableConnectorsResponsePlugins createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final ServiceKafkaConnectGetAvailableConnectorsResponsePluginsType value) {
        this.type = value;
    }
    /**
