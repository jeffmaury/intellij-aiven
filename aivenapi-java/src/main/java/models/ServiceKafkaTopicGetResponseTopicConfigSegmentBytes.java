...
public class ServiceKafkaTopicGetResponseTopicConfigSegmentBytes implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigSegmentBytes createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSource(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigSegmentBytesSource value) {
        this.source = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSynonyms(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigSegmentBytesSynonyms> value) {
        this.synonyms = value;
    }
    /**
