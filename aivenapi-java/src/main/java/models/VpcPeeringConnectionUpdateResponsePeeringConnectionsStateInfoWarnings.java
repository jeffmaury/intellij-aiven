...
public class VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarnings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfoWarningsType value) {
        this.type = value;
    }
}
