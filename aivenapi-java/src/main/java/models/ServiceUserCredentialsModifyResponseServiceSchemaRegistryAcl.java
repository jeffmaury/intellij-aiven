...
public class ServiceUserCredentialsModifyResponseServiceSchemaRegistryAcl implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceSchemaRegistryAcl createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPermission(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceSchemaRegistryAclPermission value) {
