...
public class ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceBackupsAdditionalRegions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
