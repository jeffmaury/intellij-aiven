...
public class OrganizationUserInvitationAcceptRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUserInvitationAcceptRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("action", (n) -> { this.setAction(n.getEnumValue(OrganizationUserInvitationAcceptRequestBodyAction.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setAction(@javax.annotation.Nullable final OrganizationUserInvitationAcceptRequestBodyAction value) {
        this.action = value;
    }
    /**
