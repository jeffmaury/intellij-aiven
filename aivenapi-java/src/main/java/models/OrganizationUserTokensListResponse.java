...
public class OrganizationUserTokensListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUserTokensListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTokens(@javax.annotation.Nullable final java.util.List<OrganizationUserTokensListResponseTokens> value) {
        this.tokens = value;
    }
}
