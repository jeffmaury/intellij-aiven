...
public enum ServiceGetResponseServiceServiceIntegrationsIntegrationStatusStateLikelyErrorCause implements ValuedEnum {
    ...
    public static ServiceGetResponseServiceServiceIntegrationsIntegrationStatusStateLikelyErrorCause forValue(@javax.annotation.Nonnull final String searchValue) {
