...
public class ServiceIntegrationCreateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationCreateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationType(@javax.annotation.Nullable final ServiceIntegrationCreateRequestBodyIntegrationType value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationCreateRequestBodyUserConfig value) {
