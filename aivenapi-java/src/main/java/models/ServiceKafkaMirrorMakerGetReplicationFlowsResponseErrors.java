...
public class ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowsResponseErrors createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
