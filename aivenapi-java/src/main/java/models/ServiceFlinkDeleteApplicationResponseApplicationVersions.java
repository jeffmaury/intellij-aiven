...
public class ServiceFlinkDeleteApplicationResponseApplicationVersions implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationResponseApplicationVersions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSinks(@javax.annotation.Nullable final java.util.List<ServiceFlinkDeleteApplicationResponseApplicationVersionsSinks> value) {
        this.sinks = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSources(@javax.annotation.Nullable final java.util.List<ServiceFlinkDeleteApplicationResponseApplicationVersionsSources> value) {
        this.sources = value;
    }
    /**
