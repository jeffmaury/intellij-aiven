...
public class ServiceOpenSearchAclSetRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchAclSetRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setOpensearchAclConfig(@javax.annotation.Nullable final ServiceOpenSearchAclSetRequestBodyOpensearchAclConfig value) {
