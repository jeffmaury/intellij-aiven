...
public class ServiceCreateResponseServiceServiceNotificationsMetadata implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceServiceNotificationsMetadata createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
