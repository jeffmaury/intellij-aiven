...
public class ServiceFlinkGetApplicationResponseApplicationVersionsSinksColumns implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkGetApplicationResponseApplicationVersionsSinksColumns createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
