...
public class ServicePrivatelinkAWSUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServicePrivatelinkAWSUpdateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServicePrivatelinkAWSUpdateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServicePrivatelinkAWSUpdateResponseState value) {
        this.state = value;
    }
}
