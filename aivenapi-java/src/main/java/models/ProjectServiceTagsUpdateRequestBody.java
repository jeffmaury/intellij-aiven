...
public class ProjectServiceTagsUpdateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectServiceTagsUpdateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTags(@javax.annotation.Nullable final ProjectServiceTagsUpdateRequestBodyTags value) {
        this.tags = value;
    }
}
