...
public class AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodGetResponseAuthenticationMethodSamlFieldMapping createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
