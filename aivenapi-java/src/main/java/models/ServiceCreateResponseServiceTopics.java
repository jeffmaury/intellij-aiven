...
public class ServiceCreateResponseServiceTopics implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceTopics createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceCreateResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
