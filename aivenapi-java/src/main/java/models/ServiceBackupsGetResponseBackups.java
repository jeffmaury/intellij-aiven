...
public class ServiceBackupsGetResponseBackups implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceBackupsGetResponseBackups createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceBackupsGetResponseBackupsAdditionalRegions
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setAdditionalRegions(@javax.annotation.Nullable final java.util.List<ServiceBackupsGetResponseBackupsAdditionalRegions> value) {
