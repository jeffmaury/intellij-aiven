...
public class OrganizationProjectsListResponseProjectsEndOfLifeExtensionElasticsearch implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationProjectsListResponseProjectsEndOfLifeExtensionElasticsearch createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
