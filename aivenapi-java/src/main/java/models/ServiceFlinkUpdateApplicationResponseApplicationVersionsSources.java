...
public class ServiceFlinkUpdateApplicationResponseApplicationVersionsSources implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkUpdateApplicationResponseApplicationVersionsSources createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setColumns(@javax.annotation.Nullable final java.util.List<ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setOptions(@javax.annotation.Nullable final ServiceFlinkUpdateApplicationResponseApplicationVersionsSourcesOptions value) {
        this.options = value;
    }
    /**
