...
public class ServiceFlinkGetApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkGetApplicationDeploymentResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkGetApplicationDeploymentResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkGetApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkGetApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
