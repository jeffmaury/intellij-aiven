...
public class ListProjectServiceTypesResponseServiceTypes implements AdditionalDataHolder, Parsable {
    ...
    public static ListProjectServiceTypesResponseServiceTypes createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setANY(@javax.annotation.Nullable final ListProjectServiceTypesResponseServiceTypesANY value) {
        this.aNY = value;
    }
}
