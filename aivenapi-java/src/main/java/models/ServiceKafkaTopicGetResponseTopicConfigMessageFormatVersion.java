...
public class ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersion implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersion createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSource(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersionSource value) {
        this.source = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSynonyms(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersionSynonyms> value) {
        this.synonyms = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setValue(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMessageFormatVersionValue value) {
        this.value = value;
    }
}
