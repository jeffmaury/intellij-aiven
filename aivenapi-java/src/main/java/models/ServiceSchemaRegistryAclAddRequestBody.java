...
public class ServiceSchemaRegistryAclAddRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistryAclAddRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPermission(@javax.annotation.Nullable final ServiceSchemaRegistryAclAddRequestBodyPermission value) {
