...
public class ServiceFlinkDeleteApplicationVersionResponseSources implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationVersionResponseSources createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setColumns(@javax.annotation.Nullable final java.util.List<ServiceFlinkDeleteApplicationVersionResponseSourcesColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setOptions(@javax.annotation.Nullable final ServiceFlinkDeleteApplicationVersionResponseSourcesOptions value) {
        this.options = value;
    }
    /**
