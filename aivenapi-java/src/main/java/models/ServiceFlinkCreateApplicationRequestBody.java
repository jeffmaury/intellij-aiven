...
public class ServiceFlinkCreateApplicationRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setApplicationVersion(@javax.annotation.Nullable final ServiceFlinkCreateApplicationRequestBodyApplicationVersion value) {
