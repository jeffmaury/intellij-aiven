...
public class ServiceIntegrationEndpointGetResponseServiceIntegrationEndpoint implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationEndpointGetResponseServiceIntegrationEndpoint createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("endpoint_type", (n) -> { this.setEndpointType(n.getEnumValue(ServiceIntegrationEndpointGetResponseServiceIntegrationEndpointEndpointType.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setEndpointConfig(@javax.annotation.Nullable final ServiceIntegrationEndpointGetResponseServiceIntegrationEndpointEndpointConfig value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setEndpointType(@javax.annotation.Nullable final ServiceIntegrationEndpointGetResponseServiceIntegrationEndpointEndpointType value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationEndpointGetResponseServiceIntegrationEndpointUserConfig value) {
