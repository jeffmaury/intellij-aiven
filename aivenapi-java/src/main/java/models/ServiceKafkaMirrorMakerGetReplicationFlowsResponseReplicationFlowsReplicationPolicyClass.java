...
public enum ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass implements ValuedEnum {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass forValue(@javax.annotation.Nonnull final String searchValue) {
