...
public class ServiceListResponseServicesServiceIntegrations implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesServiceIntegrations createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceListResponseServicesServiceIntegrationsUserConfig value) {
