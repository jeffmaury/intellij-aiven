...
public class ServiceOpenSearchAclSetRequestBodyOpensearchAclConfig implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchAclSetRequestBodyOpensearchAclConfig createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAcls(@javax.annotation.Nullable final java.util.List<ServiceOpenSearchAclSetRequestBodyOpensearchAclConfigAcls> value) {
        this.acls = value;
    }
    /**
