...
public class ServiceFlinkValidateApplicationVersionRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkValidateApplicationVersionRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSinks(@javax.annotation.Nullable final java.util.List<ServiceFlinkValidateApplicationVersionRequestBodySinks> value) {
        this.sinks = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSources(@javax.annotation.Nullable final java.util.List<ServiceFlinkValidateApplicationVersionRequestBodySources> value) {
        this.sources = value;
    }
    /**
