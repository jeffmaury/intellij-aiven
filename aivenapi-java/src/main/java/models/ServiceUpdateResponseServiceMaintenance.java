...
public class ServiceUpdateResponseServiceMaintenance implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateResponseServiceMaintenance createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setDow(@javax.annotation.Nullable final ServiceUpdateResponseServiceMaintenanceDow value) {
        this.dow = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUpdates(@javax.annotation.Nullable final java.util.List<ServiceUpdateResponseServiceMaintenanceUpdates> value) {
        this.updates = value;
    }
}
