...
public class ServiceKafkaConnectGetConnectorConfigurationResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectGetConnectorConfigurationResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @param value Value to set for the configurationSchema property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setConfigurationSchema(@javax.annotation.Nullable final java.util.List<ServiceKafkaConnectGetConnectorConfigurationResponseConfigurationSchema> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaConnectGetConnectorConfigurationResponseErrors> value) {
        this.errors = value;
    }
    /**
