...
public class ServiceFlinkCreateApplicationVersionResponseSourcesColumns implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationVersionResponseSourcesColumns createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
