...
public class AccountGetResponseAccount implements AdditionalDataHolder, Parsable {
    ...
    public static AccountGetResponseAccount createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessSource(@javax.annotation.Nullable final AccountGetResponseAccountAccessSource value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setFeatures(@javax.annotation.Nullable final AccountGetResponseAccountFeatures value) {
        this.features = value;
    }
    /**
