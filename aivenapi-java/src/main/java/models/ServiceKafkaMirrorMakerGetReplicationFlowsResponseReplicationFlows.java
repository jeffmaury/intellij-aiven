...
public class ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlows createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setOffsetSyncsTopicLocation(@javax.annotation.Nullable final ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setReplicationPolicyClass(@javax.annotation.Nullable final ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsReplicationPolicyClass value) {
