...
public class ServiceUserCredentialsResetResponseServiceNodeStates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceNodeStates createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setProgressUpdates(@javax.annotation.Nullable final java.util.List<ServiceUserCredentialsResetResponseServiceNodeStatesProgressUpdates> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRole(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceNodeStatesRole value) {
        this.role = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setShard(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceNodeStatesShard value) {
        this.shard = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceNodeStatesState value) {
        this.state = value;
    }
}
