...
public enum ServiceKafkaTopicGetResponseTopicConfigMessageTimestampDifferenceMaxMsSynonymsSource implements ValuedEnum {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMessageTimestampDifferenceMaxMsSynonymsSource forValue(@javax.annotation.Nonnull final String searchValue) {
