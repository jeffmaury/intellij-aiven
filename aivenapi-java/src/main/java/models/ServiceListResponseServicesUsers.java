...
public class ServiceListResponseServicesUsers implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceListResponseServicesUsers createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessControl(@javax.annotation.Nullable final ServiceListResponseServicesUsersAccessControl value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthentication(@javax.annotation.Nullable final ServiceListResponseServicesUsersAuthentication value) {
