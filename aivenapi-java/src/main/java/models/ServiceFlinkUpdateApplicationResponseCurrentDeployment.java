...
public class ServiceFlinkUpdateApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkUpdateApplicationResponseCurrentDeployment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkUpdateApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
