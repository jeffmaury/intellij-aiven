...
public class ServiceFlinkDeleteApplicationResponseApplicationVersionsSourcesColumns implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationResponseApplicationVersionsSourcesColumns createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
