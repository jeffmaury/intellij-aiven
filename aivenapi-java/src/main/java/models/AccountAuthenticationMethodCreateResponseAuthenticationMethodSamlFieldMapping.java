...
public class AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlFieldMapping implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodCreateResponseAuthenticationMethodSamlFieldMapping createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
