...
public class ServiceKafkaTopicGetResponseTopicConfigMaxMessageBytes implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigMaxMessageBytes createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSource(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigMaxMessageBytesSource value) {
        this.source = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSynonyms(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseTopicConfigMaxMessageBytesSynonyms> value) {
        this.synonyms = value;
    }
    /**
