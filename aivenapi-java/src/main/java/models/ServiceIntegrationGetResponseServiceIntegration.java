...
public class ServiceIntegrationGetResponseServiceIntegration implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationGetResponseServiceIntegration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceIntegrationGetResponseServiceIntegrationIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationGetResponseServiceIntegrationUserConfig value) {
