...
public class OrganizationUserSetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUserSetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserInfo(@javax.annotation.Nullable final OrganizationUserSetResponseUserInfo value) {
        this.userInfo = value;
    }
}
