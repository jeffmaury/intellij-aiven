...
public class OrganizationUserUpdateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUserUpdateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserInfo(@javax.annotation.Nullable final OrganizationUserUpdateResponseUserInfo value) {
        this.userInfo = value;
    }
}
