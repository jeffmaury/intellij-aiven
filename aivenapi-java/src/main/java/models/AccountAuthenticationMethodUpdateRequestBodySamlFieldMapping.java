...
public class AccountAuthenticationMethodUpdateRequestBodySamlFieldMapping implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodUpdateRequestBodySamlFieldMapping createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
