...
public class ServiceCreateResponseServiceServiceIntegrations implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceServiceIntegrations createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceCreateResponseServiceServiceIntegrationsIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceCreateResponseServiceServiceIntegrationsUserConfig value) {
