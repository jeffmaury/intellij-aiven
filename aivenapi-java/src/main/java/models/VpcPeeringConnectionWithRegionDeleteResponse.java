...
public class VpcPeeringConnectionWithRegionDeleteResponse implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionWithRegionDeleteResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a VpcPeeringConnectionWithRegionDeleteResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<VpcPeeringConnectionWithRegionDeleteResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStateInfo(@javax.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseStateInfo value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setVpcPeeringConnectionType(@javax.annotation.Nullable final VpcPeeringConnectionWithRegionDeleteResponseVpcPeeringConnectionType value) {
