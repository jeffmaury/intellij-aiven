...
public class AccountBillingGroupListResponseAccountBillingGroups implements AdditionalDataHolder, Parsable {
    ...
    public static AccountBillingGroupListResponseAccountBillingGroups createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a AccountBillingGroupListResponseAccountBillingGroupsBillingEmails
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingCurrency(@javax.annotation.Nullable final AccountBillingGroupListResponseAccountBillingGroupsBillingCurrency value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingEmails(@javax.annotation.Nullable final java.util.List<AccountBillingGroupListResponseAccountBillingGroupsBillingEmails> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCardInfo(@javax.annotation.Nullable final AccountBillingGroupListResponseAccountBillingGroupsCardInfo value) {
        this.cardInfo = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPaymentMethod(@javax.annotation.Nullable final AccountBillingGroupListResponseAccountBillingGroupsPaymentMethod value) {
