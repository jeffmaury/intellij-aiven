...
public class ServiceUpdateResponseServiceUsers implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateResponseServiceUsers createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessControl(@javax.annotation.Nullable final ServiceUpdateResponseServiceUsersAccessControl value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthentication(@javax.annotation.Nullable final ServiceUpdateResponseServiceUsersAuthentication value) {
