...
public class PgAvailableExtensionsResponsePg implements AdditionalDataHolder, Parsable {
    ...
    public static PgAvailableExtensionsResponsePg createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setExtensions(@javax.annotation.Nullable final java.util.List<PgAvailableExtensionsResponsePgExtensions> value) {
