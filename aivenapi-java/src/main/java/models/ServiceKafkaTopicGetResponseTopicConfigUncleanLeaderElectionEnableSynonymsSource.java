...
public enum ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSynonymsSource implements ValuedEnum {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigUncleanLeaderElectionEnableSynonymsSource forValue(@javax.annotation.Nonnull final String searchValue) {
