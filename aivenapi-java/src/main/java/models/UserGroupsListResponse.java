...
public class UserGroupsListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static UserGroupsListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserGroups(@javax.annotation.Nullable final java.util.List<UserGroupsListResponseUserGroups> value) {
