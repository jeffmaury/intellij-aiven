...
public class ServiceCreateResponseServiceNodeStatesProgressUpdates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceNodeStatesProgressUpdates createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPhase(@javax.annotation.Nullable final ServiceCreateResponseServiceNodeStatesProgressUpdatesPhase value) {
        this.phase = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUnit(@javax.annotation.Nullable final ServiceCreateResponseServiceNodeStatesProgressUpdatesUnit value) {
        this.unit = value;
    }
}
