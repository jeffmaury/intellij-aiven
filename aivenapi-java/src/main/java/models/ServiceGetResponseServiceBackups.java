...
public class ServiceGetResponseServiceBackups implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceBackups createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAdditionalRegions(@javax.annotation.Nullable final java.util.List<ServiceGetResponseServiceBackupsAdditionalRegions> value) {
