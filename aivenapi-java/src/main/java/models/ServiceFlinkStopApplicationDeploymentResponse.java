...
public class ServiceFlinkStopApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkStopApplicationDeploymentResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkStopApplicationDeploymentResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkStopApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkStopApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
