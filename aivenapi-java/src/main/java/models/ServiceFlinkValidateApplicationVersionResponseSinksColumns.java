...
public class ServiceFlinkValidateApplicationVersionResponseSinksColumns implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkValidateApplicationVersionResponseSinksColumns createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
