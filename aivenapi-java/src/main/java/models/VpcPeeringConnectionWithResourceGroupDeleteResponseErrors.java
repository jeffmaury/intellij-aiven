...
public class VpcPeeringConnectionWithResourceGroupDeleteResponseErrors implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionWithResourceGroupDeleteResponseErrors createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
