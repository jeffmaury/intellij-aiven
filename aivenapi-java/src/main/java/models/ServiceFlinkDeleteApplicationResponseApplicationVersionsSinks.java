...
public class ServiceFlinkDeleteApplicationResponseApplicationVersionsSinks implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationResponseApplicationVersionsSinks createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setColumns(@javax.annotation.Nullable final java.util.List<ServiceFlinkDeleteApplicationResponseApplicationVersionsSinksColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setOptions(@javax.annotation.Nullable final ServiceFlinkDeleteApplicationResponseApplicationVersionsSinksOptions value) {
        this.options = value;
    }
    /**
