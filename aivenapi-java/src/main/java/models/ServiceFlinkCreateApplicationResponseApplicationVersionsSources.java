...
public class ServiceFlinkCreateApplicationResponseApplicationVersionsSources implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationResponseApplicationVersionsSources createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setColumns(@javax.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setOptions(@javax.annotation.Nullable final ServiceFlinkCreateApplicationResponseApplicationVersionsSourcesOptions value) {
        this.options = value;
    }
    /**
