...
public class ServiceKafkaAclAddResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaAclAddResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAcl(@javax.annotation.Nullable final java.util.List<ServiceKafkaAclAddResponseAcl> value) {
        this.acl = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaAclAddResponseErrors> value) {
        this.errors = value;
    }
    /**
