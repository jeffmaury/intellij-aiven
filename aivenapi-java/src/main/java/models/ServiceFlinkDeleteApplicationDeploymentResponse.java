...
public class ServiceFlinkDeleteApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkDeleteApplicationDeploymentResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkDeleteApplicationDeploymentResponseErrors
     */
    @javax.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(ServiceFlinkDeleteApplicationDeploymentResponseStatus.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkDeleteApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkDeleteApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
