...
public class ServiceFlinkCreateApplicationResponseCurrentDeployment implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationResponseCurrentDeployment createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkCreateApplicationResponseCurrentDeploymentStatus value) {
        this.status = value;
    }
    /**
