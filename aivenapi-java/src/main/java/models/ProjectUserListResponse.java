...
public class ProjectUserListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectUserListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ProjectUserListResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ProjectUserListResponseErrors> value) {
        this.errors = value;
    }
    /**
     * Sets the group_users property value. List of users in groups that have access to the project
     * @param value Value to set for the groupUsers property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setGroupUsers(@javax.annotation.Nullable final java.util.List<ProjectUserListResponseGroupUsers> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setInvitations(@javax.annotation.Nullable final java.util.List<ProjectUserListResponseInvitations> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUsers(@javax.annotation.Nullable final java.util.List<ProjectUserListResponseUsers> value) {
        this.users = value;
    }
}
