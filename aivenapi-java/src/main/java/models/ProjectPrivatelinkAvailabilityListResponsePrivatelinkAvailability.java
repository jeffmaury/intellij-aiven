...
public class ProjectPrivatelinkAvailabilityListResponsePrivatelinkAvailability implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectPrivatelinkAvailabilityListResponsePrivatelinkAvailability createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
