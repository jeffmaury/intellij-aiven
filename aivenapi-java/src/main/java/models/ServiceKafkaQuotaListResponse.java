...
public class ServiceKafkaQuotaListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaQuotaListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaQuotaListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setQuotas(@javax.annotation.Nullable final java.util.List<ServiceKafkaQuotaListResponseQuotas> value) {
        this.quotas = value;
    }
}
