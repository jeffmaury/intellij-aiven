...
public class VpcPeeringConnectionUpdateResponsePeeringConnections implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionUpdateResponsePeeringConnections createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStateInfo(@javax.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsStateInfo value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setVpcPeeringConnectionType(@javax.annotation.Nullable final VpcPeeringConnectionUpdateResponsePeeringConnectionsVpcPeeringConnectionType value) {
