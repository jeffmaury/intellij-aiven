...
public class ProjectCreateResponseProjectEndOfLifeExtension implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectCreateResponseProjectEndOfLifeExtension createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setElasticsearch(@javax.annotation.Nullable final ProjectCreateResponseProjectEndOfLifeExtensionElasticsearch value) {
