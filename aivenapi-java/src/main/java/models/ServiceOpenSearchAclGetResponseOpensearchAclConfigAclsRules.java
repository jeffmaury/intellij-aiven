...
public class ServiceOpenSearchAclGetResponseOpensearchAclConfigAclsRules implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchAclGetResponseOpensearchAclConfigAclsRules createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("permission", (n) -> { this.setPermission(n.getEnumValue(ServiceOpenSearchAclGetResponseOpensearchAclConfigAclsRulesPermission.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setPermission(@javax.annotation.Nullable final ServiceOpenSearchAclGetResponseOpensearchAclConfigAclsRulesPermission value) {
