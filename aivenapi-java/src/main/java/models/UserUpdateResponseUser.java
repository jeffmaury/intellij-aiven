...
public class UserUpdateResponseUser implements AdditionalDataHolder, Parsable {
    ...
    public static UserUpdateResponseUser createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a UserUpdateResponseUserInvitations
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setFeatures(@javax.annotation.Nullable final UserUpdateResponseUserFeatures value) {
        this.features = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setIntercom(@javax.annotation.Nullable final UserUpdateResponseUserIntercom value) {
        this.intercom = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setInvitations(@javax.annotation.Nullable final java.util.List<UserUpdateResponseUserInvitations> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setProjectMembership(@javax.annotation.Nullable final UserUpdateResponseUserProjectMembership value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setProjectMemberships(@javax.annotation.Nullable final UserUpdateResponseUserProjectMemberships value) {
