...
public class ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpoint createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setEndpointConfig(@javax.annotation.Nullable final ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointConfig value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setEndpointType(@javax.annotation.Nullable final ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointEndpointType value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationEndpointUpdateResponseServiceIntegrationEndpointUserConfig value) {
