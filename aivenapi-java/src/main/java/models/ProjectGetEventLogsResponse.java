...
public class ProjectGetEventLogsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectGetEventLogsResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ProjectGetEventLogsResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setEvents(@javax.annotation.Nullable final java.util.List<ProjectGetEventLogsResponseEvents> value) {
        this.events = value;
    }
    /**
