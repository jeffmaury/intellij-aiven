...
public class ServiceUpdateResponseServiceTopics implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateResponseServiceTopics createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("state", (n) -> { this.setState(n.getEnumValue(ServiceUpdateResponseServiceTopicsState.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceUpdateResponseServiceTopicsState value) {
        this.state = value;
    }
    /**
