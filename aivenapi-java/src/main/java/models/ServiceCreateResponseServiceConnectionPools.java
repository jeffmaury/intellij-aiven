...
public class ServiceCreateResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceCreateResponseServiceConnectionPools createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPoolMode(@javax.annotation.Nullable final ServiceCreateResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
