...
public class ServiceKafkaTieredStorageStorageUsageByTopicResponseErrors implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTieredStorageStorageUsageByTopicResponseErrors createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
