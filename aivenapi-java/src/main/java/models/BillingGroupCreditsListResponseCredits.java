...
public class BillingGroupCreditsListResponseCredits implements AdditionalDataHolder, Parsable {
    ...
    public static BillingGroupCreditsListResponseCredits createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final BillingGroupCreditsListResponseCreditsType value) {
        this.type = value;
    }
    /**
