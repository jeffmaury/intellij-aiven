...
public class ServiceFlinkValidateApplicationVersionRequestBodySources implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkValidateApplicationVersionRequestBodySources createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
