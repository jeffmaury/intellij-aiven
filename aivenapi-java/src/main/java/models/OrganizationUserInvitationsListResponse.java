...
public class OrganizationUserInvitationsListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUserInvitationsListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setInvitations(@javax.annotation.Nullable final java.util.List<OrganizationUserInvitationsListResponseInvitations> value) {
