...
public class AccountCreateResponseAccount implements AdditionalDataHolder, Parsable {
    ...
    public static AccountCreateResponseAccount createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAccessSource(@javax.annotation.Nullable final AccountCreateResponseAccountAccessSource value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setFeatures(@javax.annotation.Nullable final AccountCreateResponseAccountFeatures value) {
        this.features = value;
    }
    /**
