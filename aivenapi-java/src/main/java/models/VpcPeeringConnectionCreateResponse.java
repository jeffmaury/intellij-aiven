...
public class VpcPeeringConnectionCreateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionCreateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a VpcPeeringConnectionCreateResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<VpcPeeringConnectionCreateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final VpcPeeringConnectionCreateResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStateInfo(@javax.annotation.Nullable final VpcPeeringConnectionCreateResponseStateInfo value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setVpcPeeringConnectionType(@javax.annotation.Nullable final VpcPeeringConnectionCreateResponseVpcPeeringConnectionType value) {
