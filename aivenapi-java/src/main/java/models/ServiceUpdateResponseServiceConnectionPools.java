...
public class ServiceUpdateResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateResponseServiceConnectionPools createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPoolMode(@javax.annotation.Nullable final ServiceUpdateResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
