...
public class ServiceKafkaConnectGetConnectorConfigurationResponseErrors implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectGetConnectorConfigurationResponseErrors createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
