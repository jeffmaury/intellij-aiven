...
public class ServiceGetResponseServiceConnectionPools implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceConnectionPools createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPoolMode(@javax.annotation.Nullable final ServiceGetResponseServiceConnectionPoolsPoolMode value) {
        this.poolMode = value;
    }
    /**
