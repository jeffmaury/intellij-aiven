...
public class ServiceFlinkJobsListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkJobsListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkJobsListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setJobs(@javax.annotation.Nullable final java.util.List<ServiceFlinkJobsListResponseJobs> value) {
        this.jobs = value;
    }
    /**
