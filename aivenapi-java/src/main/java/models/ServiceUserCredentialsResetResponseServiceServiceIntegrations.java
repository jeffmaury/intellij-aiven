...
public class ServiceUserCredentialsResetResponseServiceServiceIntegrations implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsResetResponseServiceServiceIntegrations createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceIntegrationsIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceUserCredentialsResetResponseServiceServiceIntegrationsUserConfig value) {
