...
public class OrganizationDomainVerifyResponse implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationDomainVerifyResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final OrganizationDomainVerifyResponseState value) {
        this.state = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setVerificationType(@javax.annotation.Nullable final OrganizationDomainVerifyResponseVerificationType value) {
