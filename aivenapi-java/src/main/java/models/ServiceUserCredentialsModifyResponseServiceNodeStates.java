...
public class ServiceUserCredentialsModifyResponseServiceNodeStates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceNodeStates createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setProgressUpdates(@javax.annotation.Nullable final java.util.List<ServiceUserCredentialsModifyResponseServiceNodeStatesProgressUpdates> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRole(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceNodeStatesRole value) {
        this.role = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setShard(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceNodeStatesShard value) {
        this.shard = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceNodeStatesState value) {
        this.state = value;
    }
}
