...
public class AccountAuthenticationMethodsListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodsListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setAuthenticationMethods(@javax.annotation.Nullable final java.util.List<AccountAuthenticationMethodsListResponseAuthenticationMethods> value) {
