...
public class ServiceSchemaRegistrySubjectsResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceSchemaRegistrySubjectsResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceSchemaRegistrySubjectsResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSubjects(@javax.annotation.Nullable final java.util.List<String> value) {
        this.subjects = value;
    }
}
