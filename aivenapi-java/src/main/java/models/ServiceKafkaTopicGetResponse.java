...
public class ServiceKafkaTopicGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaTopicGetResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setTopic(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopic value) {
        this.topic = value;
    }
}
