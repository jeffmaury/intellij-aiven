...
public class ServiceUpdateResponseServiceNodeStates implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUpdateResponseServiceNodeStates createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setProgressUpdates(@javax.annotation.Nullable final java.util.List<ServiceUpdateResponseServiceNodeStatesProgressUpdates> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRole(@javax.annotation.Nullable final ServiceUpdateResponseServiceNodeStatesRole value) {
        this.role = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setShard(@javax.annotation.Nullable final ServiceUpdateResponseServiceNodeStatesShard value) {
        this.shard = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceUpdateResponseServiceNodeStatesState value) {
        this.state = value;
    }
}
