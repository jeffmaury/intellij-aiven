...
public class ServiceKafkaMirrorMakerPatchReplicationFlowResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerPatchReplicationFlowResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaMirrorMakerPatchReplicationFlowResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     * @param value Value to set for the replicationFlow property.
     * @return a void
     */
    @javax.annotation.Nonnull
    public void setReplicationFlow(@javax.annotation.Nullable final ServiceKafkaMirrorMakerPatchReplicationFlowResponseReplicationFlow value) {
