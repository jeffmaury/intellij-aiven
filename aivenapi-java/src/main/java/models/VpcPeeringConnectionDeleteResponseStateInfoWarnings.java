...
public class VpcPeeringConnectionDeleteResponseStateInfoWarnings implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionDeleteResponseStateInfoWarnings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final VpcPeeringConnectionDeleteResponseStateInfoWarningsType value) {
        this.type = value;
    }
}
