...
public class ServiceKafkaAclAddResponseAcl implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaAclAddResponseAcl createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setPermission(@javax.annotation.Nullable final ServiceKafkaAclAddResponseAclPermission value) {
