...
public class AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping implements AdditionalDataHolder, Parsable {
    ...
    public static AccountAuthenticationMethodsListResponseAuthenticationMethodsSamlFieldMapping createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
