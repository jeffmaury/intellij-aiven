...
public class ServiceKafkaMirrorMakerDeleteReplicationFlowResponseErrors implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaMirrorMakerDeleteReplicationFlowResponseErrors createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
