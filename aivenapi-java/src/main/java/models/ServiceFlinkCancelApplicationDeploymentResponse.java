...
public class ServiceFlinkCancelApplicationDeploymentResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCancelApplicationDeploymentResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkCancelApplicationDeploymentResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkCancelApplicationDeploymentResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final ServiceFlinkCancelApplicationDeploymentResponseStatus value) {
        this.status = value;
    }
    /**
