...
public class OrganizationUpdateRequestBody implements AdditionalDataHolder, Parsable {
    ...
    public static OrganizationUpdateRequestBody createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTier(@javax.annotation.Nullable final OrganizationUpdateRequestBodyTier value) {
        this.tier = value;
    }
}
