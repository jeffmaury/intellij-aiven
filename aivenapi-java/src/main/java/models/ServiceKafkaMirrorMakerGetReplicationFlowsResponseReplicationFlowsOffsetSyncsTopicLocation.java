...
public enum ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation implements ValuedEnum {
    ...
    public static ServiceKafkaMirrorMakerGetReplicationFlowsResponseReplicationFlowsOffsetSyncsTopicLocation forValue(@javax.annotation.Nonnull final String searchValue) {
