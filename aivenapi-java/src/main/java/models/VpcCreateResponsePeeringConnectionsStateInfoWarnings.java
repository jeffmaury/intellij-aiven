...
public class VpcCreateResponsePeeringConnectionsStateInfoWarnings implements AdditionalDataHolder, Parsable {
    ...
    public static VpcCreateResponsePeeringConnectionsStateInfoWarnings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final VpcCreateResponsePeeringConnectionsStateInfoWarningsType value) {
        this.type = value;
    }
}
