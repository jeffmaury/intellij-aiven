...
public class ServiceKafkaTopicGetResponseTopicPartitionsConsumerGroups implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicPartitionsConsumerGroups createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
