...
public class ServiceGetResponseServiceComponents implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceGetResponseServiceComponents createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setKafkaAuthenticationMethod(@javax.annotation.Nullable final ServiceGetResponseServiceComponentsKafkaAuthenticationMethod value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setRoute(@javax.annotation.Nullable final ServiceGetResponseServiceComponentsRoute value) {
        this.route = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUsage(@javax.annotation.Nullable final ServiceGetResponseServiceComponentsUsage value) {
        this.usage = value;
    }
}
