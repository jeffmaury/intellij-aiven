...
public class ServiceKafkaConnectListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setConnectors(@javax.annotation.Nullable final java.util.List<ServiceKafkaConnectListResponseConnectors> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceKafkaConnectListResponseErrors> value) {
        this.errors = value;
    }
    /**
