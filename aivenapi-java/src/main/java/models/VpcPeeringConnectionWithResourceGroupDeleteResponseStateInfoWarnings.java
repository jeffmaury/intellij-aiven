...
public class VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings implements AdditionalDataHolder, Parsable {
    ...
    public static VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarnings createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final VpcPeeringConnectionWithResourceGroupDeleteResponseStateInfoWarningsType value) {
        this.type = value;
    }
}
