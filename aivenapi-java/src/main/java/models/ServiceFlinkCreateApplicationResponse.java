...
public class ServiceFlinkCreateApplicationResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkCreateApplicationResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setApplicationVersions(@javax.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseApplicationVersions> value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setCurrentDeployment(@javax.annotation.Nullable final ServiceFlinkCreateApplicationResponseCurrentDeployment value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationResponseErrors> value) {
        this.errors = value;
    }
    /**
