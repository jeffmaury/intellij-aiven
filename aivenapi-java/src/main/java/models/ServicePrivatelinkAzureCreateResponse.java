...
public class ServicePrivatelinkAzureCreateResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServicePrivatelinkAzureCreateResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServicePrivatelinkAzureCreateResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServicePrivatelinkAzureCreateResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServicePrivatelinkAzureCreateResponseState value) {
        this.state = value;
    }
    /**
