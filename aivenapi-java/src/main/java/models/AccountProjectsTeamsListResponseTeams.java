...
public class AccountProjectsTeamsListResponseTeams implements AdditionalDataHolder, Parsable {
    ...
    public static AccountProjectsTeamsListResponseTeams createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setTeamType(@javax.annotation.Nullable final AccountProjectsTeamsListResponseTeamsTeamType value) {
        this.teamType = value;
    }
    /**
