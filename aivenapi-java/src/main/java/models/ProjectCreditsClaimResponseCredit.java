...
public class ProjectCreditsClaimResponseCredit implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectCreditsClaimResponseCredit createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setType(@javax.annotation.Nullable final ProjectCreditsClaimResponseCreditType value) {
        this.type = value;
    }
    /**
