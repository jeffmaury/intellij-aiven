...
public class ServiceIntegrationCreateResponseServiceIntegration implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceIntegrationCreateResponseServiceIntegration createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setIntegrationStatus(@javax.annotation.Nullable final ServiceIntegrationCreateResponseServiceIntegrationIntegrationStatus value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setUserConfig(@javax.annotation.Nullable final ServiceIntegrationCreateResponseServiceIntegrationUserConfig value) {
