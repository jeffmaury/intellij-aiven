...
public class ListProjectServiceTypesResponseServiceTypesANY implements AdditionalDataHolder, Parsable {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("service_plans", (n) -> { this.setServicePlans(n.getCollectionOfObjectValues(ListProjectServiceTypesResponseServiceTypesANYServicePlans::createFromDiscriminatorValue)); });
        deserializerMap.put("user_config_schema", (n) -> { this.setUserConfigSchema(n.getObjectValue(ListProjectServiceTypesResponseServiceTypesANYUserConfigSchema::createFromDiscriminatorValue)); });
