...
public class ServiceKafkaConnectCreateConnectorResponseConnector implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaConnectCreateConnectorResponseConnector createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setConfig(@javax.annotation.Nullable final ServiceKafkaConnectCreateConnectorResponseConnectorConfig value) {
        this.config = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPlugin(@javax.annotation.Nullable final ServiceKafkaConnectCreateConnectorResponseConnectorPlugin value) {
        this.plugin = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setTasks(@javax.annotation.Nullable final java.util.List<ServiceKafkaConnectCreateConnectorResponseConnectorTasks> value) {
        this.tasks = value;
    }
}
