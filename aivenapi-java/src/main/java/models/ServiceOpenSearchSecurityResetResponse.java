...
public class ServiceOpenSearchSecurityResetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchSecurityResetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceOpenSearchSecurityResetResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceOpenSearchSecurityResetResponseErrors> value) {
        this.errors = value;
    }
    /**
