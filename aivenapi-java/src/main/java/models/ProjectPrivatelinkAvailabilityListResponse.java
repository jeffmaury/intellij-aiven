...
public class ProjectPrivatelinkAvailabilityListResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ProjectPrivatelinkAvailabilityListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ProjectPrivatelinkAvailabilityListResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ProjectPrivatelinkAvailabilityListResponseErrors> value) {
        this.errors = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPrivatelinkAvailability(@javax.annotation.Nullable final java.util.List<ProjectPrivatelinkAvailabilityListResponsePrivatelinkAvailability> value) {
