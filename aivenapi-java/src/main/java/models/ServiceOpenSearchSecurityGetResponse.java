...
public class ServiceOpenSearchSecurityGetResponse implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceOpenSearchSecurityGetResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceOpenSearchSecurityGetResponseErrors
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ServiceOpenSearchSecurityGetResponseErrors> value) {
        this.errors = value;
    }
    /**
