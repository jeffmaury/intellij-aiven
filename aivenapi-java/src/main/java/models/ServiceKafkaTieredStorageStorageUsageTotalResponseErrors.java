...
public class ServiceKafkaTieredStorageStorageUsageTotalResponseErrors implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTieredStorageStorageUsageTotalResponseErrors createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
