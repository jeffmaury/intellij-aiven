...
public class ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSynonyms implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSynonyms createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setSource(@javax.annotation.Nullable final ServiceKafkaTopicGetResponseTopicConfigIndexIntervalBytesSynonymsSource value) {
        this.source = value;
    }
    /**
