...
public class ServiceFlinkCreateApplicationVersionResponseSinks implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceFlinkCreateApplicationVersionResponseSinks createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ServiceFlinkCreateApplicationVersionResponseSinksColumns
     */
    @javax.annotation.Nullable
     ...
     */
    @javax.annotation.Nonnull
    public void setColumns(@javax.annotation.Nullable final java.util.List<ServiceFlinkCreateApplicationVersionResponseSinksColumns> value) {
        this.columns = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setOptions(@javax.annotation.Nullable final ServiceFlinkCreateApplicationVersionResponseSinksOptions value) {
        this.options = value;
    }
    /**
