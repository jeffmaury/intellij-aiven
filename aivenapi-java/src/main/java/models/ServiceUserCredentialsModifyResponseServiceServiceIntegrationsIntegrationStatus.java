...
public class ServiceUserCredentialsModifyResponseServiceServiceIntegrationsIntegrationStatus implements AdditionalDataHolder, Parsable {
    ...
    public static ServiceUserCredentialsModifyResponseServiceServiceIntegrationsIntegrationStatus createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setState(@javax.annotation.Nullable final ServiceUserCredentialsModifyResponseServiceServiceIntegrationsIntegrationStatusState value) {
        this.state = value;
    }
    /**
