...
public class AuthenticationRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigGetResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigGetResponse> executionException = new java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigGetResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigGetResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigUpdateResponse> patch(@javax.annotation.Nonnull final OrganizationAuthenticationConfigUpdateRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigUpdateResponse> executionException = new java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigUpdateResponse>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<OrganizationAuthenticationConfigUpdateResponse> patch(@javax.annotation.Nonnull final OrganizationAuthenticationConfigUpdateRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final OrganizationAuthenticationConfigUpdateRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPatchRequestInformation(@javax.annotation.Nonnull final OrganizationAuthenticationConfigUpdateRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
