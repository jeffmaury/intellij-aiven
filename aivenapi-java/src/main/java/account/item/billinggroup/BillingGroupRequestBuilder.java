...
public class BillingGroupRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccountBillingGroupListResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AccountBillingGroupListResponse> executionException = new java.util.concurrent.CompletableFuture<AccountBillingGroupListResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AccountBillingGroupListResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
