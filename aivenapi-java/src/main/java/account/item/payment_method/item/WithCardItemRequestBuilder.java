...
public class WithCardItemRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<AccountPaymentMethodDeleteResponse> delete() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<AccountPaymentMethodDeleteResponse> executionException = new java.util.concurrent.CompletableFuture<AccountPaymentMethodDeleteResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<AccountPaymentMethodDeleteResponse> delete(@javax.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        try {
