...
public class CaRequestBuilder extends BaseRequestBuilder {
     ...
     * @return a CompletableFuture of ProjectKmsGetCAResponse
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ProjectKmsGetCAResponse> get() {
        try {
            final RequestInformation requestInfo = toGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, ProjectKmsGetCAResponse::createFromDiscriminatorValue, null);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<ProjectKmsGetCAResponse> executionException = new java.util.concurrent.CompletableFuture<ProjectKmsGetCAResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ProjectKmsGetCAResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
