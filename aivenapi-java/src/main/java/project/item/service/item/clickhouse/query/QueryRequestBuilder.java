package com.jeffmaury.aiven.intellij.api.project.item.service.item.clickhouse.query;

import com.jeffmaury.aiven.intellij.api.project.item.service.item.clickhouse.query.stats.StatsRequestBuilder;
import com.microsoft.kiota.BaseRequestBuilder;
import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
/**
 * Builds and executes requests for operations under /project/{project}/service/{service_name}/clickhouse/query
 */
public class QueryRequestBuilder extends BaseRequestBuilder {
    ...
    public QueryRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/project/{project}/service/{service_name}/clickhouse/query", pathParameters);
    }
    /**
     * Instantiates a new QueryRequestBuilder and sets the default values.
    ...
    public QueryRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/project/{project}/service/{service_name}/clickhouse/query", rawUrl);
    }
}
