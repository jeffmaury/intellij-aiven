...
public class ConnectionsRequestBuilder extends BaseRequestBuilder {
     ...
     * @param privatelink_connection_id Unique identifier of the item
     * @return a WithPrivatelinkConnectionItemRequestBuilder
     */
    @javax.annotation.Nonnull
    public WithPrivatelinkConnectionItemRequestBuilder byPrivatelink_connection_id(@javax.annotation.Nonnull final String privatelink_connection_id) {
     ...
     * @return a CompletableFuture of ServicePrivatelinkAzureConnectionListResponse
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionListResponse> get() {
        try {
            final RequestInformation requestInfo = toGetRequestInformation(null);
            return this.requestAdapter.sendAsync(requestInfo, ServicePrivatelinkAzureConnectionListResponse::createFromDiscriminatorValue, null);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionListResponse> executionException = new java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionListResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionListResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
