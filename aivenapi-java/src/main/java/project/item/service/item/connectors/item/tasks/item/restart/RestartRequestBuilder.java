...
public class RestartRequestBuilder extends BaseRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<ServiceKafkaConnectRestartConnectorTaskResponse> post() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ServiceKafkaConnectRestartConnectorTaskResponse> executionException = new java.util.concurrent.CompletableFuture<ServiceKafkaConnectRestartConnectorTaskResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceKafkaConnectRestartConnectorTaskResponse> post(@javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        try {
