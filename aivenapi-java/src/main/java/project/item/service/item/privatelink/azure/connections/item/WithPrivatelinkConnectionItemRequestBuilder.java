...
public class WithPrivatelinkConnectionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithPrivatelinkConnectionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public WithPrivatelinkConnectionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionUpdateResponse> put(@javax.annotation.Nonnull final ServicePrivatelinkAzureConnectionUpdateRequestBody body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionUpdateResponse> executionException = new java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionUpdateResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServicePrivatelinkAzureConnectionUpdateResponse> put(@javax.annotation.Nonnull final ServicePrivatelinkAzureConnectionUpdateRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@javax.annotation.Nonnull final ServicePrivatelinkAzureConnectionUpdateRequestBody body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@javax.annotation.Nonnull final ServicePrivatelinkAzureConnectionUpdateRequestBody body, @javax.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
