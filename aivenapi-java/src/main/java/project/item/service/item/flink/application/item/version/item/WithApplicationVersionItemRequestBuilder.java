...
public class WithApplicationVersionItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithApplicationVersionItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @javax.annotation.Nullable
    public WithApplicationVersionItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<ServiceFlinkDeleteApplicationVersionResponse> delete() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ServiceFlinkDeleteApplicationVersionResponse> executionException = new java.util.concurrent.CompletableFuture<ServiceFlinkDeleteApplicationVersionResponse>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceFlinkDeleteApplicationVersionResponse> delete(@javax.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
        try {
    ...
    public java.util.concurrent.CompletableFuture<ServiceFlinkGetApplicationVersionResponse> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ServiceFlinkGetApplicationVersionResponse> executionException = new java.util.concurrent.CompletableFuture<ServiceFlinkGetApplicationVersionResponse>();
            executionException.completeExceptionally(ex);
            return executionException;
        }
    }
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ServiceFlinkGetApplicationVersionResponse> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
